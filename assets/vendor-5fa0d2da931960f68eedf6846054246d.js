...
e.default=be})),t("@ember/-internals/bootstrap")}(),"undefined"==typeof FastBoot&&/*! UIkit 3.13.1 | https://www.getuikit.com | (c) 2014 - 2022 YOOtheme | MIT License */
...
return t?ue(r,t):r}function me(e,t){return t?I(e).indexOf(j(t)):fe(le(e)).indexOf(e)}function ge(e,t){return be(e,ke(e,t))}function ve(e,t){return ye(e,ke(e,t))}function be(e,t){return j(Ee(e,t,"querySelector"))}function ye(e,t){return I(Ee(e,t,"querySelectorAll"))}const we=/(^|[^\\],)\s*[!>+~-]/,_e=K((e=>e.match(we)))
function ke(e,t){return void 0===t&&(t=document),E(e)&&_e(e)||w(t)?t:t.ownerDocument}const xe=/([!>+~-])(?=\s+[!>+~-]|\s*$)/g,Oe=K((e=>e.replace(xe,"$1 *")))
function Ee(e,t,r){if(void 0===t&&(t=document),!e||!E(e))return e
if(e=Oe(e),_e(e)){const r=Pe(e)
e=""
for(let n of r){let i=t
if("!"===n[0]){const e=n.substr(1).trim().split(" ")
if(i=de(le(t),e[0]),n=e.slice(1).join(" ").trim(),!n.length&&1===r.length)return i}if("-"===n[0]){const e=n.substr(1).trim().split(" "),r=(i||t).previousElementSibling
i=ce(r,n.substr(1))?r:null,n=e.slice(1).join(" ")}i&&(e+=(e?",":"")+Te(i)+" "+n)}t=document}try{return t[r](e)}catch(n){return null}}const Ce=/.*?[^\\](?:,|$)/g,Pe=K((e=>e.match(Ce).map((e=>e.replace(/,$/,"").trim()))))
function Te(e){const t=[]
for(;e.parentNode;){const r=Z(e,"id")
if(r){t.unshift("#"+Se(r))
break}{let{tagName:r}=e
"HTML"!==r&&(r+=":nth-child("+(me(e)+1)+")"),t.unshift(r),e=e.parentNode}}return t.join(" > ")}function Se(e){return E(e)?CSS.escape(e):""}function Ae(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r]
let[n,i,s,o,a=!1]=Le(t)
o.length>1&&(o=De(o)),null!=a&&a.self&&(o=Fe(o)),s&&(o=Ne(s,o))
...
let[n,i,,s,o=!1]=Le(t)
for(const a of i)for(const e of n)e.removeEventListener(a,s,o)}function Re(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r]
const[n,i,s,o,a=!1,l]=Le(t),u=Ae(n,i,s,(e=>{const t=!l||l(e)
t&&(u(),o(e,t))}),a)
return u}function je(e,t,r){return Be(e).every((e=>e.dispatchEvent(Ie(t,!0,!0,r))))}function Ie(e,t,r,n){return void 0===t&&(t=!0),void 0===r&&(r=!1),E(e)&&(e=new CustomEvent(e,{bubbles:t,cancelable:r,detail:n})),e}function Le(e){return e[0]=Be(e[0]),E(e[1])&&(e[1]=e[1].split(" ")),g(e[2])&&e.splice(2,0,!1),e}function Ne(e,t){return r=>{const n=">"===e[0]?ye(e,r.currentTarget).reverse().filter((e=>he(r.target,e)))[0]:de(r.target,e)
n&&(r.current=n,t.call(this,r))}}function De(e){return t=>p(t.detail)?e(t,...t.detail):e(t)}function Fe(e){return function(t){if(t.target===t.currentTarget||t.target===t.current)return e.call(null,t)}}function $e(e){return e&&"addEventListener"in e}function ze(e){return $e(e)?e:j(e)}function Be(e){return p(e)?e.map(ze).filter(Boolean):E(e)?ye(e):$e(e)?[e]:I(e)}function Ue(e){return"touch"===e.pointerType||!!e.touches}function He(e){var t,r
const{clientX:n,clientY:i}=(null==(t=e.touches)?void 0:t[0])||(null==(r=e.changedTouches)?void 0:r[0])||e
return{x:n,y:i}}function Ve(e,t){const r={data:null,method:"GET",headers:{},xhr:new XMLHttpRequest,beforeSend:V,responseType:"",...t}
...
Ae(i,"load",(()=>{0===i.status||i.status>=200&&i.status<300||304===i.status?r(i):n(m(Error(i.statusText),{xhr:i,status:i.status}))})),Ae(i,"error",(()=>n(m(Error("Network Error"),{xhr:i})))),Ae(i,"timeout",(()=>n(m(Error("Network Timeout"),{xhr:i})))),i.send(t.data)}))}(e,r)))}function qe(e,t,r){return new Promise(((n,i)=>{const s=new Image
s.onerror=e=>{i(e)},s.onload=()=>{n(s)},r&&(s.sizes=r),t&&(s.srcset=t),s.src=e}))}const We={"animation-iteration-count":!0,"column-count":!0,"fill-opacity":!0,"flex-grow":!0,"flex-shrink":!0,"font-weight":!0,"line-height":!0,opacity:!0,order:!0,orphans:!0,"stroke-dasharray":!0,"stroke-dashoffset":!0,widows:!0,"z-index":!0,zoom:!0}
function Ye(e,t,r,n){void 0===n&&(n="")
const i=I(e)
for(const s of i)if(E(t)){if(t=Xe(t),S(r))return Ke(s,t)
r||C(r)?s.style.setProperty(t,P(r)&&!We[t]?r+"px":r,n):s.style.removeProperty(t)}else{if(p(t)){const e=Ge(s),r={}
for(const n of t)r[n]=e[Xe(n)]
return r}v(t)&&(n=r,z(t,((e,t)=>Ye(s,t,e,n))))}return i[0]}function Ge(e,t){return L(e).getComputedStyle(e,t)}function Ke(e,t,r){return Ge(e,r)[t]}const Qe=/^\s*(["'])?(.*?)\1\s*$/
function Ze(e){return Ge(document.documentElement).getPropertyValue("--uk-"+e).replace(Qe,"$2")}const Xe=K((e=>function(e){e=i(e)
const{style:t}=document.documentElement
if(e in t)return e
let r,n=Je.length
for(;n--;)if(r="-"+Je[n]+"-"+e,r in t)return r}(e))),Je=["webkit","moz"]
function et(e){for(var t=arguments.length,r=new Array(t>1?t-1:0),n=1;n<t;n++)r[n-1]=arguments[n]
ot(e,r,"add")}function tt(e){for(var t=arguments.length,r=new Array(t>1?t-1:0),n=1;n<t;n++)r[n-1]=arguments[n]
ot(e,r,"remove")}function rt(e,t){Z(e,"class",(e=>(e||"").replace(new RegExp("\\b"+t+"\\b","g"),"")))}function nt(e){(arguments.length<=1?void 0:arguments[1])&&tt(e,arguments.length<=1?void 0:arguments[1]),(arguments.length<=2?void 0:arguments[2])&&et(e,arguments.length<=2?void 0:arguments[2])}function it(e,t){return[t]=at(t),!!t&&I(e).some((e=>e.classList.contains(t)))}function st(e,t,r){const n=at(t)
S(r)||(r=!!r)
for(const i of I(e))for(const e of n)i.classList.toggle(e,r)}function ot(e,t,r){t=t.reduce(((e,t)=>e.concat(at(t))),[])
for(const n of I(e))n.classList[r](...t)}function at(e){return String(e).split(/\s|,/).filter(Boolean)}function lt(e,t,r,n){return void 0===r&&(r=400),void 0===n&&(n="linear"),Promise.all(I(e).map((e=>new Promise(((i,s)=>{for(const r in t){const t=Ye(e,r)
""===t&&Ye(e,r,t)}const o=setTimeout((()=>je(e,"transitionend")),r)
Re(e,"transitionend transitioncanceled",(t=>{let{type:r}=t
clearTimeout(o),tt(e,"uk-transition"),Ye(e,{transitionProperty:"",transitionDuration:"",transitionTimingFunction:""}),"transitioncanceled"===r?s():i(e)}),{self:!0}),et(e,"uk-transition"),Ye(e,{transitionProperty:Object.keys(t).map(Xe).join(","),transitionDuration:r+"ms",transitionTimingFunction:n,...t})})))))}const ut={start:lt,stop:e=>(je(e,"transitionend"),Promise.resolve()),cancel(e){je(e,"transitioncanceled")},inProgress:e=>it(e,"uk-transition")},ct="uk-animation-"
function dt(e,t,r,n,i){return void 0===r&&(r=200),Promise.all(I(e).map((e=>new Promise(((s,o)=>{je(e,"animationcanceled")
const a=setTimeout((()=>je(e,"animationend")),r)
Re(e,"animationend animationcanceled",(t=>{let{type:r}=t
clearTimeout(a),"animationcanceled"===r?o():s(e),Ye(e,"animationDuration",""),rt(e,"uk-animation-\\S*")}),{self:!0}),Ye(e,"animationDuration",r+"ms"),et(e,t,ct+(i?"leave":"enter")),u(t,ct)&&(n&&et(e,"uk-transform-origin-"+n),i&&et(e,"uk-animation-reverse"))})))))}const ht=new RegExp("uk-animation-(enter|leave)"),pt={in:dt,out:(e,t,r,n)=>dt(e,t,r,n,!0),inProgress:e=>ht.test(Z(e,"class")),cancel(e){je(e,"animationcanceled")}},ft={width:["left","right"],height:["top","bottom"]}
function mt(e){const t=k(e)?j(e).getBoundingClientRect():{height:yt(e),width:wt(e),top:0,left:0}
return{height:t.height,width:t.width,top:t.top,left:t.left,bottom:t.top+t.height,right:t.left+t.width}}function gt(e,t){const r=mt(e)
if(e){const{scrollY:t,scrollX:n}=L(e),i={height:t,width:n}
for(const e in ft)for(const t in ft[e])r[ft[e][t]]+=i[e]}if(!t)return r
const n=Ye(e,"position")
z(Ye(e,["left","top"]),((i,s)=>Ye(e,s,t[s]-r[s]+R("absolute"===n&&"auto"===i?vt(e)[s]:i))))}function vt(e){let{top:t,left:r}=gt(e)
const{ownerDocument:{body:n,documentElement:i},offsetParent:s}=j(e)
let o=s||i
for(;o&&(o===n||o===i)&&"static"===Ye(o,"position");)o=o.parentNode
if(k(o)){const e=gt(o)
t-=e.top+R(Ye(o,"borderTopWidth")),r-=e.left+R(Ye(o,"borderLeftWidth"))}return{top:t-R(Ye(e,"marginTop")),left:r-R(Ye(e,"marginLeft"))}}function bt(e){const t=[0,0]
e=j(e)
do{if(t[0]+=e.offsetTop,t[1]+=e.offsetLeft,"fixed"===Ye(e,"position")){const r=L(e)
return t[0]+=r.scrollY,t[1]+=r.scrollX,t}}while(e=e.offsetParent)
return t}const yt=_t("height"),wt=_t("width")
function _t(e){const t=a(e)
return(r,n)=>{if(S(n)){if(y(r))return r["inner"+t]
if(w(r)){const e=r.documentElement
return Math.max(e["offset"+t],e["scroll"+t])}return(n="auto"===(n=Ye(r=j(r),e))?r["offset"+t]:R(n)||0)-kt(r,e)}return Ye(r,e,n||0===n?+n+kt(r,e)+"px":"")}}function kt(e,t,r){return void 0===r&&(r="border-box"),Ye(e,"boxSizing")===r?ft[t].map(a).reduce(((t,r)=>t+R(Ye(e,"padding"+r))+R(Ye(e,"border"+r+"Width"))),0):0}function xt(e){for(const t in ft)for(const r in ft[t])if(ft[t][r]===e)return ft[t][1-r]
return e}function Ot(e,t,r,n){return void 0===t&&(t="width"),void 0===r&&(r=window),void 0===n&&(n=!1),E(e)?Ct(e).reduce(((e,i)=>{const s=Tt(i)
return s&&(i=function(e,t){return e*R(t)/100}("vh"===s?yt(L(r)):"vw"===s?wt(L(r)):n?r["offset"+a(t)]:mt(r)[t],i)),e+R(i)}),0):R(e)}const Et=/-?\d+(?:\.\d+)?(?:v[wh]|%|px)?/g,Ct=K((e=>e.toString().replace(/\s/g,"").match(Et)||[])),Pt=/(?:v[hw]|%)$/,Tt=K((e=>(e.match(Pt)||[])[0]))
function St(e){"loading"===document.readyState?Re(document,"DOMContentLoaded",e):e()}function At(e,t){var r
return(null==e||null==(r=e.tagName)?void 0:r.toLowerCase())===t.toLowerCase()}function Mt(e,t){return S(t)?Yt(e).innerHTML:Rt(e,t)}const Rt=Dt("replaceChildren"),jt=Dt("prepend"),It=Dt("append"),Lt=Dt("before"),Nt=Dt("after")
function Dt(e){return function(t,r){var n
const i=I(E(r)?Vt(r):r)
return null==(n=Yt(t))||n[e](...i),qt(i)}}function Ft(e){I(e).forEach((e=>e.remove()))}function $t(e,t){for(t=j(Lt(e,t));t.firstChild;)t=t.firstChild
return It(t,e),t}function zt(e,t){return I(I(e).map((e=>e.hasChildNodes()?$t(I(e.childNodes),t):It(e,t))))}function Bt(e){I(e).map(le).filter(((e,t,r)=>r.indexOf(e)===t)).forEach((e=>e.replaceWith(...e.childNodes)))}const Ut=/^\s*<(\w+|!)[^>]*>/,Ht=/^<(\w+)\s*\/?>(?:<\/\1>)?$/
function Vt(e){const t=Ht.exec(e)
if(t)return document.createElement(t[1])
const r=document.createElement("div")
return Ut.test(e)?r.insertAdjacentHTML("beforeend",e.trim()):r.textContent=e,qt(r.childNodes)}function qt(e){return e.length>1?e:e[0]}function Wt(e,t){if(k(e))for(t(e),e=e.firstElementChild;e;){const r=e.nextElementSibling
Wt(e,t),e=r}}function Yt(e,t){return Kt(e)?j(Vt(e)):be(e,t)}function Gt(e,t){return Kt(e)?I(Vt(e)):ye(e,t)}function Kt(e){return E(e)&&u(e.trim(),"<")}const Qt="undefined"!=typeof window,Zt=Qt&&"rtl"===Z(document.documentElement,"dir"),Xt=Qt&&"ontouchstart"in window,Jt=Qt&&window.PointerEvent,er=Jt?"pointerdown":Xt?"touchstart":"mousedown",tr=Jt?"pointermove":Xt?"touchmove":"mousemove",rr=Jt?"pointerup":Xt?"touchend":"mouseup",nr=Jt?"pointerenter":Xt?"":"mouseenter",ir=Jt?"pointerleave":Xt?"":"mouseleave",sr=Jt?"pointercancel":"touchcancel",or={reads:[],writes:[],read(e){return this.reads.push(e),lr(),e},write(e){return this.writes.push(e),lr(),e},clear(e){cr(this.reads,e),cr(this.writes,e)},flush:ar}
function ar(e){ur(or.reads),ur(or.writes.splice(0)),or.scheduled=!1,(or.reads.length||or.writes.length)&&lr(e+1)}function lr(e){or.scheduled||(or.scheduled=!0,e&&e<4?Promise.resolve().then((()=>ar(e))):requestAnimationFrame((()=>ar(1))))}function ur(e){let t
for(;t=e.shift();)try{t()}catch(r){console.error(r)}}function cr(e,t){const r=e.indexOf(t)
return~r&&e.splice(r,1)}function dr(){}function hr(e,t,r,n){return void 0===n&&(n=!0),vr(IntersectionObserver,e,n?(e,r)=>{e.some((e=>e.isIntersecting))&&t(e,r)}:t,r)}dr.prototype={positions:[],init(){let e
this.positions=[],this.unbind=Ae(document,"mousemove",(t=>e=He(t))),this.interval=setInterval((()=>{e&&(this.positions.push(e),this.positions.length>5&&this.positions.shift())}),50)},cancel(){var e
...
function fr(e,t,r){return void 0===r&&(r={box:"border-box"}),pr?vr(ResizeObserver,e,t,r):(function(){if(mr)return
let e
mr=new Set
const t=()=>{if(!e){e=!0,or.read((()=>e=!1))
for(const e of mr)e()}}
Ae(window,"load resize",t),Ae(document,"loadedmetadata load",t,!0)}(),mr.add(t),{disconnect(){mr.delete(t)}})}let mr
function gr(e,t,r){return vr(MutationObserver,e,t,r)}function vr(e,t,r,n){const i=new e(r)
for(const s of I(t))i.observe(s,n)
return i}const br={}
function yr(e,t,r){return br.computed(g(e)?e.call(r,r):e,g(t)?t.call(r,r):t)}function wr(e,t){return e=e&&!p(e)?[e]:e,t?e?e.concat(t):p(t)?t:[t]:e}function _r(e,t){return S(t)?e:t}function kr(e,t,n){const i={}
if(g(t)&&(t=t.options),t.extends&&(e=kr(e,t.extends,n)),t.mixins)for(const r of t.mixins)e=kr(e,r,n)
for(const r in e)s(r)
for(const o in t)r(e,o)||s(o)
function s(r){i[r]=(br[r]||_r)(e[r],t[r],n)}return i}function xr(e,t){void 0===t&&(t=[])
try{return e?u(e,"{")?JSON.parse(e):t.length&&!d(e,":")?{[t[0]]:e}:e.split(";").reduce(((e,t)=>{const[r,n]=t.split(/:(.*)/)
return r&&!S(n)&&(e[r.trim()]=n.trim()),e}),{}):{}}catch(r){return{}}}function Or(e){if(Sr(e)&&Rr(e,{func:"playVideo",method:"play"}),Tr(e))try{e.play().catch(V)}catch(t){}}function Er(e){Sr(e)&&Rr(e,{func:"pauseVideo",method:"pause"}),Tr(e)&&e.pause()}function Cr(e){Sr(e)&&Rr(e,{func:"mute",method:"setVolume",value:0}),Tr(e)&&(e.muted=!0)}function Pr(e){return Tr(e)||Sr(e)}function Tr(e){return At(e,"video")}function Sr(e){return At(e,"iframe")&&(Ar(e)||Mr(e))}function Ar(e){return!!e.src.match(/\/\/.*?youtube(-nocookie)?\.[a-z]+\/(watch\?v=[^&\s]+|embed)|youtu\.be\/.*/)}function Mr(e){return!!e.src.match(/vimeo\.com\/video\/.*/)}async function Rr(e,t){await function(e){if(e._ukPlayer)return e._ukPlayer
const t=Ar(e),r=Mr(e),n=++Ir
let i
return e._ukPlayer=new Promise((s=>{t&&Re(e,"load",(()=>{const t=()=>jr(e,{event:"listening",id:n})
i=setInterval(t,100),t()})),Re(window,"message",s,!1,(e=>{let{data:i}=e
try{return i=JSON.parse(i),i&&(t&&i.id===n&&"onReady"===i.event||r&&Number(i.player_id)===n)}catch(s){}})),e.src=e.src+(d(e.src,"?")?"&":"?")+(t?"enablejsapi=1":"api=1&player_id="+n)})).then((()=>clearInterval(i)))}(e),jr(e,t)}function jr(e,t){try{e.contentWindow.postMessage(JSON.stringify({event:"command",...t}),"*")}catch(r){}}br.events=br.created=br.beforeConnect=br.connected=br.beforeDisconnect=br.disconnected=br.destroy=wr,br.args=function(e,t){return!1!==t&&wr(t||e)},br.update=function(e,t){return B(wr(e,g(t)?{read:t}:t),"order")},br.props=function(e,t){if(p(t)){const e={}
for(const r of t)e[r]=String
t=e}return br.methods(e,t)},br.computed=br.methods=function(e,t){return t?e?{...e,...t}:t:e},br.data=function(e,t,r){return r?yr(e,t,r):t?e?function(r){return yr(e,t,r)}:t:e}
let Ir=0
function Lr(e,t,r){return void 0===t&&(t=0),void 0===r&&(r=0),!!ne(e)&&q(...$r(e).map((e=>{const{top:n,left:i,bottom:s,right:o}=gt(zr(e))
return{top:n-t,left:i-r,bottom:s+t,right:o+r}})).concat(gt(e)))}function Nr(e,t){if(e=y(e)||w(e)?Ur(e):j(e),S(t))return e.scrollTop
e.scrollTop=t}function Dr(e,t){let{offset:r=0}=void 0===t?{}:t
const n=ne(e)?$r(e):[]
return n.reduce(((t,s,o)=>{const{scrollTop:a,scrollHeight:l,offsetHeight:u}=s,c=l-Br(s),{height:d,top:h}=gt(n[o-1]||e)
let p=Math.ceil(h-gt(zr(s)).top-r+a)
...
var l
Nr(e,n+t*a),1===a?r():requestAnimationFrame(s)})()}))}}function Fr(e,t,r){if(void 0===t&&(t=0),void 0===r&&(r=0),!ne(e))return 0
const[n]=$r(e,/auto|scroll/,!0),{scrollHeight:i,scrollTop:s}=n,o=Br(n),a=i-o,l=bt(e)[0]-bt(n)[0],u=Math.max(0,l-o+t)
return H((s-u)/(Math.min(a,l+e.offsetHeight-r)-u))}function $r(e,t,r){void 0===t&&(t=/auto|scroll|hidden/),void 0===r&&(r=!1)
const n=Ur(e)
let i=pe(e).reverse()
i=i.slice(i.indexOf(n)+1)
const s=h(i,(e=>"fixed"===Ye(e,"position")))
return~s&&(i=i.slice(s)),[n].concat(i.filter((e=>t.test(Ye(e,"overflow"))&&(!r||e.scrollHeight>Br(e))))).reverse()}function zr(e){return e===Ur(e)?window:e}function Br(e){return(e===Ur(e)?document.documentElement:e).clientHeight}function Ur(e){const{document:t}=L(e)
return t.scrollingElement||t.documentElement}const Hr={width:["x","left","right"],height:["y","top","bottom"]}
function Vr(e,t,r,n,i,s,o,a){r=Wr(r),n=Wr(n)
const l={element:r,target:n}
if(!e||!t)return l
const u=gt(e),c=gt(t),h=c
if(qr(h,r,u,-1),qr(h,n,c,1),i=Yr(i,u.width,u.height),s=Yr(s,c.width,c.height),i.x+=s.x,i.y+=s.y,h.left+=i.x,h.top+=i.y,o){let t=$r(e).map(zr)
a&&!d(t,a)&&t.unshift(a),t=t.map((e=>gt(e))),z(Hr,((e,s)=>{let[a,p,f]=e;(!0===o||d(o,a))&&t.some((e=>{const t=r[a]===p?-u[s]:r[a]===f?u[s]:0,o=n[a]===p?c[s]:n[a]===f?-c[s]:0
...
for(const e of["element","target"])t&&(l[e][a]=l[e][a]===Hr[s][1]?Hr[s][2]:Hr[s][1])
return!0}}}))}))}return gt(e,h),l}function qr(e,t,r,n){z(Hr,((i,s)=>{let[o,a,l]=i
t[o]===l?e[a]+=r[s]*n:"center"===t[o]&&(e[a]+=r[s]*n/2)}))}function Wr(e){const t=/left|center|right/,r=/top|center|bottom/
return 1===(e=(e||"").split(" ")).length&&(e=t.test(e[0])?e.concat("center"):r.test(e[0])?["center"].concat(e):["center","center"]),{x:t.test(e[0])?e[0]:"center",y:r.test(e[1])?e[1]:"center"}}function Yr(e,t,r){const[n,i]=(e||"").split(" ")
return{x:n?R(n)*(c(n,"%")?t/100:1):0,y:i?R(i)*(c(i,"%")?r/100:1):0}}var Gr=Object.freeze({__proto__:null,ajax:Ve,getImage:qe,transition:lt,Transition:ut,animate:dt,Animation:pt,attr:Z,hasAttr:X,removeAttr:J,data:ee,addClass:et,removeClass:tt,removeClasses:rt,replaceClass:nt,hasClass:it,toggleClass:st,dimensions:mt,offset:gt,position:vt,offsetPosition:bt,height:yt,width:wt,boxModelAdjust:kt,flipPosition:xt,toPx:Ot,ready:St,isTag:At,empty:function(e){return Rt(e,"")},html:Mt,replaceChildren:Rt,prepend:jt,append:It,before:Lt,after:Nt,remove:Ft,wrapAll:$t,wrapInner:zt,unwrap:Bt,fragment:Vt,apply:Wt,$:Yt,$$:Gt,inBrowser:Qt,isRtl:Zt,hasTouch:Xt,pointerDown:er,pointerMove:tr,pointerUp:rr,pointerEnter:nr,pointerLeave:ir,pointerCancel:sr,on:Ae,off:Me,once:Re,trigger:je,createEvent:Ie,toEventTargets:Be,isTouch:Ue,getEventPos:He,fastdom:or,isVoidElement:re,isVisible:ne,selInput:ie,isInput:se,selFocusable:oe,isFocusable:ae,parent:le,filter:ue,matches:ce,closest:de,within:he,parents:pe,children:fe,index:me,hasOwn:r,hyphenate:i,camelize:o,ucfirst:a,startsWith:u,endsWith:c,includes:d,findIndex:h,isArray:p,toArray:f,assign:m,isFunction:g,isObject:v,isPlainObject:b,isWindow:y,isDocument:w,isNode:_,isElement:k,isBoolean:O,isString:E,isNumber:C,isNumeric:P,isEmpty:T,isUndefined:S,toBoolean:A,toNumber:M,toFloat:R,toNode:j,toNodes:I,toWindow:L,toMs:N,isEqual:D,swap:F,last:$,each:z,sortBy:B,uniqueBy:U,clamp:H,noop:V,intersectRect:q,pointInRect:W,Dimensions:Y,getIndex:G,memoize:K,Deferred:Q,MouseTracker:dr,observeIntersection:hr,observeResize:fr,observeMutation:gr,mergeOptions:kr,parseOptions:xr,play:Or,pause:Er,mute:Cr,isVideo:Pr,positionAt:Vr,query:ge,queryAll:ve,find:be,findAll:ye,escape:Se,css:Ye,getCssVar:Ze,propName:Xe,isInView:Lr,scrollTop:Nr,scrollIntoView:Dr,scrolledOver:Fr,scrollParents:$r,getViewport:zr,getViewportClientHeight:Br,getScrollingElement:Ur})
function Kr(e,t){const r={},{args:n=[],props:s={},el:a}=e
if(!s)return r
for(const o in s){const e=i(o)
let t=ee(a,e)
S(t)||(t=s[o]===Boolean&&""===t||Jr(s[o],t),("target"!==e||t&&!u(t,"_"))&&(r[o]=t))}const l=xr(ee(a,t),n)
for(const i in l){const e=o(i)
void 0!==s[e]&&(r[e]=Jr(s[e],l[i]))}return r}function Qr(e,t,n){Object.defineProperty(e,t,{enumerable:!0,get(){const{_computed:i,$props:s,$el:o}=e
return r(i,t)||(i[t]=(n.get||n).call(e,s,o)),i[t]},set(r){const{_computed:i}=e
i[t]=n.set?n.set.call(e,r):r,S(i[t])&&delete i[t]}})}function Zr(e,t,r){b(t)||(t={name:r,handler:t})
let{name:n,el:i,handler:s,capture:o,passive:a,delegate:l,filter:u,self:c}=t
i=g(i)?i.call(e):i||e.$el,p(i)?i.forEach((n=>Zr(e,{...t,el:n},r))):!i||u&&!u.call(e)||e._events.push(Ae(i,n,l?E(l)?l:l.call(e):null,E(s)?e[s]:s.bind(e),{passive:a,capture:o,self:c}))}function Xr(e,t){return e.every((e=>!e||!r(e,t)))}function Jr(e,t){return e===Boolean?A(t):e===Number?M(t):"list"===e?function(e){return p(e)?e:E(e)?e.split(/,(?![^(]*\))/).map((e=>P(e)?M(e):A(e.trim()))):[e]}(t):e?e(t):t}function en(e){const{$name:t,$options:r,$props:n}=e,{attrs:s,props:a,el:l}=r
if(!a||!1===s)return
const u=p(s)?s:Object.keys(a),c=u.map((e=>i(e))).concat(t),d=new MutationObserver((i=>{const s=Kr(r,t)
i.some((e=>{let{attributeName:r}=e
const i=r.replace("data-","")
return(i===t?u:[o(i),o(r)]).some((e=>!S(s[e])&&s[e]!==n[e]))}))&&e.$reset()}))
return d.observe(l,{attributes:!0,attributeFilter:c.concat(c.map((e=>"data-"+e)))}),d}const tn=K((e=>!(!u(e,"uk-")&&!u(e,"data-uk-"))&&o(e.replace("data-uk-","").replace("uk-","")))),rn=function(e){this._init(e)}
rn.util=Gr,rn.data="__uikit__",rn.prefix="uk-",rn.options={},rn.version="3.13.1",function(e){const t=e.data
let r
function n(e,t){if(e)for(const r in e)e[r]._connected&&e[r]._callUpdate(t)}e.use=function(e){if(!e.installed)return e.call(null,this),e.installed=!0,this},e.mixin=function(t,r){(r=(E(r)?e.component(r):r)||this).options=kr(r.options,t)},e.extend=function(e){e=e||{}
const t=this,r=function(e){this._init(e)}
return(r.prototype=Object.create(t.prototype)).constructor=r,r.options=kr(t.options,e),r.super=t,r.extend=t.extend,r},e.update=function(e,r){e=e?j(e):document.body
for(const i of pe(e).reverse())n(i[t],r)
Wt(e,(e=>n(e[t],r)))},Object.defineProperty(e,"container",{get:()=>r||document.body,set(e){r=Yt(e)}})}(rn),function(e){function t(e){for(const{read:t,write:r,events:n=[]}of this.$options.update){if(!e.has("update")&&!n.some((t=>e.has(t))))continue
let i
t&&(i=t.call(this,this._data,e),i&&b(i)&&m(this._data,i)),r&&!1!==i&&or.write((()=>r.call(this,this._data,e)))}}function n(e){const{$options:{computed:t}}=this,n={...this._computed}
this._computed={}
...
for(const s in r)S(r[s])?delete r[s]:i[s]&&(r[s]=Jr(i[s],r[s]))
return r}(e,this.constructor.options),this.$options=kr(this.constructor.options,e,this),this.$el=null,this.$props={},this._uid=t++,this._initData(),this._initMethods(),this._initComputeds(),this._callHook("created"),e.el&&this.$mount(e.el)},e.prototype._initData=function(){const{data:e={}}=this.$options
...
if(this._computed={},e)for(const t in e)Qr(this,t,e[t])},e.prototype._initProps=function(e){let t
for(t in e=e||Kr(this.$options,this.$name))S(e[t])||(this.$props[t]=e[t])
const r=[this.$options.computed,this.$options.methods]
for(t in this.$props)t in e&&Xr(r,t)&&(this[t]=this.$props[t])},e.prototype._initEvents=function(){this._events=[]
for(const e of this.$options.events||[])if(r(e,"handler"))Zr(this,e)
else for(const t in e)Zr(this,e[t],t)},e.prototype._unbindEvents=function(){this._events.forEach((e=>e())),delete this._events},e.prototype._initObservers=function(){this._observers=[en(this)],this.$options.computed&&this.registerObserver(function(e){const{el:t}=e.$options,r=new MutationObserver((()=>e.$emit()))
return r.observe(t,{childList:!0,subtree:!0}),r}(this))},e.prototype.registerObserver=function(e){this._observers.push(e)},e.prototype._disconnectObservers=function(){this._observers.forEach((e=>null==e?void 0:e.disconnect()))}}(rn),function(e){const t=e.data,r={}
e.component=function(t,n){const s=i(t)
if(t=o(s),!n)return b(r[t])&&(r[t]=e.extend(r[t])),r[t]
e[t]=function(r,n){const i=e.component(t)
return i.options.functional?new i({data:b(r)?r:[...arguments]}):r?Gt(r).map(s)[0]:s()
function s(r){const s=e.getComponent(r,t)
if(s){if(!n)return s
s.$destroy()}return new i({el:r,data:n})}}
const a=b(n)?{...n}:n.options
return a.name=t,null==a.install||a.install(e,a,t),e._initialized&&!a.functional&&or.read((()=>e[t]("[uk-"+s+"],[data-uk-"+s+"]"))),r[t]=b(n)?a:n},e.getComponents=e=>(null==e?void 0:e[t])||{},e.getComponent=(t,r)=>e.getComponents(t)[r],e.connect=n=>{if(n[t])for(const e in n[t])n[t][e]._callConnected()
for(const t of n.attributes){const i=tn(t.name)
i&&i in r&&e[i](n)}},e.disconnect=e=>{for(const r in e[t])e[t][r]._callDisconnected()}}(rn),function(e){const t=e.data
...
r&&this._callDisconnected(),this._callHook("destroy"),null!=r&&r[t]&&(delete r[t][n],T(r[t])||delete r[t],e&&Ft(this.$el))},e.prototype.$emit=function(e){this._callUpdate(e)},e.prototype.$update=function(t,r){void 0===t&&(t=this.$el),e.update(t,r)},e.prototype.$getComponent=e.getComponent
const r=K((t=>e.prefix+i(t)))
Object.defineProperties(e.prototype,{$container:Object.getOwnPropertyDescriptor(e,"container"),$name:{get(){return r(this.$options.name)}}})}(rn)
var nn={connected(){!it(this.$el,this.$name)&&et(this.$el,this.$name)}},sn={methods:{lazyload(e,t){void 0===e&&(e=this.$el),void 0===t&&(t=this.$el),this.registerObserver(hr(e,((e,r)=>{for(const n of I(g(t)?t():t))Gt('[loading="lazy"]',n).forEach((e=>J(e,"loading")))
for(const t of e.filter((e=>{let{isIntersecting:t}=e
return t})).map((e=>{let{target:t}=e
return t})))r.unobserve(t)})))}}},on={props:{cls:Boolean,animation:"list",duration:Number,origin:String,transition:String},data:{cls:!1,animation:[!1],duration:200,origin:!1,transition:"linear",clsEnter:"uk-togglabe-enter",clsLeave:"uk-togglabe-leave",initProps:{overflow:"",height:"",paddingTop:"",paddingBottom:"",marginTop:"",marginBottom:""},hideProps:{overflow:"hidden",height:0,paddingTop:0,paddingBottom:0,marginTop:0,marginBottom:0}},computed:{hasAnimation(e){let{animation:t}=e
...
if(!je(e,"before"+(n?"show":"hide"),[this]))return Promise.reject()
const i=(g(r)?r:!1!==r&&this.hasAnimation?this.hasTransition?an(this):(s=this,(e,t)=>{pt.cancel(e)
const{animation:r,duration:n,_toggle:i}=s
return t?(i(e,!0),pt.in(e,r[0],n,s.origin)):pt.out(e,r[1]||r[0],n,s.origin).then((()=>i(e,!1)))}):this._toggle)(e,n)
var s
const o=n?this.clsEnter:this.clsLeave
et(e,o),je(e,n?"show":"hide",[this])
const a=()=>{tt(e,o),je(e,n?"shown":"hidden",[this]),this.$update(e)}
return i?i.then(a,(()=>(tt(e,o),Promise.reject()))):a()}))).then(n,V)))},isToggled(e){return void 0===e&&(e=this.$el),[e]=I(e),!!it(e,this.clsEnter)||!it(e,this.clsLeave)&&(this.cls?it(e,this.cls.split(" ")[0]):ne(e))},_toggle(e,t){if(!e)return
let r
t=Boolean(t),this.cls?(r=d(this.cls," ")||t!==it(e,this.cls),r&&st(e,this.cls,d(this.cls," ")?void 0:t)):(r=t===e.hidden,r&&(e.hidden=!t)),Gt("[autofocus]",e).some((e=>ne(e)?e.focus()||!0:e.blur())),r&&(je(e,"toggled",[t,this]),this.$update(e))}}}
function an(e){let{isToggled:t,duration:r,initProps:n,hideProps:i,transition:s,_toggle:o}=e
return(e,a)=>{const l=ut.inProgress(e),u=e.hasChildNodes()?R(Ye(e.firstElementChild,"marginTop"))+R(Ye(e.lastElementChild,"marginBottom")):0,c=ne(e)?yt(e)+(l?0:u):0
ut.cancel(e),t(e)||o(e,!0),yt(e,""),or.flush()
const d=yt(e)+(l?0:u)
return yt(e,c),(a?ut.start(e,{...n,overflow:"hidden",height:d},Math.round(r*(1-c/d)),s):ut.start(e,i,Math.round(r*(c/d)),s).then((()=>o(e,!1)))).then((()=>Ye(e,n)))}}var ln={mixins:[nn,sn,on],props:{targets:String,active:null,collapsible:Boolean,multiple:Boolean,toggle:String,content:String,transition:String,offset:Number},data:{targets:"> *",active:!1,animation:[!0],collapsible:!0,multiple:!1,clsOpen:"uk-open",toggle:"> .uk-accordion-title",content:"> .uk-accordion-content",transition:"ease",offset:0},computed:{items:{get(e,t){let{targets:r}=e
return Gt(r,t)},watch(e,t){if(e.forEach((e=>un(Yt(this.content,e),!it(e,this.clsOpen)))),t||it(e,this.clsOpen))return
const r=!1!==this.active&&e[Number(this.active)]||!this.collapsible&&e[0]
r&&this.toggle(r,!1)},immediate:!0},toggles(e){let{toggle:t}=e
return this.items.map((e=>Yt(t,e)))}},connected(){this.lazyload()},events:[{name:"click",delegate(){return this.targets+" "+this.$props.toggle},handler(e){e.preventDefault(),this.toggle(me(this.toggles,e.current))}}],methods:{toggle(e,t){let r=[this.items[G(e,this.items)]]
const n=ue(this.items,"."+this.clsOpen)
if(this.multiple||d(n,r[0])||(r=r.concat(n)),this.collapsible||!(n.length<2)||ue(r,":not(."+this.clsOpen+")").length)for(const i of r)this.toggleElement(i,!it(i,this.clsOpen),(async(e,r)=>{st(e,this.clsOpen,r),Z(Yt(this.$props.toggle,e),"aria-expanded",r)
const n=Yt((e._wrapper?"> * ":"")+this.content,e)
if(!1!==t&&this.hasTransition){if(e._wrapper||(e._wrapper=$t(n,"<div"+(r?" hidden":"")+">")),un(n,!1),await an(this)(e._wrapper,r),un(n,!r),delete e._wrapper,Bt(n),r){const t=Yt(this.$props.toggle,e)
or.read((()=>{Lr(t)||Dr(t,{offset:this.offset})}))}}else un(n,!r)}))}}}
function un(e,t){e&&(e.hidden=t)}var cn={mixins:[nn,on],args:"animation",props:{close:String},data:{animation:[!0],selClose:".uk-alert-close",duration:150,hideProps:{opacity:0,...on.data.hideProps}},events:[{name:"click",delegate(){return this.selClose},handler(e){e.preventDefault(),this.close()}}],methods:{async close(){await this.toggleElement(this.$el),this.$destroy(!0)}}},dn={args:"autoplay",props:{automute:Boolean,autoplay:Boolean},data:{automute:!1,autoplay:!0},connected(){this.inView="inview"===this.autoplay,this.inView&&!X(this.$el,"preload")&&(this.$el.preload="none"),this.automute&&Cr(this.$el),this.registerObserver(hr(this.$el,(()=>this.$emit("scroll")),{},!1))},update:{read(){return!!Pr(this.$el)&&{visible:ne(this.$el)&&"hidden"!==Ye(this.$el,"visibility"),inView:this.inView&&Lr(this.$el)}},write(e){let{visible:t,inView:r}=e
!t||this.inView&&!r?Er(this.$el):(!0===this.autoplay||this.inView&&r)&&Or(this.$el)}}},hn={connected(){var e
this.registerObserver(fr((null==(e=this.$options.resizeTargets)?void 0:e.call(this))||this.$el,(()=>this.$emit("resize"))))}},pn={mixins:[hn,dn],props:{width:Number,height:Number},data:{automute:!0},events:{load(){this.$emit("resize")}},resizeTargets(){return[this.$el,le(this.$el)]},update:{read(){const e=this.$el,{offsetHeight:t,offsetWidth:r}=function(e){for(;e=le(e);)if("static"!==Ye(e,"position"))return e}(e)||le(e),n=Y.cover({width:this.width||e.naturalWidth||e.videoWidth||e.clientWidth,height:this.height||e.naturalHeight||e.videoHeight||e.clientHeight},{width:r+(r%2?1:0),height:t+(t%2?1:0)})
return!(!n.width||!n.height)&&n},write(e){let{height:t,width:r}=e
Ye(this.$el,{height:t,width:r})},events:["resize"]}}
var fn={props:{container:Boolean},data:{container:!0},computed:{container(e){let{container:t}=e
return!0===t&&this.$container||t&&Yt(t)}}},mn={props:{pos:String,offset:null,flip:Boolean,clsPos:String},data:{pos:"bottom-"+(Zt?"right":"left"),flip:!0,offset:!1,clsPos:""},connected(){this.pos=this.$props.pos.split("-").concat("center").slice(0,2),this.dir=this.pos[0],this.align=this.pos[1]},methods:{positionAt(e,t,r){rt(e,this.clsPos+"-(top|bottom|left|right)(-[a-z]+)?")
let{offset:n}=this
const i=this.getAxis(),s=this.pos[0],o=this.pos[1]
if(!P(n)){const e=Yt(n)
n=e?gt(e)["x"===i?"left":"top"]-gt(t)["x"===i?"right":"bottom"]:0}const{x:a,y:l}=Vr(e,t,"x"===i?xt(s)+" "+o:o+" "+xt(s),"x"===i?s+" "+o:o+" "+s,"x"===i?""+("left"===s?-n:n):" "+("top"===s?-n:n),null,this.flip,r).target
this.dir="x"===i?a:l,this.align="x"===i?l:a,st(e,this.clsPos+"-"+this.dir+"-"+this.align,!1===this.offset)},getAxis(){return"top"===this.dir||"bottom"===this.dir?"y":"x"}}}
let gn
var vn={mixins:[fn,sn,mn,on],args:"pos",props:{mode:"list",toggle:Boolean,boundary:Boolean,boundaryAlign:Boolean,delayShow:Number,delayHide:Number,clsDrop:String},data:{mode:["click","hover"],toggle:"- *",boundary:!0,boundaryAlign:!1,delayShow:0,delayHide:800,clsDrop:!1,animation:["uk-animation-fade"],cls:"uk-open",container:!1},created(){this.tracker=new dr},connected(){this.clsPos=this.clsDrop=this.$props.clsDrop||"uk-"+this.$options.name,et(this.$el,this.clsDrop),this.toggle&&!this.target&&(this.target=this.$create("toggle",ge(this.toggle,this.$el),{target:this.$el,mode:this.mode}).$el,Z(this.target,"aria-haspopup",!0),this.lazyload(this.target))},disconnected(){this.isActive()&&(gn=null)},events:[{name:"click",delegate(){return"."+this.clsDrop+"-close"},handler(e){e.preventDefault(),this.hide(!1)}},{name:"click",delegate:()=>'a[href^="#"]',handler(e){let{defaultPrevented:t,current:{hash:r}}=e
t||!r||he(r,this.$el)||this.hide(!1)}},{name:"beforescroll",handler(){this.hide(!1)}},{name:"toggle",self:!0,handler(e,t){e.preventDefault(),this.isToggled()?this.hide(!1):this.show(t.$el,!1)}},{name:"toggleshow",self:!0,handler(e,t){e.preventDefault(),this.show(t.$el)}},{name:"togglehide",self:!0,handler(e){e.preventDefault(),ce(this.$el,":focus,:hover")||this.hide()}},{name:nr+" focusin",filter(){return d(this.mode,"hover")},handler(e){Ue(e)||this.clearTimers()}},{name:ir+" focusout",filter(){return d(this.mode,"hover")},handler(e){!Ue(e)&&e.relatedTarget&&this.hide()}},{name:"toggled",self:!0,handler(e,t){t&&(this.clearTimers(),this.position())}},{name:"show",self:!0,handler(){gn=this,this.tracker.init()
for(const e of[Ae(document,er,(e=>{let{target:t}=e
return!he(t,this.$el)&&Re(document,rr+" "+sr+" scroll",(e=>{let{defaultPrevented:r,type:n,target:i}=e
r||n!==rr||t!==i||this.target&&he(t,this.target)||this.hide(!1)}),!0)})),Ae(document,"keydown",(e=>{27===e.keyCode&&this.hide(!1)})),Ae(window,"resize",(()=>this.$emit("resize")))])Re(this.$el,"hide",e,{self:!0})}},{name:"beforehide",self:!0,handler(){this.clearTimers()}},{name:"hide",handler(e){let{target:t}=e
this.$el===t?(gn=this.isActive()?null:gn,this.tracker.cancel()):gn=null===gn&&he(t,this.$el)&&this.isToggled()?this:gn}}],update:{write(){this.isToggled()&&!it(this.$el,this.clsEnter)&&this.position()},events:["resize"]},methods:{show(e,t){if(void 0===e&&(e=this.target),void 0===t&&(t=!0),this.isToggled()&&e&&this.target&&e!==this.target&&this.hide(!1),this.target=e,this.clearTimers(),!this.isActive()){if(gn){if(t&&gn.isDelaying)return void(this.showTimer=setTimeout((()=>ce(e,":hover")&&this.show()),10))
let r
for(;gn&&r!==gn&&!he(this.$el,gn.$el);)r=gn,gn.hide(!1)}this.container&&le(this.$el)!==this.container&&It(this.container,this.$el),this.showTimer=setTimeout((()=>this.toggleElement(this.$el,!0)),t&&this.delayShow||0)}},hide(e){void 0===e&&(e=!0)
const t=()=>this.toggleElement(this.$el,!1,!1)
this.clearTimers(),this.isDelaying=function(e){const t=[]
return Wt(e,(e=>"static"!==Ye(e,"position")&&t.push(e))),t}(this.$el).some((e=>this.tracker.movesTo(e))),e&&this.isDelaying?this.hideTimer=setTimeout(this.hide,50):e&&this.delayHide?this.hideTimer=setTimeout(t,this.delayHide):t()},clearTimers(){clearTimeout(this.showTimer),clearTimeout(this.hideTimer),this.showTimer=null,this.hideTimer=null,this.isDelaying=!1},isActive(){return gn===this},position(){const e=!0===this.boundary?window:ge(this.boundary,this.$el)
tt(this.$el,this.clsDrop+"-stack"),st(this.$el,this.clsDrop+"-boundary",this.boundaryAlign)
const t=gt(e),r=this.boundaryAlign?t:gt(this.target)
if("justify"===this.align){const e="y"===this.getAxis()?"width":"height"
Ye(this.$el,e,r[e])}else e&&this.$el.offsetWidth>Math.max(t.right-r.left,r.right-t.left)&&et(this.$el,this.clsDrop+"-stack")
this.positionAt(this.$el,this.boundaryAlign?e:this.target,e)}}}
var bn={mixins:[nn],args:"target",props:{target:Boolean},data:{target:!1},computed:{input:(e,t)=>Yt(ie,t),state(){return this.input.nextElementSibling},target(e,t){let{target:r}=e
return r&&(!0===r&&le(this.input)===t&&this.input.nextElementSibling||Yt(r,t))}},update(){var e
const{target:t,input:r}=this
if(!t)return
let n
const i=se(t)?"value":"textContent",s=t[i],o=null!=(e=r.files)&&e[0]?r.files[0].name:ce(r,"select")&&(n=Gt("option",r).filter((e=>e.selected))[0])?n.textContent:r.value
s!==o&&(t[i]=o)},events:[{name:"change",handler(){this.$emit()}},{name:"reset",el(){return de(this.$el,"form")},handler(){this.$emit()}}]},yn={mixins:[hn],props:{margin:String,firstColumn:Boolean},data:{margin:"uk-margin-small-top",firstColumn:"uk-first-column"},resizeTargets(){return this.$el.children},connected(){this.registerObserver(gr(this.$el,(()=>this.$reset()),{childList:!0}))},update:{read(){const e=wn(this.$el.children)
return{rows:e,columns:_n(e)}},write(e){let{columns:t,rows:r}=e
for(const n of r)for(const e of n)st(e,this.margin,r[0]!==n),st(e,this.firstColumn,!!~t[0].indexOf(e))},events:["resize"]}}
function wn(e){return kn(e,"top","bottom")}function _n(e){const t=[]
for(const r of e){const e=kn(r,"left","right")
for(let r=0;r<e.length;r++)t[r]=t[r]?t[r].concat(e[r]):e[r]}return Zt?t.reverse():t}function kn(e,t,r){const n=[[]]
for(const i of e){if(!ne(i))continue
let e=xn(i)
for(let s=n.length-1;s>=0;s--){const o=n[s]
if(!o[0]){o.push(i)
break}let a
if(o[0].offsetParent===i.offsetParent?a=xn(o[0]):(e=xn(i,!0),a=xn(o[0],!0)),e[t]>=a[r]-1&&e[t]!==a[t]){n.push([i])
break}if(e[r]-1>a[t]||e[t]===a[t]){o.push(i)
break}if(0===s){n.unshift([i])
break}}}return n}function xn(e,t){void 0===t&&(t=!1)
let{offsetTop:r,offsetLeft:n,offsetHeight:i,offsetWidth:s}=e
return t&&([r,n]=bt(e)),{top:r,left:n,bottom:r+i,right:n+s}}var On={connected(){var e,t
e=this._uid,t=()=>this.$emit("scroll"),Cn=Cn||Ae(window,"scroll",(()=>En.forEach((e=>e()))),{passive:!0,capture:!0}),En.set(e,t)},disconnected(){var e
e=this._uid,En.delete(e),Cn&&!En.size&&(Cn(),Cn=null)}}
const En=new Map
let Cn
var Pn={extends:yn,mixins:[nn,On],name:"grid",props:{masonry:Boolean,parallax:Number},data:{margin:"uk-grid-margin",clsStack:"uk-grid-stack",masonry:!1,parallax:0},connected(){this.masonry&&et(this.$el,"uk-flex-top uk-flex-wrap-top")},update:[{write(e){let{columns:t}=e
st(this.$el,this.clsStack,t.length<2)},events:["resize"]},{read(e){let{columns:t,rows:r}=e
if(!t.length||!this.masonry&&!this.parallax||Tn(this.$el))return e.translates=!1,!1
let n=!1
const i=fe(this.$el),s=function(e){return e.map((e=>e.reduce(((e,t)=>e+t.offsetHeight),0)))}(t),o=function(e,t){const[r]=e.filter((e=>it(e,t)))
return R(r?Ye(r,"marginTop"):Ye(e[0],"paddingLeft"))}(i,this.margin)*(r.length-1),a=Math.max(...s)+o
...
Ye(this.$el,"paddingBottom",r||""),!1!==t&&Ye(this.$el,"height",t)},events:["resize"]},{read(){return(!this.parallax||!Tn(this.$el))&&{scrolled:!!this.parallax&&Fr(this.$el)*Math.abs(this.parallax)}},write(e){let{columns:t,scrolled:r,translates:n}=e;(!1!==r||n)&&t.forEach(((e,t)=>e.forEach(((e,i)=>Ye(e,"transform",r||n?"translateY("+((n&&-n[t][i])+(r?t%2?r:r/8:0))+"px)":"")))))},events:["scroll","resize"]}]}
function Tn(e){return fe(e).some((e=>"absolute"===Ye(e,"position")))}var Sn={args:"target",props:{target:String,row:Boolean},data:{target:"> *",row:!0,forceHeight:!0},computed:{elements:{get(e,t){let{target:r}=e
return Gt(r,t)},watch(){this.$reset()}}},resizeTargets(){return this.elements},update:{read(){return{rows:(this.row?wn(this.elements):[this.elements]).map(An)}},write(e){let{rows:t}=e
for(const{heights:r,elements:n}of t)n.forEach(((e,t)=>Ye(e,"minHeight",r[t])))},events:["resize"]}}
function An(e){if(e.length<2)return{heights:[""],elements:e}
let t=e.map(Mn),r=Math.max(...t)
const n=e.some((e=>e.style.minHeight)),i=e.some(((e,n)=>!e.style.minHeight&&t[n]<r))
return n&&i&&(Ye(e,"minHeight",""),t=e.map(Mn),r=Math.max(...t)),t=e.map(((e,n)=>t[n]===r&&R(e.style.minHeight).toFixed(2)!==r.toFixed(2)?"":r)),{heights:t,elements:e}}function Mn(e){let t=!1
ne(e)||(t=e.style.display,Ye(e,"display","block","important"))
const r=mt(e).height-kt(e,"height","content-box")
return!1!==t&&Ye(e,"display",t),r}var Rn={mixins:[nn,hn],props:{expand:Boolean,offsetTop:Boolean,offsetBottom:Boolean,minHeight:Number},data:{expand:!1,offsetTop:!1,offsetBottom:!1,minHeight:0},resizeTargets(){return[this.$el,document.documentElement]},update:{read(e){let{minHeight:t}=e
if(!ne(this.$el))return!1
let r=""
const n=kt(this.$el,"height","content-box")
if(this.expand)r=yt(window)-(mt(document.documentElement).height-mt(this.$el).height)-n||""
else{if(r="calc(100vh",this.offsetTop){const{top:e}=gt(this.$el)
r+=e>0&&e<yt(window)/2?" - "+e+"px":""}!0===this.offsetBottom?r+=" - "+mt(this.$el.nextElementSibling).height+"px":P(this.offsetBottom)?r+=" - "+this.offsetBottom+"vh":this.offsetBottom&&c(this.offsetBottom,"px")?r+=" - "+R(this.offsetBottom)+"px":E(this.offsetBottom)&&(r+=" - "+mt(ge(this.offsetBottom,this.$el)).height+"px"),r+=(n?" - "+n+"px":"")+")"}return{minHeight:r,prev:t}},write(e){let{minHeight:t}=e
Ye(this.$el,{minHeight:t}),this.minHeight&&R(Ye(this.$el,"minHeight"))<this.minHeight&&Ye(this.$el,"minHeight",this.minHeight)},events:["resize"]}},jn={args:"src",props:{id:Boolean,icon:String,src:String,style:String,width:Number,height:Number,ratio:Number,class:String,strokeAnimation:Boolean,focusable:Boolean,attributes:"list"},data:{ratio:1,include:["style","class","focusable"],class:"",strokeAnimation:!1},beforeConnect(){this.class+=" uk-svg"},connected(){!this.icon&&d(this.src,"#")&&([this.src,this.icon]=this.src.split("#")),this.svg=this.getSvg().then((e=>{if(this._connected){const t=function(e,t){if(re(t)||At(t,"canvas")){t.hidden=!0
const r=t.nextElementSibling
return $n(e,r)?r:Nt(t,e)}const r=t.lastElementChild
return $n(e,r)?r:It(t,e)}(e,this.$el)
return this.svgEl&&t!==this.svgEl&&Ft(this.svgEl),this.applyAttributes(t,e),this.svgEl=t}}),V),this.strokeAnimation&&this.svg.then((e=>{this._connected&&(Dn(e),this.registerObserver(hr(e,((t,r)=>{Dn(e),r.disconnect()}))))}))},disconnected(){this.svg.then((e=>{this._connected||(re(this.$el)&&(this.$el.hidden=!1),Ft(e),this.svgEl=null)})),this.svg=null},methods:{async getSvg(){return At(this.$el,"img")&&!this.$el.complete&&"lazy"===this.$el.loading?new Promise((e=>Re(this.$el,"load",(()=>e(this.getSvg()))))):function(e,t){var r
t&&d(e,"<symbol")&&(e=function(e,t){if(!Nn[e]){let t
for(Nn[e]={},Ln.lastIndex=0;t=Ln.exec(e);)Nn[e][t[3]]='<svg xmlns="http://www.w3.org/2000/svg"'+t[1]+"svg>"}return Nn[e][t]}(e,t)||e)
return e=Yt(e.substr(e.indexOf("<svg"))),(null==(r=e)?void 0:r.hasChildNodes())&&e}(await In(this.src),this.icon)||Promise.reject("SVG not found.")},applyAttributes(e,t){for(const s in this.$options.props)d(this.include,s)&&s in this&&Z(e,s,this[s])
...
const In=K((async e=>e?u(e,"data:")?decodeURIComponent(e.split(",")[1]):(await fetch(e)).text():Promise.reject()))
const Ln=/<symbol([^]*?id=(['"])(.+?)\2[^]*?<\/)symbol>/g,Nn={}
function Dn(e){const t=Fn(e)
t&&e.style.setProperty("--uk-animation-stroke",t)}function Fn(e){return Math.ceil(Math.max(0,...Gt("[stroke]",e).map((e=>{try{return e.getTotalLength()}catch(t){return 0}}))))}function $n(e,t){return At(e,"svg")&&At(t,"svg")&&zn(e)===zn(t)}function zn(e){return(e.innerHTML||(new XMLSerializer).serializeToString(e).replace(/<svg.*?>(.*?)<\/svg>/g,"$1")).replace(/\s/g,"")}const Bn={spinner:'<svg width="30" height="30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" cx="15" cy="15" r="14"/></svg>',totop:'<svg width="18" height="10" viewBox="0 0 18 10" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 9 9 1 17 9 "/></svg>',marker:'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><rect x="9" y="4" width="1" height="11"/><rect x="4" y="9" width="11" height="1"/></svg>',"close-icon":'<svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg"><line fill="none" stroke="#000" stroke-width="1.1" x1="1" y1="1" x2="13" y2="13"/><line fill="none" stroke="#000" stroke-width="1.1" x1="13" y1="1" x2="1" y2="13"/></svg>',"close-large":'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><line fill="none" stroke="#000" stroke-width="1.4" x1="1" y1="1" x2="19" y2="19"/><line fill="none" stroke="#000" stroke-width="1.4" x1="19" y1="1" x2="1" y2="19"/></svg>',"navbar-toggle-icon":'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><rect y="9" width="20" height="2"/><rect y="3" width="20" height="2"/><rect y="15" width="20" height="2"/></svg>',"overlay-icon":'<svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><rect x="19" y="0" width="1" height="40"/><rect x="0" y="19" width="40" height="1"/></svg>',"pagination-next":'<svg width="7" height="12" viewBox="0 0 7 12" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 1 6 6 1 11"/></svg>',"pagination-previous":'<svg width="7" height="12" viewBox="0 0 7 12" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="6 1 1 6 6 11"/></svg>',"search-icon":'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" stroke-width="1.1" cx="9" cy="9" r="7"/><path fill="none" stroke="#000" stroke-width="1.1" d="M14,14 L18,18 L14,14 Z"/></svg>',"search-large":'<svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" stroke-width="1.8" cx="17.5" cy="17.5" r="16.5"/><line fill="none" stroke="#000" stroke-width="1.8" x1="38" y1="39" x2="29" y2="30"/></svg>',"search-navbar":'<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" stroke-width="1.1" cx="10.5" cy="10.5" r="9.5"/><line fill="none" stroke="#000" stroke-width="1.1" x1="23" y1="23" x2="17" y2="17"/></svg>',"slidenav-next":'<svg width="14" height="24" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1 "/></svg>',"slidenav-next-large":'<svg width="25" height="40" viewBox="0 0 25 40" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="2" points="4.002,38.547 22.527,20.024 4,1.5 "/></svg>',"slidenav-previous":'<svg width="14" height="24" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.4" points="12.775,1 1.225,12 12.775,23 "/></svg>',"slidenav-previous-large":'<svg width="25" height="40" viewBox="0 0 25 40" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="2" points="20.527,1.5 2,20.024 20.525,38.547 "/></svg>'},Un={install:function(e){e.icon.add=(t,r)=>{const n=E(t)?{[t]:r}:t
z(n,((e,t)=>{Bn[t]=e,delete Gn[t]})),e._initialized&&Wt(document.body,(t=>z(e.getComponents(t),(e=>{e.$options.isIcon&&e.icon in n&&e.$reset()}))))}},extends:jn,args:"icon",props:["icon"],data:{include:["focusable"]},isIcon:!0,beforeConnect(){et(this.$el,"uk-icon")},methods:{async getSvg(){const e=function(e){if(!Bn[e])return null
Gn[e]||(Gn[e]=Yt((Bn[function(e){return Zt?F(F(e,"left","right"),"previous","next"):e}(e)]||Bn[e]).trim()))
return Gn[e].cloneNode(!0)}(this.icon)
if(!e)throw"Icon not found."
return e}}},Hn={args:!1,extends:Un,data:e=>({icon:i(e.constructor.options.name)}),beforeConnect(){et(this.$el,this.$name)}},Vn={extends:Hn,beforeConnect(){et(this.$el,"uk-slidenav")
const e=this.$props.icon
this.icon=it(this.$el,"uk-slidenav-large")?e+"-large":e}},qn={extends:Hn,beforeConnect(){this.icon=it(this.$el,"uk-search-icon")&&pe(this.$el,".uk-search-large").length?"search-large":pe(this.$el,".uk-search-navbar").length?"search-navbar":this.$props.icon}},Wn={extends:Hn,beforeConnect(){this.icon="close-"+(it(this.$el,"uk-close-large")?"large":"icon")}},Yn={extends:Hn,methods:{async getSvg(){const e=await Un.methods.getSvg.call(this)
return 1!==this.ratio&&Ye(Yt("circle",e),"strokeWidth",1/this.ratio),e}}},Gn={}
const Kn="loading"in HTMLImageElement.prototype
...
const e=[this.$el,...ve(this.$props.target,this.$el)]
var t
Kn&&si(this.$el)&&(this.$el.loading="lazy",Zn(this.$el),1===e.length)||(si(t=this.$el)&&!X(t,"src")&&Z(t,"src",'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg"></svg>'),this.registerObserver(hr(e,((e,t)=>{this.load(),t.disconnect()}),{rootMargin:Ot(this.offsetTop,"height")+"px "+Ot(this.offsetLeft,"width")+"px"})))},disconnected(){this._data.image&&(this._data.image.onload="")},update:{write(e){if(!this.observer||si(this.$el))return!1
const t=ee(this.$el,"data-srcset")
if(t&&1!==window.devicePixelRatio){const r=Ye(this.$el,"backgroundSize");(r.match(/^(auto\s?)+$/)||R(r)===e.bgSize)&&(e.bgSize=function(e,t){const r=Ot(function(e){let t
ei.lastIndex=0
for(;t=ei.exec(e);)if(!t[1]||window.matchMedia(t[1]).matches){t=ni(t[2])
break}return t||"100vw"}(t)),n=(e.match(ii)||[]).map(R).sort(((e,t)=>e-t))
return n.filter((e=>e>=r))[0]||n.pop()||""}(t,ee(this.$el,"sizes")),Ye(this.$el,"backgroundSize",e.bgSize+"px"))}},events:["resize"]},methods:{load(){if(this._data.image)return this._data.image
const e=si(this.$el)?this.$el:function(e,t,r){const n=new Image
return function(e,t){if((t=function(e){if(!e)return[]
if(u(e,"["))try{e=JSON.parse(e)}catch(t){e=[]}else e=xr(e)
p(e)||(e=[e])
return e.filter((e=>!T(e)))}(t)).length){const r=Vt("<picture>")
for(const e of t){const t=Vt("<source>")
Z(t,e),It(r,t)}It(r,e)}}(n,r),Jn(e,n),n.onload=()=>{Zn(e,n.currentSrc)},Z(n,"src",t),n}(this.$el,this.dataSrc,this.sources)
return J(e,"loading"),Zn(this.$el,e.currentSrc),this._data.image=e}}}
function Zn(e,t){if(si(e)){const t=le(e);(function(e){return At(e,"picture")}(t)?fe(t):[e]).forEach((e=>Jn(e,e)))}else if(t){!d(e.style.backgroundImage,t)&&(Ye(e,"backgroundImage","url("+Se(t)+")"),je(e,Ie("load",!1)))}}const Xn=["data-src","data-srcset","sizes"]
function Jn(e,t){Xn.forEach((r=>{const n=ee(e,r)
n&&Z(t,r.replace(/^(data-)+/,""),n)}))}const ei=/\s*(.*?)\s*(\w+|calc\(.*?\))\s*(?:,|$)/g
const ti=/\d+(?:\w+|%)/g,ri=/[+-]?(\d+)/g
function ni(e){return u(e,"calc")?e.slice(5,-1).replace(ti,(e=>Ot(e))).replace(/ /g,"").match(ri).reduce(((e,t)=>e+ +t),0):e}const ii=/\s+\d+w\s*(?:,|$)/g
function si(e){return At(e,"img")}var oi={props:{media:Boolean},data:{media:!1},connected(){const e=function(e){if(E(e))if(u(e,"@")){const t="breakpoint-"+e.substr(1)
e=R(Ze(t))}else if(isNaN(e))return e
return e&&P(e)?"(min-width: "+e+"px)":""}(this.media)
this.mediaObj=window.matchMedia(e)
const t=()=>{this.matchMedia=this.mediaObj.matches,je(this.$el,Ie("mediachange",!1,!0,[this.mediaObj]))}
this.offMediaObj=Ae(this.mediaObj,"change",(()=>{t(),this.$emit("resize")})),t()},disconnected(){var e
null==(e=this.offMediaObj)||e.call(this)}}
var ai={mixins:[nn,oi,hn],props:{fill:String},data:{fill:"",clsWrapper:"uk-leader-fill",clsHide:"uk-leader-hide",attrFill:"data-fill"},computed:{fill(e){let{fill:t}=e
return t||Ze("leader-fill-content")}},connected(){[this.wrapper]=zt(this.$el,'<span class="'+this.clsWrapper+'">')},disconnected(){Bt(this.wrapper.childNodes)},update:{read(){return{width:Math.trunc(this.$el.offsetWidth/2),fill:this.fill,hide:!this.matchMedia}},write(e){let{width:t,fill:r,hide:n}=e
st(this.wrapper,this.clsHide,n),Z(this.wrapper,this.attrFill,new Array(t).join(r))},events:["resize"]}}
const li=[]
var ui={mixins:[nn,fn,on],props:{selPanel:String,selClose:String,escClose:Boolean,bgClose:Boolean,stack:Boolean},data:{cls:"uk-open",escClose:!0,bgClose:!0,overlay:!0,stack:!1},computed:{panel(e,t){let{selPanel:r}=e
return Yt(r,t)},transitionElement(){return this.panel},bgClose(e){let{bgClose:t}=e
return t&&this.panel}},beforeDisconnect(){d(li,this)&&this.toggleElement(this.$el,!1,!1)},events:[{name:"click",delegate(){return this.selClose},handler(e){e.preventDefault(),this.hide()}},{name:"toggle",self:!0,handler(e){e.defaultPrevented||(e.preventDefault(),this.isToggled()===d(li,this)&&this.toggle())}},{name:"beforeshow",self:!0,handler(e){if(d(li,this))return!1
!this.stack&&li.length?(Promise.all(li.map((e=>e.hide()))).then(this.show),e.preventDefault()):li.push(this)}},{name:"show",self:!0,handler(){const e=document.documentElement
wt(window)>e.clientWidth&&this.overlay&&Ye(document.body,"overflowY","scroll"),this.stack&&Ye(this.$el,"zIndex",R(Ye(this.$el,"zIndex"))+li.length),et(e,this.clsPage),this.bgClose&&Re(this.$el,"hide",Ae(document,er,(e=>{let{target:t}=e
$(li)!==this||this.overlay&&!he(t,this.$el)||he(t,this.panel)||Re(document,rr+" "+sr+" scroll",(e=>{let{defaultPrevented:r,type:n,target:i}=e
r||n!==rr||t!==i||this.hide()}),!0)})),{self:!0}),this.escClose&&Re(this.$el,"hide",Ae(document,"keydown",(e=>{27===e.keyCode&&$(li)===this&&this.hide()})),{self:!0})}},{name:"shown",self:!0,handler(){ae(this.$el)||Z(this.$el,"tabindex","-1"),Yt(":focus",this.$el)||this.$el.focus()}},{name:"hidden",self:!0,handler(){d(li,this)&&li.splice(li.indexOf(this),1),li.length||Ye(document.body,"overflowY",""),Ye(this.$el,"zIndex",""),li.some((e=>e.clsPage===this.clsPage))||tt(document.documentElement,this.clsPage)}}],methods:{toggle(){return this.isToggled()?this.hide():this.show()},show(){return this.container&&le(this.$el)!==this.container?(It(this.container,this.$el),new Promise((e=>requestAnimationFrame((()=>this.show().then(e)))))):this.toggleElement(this.$el,!0,ci(this))},hide(){return this.toggleElement(this.$el,!1,ci(this))}}}
function ci(e){let{transitionElement:t,_toggle:r}=e
return(e,n)=>new Promise(((i,s)=>Re(e,"show hide",(()=>{e._reject&&e._reject(),e._reject=s,r(e,n)
const o=Re(t,"transitionstart",(()=>{Re(t,"transitionend transitioncancel",i,{self:!0}),clearTimeout(a)}),{self:!0}),a=setTimeout((()=>{o(),i()}),N(Ye(t,"transitionDuration")))})))).then((()=>delete e._reject))}var di={install:function(e){let{modal:t}=e
function r(e,r,n,i){r={bgClose:!1,escClose:!0,labels:t.labels,...r}
const s=t.dialog(e(r),r),o=new Q
let a=!1
return Ae(s.$el,"submit","form",(e=>{e.preventDefault(),o.resolve(null==i?void 0:i(s)),a=!0,s.hide()})),Ae(s.$el,"hide",(()=>!a&&n(o))),o.promise.dialog=s,o.promise}t.dialog=function(e,r){const n=t('<div class="uk-modal"> <div class="uk-modal-dialog">'+e+"</div> </div>",r)
return n.show(),Ae(n.$el,"hidden",(async()=>{await Promise.resolve(),n.$destroy(!0)}),{self:!0}),n},t.alert=function(e,t){return r((t=>{let{labels:r}=t
return'<div class="uk-modal-body">'+(E(e)?e:Mt(e))+'</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-primary uk-modal-close" autofocus>'+r.ok+"</button> </div>"}),t,(e=>e.resolve()))},t.confirm=function(e,t){return r((t=>{let{labels:r}=t
...
return'<form class="uk-form-stacked"> <div class="uk-modal-body"> <label>'+(E(e)?e:Mt(e))+'</label> <input class="uk-input" value="'+(t||"")+'" autofocus> </div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-default uk-modal-close" type="button">'+n.cancel+'</button> <button class="uk-button uk-button-primary">'+n.ok+"</button> </div> </form>"}),n,(e=>e.resolve(null)),(e=>Yt("input",e.$el).value))},t.labels={ok:"Ok",cancel:"Cancel"}},mixins:[ui],data:{clsPage:"uk-modal-page",selPanel:".uk-modal-dialog",selClose:".uk-modal-close, .uk-modal-close-default, .uk-modal-close-outside, .uk-modal-close-full"},events:[{name:"show",self:!0,handler(){it(this.panel,"uk-margin-auto-vertical")?et(this.$el,"uk-flex"):Ye(this.$el,"display","block"),yt(this.$el)}},{name:"hidden",self:!0,handler(){Ye(this.$el,"display",""),tt(this.$el,"uk-flex")}}]}
var hi={extends:ln,data:{targets:"> .uk-parent",toggle:"> a",content:"> ul"}}
const pi=".uk-navbar-nav > li > a, .uk-navbar-item, .uk-navbar-toggle"
var fi={mixins:[nn,fn],props:{dropdown:String,mode:"list",align:String,offset:Number,boundary:Boolean,boundaryAlign:Boolean,clsDrop:String,delayShow:Number,delayHide:Number,dropbar:Boolean,dropbarMode:String,dropbarAnchor:Boolean,duration:Number},data:{dropdown:pi,align:Zt?"right":"left",clsDrop:"uk-navbar-dropdown",mode:void 0,offset:void 0,delayShow:void 0,delayHide:void 0,boundaryAlign:void 0,flip:"x",boundary:!0,dropbar:!1,dropbarMode:"slide",dropbarAnchor:!1,duration:200,forceHeight:!0,selMinHeight:pi,container:!1},computed:{boundary(e,t){let{boundary:r,boundaryAlign:n}=e
...
return t?(t=this._dropbar||ge(t,this.$el)||Yt("+ .uk-navbar-dropbar",this.$el),t||(this._dropbar=Yt("<div></div>"))):null},watch(e){et(e,"uk-navbar-dropbar")},immediate:!0},dropContainer(e,t){return this.container||t},dropdowns:{get(e,t){let{clsDrop:r}=e
const n=Gt("."+r,t)
if(this.dropContainer!==t)for(const s of Gt("."+r,this.dropContainer)){var i
...
return Gt(r,t)}},disconnected(){this.dropbar&&Ft(this.dropbar),delete this._dropbar},events:[{name:"mouseover focusin",delegate(){return this.dropdown},handler(e){let{current:t}=e
...
r===vi.DOWN&&X(t,"aria-expanded")&&(e.preventDefault(),n&&n.target===t?gi(n.$el):(t.click(),Re(this.dropContainer,"show",(e=>{let{target:t}=e
return gi(t)})))),mi(e,this.toggles,n)}},{name:"keydown",el(){return this.dropContainer},delegate(){return"."+this.clsDrop},handler(e){const{current:t,keyCode:r}=e
if(!d(this.dropdowns,t))return
const n=this.getActive(),i=Gt(oe,t),s=h(i,(e=>ce(e,":focus")))
var o;(r===vi.UP&&(e.preventDefault(),s>0&&i[s-1].focus()),r===vi.DOWN&&(e.preventDefault(),s<i.length-1&&i[s+1].focus()),r===vi.ESC)&&(null==n||null==(o=n.target)||o.focus())
mi(e,this.toggles,n)}},{name:"mouseleave",el(){return this.dropbar},filter(){return this.dropbar},handler(){const e=this.getActive()
e&&d(e.mode,"hover")&&!this.dropdowns.some((e=>ce(e,":hover")))&&e.hide()}},{name:"beforeshow",el(){return this.dropContainer},filter(){return this.dropbar},handler(){le(this.dropbar)||Nt(this.dropbarAnchor||this.$el,this.dropbar)}},{name:"show",el(){return this.dropContainer},filter(){return this.dropbar},handler(e,t){let{$el:r,dir:n}=t
it(r,this.clsDrop)&&("slide"===this.dropbarMode&&et(this.dropbar,"uk-navbar-dropbar-slide"),this.clsDrop&&et(r,this.clsDrop+"-dropbar"),"bottom"===n&&this.transitionTo(r.offsetHeight+R(Ye(r,"marginTop"))+R(Ye(r,"marginBottom")),r))}},{name:"beforehide",el(){return this.dropContainer},filter(){return this.dropbar},handler(e,t){let{$el:r}=t
...
if(!it(r,this.clsDrop))return
const n=this.getActive()
n&&(null==n?void 0:n.$el)!==r||this.transitionTo(0)}}],methods:{getActive(){return gn&&he(gn.target,this.$el)&&gn},transitionTo(e,t){const{dropbar:r}=this,n=ne(r)?yt(r):0
return Ye(t=n<e&&t,"clip","rect(0,"+t.offsetWidth+"px,"+n+"px,0)"),yt(r,n),ut.cancel([t,r]),Promise.all([ut.start(r,{height:e},this.duration),ut.start(t,{clip:"rect(0,"+t.offsetWidth+"px,"+e+"px,0)"},this.duration)]).catch(V).then((()=>{Ye(t,{clip:""}),this.$update(r)}))},getDropdown(e){return this.$getComponent(e,"drop")||this.$getComponent(e,"dropdown")}}}
function mi(e,t,r){const{current:n,keyCode:i}=e,s=(null==r?void 0:r.target)||n,o=t.indexOf(s)
i===vi.LEFT&&o>0&&(null==r||r.hide(!1),t[o-1].focus()),i===vi.RIGHT&&o<t.length-1&&(null==r||r.hide(!1),t[o+1].focus()),i===vi.TAB&&(s.focus(),null==r||r.hide(!1))}function gi(e){var t
Yt(":focus",e)||(null==(t=Yt(oe,e))||t.focus())}const vi={TAB:9,ESC:27,LEFT:37,UP:38,RIGHT:39,DOWN:40}
var bi={props:{swiping:Boolean},data:{swiping:!0},computed:{swipeTarget:(e,t)=>t},connected(){this.swiping&&Zr(this,{el:this.swipeTarget,name:er,passive:!0,handler(e){if(!Ue(e))return
const t=He(e),r="tagName"in e.target?e.target:le(e.target)
Re(document,rr+" "+sr+" scroll",(e=>{const{x:n,y:i}=He(e);("scroll"!==e.type&&r&&n&&Math.abs(t.x-n)>100||i&&Math.abs(t.y-i)>100)&&setTimeout((()=>{var e,s,o,a
je(r,"swipe"),je(r,"swipe"+(e=t.x,s=t.y,o=n,a=i,Math.abs(e-o)>=Math.abs(s-a)?e-o>0?"Left":"Right":s-a>0?"Up":"Down"))}))}))}})}}
var yi={mixins:[ui,bi],args:"mode",props:{mode:String,flip:Boolean,overlay:Boolean},data:{mode:"slide",flip:!1,overlay:!1,clsPage:"uk-offcanvas-page",clsContainer:"uk-offcanvas-container",selPanel:".uk-offcanvas-bar",clsFlip:"uk-offcanvas-flip",clsContainerAnimation:"uk-offcanvas-container-animation",clsSidebarAnimation:"uk-offcanvas-bar-animation",clsMode:"uk-offcanvas",clsOverlay:"uk-offcanvas-overlay",selClose:".uk-offcanvas-close",container:!1},computed:{clsFlip(e){let{flip:t,clsFlip:r}=e
...
!r&&t&&Yt(t,document.body)&&this.hide()}},{name:"touchstart",passive:!0,el(){return this.panel},handler(e){let{targetTouches:t}=e
...
const t=e.targetTouches[0].clientY-this.clientY,{scrollTop:r,scrollHeight:n,clientHeight:i}=this.panel;(i>=n||0===r&&t>0||n-r<=i&&t<0)&&e.cancelable&&e.preventDefault()}},{name:"show",self:!0,handler(){"reveal"!==this.mode||it(le(this.panel),this.clsMode)||($t(this.panel,"<div>"),et(le(this.panel),this.clsMode)),Ye(document.documentElement,"overflowY",this.overlay?"hidden":""),et(document.body,this.clsContainer,this.clsFlip),Ye(document.body,"touch-action","pan-y pinch-zoom"),Ye(this.$el,"display","block"),et(this.$el,this.clsOverlay),et(this.panel,this.clsSidebarAnimation,"reveal"!==this.mode?this.clsMode:""),yt(document.body),et(document.body,this.clsContainerAnimation),this.clsContainerAnimation&&(wi().content+=",user-scalable=0")}},{name:"hide",self:!0,handler(){tt(document.body,this.clsContainerAnimation),Ye(document.body,"touch-action","")}},{name:"hidden",self:!0,handler(){this.clsContainerAnimation&&function(){const e=wi()
e.content=e.content.replace(/,user-scalable=0$/,"")}(),"reveal"===this.mode&&Bt(this.panel),tt(this.panel,this.clsSidebarAnimation,this.clsMode),tt(this.$el,this.clsOverlay),Ye(this.$el,"display",""),tt(document.body,this.clsContainer,this.clsFlip),Ye(document.documentElement,"overflowY","")}},{name:"swipeLeft swipeRight",handler(e){this.isToggled()&&c(e.type,"Left")^this.flip&&this.hide()}}]}
function wi(){return Yt('meta[name="viewport"]',document.head)||It(document.head,'<meta name="viewport">')}var _i={mixins:[nn,hn],props:{selContainer:String,selContent:String,minHeight:Number},data:{selContainer:".uk-modal",selContent:".uk-modal-dialog",minHeight:150},computed:{container(e,t){let{selContainer:r}=e
return de(t,r)},content(e,t){let{selContent:r}=e
return de(t,r)}},resizeTargets(){return[this.container,this.content]},update:{read(){return!!(this.content&&this.container&&ne(this.$el))&&{max:Math.max(this.minHeight,yt(this.container)-(mt(this.content).height-yt(this.$el)))}},write(e){let{max:t}=e
Ye(this.$el,{minHeight:this.minHeight,maxHeight:t})},events:["resize"]}},ki={mixin:[hn],props:["width","height"],resizeTargets(){return[this.$el,le(this.$el)]},connected(){et(this.$el,"uk-responsive-width")},update:{read(){return!!(ne(this.$el)&&this.width&&this.height)&&{width:wt(le(this.$el)),height:this.height}},write(e){yt(this.$el,Y.contain({height:this.height,width:this.width},e).height)},events:["resize"]}},xi={props:{offset:Number},data:{offset:0},methods:{async scrollTo(e){e=e&&Yt(e)||document.body,je(this.$el,"beforescroll",[this,e])&&(await Dr(e,{offset:this.offset}),je(this.$el,"scrolled",[this,e]))}},events:{click(e){e.defaultPrevented||(e.preventDefault(),this.scrollTo(Oi(this.$el)))}}}
function Oi(e){return document.getElementById(decodeURIComponent(e.hash).substring(1))}const Ei="_ukScrollspy"
var Ci={mixins:[On],args:"cls",props:{cls:String,target:String,hidden:Boolean,offsetTop:Number,offsetLeft:Number,repeat:Boolean,delay:Number},data:()=>({cls:"",target:!1,hidden:!0,offsetTop:0,offsetLeft:0,repeat:!1,delay:0,inViewClass:"uk-scrollspy-inview"}),computed:{elements:{get(e,t){let{target:r}=e
return r?Gt(r,t):[t]},watch(e){this.hidden&&Ye(ue(e,":not(."+this.inViewClass+")"),"visibility","hidden")},immediate:!0}},disconnected(){for(const t of this.elements){var e
tt(t,this.inViewClass,(null==(e=t[Ei])?void 0:e.cls)||""),delete t[Ei]}},update:[{read(){for(const e of this.elements)e[Ei]||(e[Ei]={cls:ee(e,"uk-scrollspy-class")||this.cls}),!this.repeat&&e[Ei].show||(e[Ei].show=Lr(e,this.offsetTop,this.offsetLeft))},write(e){for(const t of this.elements){const r=t[Ei]
!r.show||r.inview||r.queued?!r.show&&r.inview&&!r.queued&&this.repeat&&this.toggle(t,!1):(r.queued=!0,e.promise=(e.promise||Promise.resolve()).then((()=>new Promise((e=>setTimeout(e,this.delay))))).then((()=>{this.toggle(t,!0),setTimeout((()=>{r.queued=!1,this.$emit()}),300)})))}},events:["scroll","resize"]}],methods:{toggle(e,t){const r=e[Ei]
if(null==r.off||r.off(),Ye(e,"visibility",!t&&this.hidden?"hidden":""),st(e,this.inViewClass,t),st(e,r.cls),/\buk-animation-/.test(r.cls)){const n=()=>rt(e,"uk-animation-[\\w-]+")
t?r.off=Re(e,"animationcancel animationend",n):n()}je(e,t?"inview":"outview"),r.inview=t,this.$update(e)}}},Pi={mixins:[On],props:{cls:String,closest:String,scroll:Boolean,overflow:Boolean,offset:Number},data:{cls:"uk-active",closest:!1,scroll:!1,overflow:!0,offset:0},computed:{links:{get:(e,t)=>Gt('a[href^="#"]',t).filter((e=>e.hash)),watch(e){this.scroll&&this.$create("scroll",e,{offset:this.offset||0})},immediate:!0},elements(e){let{closest:t}=e
return de(this.links,t||"*")}},update:[{read(){const e=this.links.map(Oi).filter(Boolean),{length:t}=e
if(!t||!ne(this.$el))return!1
const[r]=$r(e,/auto|scroll/,!0),{scrollTop:n,scrollHeight:i}=r
let s=!1
if(n===i-Br(r))s=t-1
else{for(const t in e){if(gt(e[t]).top-gt(zr(r)).top-this.offset>0)break
s=+t}!1===s&&this.overflow&&(s=0)}return{active:s}},write(e){let{active:t}=e
const r=!1!==t&&!it(this.elements[t],this.cls)
this.links.forEach((e=>e.blur()))
for(const n in this.elements)st(this.elements[n],this.cls,+n===t)
r&&je(this.$el,"active",[t,this.elements[t]])},events:["scroll","resize"]}]},Ti={mixins:[nn,oi,hn,On],props:{position:String,top:null,bottom:Boolean,offset:String,animation:String,clsActive:String,clsInactive:String,clsFixed:String,clsBelow:String,selTarget:String,showOnUp:Boolean,targetOffset:Number},data:{position:"top",top:0,bottom:!1,offset:0,animation:"",clsActive:"uk-active",clsInactive:"",clsFixed:"uk-sticky-fixed",clsBelow:"uk-sticky-below",selTarget:"",showOnUp:!1,targetOffset:!1},computed:{selTarget(e,t){let{selTarget:r}=e
return r&&Yt(r,t)||t}},resizeTargets:()=>document.documentElement,connected(){this.placeholder=Yt("+ .uk-sticky-placeholder",this.$el)||Yt('<div class="uk-sticky-placeholder"></div>'),this.isFixed=!1,this.setActive(!1)},disconnected(){this.isFixed&&(this.hide(),tt(this.selTarget,this.clsInactive)),Ft(this.placeholder),this.placeholder=null},events:[{name:"load hashchange popstate",el:()=>window,filter(){return!1!==this.targetOffset},handler(){location.hash&&0!==Nr(window)&&or.read((()=>{const e=gt(Yt(location.hash)),t=gt(this.$el)
this.isFixed&&q(e,t)&&Nr(window,e.top-t.height-Ot(this.targetOffset,"height")-Ot(this.offset,"height"))}))}}],update:[{read(e,t){let{height:r,margin:n}=e
if(this.inactive=!this.matchMedia||!ne(this.$el),this.inactive)return!1
const i=this.isActive&&t.has("resize")
i&&(Ye(this.selTarget,"transition","0s"),this.hide()),this.isActive||(r=gt(this.$el).height,n=Ye(this.$el,"margin")),i&&(this.show(),or.write((()=>Ye(this.selTarget,"transition",""))))
const s=this.isFixed?this.placeholder:this.$el,o=yt(window)
let a=this.position
"auto"===a&&r>o&&(a="bottom")
let l=Ot(this.offset,"height",s)
"bottom"===a&&(l+=o-r)
const u=Math.max(0,r+l-o),c=gt(s).top,d=Si(this.top,this.$el,c),h=Si(this.bottom,this.$el,c+r,!0)
return{start:Math.max(d,c)-l,end:h?h-gt(this.$el).height+u-l:Ur(this.$el).scrollHeight-o,offset:l,overflow:u,topOffset:c,height:r,margin:n,width:mt(s).width,top:bt(s)[0]}},write(e){let{height:t,margin:r}=e
const{placeholder:n}=this
Ye(n,{height:t,margin:r}),he(n,document)||(Nt(this.$el,n),n.hidden=!0)},events:["resize"]},{read(e){let{scroll:t=0,dir:r="down",overflow:n,overflowScroll:i=0,start:s,end:o}=e
const a=Nr(window)
return{dir:t<=a?"down":"up",prevDir:r,scroll:a,prevScroll:t,offsetParentTop:gt(this.$el.offsetParent).top,overflowScroll:H(i+H(a,s,o)-H(t,s,o),0,n)}},write(e,t){const r=t.has("scroll"),{initTimestamp:n=0,dir:i,prevDir:s,scroll:o,prevScroll:a=0,top:l,start:u,topOffset:c,height:d}=e
if(o<0||o===a&&r||this.showOnUp&&!r&&!this.isFixed)return
const h=Date.now()
if((h-n>300||i!==s)&&(e.initScroll=o,e.initTimestamp=h),!(this.showOnUp&&!this.isFixed&&Math.abs(e.initScroll-o)<=30&&Math.abs(a-o)<=10))if(this.inactive||o<u||this.showOnUp&&(o<=u||"down"===i&&r||"up"===i&&!this.isFixed&&o<=c+d)){if(!this.isFixed)return void(pt.inProgress(this.$el)&&l>o&&(pt.cancel(this.$el),this.hide()))
this.isFixed=!1,this.animation&&o>c?(pt.cancel(this.$el),pt.out(this.$el,this.animation).then((()=>this.hide()),V)):this.hide()}else this.isFixed?this.update():this.animation&&o>c?(pt.cancel(this.$el),this.show(),pt.in(this.$el,this.animation).catch(V)):this.show()},events:["resize","scroll"]}],methods:{show(){this.isFixed=!0,this.update(),this.placeholder.hidden=!1},hide(){this.setActive(!1),tt(this.$el,this.clsFixed,this.clsBelow),Ye(this.$el,{position:"",top:"",width:""}),this.placeholder.hidden=!0},update(){let{width:e,scroll:t=0,overflow:r,overflowScroll:n=0,start:i,end:s,offset:o,topOffset:a,height:l,offsetParentTop:u}=this._data
const c=0!==i||t>i
let d="fixed"
t>s&&(o+=s-u,d="absolute"),r&&(o-=n),Ye(this.$el,{position:d,top:o+"px",width:e}),this.setActive(c),st(this.$el,this.clsBelow,t>a+l),et(this.$el,this.clsFixed)},setActive(e){const t=this.active
this.active=e,e?(nt(this.selTarget,this.clsInactive,this.clsActive),t!==e&&je(this.$el,"active")):(nt(this.selTarget,this.clsActive,this.clsInactive),t!==e&&je(this.$el,"inactive"))}}}
function Si(e,t,r,n){if(!e)return 0
if(E(e)&&e.match(/^-?\d/))return r+Ot(e)
{const r=!0===e?le(t):ge(e,t)
return gt(r).bottom-(n&&r&&he(t,r)?R(Ye(r,"paddingBottom")):0)}}var Ai={mixins:[sn,bi,on],args:"connect",props:{connect:String,toggle:String,itemNav:String,active:Number},data:{connect:"~.uk-switcher",toggle:"> * > :first-child",itemNav:!1,active:0,cls:"uk-active",attrItem:"uk-switcher-item"},computed:{connects:{get(e,t){let{connect:r}=e
return ve(r,t)},watch(e){this.swiping&&Ye(e,"touch-action","pan-y pinch-zoom")
const t=this.index()
this.connects.forEach((e=>fe(e).forEach(((e,r)=>st(e,this.cls,r===t)))))},immediate:!0},toggles:{get(e,t){let{toggle:r}=e
return Gt(r,t).filter((e=>!ce(e,".uk-disabled *, .uk-disabled, [disabled]")))},watch(e){const t=this.index()
this.show(~t?t:e[this.active]||e[0])},immediate:!0},children(){return fe(this.$el).filter((e=>this.toggles.some((t=>he(t,e)))))},swipeTarget(){return this.connects}},connected(){this.lazyload(this.$el,this.connects),St((()=>this.$emit()))},events:[{name:"click",delegate(){return this.toggle},handler(e){e.preventDefault(),this.show(e.current)}},{name:"click",el(){return this.connects.concat(this.itemNav?ve(this.itemNav,this.$el):[])},delegate(){return"["+this.attrItem+"],[data-"+this.attrItem+"]"},handler(e){e.preventDefault(),this.show(ee(e.current,this.attrItem))}},{name:"swipeRight swipeLeft",filter(){return this.swiping},el(){return this.connects},handler(e){let{type:t}=e
this.show(c(t,"Left")?"next":"previous")}}],methods:{index(){return h(this.children,(e=>it(e,this.cls)))},show(e){const t=this.index(),r=G(this.children[G(e,this.toggles,t)],fe(this.$el))
t!==r&&(fe(this.$el).forEach(((e,t)=>{st(e,this.cls,r===t),Z(this.toggles[t],"aria-expanded",r===t)})),this.connects.forEach((async e=>{let{children:n}=e
await this.toggleElement(I(n).filter((e=>it(e,this.cls))),!1,t>=0),await this.toggleElement(n[r],!0,t>=0)})))}}},Mi={mixins:[nn],extends:Ai,props:{media:Boolean},data:{media:960,attrItem:"uk-tab-item"},connected(){const e=it(this.$el,"uk-tab-left")?"uk-tab-left":!!it(this.$el,"uk-tab-right")&&"uk-tab-right"
e&&this.$create("toggle",this.$el,{cls:e,mode:"media",media:this.media})}}
var Ri={mixins:[sn,oi,on],args:"target",props:{href:String,target:null,mode:"list",queued:Boolean},data:{href:!1,target:!1,mode:"click",queued:!0},computed:{target:{get(e,t){let{href:r,target:n}=e
return n=ve(n||r,t),n.length&&n||[t]},watch(){this.updateAria()},immediate:!0}},connected(){d(this.mode,"media")||ae(this.$el)||Z(this.$el,"tabindex","0"),this.lazyload(this.$el,this.target),St((()=>this.$emit()))},events:[{name:er,filter(){return d(this.mode,"hover")},handler(e){Ue(e)&&!this._showState&&(je(this.$el,"focus"),Re(document,er,(()=>je(this.$el,"blur")),!0,(e=>!he(e.target,this.$el))),d(this.mode,"click")&&(this._preventClick=!0))}},{name:nr+" "+ir+" focus blur",filter(){return d(this.mode,"hover")},handler(e){if(Ue(e))return
const t=d([nr,"focus"],e.type),r=Z(this.$el,"aria-expanded")
!t&&(e.type===ir&&ce(this.$el,":focus")||"blur"===e.type&&ce(this.$el,":hover"))||(this._showState&&t===(r!==this._showState)?t||(this._showState=null):(this._showState=t?r:null,this.toggle("toggle"+(t?"show":"hide"))))}},{name:"keydown",filter(){return d(this.mode,"click")&&!At(this.$el,"input")},handler(e){32===e.keyCode&&(e.preventDefault(),this.$el.click())}},{name:"click",filter(){return d(this.mode,"click")},handler(e){if(this._preventClick)return this._preventClick=null
let t;(de(e.target,'a[href="#"], a[href=""]')||(t=de(e.target,"a[href]"))&&("true"!==Z(this.$el,"aria-expanded")||t.hash&&ce(this.target,t.hash)))&&e.preventDefault(),this.toggle()}},{name:"toggled",self:!0,el(){return this.target},handler(e,t){e.target===this.target[0]&&this.updateAria(t)}},{name:"mediachange",filter(){return d(this.mode,"media")},el(){return this.target},handler(e,t){t.matches^this.isToggled(this.target)&&this.toggle()}}],methods:{async toggle(e){if(!je(this.target,e||"toggle",[this]))return
if(!this.queued)return this.toggleElement(this.target)
const t=this.target.filter((e=>it(e,this.clsLeave)))
...
z(Object.freeze({__proto__:null,Accordion:ln,Alert:cn,Cover:pn,Drop:vn,Dropdown:vn,FormCustom:bn,Grid:Pn,HeightMatch:Sn,HeightViewport:Rn,Icon:Un,Img:Qn,Leader:ai,Margin:yn,Modal:di,Nav:hi,Navbar:fi,Offcanvas:yi,OverflowAuto:_i,Responsive:ki,Scroll:xi,Scrollspy:Ci,ScrollspyNav:Pi,Sticky:Ti,Svg:jn,Switcher:Ai,Tab:Mi,Toggle:Ri,Video:dn,Close:Wn,Spinner:Yn,SlidenavNext:Vn,SlidenavPrevious:Vn,SearchIcon:qn,Marker:Hn,NavbarToggleIcon:Hn,OverlayIcon:Hn,PaginationNext:Hn,PaginationPrevious:Hn,Totop:Hn}),((e,t)=>rn.component(t,e))),rn.use((function(){if(!Qt)return
let e=0
Ae(document,"animationstart",(t=>{let{target:r}=t;(Ye(r,"animationName")||"").match(/^uk-.*(left|right)/)&&(e++,Ye(document.documentElement,"overflowX","hidden"),setTimeout((()=>{--e||Ye(document.documentElement,"overflowX","")}),N(Ye(r,"animationDuration"))+100))}),!0)})),function(e){const{connect:t,disconnect:r}=e
function n(e){let{addedNodes:n,removedNodes:i}=e
for(const r of n)Wt(r,t)
for(const t of i)Wt(t,r)}function i(t){var r
let{target:n,attributeName:i}=t
const s=tn(i)
s&&s in e&&(X(n,i)?e[s](n):null==(r=e.getComponent(n,s))||r.$destroy())}Qt&&window.MutationObserver&&or.read((function(){document.body&&Wt(document.body,t),new MutationObserver((e=>e.forEach(n))).observe(document,{childList:!0,subtree:!0}),new MutationObserver((e=>e.forEach(i))).observe(document,{attributes:!0,subtree:!0}),e._initialized=!0}))}(rn)
const ji=["days","hours","minutes","seconds"]
...
for(const t of ji){const r=Yt(this.clsWrapper.replace("%unit%",t),this.$el)
if(!r)continue
let n=String(Math.trunc(e[t]))
n=n.length<2?"0"+n:n,r.textContent!==n&&(n=n.split(""),n.length!==r.children.length&&Mt(r,n.map((()=>"<span></span>")).join("")),n.forEach(((e,t)=>r.children[t].textContent=e)))}}}}
const Li="uk-transition-leave",Ni="uk-transition-enter"
function Di(e,t,r,n){void 0===n&&(n=0)
const i=Fi(t,!0),s={opacity:1},o={opacity:0},a=e=>()=>i===Fi(t)?e():Promise.reject(),l=a((()=>(et(t,Li),Promise.all(zi(t).map(((e,t)=>new Promise((i=>setTimeout((()=>ut.start(e,o,r/2,"ease").then(i)),t*n)))))).then((()=>tt(t,Li)))))),u=a((()=>{const a=yt(t)
return et(t,Ni),e(),Ye(fe(t),{opacity:0}),new Promise((e=>requestAnimationFrame((()=>{const l=fe(t),u=yt(t)
Ye(t,"alignContent","flex-start"),yt(t,a)
const c=zi(t)
Ye(l,o)
const d=c.map(((e,t)=>new Promise((i=>setTimeout((()=>ut.start(e,s,r/2,"ease").then(i)),t*n)))))
a!==u&&d.push(ut.start(t,{height:u},r/2+c.length*n,"ease")),Promise.all(d).then((()=>{tt(t,Ni),i===Fi(t)&&(Ye(t,{height:"",alignContent:""}),Ye(l,{opacity:""}),delete t.dataset.transition),e()}))}))))}))
return it(t,Li)?$i(t).then(u):it(t,Ni)?$i(t).then(l).then(u):l().then(u)}function Fi(e,t){return t&&(e.dataset.transition=1+Fi(e)),M(e.dataset.transition)||0}function $i(e){return Promise.all(fe(e).filter(ut.inProgress).map((e=>new Promise((t=>Re(e,"transitionend transitioncanceled",t))))))}function zi(e){return wn(fe(e)).reduce(((e,t)=>e.concat(B(t.filter((e=>Lr(e))),"offsetLeft"))),[])}function Bi(e,t,r){return new Promise((n=>requestAnimationFrame((()=>{let i=fe(t)
const s=i.map((e=>Ui(e,!0))),o=Ye(t,["height","padding"])
ut.cancel(t),i.forEach(ut.cancel),Hi(t),e(),i=i.concat(fe(t).filter((e=>!d(i,e)))),Promise.resolve().then((()=>{or.flush()
const e=Ye(t,["height","padding"]),[a,l]=function(e,t,r){const n=t.map(((e,t)=>!(!le(e)||!(t in r))&&(r[t]?ne(e)?Vi(e):{opacity:0}:{opacity:ne(e)?1:0}))),i=n.map(((n,i)=>{const s=le(t[i])===e&&(r[i]||Ui(t[i]))
if(!s)return!1
if(n){if(!("opacity"in n)){const{opacity:e}=s
e%1?n.opacity=1:delete s.opacity}}else delete s.opacity
return s}))
return[n,i]}(t,i,s)
i.forEach(((e,t)=>l[t]&&Ye(e,l[t]))),Ye(t,{display:"block",...o}),requestAnimationFrame((()=>{const s=i.map(((e,n)=>le(e)===t&&ut.start(e,a[n],r,"ease"))).concat(ut.start(t,e,r,"ease"))
Promise.all(s).then((()=>{i.forEach(((e,r)=>le(e)===t&&Ye(e,"display",0===a[r].opacity?"none":""))),Hi(t)}),V).then(n)}))}))}))))}function Ui(e,t){const r=Ye(e,"zIndex")
return!!ne(e)&&{display:"",opacity:t?Ye(e,"opacity"):"0",pointerEvents:"none",position:"absolute",zIndex:"auto"===r?me(e):r,...Vi(e)}}function Hi(e){Ye(e.children,{height:"",left:"",opacity:"",pointerEvents:"",position:"",top:"",marginTop:"",marginLeft:"",transform:"",width:"",zIndex:""}),Ye(e,{height:"",display:"",padding:""})}function Vi(e){const{height:t,width:r}=gt(e),{top:n,left:i}=vt(e),{marginLeft:s,marginTop:o}=Ye(e,["marginTop","marginLeft"])
return{top:n,left:i,height:t,width:r,marginLeft:s,marginTop:o,transform:""}}var qi={props:{duration:Number,animation:Boolean},data:{duration:150,animation:"slide"},methods:{animate(e,t){void 0===t&&(t=this.$el)
const r=this.animation,n="fade"===r?Di:"delayed-fade"===r?function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r]
return Di(...t,40)}:r?Bi:()=>(e(),Promise.resolve())
return n(e,t,this.duration).then((()=>this.$update(t,"resize")),V)}}},Wi={mixins:[qi],args:"target",props:{target:Boolean,selActive:Boolean},data:{target:null,selActive:!1,attrItem:"uk-filter-control",cls:"uk-active",duration:250},computed:{toggles:{get(e,t){let{attrItem:r}=e
return Gt("["+r+"],[data-"+r+"]",t)},watch(){if(this.updateState(),!1!==this.selActive){const e=Gt(this.selActive,this.$el)
this.toggles.forEach((t=>st(t,this.cls,d(e,t))))}},immediate:!0},children:{get(e,t){let{target:r}=e
return Gt(r+" > *",t)},watch(e,t){var r,n
t&&(n=t,(r=e).length!==n.length||!r.every((e=>~n.indexOf(e))))&&this.updateState()},immediate:!0}},events:[{name:"click",delegate(){return"["+this.attrItem+"],[data-"+this.attrItem+"]"},handler(e){e.preventDefault(),this.apply(e.current)}}],methods:{apply(e){const t=this.getState(),r=Gi(e,this.attrItem,this.getState())
var n,i
n=t,i=r,["filter","sort"].every((e=>D(n[e],i[e])))||this.setState(r)},getState(){return this.toggles.filter((e=>it(e,this.cls))).reduce(((e,t)=>Gi(t,this.attrItem,e)),{filter:{"":""},sort:[]})},setState(e,t){void 0===t&&(t=!0),e={filter:{"":""},sort:[],...e},je(this.$el,"beforeFilter",[this,e]),this.toggles.forEach((t=>st(t,this.cls,!!function(e,t,r){let{filter:n={"":""},sort:[i,s]}=r
const{filter:o="",group:a="",sort:l,order:u="asc"}=Yi(e,t)
return S(l)?a in n&&o===n[a]||!o&&a&&!(a in n)&&!n[""]:i===l&&s===u}(t,this.attrItem,e)))),Promise.all(Gt(this.target,this.$el).map((r=>{const n=()=>{(function(e,t,r){const n=function(e){let{filter:t}=e,r=""
return z(t,(e=>r+=e||"")),r}(e)
r.forEach((e=>Ye(e,"display",n&&!ce(e,n)?"none":"")))
const[i,s]=e.sort
if(i){const e=function(e,t,r){return[...e].sort(((e,n)=>ee(e,t).localeCompare(ee(n,t),void 0,{numeric:!0})*("asc"===r||-1)))}(r,i,s)
D(e,r)||It(t,e)}})(e,r,fe(r)),this.$update(this.$el)}
return t?this.animate(n,r):n()}))).then((()=>je(this.$el,"afterFilter",[this])))},updateState(){or.write((()=>this.setState(this.getState(),!1)))}}}
function Yi(e,t){return xr(ee(e,t),["filter"])}function Gi(e,t,r){const n=Yi(e,t),{filter:i,group:s,sort:o,order:a="asc"}=n
return(i||S(o))&&(s?i?(delete r.filter[""],r.filter[s]=i):(delete r.filter[s],(T(r.filter)||""in r.filter)&&(r.filter={"":i||""})):r.filter={"":i||""}),S(o)||(r.sort=[o,a]),r}var Ki={slide:{show:e=>[{transform:Zi(-100*e)},{transform:Zi()}],percent:e=>Qi(e),translate:(e,t)=>[{transform:Zi(-100*t*e)},{transform:Zi(100*t*(1-e))}]}}
function Qi(e){return Math.abs(Ye(e,"transform").split(",")[4]/e.offsetWidth)||0}function Zi(e,t){return void 0===e&&(e=0),void 0===t&&(t="%"),"translate3d("+(e+=e?t:"")+", 0, 0)"}function Xi(e){return"scale3d("+e+", "+e+", 1)"}var Ji={...Ki,fade:{show:()=>[{opacity:0},{opacity:1}],percent:e=>1-Ye(e,"opacity"),translate:e=>[{opacity:1-e},{opacity:e}]},scale:{show:()=>[{opacity:0,transform:Xi(.8)},{opacity:1,transform:Xi(1)}],percent:e=>1-Ye(e,"opacity"),translate:e=>[{opacity:1-e,transform:Xi(1-.2*e)},{opacity:e,transform:Xi(.8+.2*e)}]}}
function es(e,t,r){je(e,Ie(t,!1,!1,r))}var ts={props:{autoplay:Boolean,autoplayInterval:Number,pauseOnHover:Boolean},data:{autoplay:!1,autoplayInterval:7e3,pauseOnHover:!0},connected(){this.autoplay&&this.startAutoplay()},disconnected(){this.stopAutoplay()},update(){Z(this.slides,"tabindex","-1")},events:[{name:"visibilitychange",el:()=>document,filter(){return this.autoplay},handler(){document.hidden?this.stopAutoplay():this.startAutoplay()}}],methods:{startAutoplay(){this.stopAutoplay(),this.interval=setInterval((()=>(!this.draggable||!Yt(":focus",this.$el))&&(!this.pauseOnHover||!ce(this.$el,":hover"))&&!this.stack.length&&this.show("next")),this.autoplayInterval)},stopAutoplay(){this.interval&&clearInterval(this.interval)}}},rs={props:{draggable:Boolean},data:{draggable:!0,threshold:10},created(){for(const e of["start","move","end"]){const t=this[e]
this[e]=e=>{const r=He(e).x*(Zt?-1:1)
this.prevPos=r===this.pos?this.prevPos:this.pos,this.pos=r,t(e)}}},events:[{name:er,delegate(){return this.selSlides},handler(e){var t
!this.draggable||!Ue(e)&&(t=e.target,!t.children.length&&t.childNodes.length)||de(e.target,ie)||e.button>0||this.length<2||this.start(e)}},{name:"dragstart",handler(e){e.preventDefault()}}],methods:{start(){this.drag=this.pos,this._transitioner?(this.percent=this._transitioner.percent(),this.drag+=this._transitioner.getDistance()*this.percent*this.dir,this._transitioner.cancel(),this._transitioner.translate(this.percent),this.dragging=!0,this.stack=[]):this.prevIndex=this.index,Ae(document,tr,this.move,{passive:!1}),Ae(document,rr+" "+sr+" input",this.end,!0),Ye(this.list,"userSelect","none")},move(e){const t=this.pos-this.drag
if(0===t||this.prevPos===this.pos||!this.dragging&&Math.abs(t)<this.threshold)return
Ye(this.list,"pointerEvents","none"),e.cancelable&&e.preventDefault(),this.dragging=!0,this.dir=t<0?1:-1
const{slides:r}=this
...
let h;[this.index,this.prevIndex].filter((e=>!d([s,n],e))).forEach((e=>{je(r[e],"itemhidden",[this]),c&&(h=!0,this.prevIndex=n)})),(this.index===n&&this.prevIndex!==n||h)&&je(r[this.index],"itemshown",[this]),u&&(this.prevIndex=n,this.index=s,!c&&je(a,"beforeitemhide",[this]),je(l,"beforeitemshow",[this])),this._transitioner=this._translate(Math.abs(this.percent),a,!c&&l),u&&(!c&&je(a,"itemhide",[this]),je(l,"itemshow",[this]))},end(){if(Me(document,tr,this.move,{passive:!1}),Me(document,rr+" "+sr+" input",this.end,!0),this.dragging)if(this.dragging=null,this.index===this.prevIndex)this.percent=1-this.percent,this.dir*=-1,this._show(!1,this.index,!0),this._transitioner=null
else{const e=(Zt?this.dir*(Zt?1:-1):this.dir)<0==this.prevPos>this.pos
this.index=e?this.index:this.prevIndex,e&&(this.percent=1-this.percent),this.show(this.dir>0&&!e||this.dir<0&&e?"next":"previous",!0)}Ye(this.list,{userSelect:"",pointerEvents:""}),this.drag=this.percent=null}}}
var ns={mixins:[ts,rs,{data:{selNav:!1},computed:{nav(e,t){let{selNav:r}=e
return Yt(r,t)},selNavItem(e){let{attrItem:t}=e
return"["+t+"],[data-"+t+"]"},navItems(e,t){return Gt(this.selNavItem,t)}},update:{write(){this.nav&&this.length!==this.nav.children.length&&Mt(this.nav,this.slides.map(((e,t)=>"<li "+this.attrItem+'="'+t+'"><a href></a></li>')).join("")),this.navItems.concat(this.nav).forEach((e=>e&&(e.hidden=!this.maxIndex))),this.updateNav()},events:["resize"]},events:[{name:"click",delegate(){return this.selNavItem},handler(e){e.preventDefault(),this.show(ee(e.current,this.attrItem))}},{name:"itemshow",handler:"updateNav"}],methods:{updateNav(){const e=this.getValidIndex()
for(const t of this.navItems){const r=ee(t,this.attrItem)
st(t,this.clsActive,M(r)===e),st(t,"uk-invisible",this.finite&&("previous"===r&&0===e||"next"===r&&e>=this.maxIndex))}}}},hn],props:{clsActivated:Boolean,easing:String,index:Number,finite:Boolean,velocity:Number,selSlides:String},data:()=>({easing:"ease",finite:!1,velocity:1,index:0,prevIndex:-1,stack:[],percent:0,clsActive:"uk-active",clsActivated:!1,Transitioner:!1,transitionOptions:{}}),connected(){this.prevIndex=-1,this.index=this.getValidIndex(this.$props.index),this.stack=[]},disconnected(){tt(this.slides,this.clsActive)},computed:{duration(e,t){let{velocity:r}=e
return is(t.offsetWidth/r)},list(e,t){let{selList:r}=e
return Yt(r,t)},maxIndex(){return this.length-1},selSlides(e){let{selList:t,selSlides:r}=e
return t+" "+(r||"> *")},slides:{get(){return Gt(this.selSlides,this.$el)},watch(){this.$reset()}},length(){return this.slides.length}},methods:{show(e,t){if(void 0===t&&(t=!1),this.dragging||!this.length)return
...
const s=this.getIndex(this.index),o=it(this.slides,this.clsActive)&&this.slides[s],a=this.getIndex(e,this.index),l=this.slides[a]
if(o===l)return void i()
if(this.dir=function(e,t){return"next"===e?1:"previous"===e||e<t?-1:1}(e,s),this.prevIndex=s,this.index=a,o&&!je(o,"beforeitemhide",[this])||!je(l,"beforeitemshow",[this,o]))return this.index=this.prevIndex,void i()
const u=this._show(o,l,t).then((()=>(o&&je(o,"itemhidden",[this]),je(l,"itemshown",[this]),new Promise((e=>{or.write((()=>{r.shift(),r.length?this.show(r.shift(),!0):this._transitioner=null,e()}))})))))
return o&&je(o,"itemhide",[this]),je(l,"itemshow",[this]),u},getIndex(e,t){return void 0===e&&(e=this.index),void 0===t&&(t=this.index),H(G(e,this.slides,t,this.finite),0,this.maxIndex)},getValidIndex(e,t){return void 0===e&&(e=this.index),void 0===t&&(t=this.prevIndex),this.getIndex(e,t)},_show(e,t,r){if(this._transitioner=this._getTransitioner(e,t,this.dir,{easing:r?t.offsetWidth<600?"cubic-bezier(0.25, 0.46, 0.45, 0.94)":"cubic-bezier(0.165, 0.84, 0.44, 1)":this.easing,...this.transitionOptions}),!r&&!e)return this._translate(1),Promise.resolve()
...
return n.translate(e),n},_getTransitioner(e,t,r,n){return void 0===e&&(e=this.prevIndex),void 0===t&&(t=this.index),void 0===r&&(r=this.dir||1),void 0===n&&(n=this.transitionOptions),new this.Transitioner(C(e)?this.slides[e]:e,C(t)?this.slides[t]:t,r*(Zt?-1:1),n)}}}
function is(e){return.5*e+300}var ss={mixins:[ns],props:{animation:String},data:{animation:"slide",clsActivated:"uk-transition-active",Animations:Ki,Transitioner:function(e,t,r,n){let{animation:i,easing:s}=n
const{percent:o,translate:a,show:l=V}=i,u=l(r),c=new Q
return{dir:r,show(n,i,o){void 0===i&&(i=0)
const a=o?"linear":s
return n-=Math.round(n*H(i,-1,1)),this.translate(i),es(t,"itemin",{percent:i,duration:n,timing:a,dir:r}),es(e,"itemout",{percent:1-i,duration:n,timing:a,dir:r}),Promise.all([ut.start(t,u[1],n,a),ut.start(e,u[0],n,a)]).then((()=>{this.reset(),c.resolve()}),V),c.promise},cancel(){ut.cancel([t,e])},reset(){for(const r in u[0])Ye([t,e],r,"")},forward(r,n){return void 0===n&&(n=this.percent()),ut.cancel([t,e]),this.show(r,n,!0)},translate(n){this.reset()
const i=a(n,r)
Ye(t,i[1]),Ye(e,i[0]),es(t,"itemtranslatein",{percent:n,dir:r}),es(e,"itemtranslateout",{percent:1-n,dir:r})},percent:()=>o(e||t,t,r),getDistance:()=>null==e?void 0:e.offsetWidth}}},computed:{animation(e){let{animation:t,Animations:r}=e
return{...r[t]||r.slide,name:t}},transitionOptions(){return{animation:this.animation}}},events:{beforeitemshow(e){let{target:t}=e
et(t,this.clsActive)},itemshown(e){let{target:t}=e
et(t,this.clsActivated)},itemhidden(e){let{target:t}=e
tt(t,this.clsActive,this.clsActivated)}}},os={mixins:[fn,ui,on,ss],functional:!0,props:{delayControls:Number,preload:Number,videoAutoplay:Boolean,template:String},data:()=>({preload:1,videoAutoplay:!1,delayControls:3e3,items:[],cls:"uk-open",clsPage:"uk-lightbox-page",selList:".uk-lightbox-items",attrItem:"uk-lightbox-item",selClose:".uk-close-large",selCaption:".uk-lightbox-caption",pauseOnHover:!1,velocity:2,Animations:Ji,template:'<div class="uk-lightbox uk-overflow-hidden"> <ul class="uk-lightbox-items"></ul> <div class="uk-lightbox-toolbar uk-position-top uk-text-right uk-transition-slide-top uk-transition-opaque"> <button class="uk-lightbox-toolbar-icon uk-close-large" type="button" uk-close></button> </div> <a class="uk-lightbox-button uk-position-center-left uk-position-medium uk-transition-fade" href uk-slidenav-previous uk-lightbox-item="previous"></a> <a class="uk-lightbox-button uk-position-center-right uk-position-medium uk-transition-fade" href uk-slidenav-next uk-lightbox-item="next"></a> <div class="uk-lightbox-toolbar uk-lightbox-caption uk-position-bottom uk-text-center uk-transition-slide-bottom uk-transition-opaque"></div> </div>'}),created(){const e=Yt(this.template),t=Yt(this.selList,e)
this.items.forEach((()=>It(t,"<li>"))),this.$mount(It(this.container,e))},computed:{caption(e,t){let{selCaption:r}=e
return Yt(r,t)}},events:[{name:tr+" "+er+" keydown",handler:"showControls"},{name:"click",self:!0,delegate(){return this.selSlides},handler(e){e.defaultPrevented||this.hide()}},{name:"shown",self:!0,handler(){this.showControls()}},{name:"hide",self:!0,handler(){this.hideControls(),tt(this.slides,this.clsActive),ut.stop(this.slides)}},{name:"hidden",self:!0,handler(){this.$destroy(!0)}},{name:"keyup",el:()=>document,handler(e){if(this.isToggled(this.$el)&&this.draggable)switch(e.keyCode){case 37:this.show("previous")
break
case 39:this.show("next")}}},{name:"beforeitemshow",handler(e){this.isToggled()||(this.draggable=!1,e.preventDefault(),this.toggleElement(this.$el,!0,!1),this.animation=Ji.scale,tt(e.target,this.clsActive),this.stack.splice(1,0,this.index))}},{name:"itemshow",handler(){Mt(this.caption,this.getItem().caption||"")
...
if("image"===n||r.match(/\.(avif|jpe?g|a?png|gif|svg|webp)($|\?)/i))try{const{width:e,height:n}=await qe(r,o.srcset,o.size)
this.setItem(t,as("img",{src:r,width:e,height:n,alt:i,...o}))}catch(u){this.setError(t)}else if("video"===n||r.match(/\.(mp4|webm|ogv)($|\?)/i)){const e=as("video",{src:r,poster:s,controls:"",playsinline:"","uk-video":""+this.videoAutoplay,...o})
Ae(e,"loadedmetadata",(()=>{Z(e,{width:e.videoWidth,height:e.videoHeight}),this.setItem(t,e)})),Ae(e,"error",(()=>this.setError(t)))}else if("iframe"===n||r.match(/\.(html|php)($|\?)/i))this.setItem(t,as("iframe",{src:r,frameborder:"0",allowfullscreen:"",class:"uk-lightbox-iframe",...o}))
else if(a=r.match(/\/\/(?:.*?youtube(-nocookie)?\..*?[?&]v=|youtu\.be\/)([\w-]{11})[&?]?(.*)?/))this.setItem(t,as("iframe",{src:"https://www.youtube"+(a[1]||"")+".com/embed/"+a[2]+(a[3]?"?"+a[3]:""),width:1920,height:1080,...l,...o}))
...
this.setItem(t,as("iframe",{src:"https://player.vimeo.com/video/"+a[1]+(a[2]?"?"+a[2]:""),width:n,height:e,...l,...o}))}catch(u){this.setError(t)}}}],methods:{loadItem(e){void 0===e&&(e=this.index)
const t=this.getItem(e)
this.getSlide(t).childElementCount||je(this.$el,"itemload",[t])},getItem(e){return void 0===e&&(e=this.index),this.items[G(e,this.slides)]},setItem(e,t){je(this.$el,"itemloaded",[this,Mt(this.getSlide(e),t)])},getSlide(e){return this.slides[this.items.indexOf(e)]},setError(e){this.setItem(e,'<span uk-icon="icon: bolt; ratio: 2"></span>')},showControls(){clearTimeout(this.controlsTimer),this.controlsTimer=setTimeout(this.hideControls,this.delayControls),et(this.$el,"uk-active","uk-transition-active")},hideControls(){tt(this.$el,"uk-active","uk-transition-active")}}}
function as(e,t){const r=Vt("<"+e+">")
return Z(r,t),r}var ls={install:function(e,t){e.lightboxPanel||e.component("lightboxPanel",os)
...
return Gt(r,t)},watch(){this.hide()}}},disconnected(){this.hide()},events:[{name:"click",delegate(){return this.toggle+":not(.uk-disabled)"},handler(e){e.preventDefault(),this.show(e.current)}}],methods:{show(e){const t=U(this.toggles.map(us),"source")
if(k(e)){const{source:r}=us(e)
e=h(t,(e=>{let{source:t}=e
return r===t}))}return this.panel=this.panel||this.$create("lightboxPanel",{...this.$props,items:t}),Ae(this.panel.$el,"hidden",(()=>this.panel=!1)),this.panel.show(e)},hide(){var e
return null==(e=this.panel)?void 0:e.hide()}}}
function us(e){const t={}
for(const r of["href","caption","type","poster","alt","attrs"])t["href"===r?"source":r]=ee(e,r)
return t.attrs=xr(t.attrs),t}var cs={mixins:[fn],functional:!0,args:["message","status"],data:{message:"",status:"",timeout:5e3,group:null,pos:"top-center",clsContainer:"uk-notification",clsClose:"uk-notification-close",clsMsg:"uk-notification-message"},install:function(e){e.notification.closeAll=function(t,r){Wt(document.body,(n=>{const i=e.getComponent(n,"notification")
!i||t&&t!==i.group||i.close(r)}))}},computed:{marginProp(e){let{pos:t}=e
return"margin"+(u(t,"top")?"Top":"Bottom")},startProps(){return{opacity:0,[this.marginProp]:-this.$el.offsetHeight}}},created(){const e=Yt("."+this.clsContainer+"-"+this.pos,this.container)||It(this.container,'<div class="'+this.clsContainer+" "+this.clsContainer+"-"+this.pos+'" style="display: block"></div>')
this.$mount(It(e,'<div class="'+this.clsMsg+(this.status?" "+this.clsMsg+"-"+this.status:"")+'"> <a href class="'+this.clsClose+'" data-uk-close></a> <div>'+this.message+"</div> </div>"))},async connected(){const e=R(Ye(this.$el,this.marginProp))
await ut.start(Ye(this.$el,this.startProps),{opacity:1,[this.marginProp]:e}),this.timeout&&(this.timer=setTimeout(this.close,this.timeout))},events:{click(e){de(e.target,'a[href="#"],a[href=""]')&&e.preventDefault(),this.close()},[nr](){this.timer&&clearTimeout(this.timer)},[ir](){this.timeout&&(this.timer=setTimeout(this.close,this.timeout))}},methods:{async close(e){this.timer&&clearTimeout(this.timer),e||await ut.start(this.$el,this.startProps),(e=>{const t=le(e)
je(e,"close",[this]),Ft(e),null!=t&&t.hasChildNodes()||Ft(t)})(this.$el)}}}
const ds={x:fs,y:fs,rotate:fs,scale:fs,color:ms,backgroundColor:ms,borderColor:ms,blur:gs,hue:gs,fopacity:gs,grayscale:gs,invert:gs,saturate:gs,sepia:gs,opacity:function(e,t,r){1===r.length&&r.unshift(Cs(t,e,""))
return r=_s(r),(t,n)=>{t[e]=xs(r,n)}},stroke:function(e,t,r){1===r.length&&r.unshift(0)
const n=Es(r),i=Fn(t)
if(r=_s(r.reverse(),(e=>(e=R(e),"%"===n?e*i/100:e))),!r.some((e=>{let[t]=e
return t})))return V
return Ye(t,"strokeDasharray",i),(e,t)=>{e.strokeDashoffset=xs(r,t)}},bgx:vs,bgy:vs},{keys:hs}=Object
var ps={mixins:[oi],props:Ps(hs(ds),"list"),data:Ps(hs(ds),void 0),computed:{props:(e,t)=>hs(ds).reduce(((r,n)=>(S(e[n])||(r[n]=ds[n](n,t,e[n].slice())),r)),{})},events:{load(){this.$emit()}},methods:{reset(){z(this.getCss(0),((e,t)=>Ye(this.$el,t,"")))},getCss(e){const t={transform:"",filter:""}
for(const r in this.props)this.props[r](t,e)
return t}}}
function fs(e,t,r){const n=Es(r)||{x:"px",y:"px",rotate:"deg"}[e]||""
let i
return"x"!==e&&"y"!==e||(e="translate"+a(e),i=e=>R(R(e).toFixed("px"===n?0:6))),1===r.length&&r.unshift("scale"===e?1:0),r=_s(r,i),(t,i)=>{t.transform+=" "+e+"("+xs(r,i)+n+")"}}function ms(e,t,r){return 1===r.length&&r.unshift(Cs(t,e,"")),r=_s(r,(e=>function(e,t){return Cs(e,"color",t).split(/[(),]/g).slice(1,-1).concat(1).slice(0,4).map(R)}(t,e))),(t,n)=>{const[i,s,o]=ks(r,n),a=i.map(((e,t)=>(e+=o*(s[t]-e),3===t?R(e):parseInt(e,10)))).join(",")
t[e]="rgba("+a+")"}}function gs(e,t,r){1===r.length&&r.unshift(0)
const n=Es(r)||{blur:"px",hue:"deg"}[e]||"%"
return e={fopacity:"opacity",hue:"hue-rotate"}[e]||e,r=_s(r),(t,i)=>{const s=xs(r,i)
t.filter+=" "+e+"("+(s+n)+")"}}function vs(e,t,r){1===r.length&&r.unshift(0)
const n="y"===(e=e.substr(-1))?"height":"width"
r=_s(r,(e=>Ot(e,n,t)))
const i=Cs(t,"background-position-"+e,"")
return"cover"===Cs(t,"backgroundSize","")?function(e,t,r,n,i){const s=function(e){const t=Ye(e,"backgroundImage").replace(/^none|url\(["']?(.+?)["']?\)$/,"$1")
if(ys[t])return ys[t]
const r=new Image
if(t&&(r.src=t,!r.naturalWidth))return r.onload=()=>{ys[t]=ws(r),je(e,Ie("load",!1))},ws(r)
return ys[t]=ws(r)}(t)
if(!s.width)return V
...
if(f<c)h[i]=p[i]+c-f
else if(f>c){const e=h[i]/Ot(n,i,t,!0)
e&&(d-=(f-c)/e)}const m=Y.cover(s,h),g=bs(e,r,d+"px")
return(e,t)=>{g(e,t),e.backgroundSize=m.width+"px "+m.height+"px",e.backgroundRepeat="no-repeat"}}(e,t,r,i,n):bs(e,r,i)}function bs(e,t,r){return function(n,i){n["background-position-"+e]="calc("+r+" + "+xs(t,i)+"px)"}}const ys={}
function ws(e){return{width:e.naturalWidth,height:e.naturalHeight}}function _s(e,t){void 0===t&&(t=R)
const r=[],{length:n}=e
let i=0
...
i=0}}return r}function ks(e,t){const r=h(e.slice(1),(e=>{let[,r]=e
return t<=r}))+1
return[e[r-1][0],e[r][0],(t-e[r-1][1])/(e[r][1]-e[r-1][1])]}function xs(e,t){const[r,n,i]=ks(e,t)
return C(r)?r+Math.abs(r-n)*i*(r<n?1:-1):+n}const Os=/^-?\d+([^\s]*)/
function Es(e,t){for(const r of e){const e=null==r.match?void 0:r.match(Os)
if(e)return e[1]}return t}function Cs(e,t,r){const n=e.style[t],i=Ye(Ye(e,t,r),t)
return e.style[t]=n,i}function Ps(e,t){return e.reduce(((e,r)=>(e[r]=t,e)),{})}var Ts={mixins:[ps,hn,On],props:{target:String,viewport:Number,easing:Number,start:String,end:String},data:{target:!1,viewport:1,easing:1,start:0,end:0},computed:{target(e,t){let{target:r}=e
return Ss(r&&ge(r,t)||t)},start(e){let{start:t}=e
return Ot(t,"height",this.target,!0)},end(e){let{end:t,viewport:r}=e
return Ot(t||(r=100*(1-r))&&r+"vh+"+r+"%","height",this.target,!0)}},update:{read(e,t){let{percent:r}=e
if(t.has("scroll")||(r=!1),!this.matchMedia)return
const n=r
return r=function(e,t){return t>=0?Math.pow(e,t+1):1-Math.pow(1-e,1-t)}(Fr(this.target,this.start,this.end),this.easing),{percent:r,style:n!==r&&this.getCss(r)}},write(e){let{style:t}=e
this.matchMedia?t&&Ye(this.$el,t):this.reset()},events:["scroll","resize"]}}
function Ss(e){return e?"offsetTop"in e?e:Ss(le(e)):document.documentElement}var As={update:{write(){if(this.stack.length||this.dragging)return
const e=this.getValidIndex(this.index)
~this.prevIndex&&this.index===e||this.show(e)},events:["resize"]}},Ms={mixins:[sn],connected(){this.lazyload(this.slides,this.getAdjacentSlides)}}
function Rs(e,t,r){const n=Ls(e,t)
return r?n-function(e,t){return mt(t).width/2-mt(e).width/2}(e,t):Math.min(n,js(t))}function js(e){return Math.max(0,Is(e)-mt(e).width)}function Is(e){return fe(e).reduce(((e,t)=>mt(t).width+e),0)}function Ls(e,t){return e&&(vt(e).left+(Zt?mt(e).width-mt(t).width:0))*(Zt?-1:1)||0}function Ns(e,t){t-=1
const r=mt(e).width,n=t+r+2
return fe(e).filter((i=>{const s=Ls(i,e),o=s+Math.min(mt(i).width,r)
return s>=t&&o<=n}))}function Ds(e,t,r){je(e,Ie(t,!1,!1,r))}var Fs={mixins:[nn,ns,As,Ms],props:{center:Boolean,sets:Boolean},data:{center:!1,sets:!1,attrItem:"uk-slider-item",selList:".uk-slider-items",selNav:".uk-slider-nav",clsContainer:"uk-slider-container",Transitioner:function(e,t,r,n){let{center:i,easing:s,list:o}=n
const a=new Q,l=e?Rs(e,o,i):Rs(t,o,i)+mt(t).width*r,u=t?Rs(t,o,i):l+mt(e).width*r*(Zt?-1:1)
return{dir:r,show(t,n,i){void 0===n&&(n=0)
const l=i?"linear":s
return t-=Math.round(t*H(n,-1,1)),this.translate(n),n=e?n:H(n,0,1),Ds(this.getItemIn(),"itemin",{percent:n,duration:t,timing:l,dir:r}),e&&Ds(this.getItemIn(!0),"itemout",{percent:1-n,duration:t,timing:l,dir:r}),ut.start(o,{transform:Zi(-u*(Zt?-1:1),"px")},t,l).then(a.resolve,V),a.promise},cancel(){ut.cancel(o)},reset(){Ye(o,"transform","")},forward(e,t){return void 0===t&&(t=this.percent()),ut.cancel(o),this.show(e,t,!0)},translate(n){const i=this.getDistance()*r*(Zt?-1:1)
Ye(o,"transform",Zi(H(i-i*n-u,-Is(o),mt(o).width)*(Zt?-1:1),"px"))
const s=this.getActives(),a=this.getItemIn(),l=this.getItemIn(!0)
n=e?H(n,-1,1):0
for(const u of fe(o)){const i=d(s,u),c=u===a,h=u===l
Ds(u,"itemtranslate"+(c||!h&&(i||r*(Zt?-1:1)==-1^Ls(u,o)>Ls(e||t))?"in":"out"),{dir:r,percent:h?1-n:c?n:i?1:0})}},percent:()=>Math.abs((Ye(o,"transform").split(",")[4]*(Zt?-1:1)+l)/(u-l)),getDistance:()=>Math.abs(u-l),getItemIn(r){void 0===r&&(r=!1)
let n=this.getActives(),s=Ns(o,Rs(t||e,o,i))
if(r){const e=n
n=s,s=e}return s[h(s,(e=>!d(n,e)))]},getActives:()=>Ns(o,Rs(e||t,o,i))}}},computed:{avgWidth(){return Is(this.list)/this.length},finite(e){let{finite:t}=e
return t||Math.ceil(Is(this.list))<Math.trunc(mt(this.list).width+(r=this.list,Math.max(0,...fe(r).map((e=>mt(e).width))))+this.center)
...
if(!t)return
let r=0
const n=[],i=mt(this.list).width
for(let s in this.slides){const e=mt(this.slides[s]).width
r+e>i&&(r=0),this.center?r<i/2&&r+e+mt(this.slides[+s+1]).width/2>i/2&&(n.push(+s),r=i/2-e/2):0===r&&n.push(Math.min(+s,this.maxIndex)),r+=e}return n.length?n:void 0},transitionOptions(){return{center:this.center,list:this.list}}},connected(){st(this.$el,this.clsContainer,!Yt("."+this.clsContainer,this.$el))},update:{write(){for(const e of this.navItems){const t=M(ee(e,this.attrItem))
...
this.duration=is(this.avgWidth/this.velocity)*(mt(this.slides[r]).width/this.avgWidth),this.reorder()},itemshow(){~this.prevIndex&&et(this._getTransitioner().getItemIn(),this.clsActive)},itemshown(){this.updateActiveClasses()}},methods:{reorder(){if(this.finite)return void Ye(this.slides,"order","")
const e=this.dir>0&&this.slides[this.prevIndex]?this.prevIndex:this.index
if(this.slides.forEach(((t,r)=>Ye(t,"order",this.dir>0&&r<e?1:this.dir<0&&r>=this.index?-1:""))),!this.center)return
const t=this.slides[e]
let r=mt(this.list).width/2-mt(t).width/2,n=0
for(;r>0;){const t=this.getIndex(--n+e,e),i=this.slides[t]
Ye(i,"order",t>e?-2:-1),r-=mt(i).width}},updateActiveClasses(){const e=this._getTransitioner(this.index).getActives(),t=[this.clsActive,(!this.sets||d(this.sets,R(this.index)))&&this.clsActivated||""]
for(const r of this.slides)st(r,t,d(e,r))},getValidIndex(e,t){if(void 0===e&&(e=this.index),void 0===t&&(t=this.prevIndex),e=this.getIndex(e,t),!this.sets)return e
let r
do{if(d(this.sets,e))return e
r=e,e=this.getIndex(e+this.dir,t)}while(e!==r)
return e},getAdjacentSlides(){const{width:e}=mt(this.list),t=-e,r=2*e,n=mt(this.slides[this.index]).width,i=this.center?e/2-n/2:0,s=new Set
for(const o of[-1,1]){let e=i+(o>0?n:0),a=0
do{const t=this.slides[this.getIndex(this.index+o+a++*o)]
e+=mt(t).width*o,s.add(t)}while(this.slides.length>a&&e>t&&e<r)}return Array.from(s)}}}
var $s={mixins:[ps],data:{selItem:"!li"},connected(){this.item=ge(this.selItem,this.$el)},disconnected(){this.item=null},events:[{name:"itemin itemout",self:!0,el(){return this.item},handler(e){let{type:t,detail:{percent:r,duration:n,timing:i,dir:s}}=e
or.read((()=>{const e=this.getCss(Bs(t,s,r)),o=this.getCss(zs(t)?.5:s>0?1:0)
or.write((()=>{Ye(this.$el,e),ut.start(this.$el,o,n,i).catch(V)}))}))}},{name:"transitioncanceled transitionend",self:!0,el(){return this.item},handler(){ut.cancel(this.$el)}},{name:"itemtranslatein itemtranslateout",self:!0,el(){return this.item},handler(e){let{type:t,detail:{percent:r,dir:n}}=e
or.read((()=>{const e=this.getCss(Bs(t,n,r))
or.write((()=>Ye(this.$el,e)))}))}}]}
function zs(e){return c(e,"in")}function Bs(e,t,r){return r/=2,zs(e)^t<0?r:1-r}var Us={...Ki,fade:{show:()=>[{opacity:0,zIndex:0},{zIndex:-1}],percent:e=>1-Ye(e,"opacity"),translate:e=>[{opacity:1-e,zIndex:0},{zIndex:-1}]},scale:{show:()=>[{opacity:0,transform:Xi(1.5),zIndex:0},{zIndex:-1}],percent:e=>1-Ye(e,"opacity"),translate:e=>[{opacity:1-e,transform:Xi(1+.5*e),zIndex:0},{zIndex:-1}]},pull:{show:e=>e<0?[{transform:Zi(30),zIndex:-1},{transform:Zi(),zIndex:0}]:[{transform:Zi(-100),zIndex:0},{transform:Zi(),zIndex:-1}],percent:(e,t,r)=>r<0?1-Qi(t):Qi(e),translate:(e,t)=>t<0?[{transform:Zi(30*e),zIndex:-1},{transform:Zi(-100*(1-e)),zIndex:0}]:[{transform:Zi(100*-e),zIndex:0},{transform:Zi(30*(1-e)),zIndex:-1}]},push:{show:e=>e<0?[{transform:Zi(100),zIndex:0},{transform:Zi(),zIndex:-1}]:[{transform:Zi(-30),zIndex:-1},{transform:Zi(),zIndex:0}],percent:(e,t,r)=>r>0?1-Qi(t):Qi(e),translate:(e,t)=>t<0?[{transform:Zi(100*e),zIndex:0},{transform:Zi(-30*(1-e)),zIndex:-1}]:[{transform:Zi(-30*e),zIndex:-1},{transform:Zi(100*(1-e)),zIndex:0}]}},Hs={mixins:[nn,ss,As,Ms],props:{ratio:String,minHeight:Number,maxHeight:Number},data:{ratio:"16:9",minHeight:!1,maxHeight:!1,selList:".uk-slideshow-items",attrItem:"uk-slideshow-item",selNav:".uk-slideshow-nav",Animations:Us},update:{read(){if(!this.list)return!1
let[e,t]=this.ratio.split(":").map(Number)
return t=t*this.list.offsetWidth/e||0,this.minHeight&&(t=Math.max(this.minHeight,t)),this.maxHeight&&(t=Math.min(this.maxHeight,t)),{height:t-kt(this.list,"height","content-box")}},write(e){let{height:t}=e
t>0&&Ye(this.list,"minHeight",t)},events:["resize"]},methods:{getAdjacentSlides(){return[1,-1].map((e=>this.slides[this.getIndex(this.index+e)]))}}},Vs={mixins:[nn,qi],props:{group:String,threshold:Number,clsItem:String,clsPlaceholder:String,clsDrag:String,clsDragState:String,clsBase:String,clsNoDrag:String,clsEmpty:String,clsCustom:String,handle:String},data:{group:!1,threshold:5,clsItem:"uk-sortable-item",clsPlaceholder:"uk-sortable-placeholder",clsDrag:"uk-sortable-drag",clsDragState:"uk-drag",clsBase:"uk-sortable",clsNoDrag:"uk-sortable-nodrag",clsEmpty:"uk-sortable-empty",clsCustom:"",handle:!1,pos:{}},created(){for(const e of["init","start","move","end"]){const t=this[e]
this[e]=e=>{m(this.pos,He(e)),t(e)}}},events:{name:er,passive:!1,handler:"init"},computed:{target(){return(this.$el.tBodies||[this.$el])[0]},items(){return fe(this.target)},isEmpty:{get(){return T(this.items)},watch(e){st(this.target,this.clsEmpty,e)},immediate:!0},handles:{get(e,t){let{handle:r}=e
return r?Gt(r,t):this.items},watch(e,t){Ye(t,{touchAction:"",userSelect:""}),Ye(e,{touchAction:Xt?"none":"",userSelect:"none"})},immediate:!0}},update:{write(e){if(!this.drag||!le(this.placeholder))return
const{pos:{x:t,y:r},origin:{offsetTop:n,offsetLeft:i},placeholder:s}=this
Ye(this.drag,{top:r-n,left:t-i})
const o=this.getSortable(document.elementFromPoint(t,r))
if(!o)return
const{items:a}=o
if(a.some(ut.inProgress))return
...
return!Ws([r.left,r.right],[t.left,t.right])}))}))
r&&Ft(t)
return i}(e,r)||i<o.top+o.height/2?t:t.nextElementSibling
const a=r.getBoundingClientRect(),l=Ws([o.top,o.bottom],[a.top,a.bottom]),u=l?n:i,c=l?"width":"height",d=l?"left":"top",h=l?"right":"bottom",p=a[c]<o[c]?o[c]-a[c]:0
...
!i||n||r>0||se(t)||he(t,"."+this.clsNoDrag)||this.handle&&!he(t,this.handle)||(e.preventDefault(),this.touched=new Set([this]),this.placeholder=i,this.origin={target:t,index:me(i),...this.pos},Ae(document,tr,this.move),Ae(document,rr,this.end),this.threshold||this.start(e))},start(e){this.drag=function(e,t){const r=It(e,t.outerHTML.replace(/(^<)(?:li|tr)|(?:li|tr)(\/>$)/g,"$1div$2"))
return Ye(r,"margin","0","important"),Ye(r,{boxSizing:"border-box",width:t.offsetWidth,height:t.offsetHeight,padding:Ye(t,"padding")}),yt(r.firstElementChild,yt(t.firstElementChild)),r}(this.$container,this.placeholder)
const{left:t,top:r}=this.placeholder.getBoundingClientRect()
m(this.origin,{offsetLeft:this.pos.x-t,offsetTop:this.pos.y-r}),et(this.drag,this.clsDrag,this.clsCustom),et(this.placeholder,this.clsPlaceholder),et(this.items,this.clsItem),et(document.documentElement,this.clsDragState),je(this.$el,"start",[this,this.placeholder]),function(e){let t=Date.now()
qs=setInterval((()=>{let{x:r,y:n}=e
n+=Nr(window)
const i=.3*(Date.now()-t)
t=Date.now(),$r(document.elementFromPoint(r,e.y),/auto|scroll/).reverse().some((e=>{let{scrollTop:t,scrollHeight:r}=e
const{top:s,bottom:o,height:a}=gt(zr(e))
if(s<n&&s+35>n)t-=i
else{if(!(o>n&&o-35<n))return
t+=i}if(t>0&&t<r-a)return Nr(e,t),!0}))}),15)}(this.pos),this.move(e)},move(e){this.drag?this.$emit("move"):(Math.abs(this.pos.x-this.origin.x)>this.threshold||Math.abs(this.pos.y-this.origin.y)>this.threshold)&&this.start(e)},end(){if(Me(document,tr,this.move),Me(document,rr,this.end),!this.drag)return
clearInterval(qs)
const e=this.getSortable(this.placeholder)
this===e?this.origin.index!==me(this.placeholder)&&je(this.$el,"moved",[this,this.placeholder]):(je(e.$el,"added",[e,this.placeholder]),je(this.$el,"removed",[this,this.placeholder])),je(this.$el,"stop",[this,this.placeholder]),Ft(this.drag),this.drag=null
for(const{clsPlaceholder:t,clsItem:r}of this.touched)for(const e of this.touched)tt(e.items,t,r)
this.touched=null,tt(document.documentElement,this.clsDragState)},insert(e,t){et(this.items,this.clsItem)
this.animate((()=>t?Lt(t,e):It(this.target,e)))},remove(e){he(e,this.target)&&this.animate((()=>Ft(e)))},getSortable(e){do{const t=this.$getComponent(e,"sortable")
if(t&&(t===this||!1!==this.group&&t.group===this.group))return t}while(e=le(e))}}}
let qs
function Ws(e,t){return e[1]>t[0]&&t[1]>e[0]}var Ys={mixins:[fn,on,mn],args:"title",props:{delay:Number,title:String},data:{pos:"top",title:"",delay:0,animation:["uk-animation-scale-up"],duration:100,cls:"uk-active",clsPos:"uk-tooltip"},beforeConnect(){var e
this._hasTitle=X(this.$el,"title"),Z(this.$el,"title",""),this.updateAria(!1),ae(e=this.$el)||Z(e,"tabindex","0")},disconnected(){this.hide(),Z(this.$el,"title",this._hasTitle?this.title:null)},methods:{show(){!this.isToggled(this.tooltip||null)&&this.title&&(this._unbind=Re(document,"show keydown "+er,this.hide,!1,(e=>e.type===er&&!he(e.target,this.$el)||"keydown"===e.type&&27===e.keyCode||"show"===e.type&&e.detail[0]!==this&&e.detail[0].$name===this.$name)),clearTimeout(this.showTimer),this.showTimer=setTimeout(this._show,this.delay))},async hide(){ce(this.$el,"input:focus")||(clearTimeout(this.showTimer),this.isToggled(this.tooltip||null)&&(await this.toggleElement(this.tooltip,!1,!1),Ft(this.tooltip),this.tooltip=null,this._unbind()))},_show(){this.tooltip=It(this.container,'<div class="'+this.clsPos+'"> <div class="'+this.clsPos+'-inner">'+this.title+"</div> </div>"),Ae(this.tooltip,"toggled",((e,t)=>{this.updateAria(t),t&&(this.positionAt(this.tooltip,this.$el),this.origin="y"===this.getAxis()?xt(this.dir)+"-"+this.align:this.align+"-"+xt(this.dir))})),this.toggleElement(this.tooltip,!0)},updateAria(e){Z(this.$el,"aria-expanded",e)}},events:{focus:"show",blur:"hide",[nr+" "+ir](e){Ue(e)||this[e.type===nr?"show":"hide"]()},[er](e){Ue(e)&&this.show()}}}
var Gs={props:{allow:String,clsDragover:String,concurrent:Number,maxSize:Number,method:String,mime:String,msgInvalidMime:String,msgInvalidName:String,msgInvalidSize:String,multiple:Boolean,name:String,params:Object,type:String,url:String},data:{allow:!1,clsDragover:"uk-dragover",concurrent:1,maxSize:0,method:"POST",mime:!1,msgInvalidMime:"Invalid File Type: %s",msgInvalidName:"Invalid File Name: %s",msgInvalidSize:"Invalid File Size: %s Kilobytes Max",multiple:!1,name:"files[]",params:{},type:"",url:"",abort:V,beforeAll:V,beforeSend:V,complete:V,completeAll:V,error:V,fail:V,load:V,loadEnd:V,loadStart:V,progress:V},events:{change(e){ce(e.target,'input[type="file"]')&&(e.preventDefault(),e.target.files&&this.upload(e.target.files),e.target.value="")},drop(e){Qs(e)
const t=e.dataTransfer
null!=t&&t.files&&(tt(this.$el,this.clsDragover),this.upload(t.files))},dragenter(e){Qs(e)},dragover(e){Qs(e),et(this.$el,this.clsDragover)},dragleave(e){Qs(e),tt(this.$el,this.clsDragover)}},methods:{async upload(e){if(!e.length)return
je(this.$el,"upload",[e])
...
if(this.allow&&!Ks(this.allow,n.name))return void this.fail(this.msgInvalidName.replace("%s",this.allow))
if(this.mime&&!Ks(this.mime,n.type))return void this.fail(this.msgInvalidMime.replace("%s",this.mime))}this.multiple||(e=e.slice(0,1)),this.beforeAll(this,e)
...
t.upload&&Ae(t.upload,"progress",this.progress)
for(const r of["loadStart","load","loadEnd","abort"])Ae(t,r.toLowerCase(),this[r])
return this.beforeSend(e)}})
this.complete(e),t.length?await r(t.shift()):this.completeAll(e)}catch(i){this.error(i)}}
await r(t.shift())}}}
function Ks(e,t){return t.match(new RegExp("^"+e.replace(/\//g,"\\/").replace(/\*\*/g,"(\\/[^\\/]+)*").replace(/\*/g,"[^\\/]+").replace(/((?!\\))\?/g,"$1.")+"$","i"))}function Qs(e){e.preventDefault(),e.stopPropagation()}return z(Object.freeze({__proto__:null,Countdown:Ii,Filter:Wi,Lightbox:ls,LightboxPanel:os,Notification:cs,Parallax:Ts,Slider:Fs,SliderParallax:$s,Slideshow:Hs,SlideshowParallax:$s,Sortable:Vs,Tooltip:Ys,Upload:Gs}),((e,t)=>rn.component(t,e))),rn})),"undefined"==typeof FastBoot&&/*! UIkit 3.13.1 | https://www.getuikit.com | (c) 2014 - 2022 YOOtheme | MIT License */
