...
var r=this.keyFor()
return Array.isArray(n)?Pe.from(n,r):(0,o.isEmberArray)(n)?Ne.from(n,r):s.HAS_NATIVE_SYMBOL&&$e(n)?Me.from(n,r):ze(n)?Pe.fromForEachable(n,r):je},t.valueReferenceFor=function(e){return new J(e.value)},t.updateValueReference=function(e,t){e.update(t.value)},t.memoReferenceFor=function(e){return new J(e.memo)},t.updateMemoReference=function(e,t){e.update(t.memo)},t.keyFor=function(){var e=this.keyPath
...
this.symbolTable=s,this.template=r,this.args=i,this.state={name:e,ComponentClass:t,handle:n,template:r,capabilities:Pt,symbolTable:s}},It=function(e){function t(t){var n
...
return null!==s&&(mt(n),o.component.static(s,[t,Mn(n),r,i]),!0)}var Xn=[]
...
l=new sn(n,s,p,o||t.owner.lookup((0,y.privatize)(M())))}}return void 0===l&&(l=new Rt(n,s||t.owner.factoryFor((0,y.privatize)(I())),null,o)),h(),this.componentDefinitionCache.set(a,l),l},t._lookupComponentManager=function(e,t){if(this.customManagerCache.has(t))return this.customManagerCache.get(t)
...
return U(function(){for(var n,r=Object.keys(t),i=0;i<r.length;i++)n=r[i],Le(e,n,t[n])}),t},e.expandProperties=Me,e.addObserver=ce,e.removeObserver=he,e.aliasMethod=function(e){return new gt(e)},e.mixin=function(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
...
return(0,r.setObservers)(i,s),i},e.applyMixin=pt,e.setHasViews=function(e){S=e},e.tagForProperty=N,e.tagFor=R,e.markObjectAsDirty=I,e.descriptor=function(e){return new wt(e)}
...
return u||(s[t]=P())}function R(e,t){return"object"==typeof e&&null!==e?(void 0===t?(0,i.meta)(e):t).writableTag(P):a.CONSTANT_TAG}function I(e,t,n){var i=n.readableTag()
...
var r=y(t)
j>0?L.add(e,t,r):x(e,r,[e,t])}(e,t,r)),M in e&&e[M](t),null!==r){if(r.isSourceDestroying())return
...
t+=n.substring(0,r)
s=l.length
for(;u<s;)(o=c.indexOf("{"))<0?i((t+l[u++]+c).replace(Ie,".[]")):e(t+l[u++],c,o,i)}("",e,n,t)}function Le(e,t,n,r){if(!e.isDestroyed){if(g(t))return function(e,t,n,r){var i=t.split("."),o=i.pop()
var s=ie(e,i)
...
return(i=r.into?N(e,r.into):t)?(0,n.set)(i.outlets,r.outlet,o):e=o,{liveRoutes:e,ownState:o}}function I(e,t,n){var r=N(e,n.routeName)
...
return this._super=n,r}return k.add(n),y(n,w(e)),x(n,E(e)),n}var O=Object.prototype.toString,T=Function.prototype.toString,A=Array.isArray,S=Object.keys,P=JSON.stringify,N=100,R=4,I=/^[\w$]+$/
...
break}r+=M(e[i],t,n)}return r+=" ]"}(e,n+1,r):function(e,t,n){if(t>R)return"[Object]"
for(var r="{",i=S(e),o=0;o<i.length;o++){if(r+=0===o?" ":", ",o>=N){r+="... "+(i.length-N)+" more keys"
break}var s=i[o]
r+=L(s)+": "+M(e[s],t,n)}return r+=" }"}(e,n+1,r)}function L(e){return I.test(e)?e:P(e)}function j(e,t){return null!=e&&"function"==typeof e[t]}var D=Array.isArray
var B=new WeakMap
...
var p=o.getTag(f);(0,r.isConstTag)(p)||e.updateWith(new I(p,o,f))})
...
e=o[0],t=o[1],void 0===(r=o[2])?i=0:a(i=r.pop())||(n=!0===i,i=r.pop())}return[e,t,r,i=parseInt(i,10),n]}var w=0,_=0,x=0,E=0,k=0,C=0,O=0,T=0,A=0,S=0,P=0,N=0,R=0,I=0,M=0,L=0,j=0,D=0,B=0,z=0,$=0,F=function(){function e(e,t){var n=this
...
this._autorun=e()},(0,t.createClass)(e,[{key:"counters",get:function(){return{begin:_,end:x,events:{begin:E,end:0},autoruns:{created:D,completed:B},run:k,join:C,defer:O,schedule:T,scheduleIterable:A,deferOnce:S,scheduleOnce:P,setTimeout:N,later:R,throttle:I,debounce:M,cancelTimers:L,cancel:j,loops:{total:z,nested:$}}}},{key:"defaultQueue",get:function(){return this._defaultQueue}}]),e}()
F.Queue=d
var H=F
...
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function r(e){return e}}),e("ember/index",["exports","require","@ember/-internals/environment","node-module","@ember/-internals/utils","@ember/-internals/container","@ember/instrumentation","@ember/-internals/meta","@ember/-internals/metal","@ember/canary-features","@ember/debug","backburner","@ember/-internals/console","@ember/controller","@ember/controller/lib/controller_mixin","@ember/string","@ember/service","@ember/object/computed","@ember/-internals/runtime","@ember/-internals/glimmer","ember/version","@ember/-internals/views","@ember/-internals/routing","@ember/-internals/extension-support","@ember/error","@ember/runloop","@ember/-internals/error-handling","@ember/-internals/owner","@ember/application","@ember/application/globals-resolver","@ember/application/instance","@ember/engine","@ember/engine/instance","@ember/polyfills","@ember/deprecated-features"],function(e,t,n,r,i,o,s,a,u,l,c,h,f,d,p,m,v,g,b,y,w,_,x,E,k,C,O,T,A,S,P,N,R,I,M){"use strict"
e.default=void 0
var L="object"==typeof n.context.imports.Ember&&n.context.imports.Ember||{}
L.isNamespace=!0,L.toString=function(){return"Ember"},Object.defineProperty(L,"ENV",{get:n.getENV,enumerable:!1}),Object.defineProperty(L,"lookup",{get:n.getLookup,set:n.setLookup,enumerable:!1}),M.EMBER_EXTEND_PROTOTYPES&&Object.defineProperty(L,"EXTEND_PROTOTYPES",{enumerable:!1,get:function(){return n.ENV.EXTEND_PROTOTYPES}}),L.getOwner=T.getOwner,L.setOwner=T.setOwner,L.Application=A.default,L.DefaultResolver=L.Resolver=S.default,L.ApplicationInstance=P.default,L.Engine=N.default,L.EngineInstance=R.default,L.assign=I.assign,L.merge=I.merge,L.generateGuid=i.generateGuid,L.GUID_KEY=i.GUID_KEY,L.guidFor=i.guidFor,L.inspect=i.inspect,L.makeArray=i.makeArray,L.canInvoke=i.canInvoke,L.tryInvoke=i.tryInvoke,L.wrap=i.wrap,L.uuid=i.uuid,Object.defineProperty(L,"NAME_KEY",{enumerable:!1,get:function(){return i.NAME_KEY}}),L._Cache=i.Cache,L.Container=o.Container,L.Registry=o.Registry,L.assert=c.assert,L.warn=c.warn,L.debug=c.debug
...
t=new M(this,s[s.length-1].name,void 0,[],o)}else"/"===e.charAt(0)?(h(this,"Attempting URL transition to "+e),t=new j(this,e)):(h(this,"Attempting transition to "+e),t=new M(this,e,void 0,n,o))
...
for(var i=l(n),o=i[0],s=i[1],a=new M(this,e,void 0,o).applyToState(this.state,!1),c={},h=0,f=a.routeInfos.length;h<f;++h){u(c,a.routeInfos[h].serialize())}return c.queryParams=s,this.recognizer.generate(e,c)},n.applyIntent=function(e,t){var n=new M(this,e,void 0,t),r=this.activeTransition&&this.activeTransition[g]||this.state
...
var f=D(new M(this,a,void 0,t).applyToHandlers(h,l,a,!0,!0).routeInfos,h.routeInfos)
if(!n||!f)return f
var d={}
u(d,n)
var m=o.queryParams
...
return t||(t=e._promiseCallbacks={}),t}e.asap=ne,e.all=D,e.allSettled=z,e.race=$,e.hash=H,e.hashSettled=V,e.rethrow=q,e.defer=W,e.denodeify=M,e.configure=s,e.on=we,e.off=_e,e.resolve=Q,e.reject=K,e.map=G,e.filter=J,e.async=e.EventTarget=e.Promise=e.cast=e.default=void 0
...
m.error=null
var u=new R(c)
return E(u,a),u}i&&!0!==i&&(s=I(i,s))}r[o]=s}var l=new R(c)
...
for(var Ee in s("instrument",!0),xe)xe.hasOwnProperty(Ee)&&we(Ee,xe[Ee])}var ke={asap:ne,cast:be,Promise:R,EventTarget:i,all:D,allSettled:z,race:$,hash:H,hashSettled:V,rethrow:q,defer:W,denodeify:M,configure:s,on:we,off:_e,resolve:Q,reject:K,map:G,async:ye,filter:J}
...
return n.defaultView||n.parentWindow||e}var R="ontouchstart"in e,I=S(e,"PointerEvent")!==r,M=R&&/mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),L=25,j=1,D=2,B=4,z=8,$=1,F=2,H=4,U=8,V=16,q=F|H,W=U|V,Y=q|W,G=["x","y"],Q=["clientX","clientY"]
...
var Ie=1,Me=2,Le=4,je=8,De=je,Be=16
function ze(e){this.options=i({},this.defaults,e||{}),this.id=P++,this.manager=null,this.options.enable=w(this.options.enable,!0),this.state=Ie,this.simultaneous={},this.requireFail=[]}function $e(e){return e&Be?"cancel":e&je?"end":e&Le?"move":e&Me?"start":""}function Fe(e){return e==V?"down":e==U?"up":e==F?"left":e==H?"right":""}function He(e,t){var n=t.manager
...
this.state&(De|Be|32)&&(this.state=Ie),this.state=this.process(t),this.state&(Me|Le|je|Be)&&this.tryEmit(t)},process:function(e){},getTouchAction:function(){},reset:function(){}},g(Ue,ze,{defaults:{pointers:1},attrTest:function(e){var t=this.options.pointers
return 0===t||e.pointers.length===t},process:function(e){var t=this.state,n=e.eventType,r=t&(Me|Le),i=this.attrTest(e)
return r&&(n&z||!i)?t|Be:r||i?n&B?t|je:t&Me?t|Le:Me:32}}),g(Ve,Ue,{defaults:{event:"pan",threshold:10,pointers:1,direction:Y},getTouchAction:function(){var e=this.options.direction,t=[]
...
for(var o=0;o<r.length;)n=r[o],2===t.stopped||i&&n!=i&&!n.canRecognizeWith(i)?n.reset():n.recognize(e),!i&&n.state&(Me|Le|je)&&(i=t.curRecognizer=n),o++}},get:function(e){if(e instanceof ze)return e
...
function m(e,t){return p.call(e,t)}var v=function(e){return~this.indexOf(e)},g=h.includes||v,b=Array.prototype.includes||v
function y(e,t){return e&&(N(e)?g:b).call(e,t)}var w=Array.isArray
function _(e){return"function"==typeof e}function x(e){return null!==e&&"object"==typeof e}function E(e){return x(e)&&Object.getPrototypeOf(e)===t}function k(e){return x(e)&&e===e.window}function C(e){return x(e)&&9===e.nodeType}function O(e){return x(e)&&!!e.jquery}function T(e){return e instanceof Node||x(e)&&e.nodeType>=1}var A=t.toString
function S(e){return A.call(e).match(/^\[object (NodeList|HTMLCollection)\]$/)}function P(e){return"boolean"==typeof e}function N(e){return"string"==typeof e}function R(e){return"number"==typeof e}function I(e){return R(e)||N(e)&&!isNaN(e-parseFloat(e))}function M(e){return void 0===e}function L(e){return P(e)?e:"true"===e||"1"===e||""===e||"false"!==e&&"0"!==e&&e}function j(e){var t=Number(e)
return!isNaN(t)&&t}function D(e){return parseFloat(e)||0}function B(e){return T(e)||k(e)||C(e)?e:S(e)||O(e)?e[0]:w(e)?B(e[0]):null}var z=Array.prototype
function $(e){return T(e)?[e]:S(e)?z.slice.call(e):w(e)?e.map(B).filter(Boolean):O(e)?e.toArray():[]}function F(e){return w(e)?e:N(e)?e.split(/,(?![^(]*\))/).map(function(e){return I(e)?j(e):L(e.trim())}):[e]}function H(e){return e?m(e,"ms")?D(e):1e3*D(e):0}function U(e,t){return e===t||x(e)&&x(t)&&Object.keys(e).length===Object.keys(t).length&&W(e,function(e,n){return e===t[n]})}function V(e,t,n){return e.replace(new RegExp(t+"|"+n,"mg"),function(e){return e===t?n:t})}var q=Object.assign||function(e){for(var t=[],n=arguments.length-1;n-- >0;)t[n]=arguments[n+1]
e=Object(e)
for(var i=0;i<t.length;i++){var o=t[i]
if(null!==o)for(var s in o)r(o,s)&&(e[s]=o[s])}return e}
function W(e,t){for(var n in e)if(!1===t(e[n],n))return!1
return!0}function Y(e,t){return e.sort(function(e,n){var r=e[t]
void 0===r&&(r=0)
var i=n[t]
...
function J(e,t,n){if(x(t))for(var r in t)J(e,r,t[r])
else{if(M(n))return(e=B(e))&&e.getAttribute(t)
$(e).forEach(function(e){_(n)&&(n=n.call(e,J(e,t))),null===n?te(e,t):e.setAttribute(t,n)})}}function ee(e,t){return $(e).some(function(e){return e.hasAttribute(t)})}function te(e,t){e=$(e),t.split(" ").forEach(function(t){return e.forEach(function(e){return e.removeAttribute(t)})})}function ne(e,t){for(var n=0,r=[t,"data-"+t];n<r.length;n++)if(ee(e,r[n]))return J(e,r[n])}function re(e,t){return B(e)||se(e,oe(e,t))}function ie(e,t){var n=$(e)
return n.length&&n||ae(e,oe(e,t))}function oe(e,t){return void 0===t&&(t=document),he(e)||C(t)?t:t.ownerDocument}function se(e,t){return B(ue(e,t,"querySelector"))}function ae(e,t){return $(ue(e,t,"querySelectorAll"))}function ue(e,t,n){if(void 0===t&&(t=document),!e||!N(e))return null
var r
he(e=e.replace(ce,"$1 *"))&&(r=[],e=e.split(",").map(function(e,n){var i=t
if("!"===(e=e.trim())[0]){var o=e.substr(1).trim().split(" ")
i=ve(t.parentNode,o[0]),e=o.slice(1).join(" ").trim()}if("-"===e[0]){var s=e.substr(1).trim().split(" "),a=(i||t).previousElementSibling
i=pe(a,e.substr(1))?a:null,e=s.slice(1).join(" ")}return i?(i.id||(i.id="uk-"+Date.now()+n,r.push(function(){return te(i,"id")})),"#"+ye(i.id)+" "+e):null}).filter(Boolean).join(","),t=document)
try{return t[n](e)}catch(i){return null}finally{r&&r.forEach(function(e){return e()})}}var le=/(^|,)\s*[!>+~-]/,ce=/([!>+~-])(?=\s+[!>+~-]|\s*$)/g
function he(e){return N(e)&&e.match(le)}var fe=Element.prototype,de=fe.matches||fe.webkitMatchesSelector||fe.msMatchesSelector
function pe(e,t){return $(e).some(function(e){return de.call(e,t)})}var me=fe.closest||function(e){var t=this
do{if(pe(t,e))return t
t=t.parentNode}while(t&&1===t.nodeType)}
function ve(e,t){return d(t,">")&&(t=t.slice(1)),T(e)?e.parentNode&&me.call(e,t):$(e).map(function(e){return ve(e,t)}).filter(Boolean)}function ge(e,t){for(var n=[],r=B(e).parentNode;r&&1===r.nodeType;)pe(r,t)&&n.push(r),r=r.parentNode
return n}var be=window.CSS&&CSS.escape||function(e){return e.replace(/([^\x7f-\uFFFF\w-])/g,function(e){return"\\"+e})}
function ye(e){return N(e)?be.call(null,e):""}var we={area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,menuitem:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0}
function _e(e){return $(e).some(function(e){return we[e.tagName.toLowerCase()]})}function xe(e){return $(e).some(function(e){return e.offsetWidth||e.offsetHeight||e.getClientRects().length})}var Ee="input,select,textarea,button"
function ke(e){return $(e).some(function(e){return pe(e,Ee)})}function Ce(e,t){return $(e).filter(function(e){return pe(e,t)})}function Oe(e,t){return N(t)?pe(e,t)||ve(e,t):e===t||(C(t)?t.documentElement:B(t)).contains(B(e))}var Te=/msie|trident/i.test(window.navigator.userAgent),Ae="rtl"===J(document.documentElement,"dir"),Se="ontouchstart"in window,Pe=window.PointerEvent,Ne=Se||window.DocumentTouch&&document instanceof DocumentTouch||navigator.maxTouchPoints,Re=Pe?"pointerdown":Se?"touchstart":"mousedown",Ie=Pe?"pointermove":Se?"touchmove":"mousemove",Me=Pe?"pointerup":Se?"touchend":"mouseup",Le=Pe?"pointerenter":Se?"":"mouseenter",je=Pe?"pointerleave":Se?"":"mouseleave",De=Pe?"pointercancel":"touchcancel"
...
return function(i){e.forEach(function(e){var o=">"===t[0]?ae(t,e).reverse().filter(function(e){return Oe(i.target,e)})[0]:ve(i.target,t)
...
i.initCustomEvent(e,t,n,r),e=i}return e}function Ue(e){return _(e[2])&&e.splice(2,0,!1),e}function Ve(e){return e&&"addEventListener"in e}function qe(e){return Ve(e)?e:B(e)}function We(e){return w(e)?e.map(qe).filter(Boolean):N(e)?ae(e):Ve(e)?[e]:$(e)}function Ye(){var e=setTimeout($e(document,"click",function(t){t.preventDefault(),t.stopImmediatePropagation(),clearTimeout(e)},!0))
Fe(document,De)}var Ge="Promise"in window?window.Promise:Ze,Qe=function(){var e=this
this.promise=new Ge(function(t,n){e.reject=n,e.resolve=t})},Ke=2,Xe="setImmediate"in window?setImmediate:setTimeout
function Ze(e){this.state=Ke,this.value=void 0,this.deferred=[]
var t=this
try{e(function(e){t.resolve(e)},function(e){t.reject(e)})}catch(n){t.reject(n)}}Ze.reject=function(e){return new Ze(function(t,n){n(e)})},Ze.resolve=function(e){return new Ze(function(t,n){t(e)})},Ze.all=function(e){return new Ze(function(t,n){var r=[],i=0
...
o.onerror=i,o.onload=function(){return r(o)},n&&(o.sizes=n),t&&(o.srcset=t),o.src=e})}function nt(e){if("loading"===document.readyState)var t=Be(document,"DOMContentLoaded",function(){t(),e()})
else e()}function rt(e,t){return t?$(e).indexOf(B(t)):$((e=B(e))&&e.parentNode.children).indexOf(e)}function it(e,t,n,r){void 0===n&&(n=0),void 0===r&&(r=!1)
var i=(t=$(t)).length
return e=I(e)?j(e):"next"===e?n+1:"previous"===e?n-1:rt(t,e),r?G(e,0,i-1):(e%=i)<0?e+i:e}function ot(e){return(e=yt(e)).innerHTML="",e}function st(e,t){return e=yt(e),M(t)?e.innerHTML:at(e.hasChildNodes()?ot(e):e,t)}function at(e,t){return e=yt(e),ct(t,function(t){return e.appendChild(t)})}function ut(e,t){return e=yt(e),ct(t,function(t){return e.parentNode.insertBefore(t,e)})}function lt(e,t){return e=yt(e),ct(t,function(t){return e.nextSibling?ut(e.nextSibling,t):at(e.parentNode,t)})}function ct(e,t){return(e=N(e)?gt(e):e)?"length"in e?$(e).map(t):t(e):null}function ht(e){$(e).map(function(e){return e.parentNode&&e.parentNode.removeChild(e)})}function ft(e,t){for(t=B(ut(e,t));t.firstChild;)t=t.firstChild
return at(t,e),t}function dt(e,t){return $($(e).map(function(e){return e.hasChildNodes?ft($(e.childNodes),t):at(e,t)}))}function pt(e){$(e).map(function(e){return e.parentNode}).filter(function(e,t,n){return n.indexOf(e)===t}).forEach(function(e){ut(e,e.childNodes),ht(e)})}Je.resolve=function(e){var t=this
if(t.state===Ke){if(e===t)throw new TypeError("Promise settled with itself.")
var n=!1
try{var r=e&&e.then
if(null!==e&&x(e)&&_(r))return void r.call(e,function(e){n||t.resolve(e),n=!0},function(e){n||t.reject(e),n=!0})}catch(i){return void(n||t.reject(i))}t.state=0,t.value=e,t.notify()}},Je.reject=function(e){if(this.state===Ke){if(e===this)throw new TypeError("Promise settled with itself.")
...
try{0===e.state?_(n)?i(n.call(void 0,e.value)):i(e.value):1===e.state&&(_(r)?i(r.call(void 0,e.value)):o(e.value))}catch(s){o(s)}}})},Je.then=function(e,t){var n=this
return new Ze(function(r,i){n.deferred.push([e,t,r,i]),n.notify()})},Je.catch=function(e){return this.then(void 0,e)}
var mt=/^\s*<(\w+|!)[^>]*>/,vt=/^<(\w+)\s*\/?>(?:<\/\1>)?$/
function gt(e){var t=vt.exec(e)
if(t)return document.createElement(t[1])
var n=document.createElement("div")
return mt.test(e)?n.insertAdjacentHTML("beforeend",e.trim()):n.textContent=e,n.childNodes.length>1?$(n.childNodes):n.firstChild}function bt(e,t){if(e&&1===e.nodeType)for(t(e),e=e.firstElementChild;e;)bt(e,t),e=e.nextElementSibling}function yt(e,t){return N(e)?_t(e)?B(gt(e)):se(e,t):B(e)}function wt(e,t){return N(e)?_t(e)?$(gt(e)):ae(e,t):$(e)}function _t(e){return"<"===e[0]||e.match(/^\s*</)}function xt(e){for(var t=[],n=arguments.length-1;n-- >0;)t[n]=arguments[n+1]
At(e,t,"add")}function Et(e){for(var t=[],n=arguments.length-1;n-- >0;)t[n]=arguments[n+1]
At(e,t,"remove")}function kt(e,t){J(e,"class",function(e){return(e||"").replace(new RegExp("\\b"+t+"\\b","g"),"")})}function Ct(e){for(var t=[],n=arguments.length-1;n-- >0;)t[n]=arguments[n+1]
...
if(t.length){var r=N((t=St(t))[t.length-1])?[]:t.pop()
t=t.filter(Boolean),$(e).forEach(function(e){for(var n=e.classList,i=0;i<t.length;i++)Nt.Force?n.toggle.apply(n,[t[i]].concat(r)):n[(M(r)?!n.contains(t[i]):r)?"add":"remove"](t[i])})}}function At(e,t,n){(t=St(t).filter(Boolean)).length&&$(e).forEach(function(e){var r=e.classList
Nt.Multiple?r[n].apply(r,t):t.forEach(function(e){return r[n](e)})})}function St(e){return e.reduce(function(e,t){return e.concat.call(e,N(t)&&y(t," ")?t.trim().split(" "):t)},[])}var Pt,Nt={};(Pt=document.createElement("_").classList)&&(Pt.add("a","b"),Pt.toggle("c",!1),Nt.Multiple=Pt.contains("b"),Nt.Force=!Pt.contains("c")),Pt=null
var Rt={"animation-iteration-count":!0,"column-count":!0,"fill-opacity":!0,"flex-grow":!0,"flex-shrink":!0,"font-weight":!0,"line-height":!0,opacity:!0,order:!0,orphans:!0,widows:!0,"z-index":!0,zoom:!0}
function It(e,t,n){return $(e).map(function(e){if(N(t)){if(t=zt(t),M(n))return Lt(e,t)
n||R(n)?e.style[t]=I(n)&&!Rt[t]?n+"px":n:e.style.removeProperty(t)}else{if(w(t)){var r=Mt(e)
return t.reduce(function(e,t){return e[t]=r[zt(t)],e},{})}x(t)&&W(t,function(t,n){return It(e,n,t)})}return e})[0]}function Mt(e,t){return(e=B(e)).ownerDocument.defaultView.getComputedStyle(e,t)}function Lt(e,t,n){return Mt(e,n)[t]}var jt={}
function Dt(e){var t=document.documentElement
if(!Te)return Mt(t).getPropertyValue("--uk-"+e)
if(!(e in jt)){var n=at(t,document.createElement("div"))
xt(n,"uk-"+e),jt[e]=Lt(n,"content",":before").replace(/^["'](.*)["']$/,"$1"),ht(n)}return jt[e]}var Bt={}
...
function Ht(e,t,n,r){return void 0===n&&(n=400),void 0===r&&(r="linear"),Ge.all($(e).map(function(e){return new Ge(function(i,o){for(var s in t){var a=It(e,s)
""===a&&It(e,s,a)}var u=setTimeout(function(){return Fe(e,"transitionend")},n)
...
return e===n}),xt(e,"uk-transition"),It(e,q({"transition-property":Object.keys(t).map(zt).join(","),"transition-duration":n+"ms","transition-timing-function":r},t))})}))}var Ut={start:Ht,stop:function(e){return Fe(e,"transitionend"),Ge.resolve()},cancel:function(e){Fe(e,"transitioncanceled")},inProgress:function(e){return Ot(e,"uk-transition")}},Vt="uk-animation-",qt="uk-cancel-animation"
function Wt(e,t,n,r,i){var o=arguments
return void 0===n&&(n=200),Ge.all($(e).map(function(e){return new Ge(function(s,a){if(Ot(e,qt))requestAnimationFrame(function(){return Ge.resolve().then(function(){return Wt.apply(void 0,o).then(s,a)})})
else{var u=t+" "+Vt+(i?"leave":"enter")
d(t,Vt)&&(r&&(u+=" uk-transform-origin-"+r),i&&(u+=" "+Vt+"reverse")),l(),$e(e,"animationend animationcancel",function(t){var n=t.type,r=!1
"animationcancel"===n?(a(),l()):(s(),Ge.resolve().then(function(){r=!0,l()})),requestAnimationFrame(function(){r||(xt(e,qt),requestAnimationFrame(function(){return Et(e,qt)}))})},!1,function(t){var n=t.target
return e===n}),It(e,"animationDuration",n+"ms"),xt(e,u)}function l(){It(e,"animationDuration",""),kt(e,Vt+"\\S*")}})}))}var Yt=new RegExp(Vt+"(enter|leave)"),Gt={in:function(e,t,n,r){return Wt(e,t,n,r,!1)},out:function(e,t,n,r){return Wt(e,t,n,r,!0)},inProgress:function(e){return Yt.test(J(e,"class"))},cancel:function(e){Fe(e,"animationcancel")}},Qt={width:["x","left","right"],height:["y","top","bottom"]}
function Kt(e,t,n,r,i,o,s,a){n=sn(n),r=sn(r)
var u={element:n,target:r}
if(!e||!t)return u
var l=Zt(e),c=Zt(t),h=c
if(on(h,n,l,-1),on(h,r,c,1),i=an(i,l.width,l.height),o=an(o,c.width,c.height),i.x+=o.x,i.y+=o.y,h.left+=i.x,h.top+=i.y,s){var f=[Zt(dn(e))]
a&&f.unshift(Zt(a)),W(Qt,function(e,t){var o=e[0],a=e[1],d=e[2];(!0===s||y(s,o))&&f.some(function(e){var s=n[o]===a?-l[t]:n[o]===d?l[t]:0,f=r[o]===a?c[t]:r[o]===d?-c[t]:0
...
if(s>=e[a]&&s+l[t]<=e[d])return h[a]=s,["element","target"].forEach(function(e){u[e][o]=n?u[e][o]===Qt[t][1]?Qt[t][2]:Qt[t][1]:u[e][o]}),!0}})})}return Xt(e,h),u}function Xt(e,t){if(e=B(e),!t)return Zt(e)
var n=Xt(e),r=It(e,"position");["left","top"].forEach(function(i){if(i in t){var o=It(e,i)
It(e,i,t[i]-n[i]+D("absolute"===r&&"auto"===o?Jt(e)[i]:o))}})}function Zt(e){var t,n,r=dn(e=B(e)),i=r.pageYOffset,o=r.pageXOffset
...
return M(t)||J(e,{style:t,hidden:n}),{height:u.height,width:u.width,top:u.top+i,left:u.left+o,bottom:u.bottom+i,right:u.right+o}}function Jt(e){var t=(e=B(e)).offsetParent||function(e){return pn(e).documentElement}(e),n=Xt(t),r=["top","left"].reduce(function(r,i){var o=c(i)
return r[i]-=n[i]+D(It(e,"margin"+o))+D(It(t,"border"+o+"Width")),r},Xt(e))
...
return Math.max(i["offset"+t],i["scroll"+t])}return(r="auto"===(r=It(n,e))?n["offset"+t]:D(r)||0)-rn(e,n)}It(n,e,r||0===r?+r+rn(e,n)+"px":"")}}function rn(e,t,n){return void 0===n&&(n="border-box"),It(t,"boxSizing")===n?Qt[e].slice(1).map(c).reduce(function(e,n){return e+D(It(t,"padding"+n))+D(It(t,"border"+n+"Width"))},0):0}function on(e,t,n,r){W(Qt,function(i,o){var s=i[0],a=i[1],u=i[2]
...
return{x:i?D(i)*(m(i,"%")?t/100:1):0,y:o?D(o)*(m(o,"%")?n/100:1):0}}function un(e){switch(e){case"left":return"right"
case"right":return"left"
case"top":return"bottom"
case"bottom":return"top"
default:return e}}function ln(e,t,n){if(void 0===t&&(t=0),void 0===n&&(n=0),!xe(e))return!1
var r=dn(e=B(e)),i=e.getBoundingClientRect(),o={top:-t,left:-n,bottom:t+en(r),right:n+tn(r)}
return K(i,o)||X({x:i.left,y:i.top},o)}function cn(e,t){if(void 0===t&&(t=0),!xe(e))return 0
var n=dn(e=B(e)),r=pn(e),i=e.offsetHeight+t,o=fn(e)[0],s=en(n),a=s+Math.min(0,o-s),u=Math.max(0,s-(en(r)+t-(o+i)))
return G((a+n.pageYOffset-o)/((a+(i-(u<s?u:0)))/100)/100)}function hn(e,t){if(k(e=B(e))||C(e)){var n=dn(e);(0,n.scrollTo)(n.pageXOffset,t)}else e.scrollTop=t}function fn(e){var t=[0,0]
do{if(t[0]+=e.offsetTop,t[1]+=e.offsetLeft,"fixed"===It(e,"position")){var n=dn(e)
return t[0]+=n.pageYOffset,t[1]+=n.pageXOffset,t}}while(e=e.offsetParent)
return t}function dn(e){return k(e)?e:pn(e).defaultView}function pn(e){return B(e).ownerDocument}var mn={reads:[],writes:[],read:function(e){return this.reads.push(e),vn(),e},write:function(e){return this.writes.push(e),vn(),e},clear:function(e){return bn(this.reads,e)||bn(this.writes,e)},flush:function(){gn(this.reads),gn(this.writes.splice(0,this.writes.length)),this.scheduled=!1,(this.reads.length||this.writes.length)&&vn()}}
function vn(){mn.scheduled||(mn.scheduled=!0,requestAnimationFrame(mn.flush.bind(mn)))}function gn(e){for(var t;t=e.shift();)t()}function bn(e,t){var n=e.indexOf(t)
return!!~n&&!!e.splice(n,1)}function yn(){}function wn(e,t){return(t.y-e.y)/(t.x-e.x)}yn.prototype={positions:[],position:null,init:function(){var e=this
...
void 0===t&&(t=[])
try{return e?d(e,"{")?JSON.parse(e):t.length&&!y(e,":")?((n={})[t[0]]=e,n):e.split(";").reduce(function(e,t){var n=t.split(/:(.*)/),r=n[0],i=n[1]
return r&&!M(i)&&(e[r.trim()]=i.trim()),e},{}):{}}catch(r){return{}}}_n.events=_n.created=_n.beforeConnect=_n.connected=_n.beforeDisconnect=_n.disconnected=_n.destroy=En,_n.args=function(e,t){return En(t||e)},_n.update=function(e,t){return Y(En(e,_(t)?{read:t}:t),"order")},_n.props=function(e,t){return w(t)&&(t=t.reduce(function(e,t){return e[t]=String,e},{})),_n.methods(e,t)},_n.computed=_n.methods=function(e,t){return t?e?q({},e,t):t:e},_n.data=function(e,t,n){return n?xn(e,t,n):t?e?function(n){return xn(e,t,n)}:t:e}
var On=0,Tn=function(e){this.id=++On,this.el=B(e)}
function An(e,t){try{e.contentWindow.postMessage(JSON.stringify(q({event:"command"},t)),"*")}catch(n){}}Tn.prototype.isVideo=function(){return this.isYoutube()||this.isVimeo()||this.isHTML5()},Tn.prototype.isHTML5=function(){return"VIDEO"===this.el.tagName},Tn.prototype.isIFrame=function(){return"IFRAME"===this.el.tagName},Tn.prototype.isYoutube=function(){return this.isIFrame()&&!!this.el.src.match(/\/\/.*?youtube(-nocookie)?\.[a-z]+\/(watch\?v=[^&\s]+|embed)|youtu\.be\/.*/)},Tn.prototype.isVimeo=function(){return this.isIFrame()&&!!this.el.src.match(/vimeo\.com\/video\/.*/)},Tn.prototype.enableApi=function(){var e=this
...
if(t&&N(t)){try{t=JSON.parse(t)}catch(n){return}return t&&o(t)}})})).then(function(){i(),t&&clearInterval(t)}),J(e.el,"src",e.el.src+(y(e.el.src,"?")?"&":"?")+(n?"enablejsapi=1":"api=1&player_id="+e.id))}):Ge.resolve()},Tn.prototype.play=function(){var e=this
...
t&&t.catch(Q)}catch(n){}},Tn.prototype.pause=function(){var e=this
this.isVideo()&&(this.isIFrame()?this.enableApi().then(function(){return An(e.el,{func:"pauseVideo",method:"pause"})}):this.isHTML5()&&this.el.pause())},Tn.prototype.mute=function(){var e=this
...
var Sn,Pn,Nn="IntersectionObserver"in window?window.IntersectionObserver:function(){function e(e,t){var n=this
void 0===t&&(t={})
var r=t.rootMargin
void 0===r&&(r="0 0"),this.targets=[]
var i,o=(r||"0 0").split(" ").map(D),s=o[0],a=o[1]
...
t.length&&e(t,n),i=!1})}))},this.off=Be(window,"scroll resize load",this.apply,{passive:!0,capture:!0})}return e.prototype.takeRecords=function(){var e=this
return this.targets.filter(function(t){var n=ln(t.target,e.offsetTop,e.offsetLeft)
if(null===t.isIntersecting||n^t.isIntersecting)return t.isIntersecting=n,!0})},e.prototype.observe=function(e){this.targets.push({target:e,isIntersecting:null}),this.apply()},e.prototype.disconnect=function(){this.targets=[],this.off()},e}(),Rn={}
function In(e){return"touch"===e.pointerType||e.touches||Pn}function Mn(e,t){void 0===t&&(t="client")
var n=e.touches,r=e.changedTouches,i=n&&n[0]||r&&r[0]||e
return{x:i[t+"X"],y:i[t+"Y"]}}function Ln(e){return!(!d(e,"uk-")&&!d(e,"data-uk-"))&&u(e.replace("data-uk-","").replace("uk-",""))}Be(document,Re,function(e){Rn.el&&(Rn={})
var t=e.target,n=Mn(e),r=n.x,i=n.y
Rn.el="tagName"in t?t:t.parentNode,Rn.x=r,Rn.y=i,Pn=In(e)}),Be(document,Me,function(e){var t=Mn(e),n=t.x,r=t.y
Rn.el&&n&&Math.abs(Rn.x-n)>100||r&&Math.abs(Rn.y-r)>100?Sn=setTimeout(function(){var e,t,i,o
Rn.el&&(Fe(Rn.el,"swipe"),Fe(Rn.el,"swipe"+(e=Rn.x,t=Rn.y,i=n,o=r,Math.abs(e-i)>=Math.abs(t-o)?e-i>0?"Left":"Right":t-o>0?"Up":"Down"))),Rn={}}):Rn={},setTimeout(function(){return Pn=!1})}),Be(document,De,function(){Sn&&clearTimeout(Sn),Sn=null,Rn={}})
var jn=function(e){this._init(e)}
jn.util=Object.freeze({ajax:et,getImage:tt,transition:Ht,Transition:Ut,animate:Wt,Animation:Gt,attr:J,hasAttr:ee,removeAttr:te,data:ne,addClass:xt,removeClass:Et,removeClasses:kt,replaceClass:Ct,hasClass:Ot,toggleClass:Tt,positionAt:Kt,offset:Xt,position:Jt,height:en,width:tn,boxModelAdjust:rn,flipPosition:un,isInView:ln,scrolledOver:cn,scrollTop:hn,offsetPosition:fn,ready:nt,index:rt,getIndex:it,empty:ot,html:st,prepend:function(e,t){return(e=yt(e)).hasChildNodes()?ct(t,function(t){return e.insertBefore(t,e.firstChild)}):at(e,t)},append:at,before:ut,after:lt,remove:ht,wrapAll:ft,wrapInner:dt,unwrap:pt,fragment:gt,apply:bt,$:yt,$$:wt,isIE:Te,isRtl:Ae,hasTouch:Ne,pointerDown:Re,pointerMove:Ie,pointerUp:Me,pointerEnter:Le,pointerLeave:je,pointerCancel:De,on:Be,off:ze,once:$e,trigger:Fe,createEvent:He,toEventTargets:We,preventClick:Ye,fastdom:mn,isVoidElement:_e,isVisible:xe,selInput:Ee,isInput:ke,filter:Ce,within:Oe,bind:e,hasOwn:r,hyphenate:s,camelize:u,ucfirst:c,startsWith:d,endsWith:m,includes:y,isArray:w,isFunction:_,isObject:x,isPlainObject:E,isWindow:k,isDocument:C,isJQuery:O,isNode:T,isNodeCollection:S,isBoolean:P,isString:N,isNumber:R,isNumeric:I,isUndefined:M,toBoolean:L,toNumber:j,toFloat:D,toNode:B,toNodes:$,toList:F,toMs:H,isEqual:U,swap:V,assign:q,each:W,sortBy:Y,clamp:G,noop:Q,intersectRect:K,pointInRect:X,Dimensions:Z,MouseTracker:yn,mergeOptions:kn,parseOptions:Cn,Player:Tn,Promise:Ge,Deferred:Qe,IntersectionObserver:Nn,query:re,queryAll:ie,find:se,findAll:ae,matches:pe,closest:ve,parents:ge,escape:ye,css:It,getStyles:Mt,getStyle:Lt,getCssVar:Dt,propName:zt,isTouch:In,getPos:Mn}),jn.data="__uikit__",jn.prefix="uk-",jn.options={},function(e){var t,n=e.data
function r(e,t){if(e)for(var n in e)e[n]._connected&&e[n]._callUpdate(t)}e.use=function(e){if(!e.installed)return e.call(null,this),e.installed=!0,this},e.mixin=function(t,n){(n=(N(n)?e.component(n):n)||this).options=kn(n.options,t)},e.extend=function(e){e=e||{}
var t=function(e){this._init(e)}
return(t.prototype=Object.create(this.prototype)).constructor=t,t.options=kn(this.options,e),t.super=this,t.extend=this.extend,t},e.update=function(e,t){(function e(t,n){t&&t!==document.body&&t.parentNode&&(e(t.parentNode,n),n(t.parentNode))})(e=e?B(e):document.body,function(e){return r(e[n],t)}),bt(e,function(e){return r(e[n],t)})},Object.defineProperty(e,"container",{get:function(){return t||document.body},set:function(e){t=yt(e)}})}(jn),function(e){e.prototype._callHook=function(e){var t=this,n=this.$options[e]
...
r&&r.forEach(function(e,r){var i=e.read,a=e.write,u=e.events;("update"===n||y(u,n))&&(i&&!y(mn.reads,o[r])&&(o[r]=mn.read(function(){var e=t._connected&&i.call(t,t._data,n)
!1===e&&a?mn.clear(s[r]):E(e)&&q(t._data,e)})),a&&!y(mn.writes,s[r])&&(s[r]=mn.write(function(){return t._connected&&a.call(t,t._data,n)})))})}}(jn),function(t){var n=0
...
var o=e.el
if(!i)return n
for(var a in i){var l=s(a),h=ne(o,l)
if(!M(h)){if(h=i[a]===Boolean&&""===h||c(i[a],h),"target"===l&&(!h||d(h,"_")))continue
n[a]=h}}var f=Cn(ne(o,t),r)
...
s=_(s)?s.call(t):s||t.$el,w(s)?s.forEach(function(e){return a(t,q({},n,{el:e}),r)}):!s||f&&!f.call(t)||(i=N(u)?t[u]:e(u,t),u=function(e){return w(e.detail)?i.apply(void 0,[e].concat(e.detail)):i(e)},d&&(u=function(e){return function(t){if(t.target===t.currentTarget||t.target===t.current)return e.call(null,t)}}(u)),t._events.push(Be(s,o,h?N(h)?h:h.call(t):null,u,P(c)?{passive:c,capture:l}:l)))}function l(e,t){return e.every(function(e){return!e||!r(e,t)})}function c(e,t){return e===Boolean?L(t):e===Number?j(t):"list"===e?F(t):e?e(t):t}t.prototype._init=function(e){(e=e||{}).data=function(e,t){var n=e.data,r=(e.el,t.args),i=t.props
if(void 0===i&&(i={}),n=w(n)?r&&r.length?n.slice(0,r.length).reduce(function(e,t,n){return E(t)?q(e,t):e[r[n]]=t,e},{}):void 0:n)for(var o in n)M(n[o])?delete n[o]:n[o]=i[o]?c(i[o],n[o]):n[o]
...
delete t[n],e[n].watch&&!U(r,this[n])&&e[n].watch.call(this,this[n],r)}},t.prototype._initProps=function(e){var t
for(t in e=e||i(this.$options,this.$name))M(e[t])||(this.$props[t]=e[t])
...
this._observer.observe(o,{attributes:!0,attributeFilter:a.concat(a.map(function(e){return"data-"+e}))})}}}(jn),function(e){var t=e.data,n={}
...
s&&s in n&&e[s](r)}},e.disconnect=function(e){for(var n in e[t])e[t][n]._callDisconnected()}}(jn),function(e){var t=e.data
...
return n[t]||(n[t]=e.prefix+s(t)),n[t]}}})}(jn)
...
return new Ge(function(i){e=$(e)
var o,s=function(e){return Ge.all(e.map(function(e){return r._toggleElement(e,t,n)}))},a=e.filter(function(e){return r.isToggled(e)}),u=e.filter(function(e){return!y(a,e)})
if(r.queued&&M(n)&&M(t)&&r.hasAnimation&&!(e.length<2)){var l=document.body,c=l.scrollTop,h=a[0],f=Gt.inProgress(h)&&Ot(h,"uk-animation-leave")||Ut.inProgress(h)&&"0px"===h.style.height
...
return new Ge(function(r){return Ge.all($(e).map(function(e){return n._toggleElement(e,t,!1)})).then(r,Q)})},isToggled:function(e){var t=$(e||this.$el)
return this.cls?Ot(t,this.cls.split(" ")[0]):!ee(t,"hidden")},updateAria:function(e){!1===this.cls&&J(e,"aria-hidden",!this.isToggled(e))},_toggleElement:function(e,t,n){var r=this
if(t=P(t)?t:Gt.inProgress(e)?Ot(e,"uk-animation-leave"):Ut.inProgress(e)?"0px"===e.style.height:!this.isToggled(e),!Fe(e,"before"+(t?"show":"hide"),[this]))return Ge.reject()
var i,o,s,a,u,l,c,h=(_(n)?n:!1!==n&&this.hasAnimation?this.hasTransition?(o=(i=this).isToggled,s=i.duration,a=i.initProps,u=i.hideProps,l=i.transition,c=i._toggle,function(e,t){var n=Ut.inProgress(e),r=e.hasChildNodes?D(It(e.firstElementChild,"marginTop"))+D(It(e.lastElementChild,"marginBottom")):0,i=xe(e)?en(e)+(n?0:r):0
Ut.cancel(e),o(e)||c(e,!0),en(e,""),mn.flush()
var h=en(e)+(n?0:r)
return en(e,i),(t?Ut.start(e,q({},a,{overflow:"hidden",height:h}),Math.round(s*(1-i/h)),l):Ut.start(e,u,Math.round(s*(i/h)),l).then(function(){return c(e,!1)})).then(function(){return It(e,a)})}):function(e){var t=e.animation,n=e.duration,r=e.origin,i=e._toggle
...
var f=function(){Fe(e,t?"shown":"hidden",[r]),r.$update(e)}
return h?h.then(f):Ge.resolve(f())},_toggle:function(e,t){var n
e&&(t=Boolean(t),this.cls?(n=y(this.cls," ")||t!==Ot(e,this.cls))&&Tt(e,this.cls,y(this.cls," ")?void 0:t):(n=t===ee(e,"hidden"))&&J(e,"hidden",t?null:""),wt("[autofocus]",e).some(function(e){return xe(e)?e.focus()||!0:e.blur()}),this.updateAria(e),n&&this.$update(e))}}}
var zn={mixins:[Dn,Bn],props:{targets:String,active:null,collapsible:Boolean,multiple:Boolean,toggle:String,content:String,transition:String},data:{targets:"> *",active:!1,animation:[!0],collapsible:!0,multiple:!1,clsOpen:"uk-open",toggle:"> .uk-accordion-title",content:"> .uk-accordion-content",transition:"ease"},computed:{items:function(e,t){return wt(e.targets,t)}},events:[{name:"click",delegate:function(){return this.targets+" "+this.$props.toggle},handler:function(e){e.preventDefault(),this.toggle(rt(wt(this.targets+" "+this.$props.toggle,this.$el),e.current))}}],connected:function(){if(!1!==this.active){var e=this.items[Number(this.active)]
e&&!Ot(e,this.clsOpen)&&this.toggle(e,!1)}},update:function(){var e=this
this.items.forEach(function(t){return e._toggle(yt(e.content,t),Ot(t,e.clsOpen))})
var t=!this.collapsible&&!Ot(this.items,this.clsOpen)&&this.items[0]
t&&this.toggle(t,!1)},methods:{toggle:function(e,t){var n=this,r=it(e,this.items),i=Ce(this.items,"."+this.clsOpen);(e=this.items[r])&&[e].concat(!this.multiple&&!y(i,e)&&i||[]).forEach(function(r){var o=r===e,s=o&&!Ot(r,n.clsOpen)
if(s||!o||n.collapsible||!(i.length<2)){Tt(r,n.clsOpen,s)
var a=r._wrapper?r._wrapper.firstElementChild:yt(n.content,r)
r._wrapper||(r._wrapper=ft(a,"<div>"),J(r._wrapper,"hidden",s?"":null)),n._toggle(a,!0),n.toggleElement(r._wrapper,s,t).then(function(){Ot(r,n.clsOpen)===s&&(s||n._toggle(a,!1),r._wrapper=null,pt(a))})}})}}},$n={mixins:[Dn,Bn],args:"animation",props:{close:String},data:{animation:[!0],selClose:".uk-alert-close",duration:150,hideProps:q({opacity:0},Bn.data.hideProps)},events:[{name:"click",delegate:function(){return this.selClose},handler:function(e){e.preventDefault(),this.close()}}],methods:{close:function(){var e=this
this.toggleElement(this.$el).then(function(){return e.$destroy(!0)})}}}
function Fn(e){nt(function(){var t
e.update(),Be(window,"load resize",function(){return e.update(null,"resize")}),Be(document,"loadedmetadata load",function(t){var n=t.target
return e.update(n,"resize")},!0),Be(window,"scroll",function(n){if(!t){t=!0,mn.write(function(){return t=!1})
var r=n.target
e.update(1!==r.nodeType?document.body:r,n.type)}},{passive:!0,capture:!0})
var n=0
Be(document,"animationstart",function(e){var t=e.target;(It(t,"animationName")||"").match(/^uk-.*(left|right)/)&&(n++,It(document.body,"overflowX","hidden"),setTimeout(function(){--n||It(document.body,"overflowX","")},H(It(t,"animationDuration"))+100))},!0)})}var Hn,Un,Vn={args:"autoplay",props:{automute:Boolean,autoplay:Boolean},data:{automute:!1,autoplay:!0},computed:{inView:function(e){return"inview"===e.autoplay}},connected:function(){this.inView&&!ee(this.$el,"preload")&&(this.$el.preload="none"),this.player=new Tn(this.$el),this.automute&&this.player.mute()},update:{read:function(){return!!this.player&&{visible:xe(this.$el)&&"hidden"!==It(this.$el,"visibility"),inView:this.inView&&ln(this.$el)}},write:function(e){var t=e.visible,n=e.inView
!t||this.inView&&!n?this.player.pause():(!0===this.autoplay||this.inView&&n)&&this.player.play()},events:["resize","scroll"]}},qn={mixins:[Dn,Vn],props:{width:Number,height:Number},data:{automute:!0},update:{read:function(){var e=this.$el
if(!xe(e))return!1
var t=e.parentNode
...
i&&o&&It(r,Z.cover({width:i,height:o},{width:n+(n%2?1:0),height:t+(t%2?1:0)}))},events:["resize"]}},Wn={props:{pos:String,offset:null,flip:Boolean,clsPos:String},data:{pos:"bottom-"+(Ae?"right":"left"),flip:!0,offset:!1,clsPos:""},computed:{pos:function(e){var t=e.pos
...
I(i)||(i=(r=yt(i))?Xt(r)["x"===o?"left":"top"]-Xt(t)["x"===o?"right":"bottom"]:0)
...
t||e.preventDefault(),t&&Oe(t,this.$el)||this.hide(!1)}}},{name:"beforescroll",handler:function(){this.hide(!1)}},{name:"toggle",self:!0,handler:function(e,t){e.preventDefault(),this.isToggled()?this.hide(!1):this.show(t,!1)}},{name:Le,filter:function(){return y(this.mode,"hover")},handler:function(e){In(e)||(Hn&&Hn!==this&&Hn.toggle&&y(Hn.toggle.mode,"hover")&&!Oe(e.target,Hn.toggle.$el)&&!X({x:e.pageX,y:e.pageY},Xt(Hn.$el))&&Hn.hide(!1),e.preventDefault(),this.show(this.toggle))}},{name:"toggleshow",handler:function(e,t){t&&!y(t.target,this.$el)||(e.preventDefault(),this.show(t||this.toggle))}},{name:"togglehide "+je,handler:function(e,t){In(e)||t&&!y(t.target,this.$el)||(e.preventDefault(),this.toggle&&y(this.toggle.mode,"hover")&&this.hide())}},{name:"beforeshow",self:!0,handler:function(){this.clearTimers(),Gt.cancel(this.$el),this.position()}},{name:"show",self:!0,handler:function(){this.tracker.init(),Fe(this.$el,"updatearia"),function(){if(Un)return
Un=!0,Be(document,Me,function(e){var t,n=e.target,r=e.defaultPrevented
if(!r)for(;Hn&&Hn!==t&&!Oe(n,Hn.$el)&&(!Hn.toggle||!Oe(n,Hn.toggle.$el));)t=Hn,Hn.hide(!1)})}()}},{name:"beforehide",self:!0,handler:function(){this.clearTimers()}},{name:"hide",handler:function(e){var t=e.target
this.$el===t?(Hn=this.isActive()?null:Hn,Fe(this.$el,"updatearia"),this.tracker.cancel()):Hn=null===Hn&&Oe(t,this.$el)&&this.isToggled()?this:Hn}},{name:"updatearia",self:!0,handler:function(e,t){e.preventDefault(),this.updateAria(this.$el),(t||this.toggle)&&(J((t||this.toggle).$el,"aria-expanded",this.isToggled()?"true":"false"),Tt(this.toggle.$el,this.cls,this.isToggled()))}}],update:{write:function(){this.isToggled()&&!Gt.inProgress(this.$el)&&this.position()},events:["resize"]},methods:{show:function(e,t){var n=this
void 0===t&&(t=!0)
...
var Gn={extends:Yn},Qn={mixins:[Dn],args:"target",props:{target:Boolean},data:{target:!1},computed:{input:function(e,t){return yt(Ee,t)},state:function(){return this.input.nextElementSibling},target:function(e,t){var n=e.target
return n&&(!0===n&&this.input.parentNode===t&&this.input.nextElementSibling||re(n,t))}},update:function(){var e=this.target,t=this.input
if(e){var n,r=ke(e)?"value":"textContent",i=e[r],o=t.files&&t.files[0]?t.files[0].name:pe(t,"select")&&(n=wt("option",t).filter(function(e){return e.selected})[0])?n.textContent:t.value
i!==o&&(e[r]=o)}},events:{change:function(){this.$emit()}}},Kn={update:{read:function(e){var t=ln(this.$el)
if(!t||e.isInView===t)return!1
e.isInView=t},write:function(){this.$el.src=this.$el.src},events:["scroll","resize"]}},Xn={props:{margin:String,firstColumn:Boolean},data:{margin:"uk-margin-small-top",firstColumn:"uk-first-column"},update:{read:function(e){var t=this.$el.children
...
e.rows.forEach(function(e,n){return e.forEach(function(e,r){Tt(e,t.margin,0!==n),Tt(e,t.firstColumn,0===r)})})},events:["resize"]}}
...
break}if(i.bottom>a.top){if(i.left<a.left&&!Ae){s.unshift(r)
break}s.push(r)
break}if(0===o){t.unshift([r])
break}}}return t}function Jn(e,t){var n
void 0===t&&(t=!1)
var r=e.offsetTop,i=e.offsetLeft,o=e.offsetHeight
return t&&(r=(n=fn(e))[0],i=n[1]),{top:r,left:i,height:o,bottom:r+o}}var er={extends:Xn,mixins:[Dn],name:"grid",props:{masonry:Boolean,parallax:Number},data:{margin:"uk-grid-margin",clsStack:"uk-grid-stack",masonry:!1,parallax:0},computed:{length:function(e,t){return t.children.length},parallax:function(e){var t=e.parallax
return t&&this.length?Math.abs(t):""}},connected:function(){this.masonry&&xt(this.$el,"uk-flex-top uk-flex-wrap-top")},update:[{read:function(e){var t=e.rows;(this.masonry||this.parallax)&&(t=t.map(function(e){return Y(e,"offsetLeft")}),Ae&&t.map(function(e){return e.reverse()}))
var n,r,i,o,s=t.some(function(e){return e.some(Ut.inProgress)}),a=!1,u=""
if(this.masonry&&this.length){var l=0
a=t.reduce(function(e,n,r){return e[r]=n.map(function(n,i){return 0===r?0:D(e[r-1][i])+(l-D(t[r-1][i]&&t[r-1][i].offsetHeight))}),l=n.reduce(function(e,t){return Math.max(e,t.offsetHeight)},0),e},[]),u=function(e){return Math.max.apply(Math,e.reduce(function(e,t){return t.forEach(function(t,n){return e[n]=(e[n]||0)+t.offsetHeight}),e},[]))}(t)+(n=this.$el,r=this.margin,i=$(n.children),D((o=i.filter(function(e){return Ot(e,r)})[0])?It(o,"marginTop"):It(i[0],"paddingLeft"))*(t.length-1))}return{rows:t,translates:a,height:!s&&u}},write:function(e){var t=e.stacks,n=e.height
Tt(this.$el,this.clsStack,t),It(this.$el,"paddingBottom",this.parallax),!1!==n&&It(this.$el,"height",n)},events:["resize"]},{read:function(e){var t=e.height
return{scrolled:!!this.parallax&&cn(this.$el,t?t-en(this.$el):0)*this.parallax}},write:function(e){var t=e.rows,n=e.scrolled,r=e.translates;(!1!==n||r)&&t.forEach(function(e,t){return e.forEach(function(e,i){return It(e,"transform",n||r?"translateY("+((r&&-r[t][i])+(n?i%2?n:n/8:0))+"px)":"")})})},events:["scroll","resize"]}]}
var tr=Te?{data:{selMinHeight:!1,forceHeight:!1},computed:{elements:function(e,t){var n=e.selMinHeight
return n?wt(n,t):[t]}},update:[{read:function(){It(this.elements,"height","")},order:-5,events:["resize"]},{write:function(){var e=this
this.elements.forEach(function(t){var n=D(It(t,"minHeight"))
n&&(e.forceHeight||Math.round(n+rn("height",t,"content-box"))>=t.offsetHeight)&&It(t,"height",n)})},order:5,events:["resize"]}]}:{},nr={mixins:[tr],args:"target",props:{target:String,row:Boolean},data:{target:"> *",row:!0,forceHeight:!0},computed:{elements:function(e,t){return wt(e.target,t)}},update:{read:function(){return{rows:(this.row?Zn(this.elements):[this.elements]).map(rr)}},write:function(e){e.rows.forEach(function(e){var t=e.heights
return e.elements.forEach(function(e,n){return It(e,"minHeight",t[n])})})},events:["resize"]}}
function rr(e){var t
...
return o&&s&&(It(e,"minHeight",""),t=ir(e),r=t.heights,i=t.max),{heights:r=e.map(function(e,t){return r[t]===i&&D(e.style.minHeight).toFixed(2)!==i.toFixed(2)?"":i}),elements:e}}function ir(e){var t=e.map(function(e){return Xt(e).height-rn("height",e,"content-box")})
return{heights:t,max:Math.max.apply(null,t)}}var or={mixins:[tr],props:{expand:Boolean,offsetTop:Boolean,offsetBottom:Boolean,minHeight:Number},data:{expand:!1,offsetTop:!1,offsetBottom:!1,minHeight:0},update:{read:function(){var e="",t=rn("height",this.$el,"content-box")
if(this.expand)e=en(window)-(sr(document.documentElement)-sr(this.$el))-t||""
else{if(e="calc(100vh",this.offsetTop){var n=Xt(this.$el).top
e+=n<en(window)/2?" - "+n+"px":""}!0===this.offsetBottom?e+=" - "+sr(this.$el.nextElementSibling)+"px":I(this.offsetBottom)?e+=" - "+this.offsetBottom+"vh":this.offsetBottom&&m(this.offsetBottom,"px")?e+=" - "+D(this.offsetBottom)+"px":N(this.offsetBottom)&&(e+=" - "+sr(re(this.offsetBottom,this.$el))+"px"),e+=(t?" - "+t+"px":"")+")"}return{minHeight:e}},write:function(e){var t=e.minHeight
It(this.$el,{minHeight:t}),this.minHeight&&D(It(this.$el,"minHeight"))<this.minHeight&&It(this.$el,"minHeight",this.minHeight)},events:["resize"]}}
...
if(N(e)?(t.icon&&y(e,"<symbol")&&(e=function(e,t){if(!cr[e]){var n
for(cr[e]={};n=lr.exec(e);)cr[e][n[3]]='<svg xmlns="http://www.w3.org/2000/svg"'+n[1]+"svg>"
lr.lastIndex=0}return cr[e][t]}(e,t.icon)||e),n=yt(e.substr(e.indexOf("<svg")))):n=e.cloneNode(!0),!n)return Ge.reject("SVG not found.")
var r=J(n,"viewBox")
for(var i in r&&(r=r.split(" "),t.width=t.$props.width||r[2],t.height=t.$props.height||r[3]),t.width*=t.ratio,t.height*=t.ratio,t.$options.props)t[i]&&!y(t.exclude,i)&&J(n,i,t[i])
...
o===J(a,"data-svg")?n=a:lt(s,n)}else{var u=s.lastElementChild
o===J(u,"data-svg")?n=u:at(s,n)}return t.svgEl=n,n},Q)},disconnected:function(){var e=this
_e(this.$el)&&J(this.$el,{hidden:null,id:this.id||null}),this.svg&&this.svg.then(function(t){return(!e._connected||t!==e.svgEl)&&ht(t)},Q),this.svg=this.svgEl=null},methods:{getSvg:function(){var e=this
return this.src?ar[this.src]?ar[this.src]:(ar[this.src]=new Ge(function(t,n){d(e.src,"data:")?t(decodeURIComponent(e.src.split(",")[1])):et(e.src).then(function(e){return t(e.response)},function(){return n("SVG not found.")})}),ar[this.src]):Ge.reject()}}},lr=/<symbol(.*?id=(['"])(.*?)\2[^]*?<\/)symbol>/g,cr={}
var hr={},fr={spinner:'<svg width="30" height="30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" cx="15" cy="15" r="14"/></svg>',totop:'<svg width="18" height="10" viewBox="0 0 18 10" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 9 9 1 17 9 "/></svg>',marker:'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><rect x="9" y="4" width="1" height="11"/><rect x="4" y="9" width="11" height="1"/></svg>',"close-icon":'<svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg"><line fill="none" stroke="#000" stroke-width="1.1" x1="1" y1="1" x2="13" y2="13"/><line fill="none" stroke="#000" stroke-width="1.1" x1="13" y1="1" x2="1" y2="13"/></svg>',"close-large":'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><line fill="none" stroke="#000" stroke-width="1.4" x1="1" y1="1" x2="19" y2="19"/><line fill="none" stroke="#000" stroke-width="1.4" x1="19" y1="1" x2="1" y2="19"/></svg>',"navbar-toggle-icon":'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><rect y="9" width="20" height="2"/><rect y="3" width="20" height="2"/><rect y="15" width="20" height="2"/></svg>',"overlay-icon":'<svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><rect x="19" y="0" width="1" height="40"/><rect x="0" y="19" width="40" height="1"/></svg>',"pagination-next":'<svg width="7" height="12" viewBox="0 0 7 12" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 1 6 6 1 11"/></svg>',"pagination-previous":'<svg width="7" height="12" viewBox="0 0 7 12" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="6 1 1 6 6 11"/></svg>',"search-icon":'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" stroke-width="1.1" cx="9" cy="9" r="7"/><path fill="none" stroke="#000" stroke-width="1.1" d="M14,14 L18,18 L14,14 Z"/></svg>',"search-large":'<svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" stroke-width="1.8" cx="17.5" cy="17.5" r="16.5"/><line fill="none" stroke="#000" stroke-width="1.8" x1="38" y1="39" x2="29" y2="30"/></svg>',"search-navbar":'<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" stroke-width="1.1" cx="10.5" cy="10.5" r="9.5"/><line fill="none" stroke="#000" stroke-width="1.1" x1="23" y1="23" x2="17" y2="17"/></svg>',"slidenav-next":'<svg width="14px" height="24px" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1 "/></svg>',"slidenav-next-large":'<svg width="25px" height="40px" viewBox="0 0 25 40" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="2" points="4.002,38.547 22.527,20.024 4,1.5 "/></svg>',"slidenav-previous":'<svg width="14px" height="24px" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.4" points="12.775,1 1.225,12 12.775,23 "/></svg>',"slidenav-previous-large":'<svg width="25px" height="40px" viewBox="0 0 25 40" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="2" points="20.527,1.5 2,20.024 20.525,38.547 "/></svg>'},dr={install:function(e){e.icon.add=function(t,n){var r,i=N(t)?((r={})[t]=n,r):t
W(i,function(e,t){fr[t]=e,delete hr[t]}),e._initialized&&bt(document.body,function(t){return W(e.getComponents(t),function(e){e.$options.isIcon&&e.icon in i&&e.$reset()})})}},attrs:["icon","ratio"],mixins:[Dn,ur],args:"icon",props:["icon"],data:{exclude:["id","style","class","src","icon","ratio"]},isIcon:!0,connected:function(){xt(this.$el,"uk-icon")},methods:{getSvg:function(){var e=function(e){if(!fr[e])return null
hr[e]||(hr[e]=yt(fr[e].trim()))
return hr[e]}(function(e){return Ae?V(V(e,"left","right"),"previous","next"):e}(this.icon))
return e?Ge.resolve(e):Ge.reject("Icon not found.")}}},pr={extends:dr,data:function(e){return{icon:s(e.constructor.options.name)}}},mr={extends:pr,connected:function(){xt(this.$el,"uk-slidenav")},computed:{icon:function(e,t){var n=e.icon
return Ot(t,"uk-slidenav-large")?n+"-large":n}}},vr={extends:pr,computed:{icon:function(e,t){var n=e.icon
return Ot(t,"uk-search-icon")&&ge(t,".uk-search-large").length?"search-large":ge(t,".uk-search-navbar").length?"search-navbar":n}}},gr={extends:pr,computed:{icon:function(){return"close-"+(Ot(this.$el,"uk-close-large")?"large":"icon")}}},br={extends:pr,connected:function(){var e=this
this.svg.then(function(t){return 1!==e.ratio&&It(yt("circle",t),"strokeWidth",1/e.ratio)},Q)}}
...
return[this.$el].concat(ie(t,this.$el))},watch:function(){this.observe()}},offsetTop:function(e){return Cr(e.offsetTop,"height")},offsetLeft:function(e){return Cr(e.offsetLeft,"width")}},connected:function(){Nr[this.cacheKey]?wr(this.$el,Nr[this.cacheKey]||this.dataSrc,this.dataSrcset,this.sizes):this.isImg&&this.width&&this.height&&wr(this.$el,function(e,t,n){var r
n&&(r=Z.ratio({width:e,height:t},"width",Cr(xr(n))),e=r.width,t=r.height)
return'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="'+e+'" height="'+t+'"></svg>'}(this.width,this.height,this.sizes)),this.observer=new Nn(this.load,{rootMargin:this.offsetTop+"px "+this.offsetLeft+"px"}),requestAnimationFrame(this.observe)},disconnected:function(){this.observer.disconnect()},update:{read:function(e){var t=this,n=e.image
if(n||"complete"!==document.readyState||this.load(this.observer.takeRecords()),this.isImg)return!1
n&&n.then(function(e){return e&&""!==e.currentSrc&&wr(t.$el,Pr(e))})},write:function(e){if(this.dataSrcset&&1!==window.devicePixelRatio){var t=It(this.$el,"backgroundSize");(t.match(/^(auto\s?)+$/)||D(t)===e.bgSize)&&(e.bgSize=(n=this.dataSrcset,r=this.sizes,i=Cr(xr(r)),(o=(n.match(Or)||[]).map(D).sort(function(e,t){return e-t})).filter(function(e){return e>=i})[0]||o.pop()||""),It(this.$el,"backgroundSize",e.bgSize+"px"))}var n,r,i,o},events:["resize"]},methods:{load:function(e){var t=this
e.some(function(e){return e.isIntersecting})&&(this._data.image=tt(this.dataSrc,this.dataSrcset,this.sizes).then(function(e){return wr(t.$el,Pr(e),e.srcset,e.sizes),Nr[t.cacheKey]=Pr(e),e},Q),this.observer.disconnect())},observe:function(){var e=this
!this._data.image&&this._connected&&this.target.forEach(function(t){return e.observer.observe(t)})}}}
function wr(e,t,n,r){if(Sr(e))r&&(e.sizes=r),n&&(e.srcset=n),t&&(e.src=t)
else if(t){!y(e.style.backgroundImage,t)&&(It(e,"backgroundImage","url("+ye(t)+")"),Fe(e,He("load",!1)))}}var _r=/\s*(.*?)\s*(\w+|calc\(.*?\))\s*(?:,|$)/g
...
break}return t||"100vw"}var Er=/\d+(?:\w+|%)/g,kr=/[+-]?(\d+)/g
function Cr(e,t,n){return void 0===t&&(t="width"),void 0===n&&(n=window),I(e)?+e:m(e,"vw")?Ar(n,"width",e):m(e,"vh")?Ar(n,"height",e):m(e,"%")?Ar(n,t,e):D(e)}var Or=/\s+\d+w\s*(?:,|$)/g
var Tr={height:en,width:tn}
function Ar(e,t,n){return Tr[t](e)*D(n)/100}function Sr(e){return"IMG"===e.tagName}function Pr(e){return e.currentSrc||e.src}var Nr
try{(Nr=window.sessionStorage||{}).__test__=1,delete Nr.__test__}catch(Xi){Nr={}}var Rr={props:{media:Boolean},data:{media:!1},computed:{matchMedia:function(){var e=function(e){if(N(e))if("@"===e[0]){var t="breakpoint-"+e.substr(1)
e=D(Dt(t))}else if(isNaN(e))return e
return!(!e||isNaN(e))&&"(min-width: "+e+"px)"}(this.media)
return!e||window.matchMedia(e).matches}}}
var Ir,Mr,Lr={mixins:[Dn,Rr],props:{fill:String},data:{fill:"",clsWrapper:"uk-leader-fill",clsHide:"uk-leader-hide",attrFill:"data-fill"},computed:{fill:function(e){return e.fill||Dt("leader-fill-content")}},connected:function(){var e
e=dt(this.$el,'<span class="'+this.clsWrapper+'">'),this.wrapper=e[0]},disconnected:function(){pt(this.wrapper.childNodes)},update:{read:function(e){var t=e.changed,n=e.width,r=n
return{width:n=Math.floor(this.$el.offsetWidth/2),changed:t||r!==n,hide:!this.matchMedia}},write:function(e){Tt(this.wrapper,this.clsHide,e.hide),e.changed&&(e.changed=!1,J(this.wrapper,this.attrFill,new Array(e.width).join(this.fill)))},events:["resize"]}},jr={props:{container:Boolean},data:{container:!0},computed:{container:function(e){var t=e.container
return!0===t&&this.$container||t&&yt(t)}}},Dr={mixins:[Dn,jr,Bn],props:{selPanel:String,selClose:String,escClose:Boolean,bgClose:Boolean,stack:Boolean},data:{cls:"uk-open",escClose:!0,bgClose:!0,overlay:!0,stack:!1},computed:{panel:function(e,t){return yt(e.selPanel,t)},transitionElement:function(){return this.panel},bgClose:function(e){return e.bgClose&&this.panel}},beforeDisconnect:function(){this.isToggled()&&this.toggleNow(this.$el,!1)},events:[{name:"click",delegate:function(){return this.selClose},handler:function(e){e.preventDefault(),this.hide()}},{name:"toggle",self:!0,handler:function(e){e.defaultPrevented||(e.preventDefault(),this.toggle())}},{name:"beforeshow",self:!0,handler:function(e){var t=Ir&&Ir!==this&&Ir
Ir=this,t?this.stack?this.prev=t:(Ir=t,t.isToggled()?t.hide().then(this.show):$e(t.$el,"beforeshow hidden",this.show,!1,function(e){var n=e.target
return"hidden"===e.type&&n===t.$el}),e.preventDefault()):function(){if(Mr)return
Mr=[Be(document,Me,function(e){var t=e.target,n=e.defaultPrevented
!Ir||!Ir.bgClose||n||Ir.overlay&&!Oe(t,Ir.$el)||Oe(t,Ir.panel)||Ir.hide()}),Be(document,"keydown",function(e){27===e.keyCode&&Ir&&Ir.escClose&&(e.preventDefault(),Ir.hide())})]}()}},{name:"show",self:!0,handler:function(){Ot(document.documentElement,this.clsPage)||(this.scrollbarWidth=tn(window)-tn(document),It(document.body,"overflowY",this.scrollbarWidth&&this.overlay?"scroll":"")),xt(document.documentElement,this.clsPage)}},{name:"hide",self:!0,handler:function(){Ir&&(Ir!==this||this.prev)||(Mr&&Mr.forEach(function(e){return e()}),Mr=null)}},{name:"hidden",self:!0,handler:function(){var e,t=this.prev
if(Ir=Ir&&Ir!==this&&Ir||t)for(;t;){if(t.clsPage===this.clsPage){e=!0
...
var $r={extends:zn,data:{targets:"> .uk-parent",toggle:"> a",content:"> ul"}},Fr={mixins:[Dn,tr],props:{dropdown:String,mode:"list",align:String,offset:Number,boundary:Boolean,boundaryAlign:Boolean,clsDrop:String,delayShow:Number,delayHide:Number,dropbar:Boolean,dropbarMode:String,dropbarAnchor:Boolean,duration:Number},data:{dropdown:".uk-navbar-nav > li",align:Ae?"right":"left",clsDrop:"uk-navbar-dropdown",mode:void 0,offset:void 0,delayShow:void 0,delayHide:void 0,boundaryAlign:void 0,flip:"x",boundary:!0,dropbar:!1,dropbarMode:"slide",dropbarAnchor:!1,duration:200,forceHeight:!0,selMinHeight:".uk-navbar-nav > li > a, .uk-navbar-item, .uk-navbar-toggle"},computed:{boundary:function(e,t){var n=e.boundary,r=e.boundaryAlign
return!0===n||r?t:n},dropbarAnchor:function(e,t){return re(e.dropbarAnchor,t)},pos:function(e){return"bottom-"+e.align},dropdowns:function(e,t){return wt(e.dropdown+" ."+e.clsDrop,t)}},beforeConnect:function(){var e=this.$props.dropbar
this.dropbar=e&&(re(e,this.$el)||yt("+ .uk-navbar-dropbar",this.$el)||yt("<div></div>")),this.dropbar&&(xt(this.dropbar,"uk-navbar-dropbar"),"slide"===this.dropbarMode&&xt(this.dropbar,"uk-navbar-dropbar-slide"))},disconnected:function(){this.dropbar&&ht(this.dropbar)},update:function(){var e=this
...
e&&!pe(this.dropbar,":hover")&&e.hide()}},{name:"beforeshow",capture:!0,filter:function(){return this.dropbar},handler:function(){this.dropbar.parentNode||lt(this.dropbarAnchor||this.$el,this.dropbar)}},{name:"show",capture:!0,filter:function(){return this.dropbar},handler:function(e,t){var n=t.$el,r=t.dir
this.clsDrop&&xt(n,this.clsDrop+"-dropbar"),"bottom"===r&&this.transitionTo(n.offsetHeight+D(It(n,"marginTop"))+D(It(n,"marginBottom")),n)}},{name:"beforehide",filter:function(){return this.dropbar},handler:function(e,t){var n=t.$el,r=this.getActive()
pe(this.dropbar,":hover")&&r&&r.$el===n&&e.preventDefault()}},{name:"hide",filter:function(){return this.dropbar},handler:function(e,t){var n=t.$el,r=this.getActive();(!r||r&&r.$el===n)&&this.transitionTo(0)}}],methods:{getActive:function(){var e=this.dropdowns.map(this.getDropdown).filter(function(e){return e&&e.isActive()})[0]
return e&&y(e.mode,"hover")&&Oe(e.toggle.$el,this.$el)&&e},transitionTo:function(e,t){var n=this,r=this.dropbar,i=xe(r)?en(r):0
return It(t=i<e&&t,"clip","rect(0,"+t.offsetWidth+"px,"+i+"px,0)"),en(r,i),Ut.cancel([t,r]),Ge.all([Ut.start(r,{height:e},this.duration),Ut.start(t,{clip:"rect(0,"+t.offsetWidth+"px,"+e+"px,0)"},this.duration)]).catch(Q).then(function(){It(t,{clip:""}),n.$update(r)})},getDropdown:function(e){return this.$getComponent(e,"drop")||this.$getComponent(e,"dropdown")}}},Hr={mixins:[Dr],args:"mode",props:{mode:String,flip:Boolean,overlay:Boolean},data:{mode:"slide",flip:!1,overlay:!1,clsPage:"uk-offcanvas-page",clsContainer:"uk-offcanvas-container",selPanel:".uk-offcanvas-bar",clsFlip:"uk-offcanvas-flip",clsContainerAnimation:"uk-offcanvas-container-animation",clsSidebarAnimation:"uk-offcanvas-bar-animation",clsMode:"uk-offcanvas",clsOverlay:"uk-offcanvas-overlay",selClose:".uk-offcanvas-close"},computed:{clsFlip:function(e){var t=e.flip,n=e.clsFlip
...
this.clsContainerAnimation&&((e=Ur()).content=e.content.replace(/,user-scalable=0$/,"")),"reveal"===this.mode&&pt(this.panel),Et(this.panel,this.clsSidebarAnimation,this.clsMode),Et(this.$el,this.clsOverlay),It(this.$el,"display",""),Et(document.body,this.clsContainer,this.clsFlip),It(document.documentElement,"overflowY","")}},{name:"swipeLeft swipeRight",handler:function(e){this.isToggled()&&In(e)&&"swipeLeft"===e.type^this.flip&&this.hide()}}]}
function Ur(){return yt('meta[name="viewport"]',document.head)||at(document.head,'<meta name="viewport">')}var Vr={mixins:[Dn],props:{selContainer:String,selContent:String},data:{selContainer:".uk-modal",selContent:".uk-modal-dialog"},computed:{container:function(e,t){return ve(t,e.selContainer)},content:function(e,t){return ve(t,e.selContent)}},connected:function(){It(this.$el,"minHeight",150)},update:{read:function(){return!(!this.content||!this.container)&&{current:D(It(this.$el,"maxHeight")),max:Math.max(150,en(this.container)-(Xt(this.content).height-en(this.$el)))}},write:function(e){var t=e.current,n=e.max
It(this.$el,"maxHeight",n),Math.round(t)!==Math.round(n)&&Fe(this.$el,"resize")},events:["resize"]}},qr={props:["width","height"],connected:function(){xt(this.$el,"uk-responsive-width")},update:{read:function(){return!!(xe(this.$el)&&this.width&&this.height)&&{width:tn(this.$el.parentNode),height:this.height}},write:function(e){en(this.$el,Z.contain({height:this.height,width:this.width},e).height)},events:["resize"]}},Wr={props:{duration:Number,offset:Number},data:{duration:1e3,offset:0},methods:{scrollTo:function(e){var t=this
e=e&&yt(e)||document.body
...
hn(window,r),r!==i?requestAnimationFrame(a):Fe(t.$el,"scrolled",[t,e])}
a()}}},events:{click:function(e){e.defaultPrevented||(e.preventDefault(),this.scrollTo(ye(decodeURIComponent(this.$el.hash)).substr(1)))}}}
var Yr={args:"cls",props:{cls:"list",target:String,hidden:Boolean,offsetTop:Number,offsetLeft:Number,repeat:Boolean,delay:Number},data:function(){return{cls:[],target:!1,hidden:!0,offsetTop:0,offsetLeft:0,repeat:!1,delay:0,inViewClass:"uk-scrollspy-inview"}},computed:{elements:function(e,t){var n=e.target
return n?wt(n,t):[t]}},update:[{write:function(){this.hidden&&It(Ce(this.elements,":not(."+this.inViewClass+")"),"visibility","hidden")}},{read:function(e){var t=this
...
It(n,"visibility",t.hidden?"hidden":""),Et(n,t.inViewClass),Tt(n,o),Fe(n,"outview"),t.$update(n),i.inview=!1}}else{var s=function(){It(n,"visibility",""),xt(n,t.inViewClass),Tt(n,o),Fe(n,"inview"),t.$update(n),i.inview=!0,i.abort&&i.abort()}
...
i.abort=function(){clearTimeout(r),n(),i.queued=!1}})})):s()}})},events:["scroll","resize"]}]},Gr={props:{cls:String,closest:String,scroll:Boolean,overflow:Boolean,offset:Number},data:{cls:"uk-active",closest:!1,scroll:!1,overflow:!0,offset:0},computed:{links:function(e,t){return wt('a[href^="#"]',t).filter(function(e){return e.hash})},elements:function(e){var t=e.closest
return ve(this.links,t||"*")},targets:function(){return wt(this.links.map(function(e){return e.hash}).join(","))}},update:[{read:function(){this.scroll&&this.$create("scroll",this.links,{offset:this.offset||0})}},{read:function(e){var t=this,n=window.pageYOffset+this.offset+1,r=en(document)-en(window)+this.offset
...
break}return!(e.active=yt(Ce(t.links,'[href="#'+i.id+'"]')))})},write:function(e){var t=e.active
this.links.forEach(function(e){return e.blur()}),Et(this.elements,this.cls),t&&Fe(this.$el,"active",[t,xt(this.closest?ve(t,this.closest):t,this.cls)])},events:["scroll","resize"]}]},Qr={mixins:[Dn,Rr],props:{top:null,bottom:Boolean,offset:Number,animation:String,clsActive:String,clsInactive:String,clsFixed:String,clsBelow:String,selTarget:String,widthElement:Boolean,showOnUp:Boolean,targetOffset:Number},data:{top:0,bottom:!1,offset:0,animation:"",clsActive:"uk-active",clsInactive:"",clsFixed:"uk-sticky-fixed",clsBelow:"uk-sticky-below",selTarget:"",widthElement:!1,showOnUp:!1,targetOffset:!1},computed:{selTarget:function(e,t){var n=e.selTarget
return n&&yt(n,t)||t},widthElement:function(e,t){return re(e.widthElement,t)||this.placeholder},isActive:{get:function(){return Ot(this.selTarget,this.clsActive)},set:function(e){e&&!this.isActive?(Ct(this.selTarget,this.clsInactive,this.clsActive),Fe(this.$el,"active")):e||Ot(this.selTarget,this.clsInactive)||(Ct(this.selTarget,this.clsActive,this.clsInactive),Fe(this.$el,"inactive"))}}},connected:function(){this.placeholder=yt("+ .uk-sticky-placeholder",this.$el)||yt('<div class="uk-sticky-placeholder"></div>'),this.isFixed=!1,this.isActive=!1},disconnected:function(){this.isFixed&&(this.hide(),Et(this.selTarget,this.clsInactive)),ht(this.placeholder),this.placeholder=null,this.widthElement=null},events:[{name:"load hashchange popstate",el:window,handler:function(){var e=this
if(!1!==this.targetOffset&&location.hash&&window.pageYOffset>0){var t=yt(location.hash)
t&&mn.read(function(){var n=Xt(t).top,r=Xt(e.$el).top,i=e.$el.offsetHeight
e.isFixed&&r+i>=n&&r<=n+t.offsetHeight&&hn(window,n-i-(I(e.targetOffset)?e.targetOffset:0)-e.offset)})}}}],update:[{read:function(e,t){var n=e.height
this.isActive&&"update"!==t&&(this.hide(),n=this.$el.offsetHeight,this.show()),n=this.isActive?n:this.$el.offsetHeight,this.topOffset=Xt(this.isFixed?this.placeholder:this.$el).top,this.bottomOffset=this.topOffset+n
var r=Kr("bottom",this)
return this.top=Math.max(D(Kr("top",this)),this.topOffset)-this.offset,this.bottom=r&&r-n,this.inactive=!this.matchMedia,{lastScroll:!1,height:n,margins:It(this.$el,["marginTop","marginBottom","marginLeft","marginRight"])}},write:function(e){var t=e.height,n=e.margins,r=this.placeholder
It(r,q({height:t},n)),Oe(r,document)||(lt(this.$el,r),J(r,"hidden","")),this.isActive=this.isActive},events:["resize"]},{read:function(e){var t=e.scroll
return void 0===t&&(t=0),this.width=(xe(this.widthElement)?this.widthElement:this.$el).offsetWidth,this.scroll=window.pageYOffset,{dir:t<=this.scroll?"down":"up",scroll:this.scroll,visible:xe(this.$el),top:fn(this.placeholder)[0]}},write:function(e,t){var n=this,r=e.initTimestamp
void 0===r&&(r=0)
var i=e.dir,o=e.lastDir,s=e.lastScroll,a=e.scroll,u=e.top,l=e.visible,c=performance.now()
if(e.lastScroll=a,!(a<0||a===s||!l||this.disabled||this.showOnUp&&"scroll"!==t||((c-r>300||i!==o)&&(e.initScroll=a,e.initTimestamp=c),e.lastDir=i,this.showOnUp&&Math.abs(e.initScroll-a)<=30&&Math.abs(s-a)<=10)))if(this.inactive||a<this.top||this.showOnUp&&(a<=this.top||"down"===i||"up"===i&&!this.isFixed&&a<=this.bottomOffset)){if(!this.isFixed)return void(Gt.inProgress(this.$el)&&u>a&&(Gt.cancel(this.$el),this.hide()))
this.isFixed=!1,this.animation&&a>this.topOffset?(Gt.cancel(this.$el),Gt.out(this.$el,this.animation).then(function(){return n.hide()},Q)):this.hide()}else this.isFixed?this.update():this.animation?(Gt.cancel(this.$el),this.show(),Gt.in(this.$el,this.animation).catch(Q)):this.show()},events:["resize","scroll"]}],methods:{show:function(){this.isFixed=!0,this.update(),J(this.placeholder,"hidden",null)},hide:function(){this.isActive=!1,Et(this.$el,this.clsFixed,this.clsBelow),It(this.$el,{position:"",top:"",width:""}),J(this.placeholder,"hidden","")},update:function(){var e=0!==this.top||this.scroll>this.top,t=Math.max(0,this.offset)
...
if(o){if(I(o))return i+D(o)
if(N(o)&&o.match(/^-?\d+vh$/))return en(window)*D(o)/100
var s=!0===o?r.parentNode:re(o,r)
return s?Xt(s).top+s.offsetHeight:void 0}}var Xr={mixins:[Bn],args:"connect",props:{connect:String,toggle:String,active:Number,swiping:Boolean},data:{connect:"~.uk-switcher",toggle:"> * > :first-child",active:0,swiping:!0,cls:"uk-active",clsContainer:"uk-switcher",attrItem:"uk-switcher-item",queued:!0},computed:{connects:function(e,t){return ie(e.connect,t)},toggles:function(e,t){return wt(e.toggle,t)}},events:[{name:"click",delegate:function(){return this.toggle+":not(.uk-disabled)"},handler:function(e){e.preventDefault(),this.show($(this.$el.children).filter(function(t){return Oe(e.current,t)})[0])}},{name:"click",el:function(){return this.connects},delegate:function(){return"["+this.attrItem+"],[data-"+this.attrItem+"]"},handler:function(e){e.preventDefault(),this.show(ne(e.current,this.attrItem))}},{name:"swipeRight swipeLeft",filter:function(){return this.swiping},el:function(){return this.connects},handler:function(e){In(e)&&(e.preventDefault(),window.getSelection().toString()||this.show("swipeLeft"===e.type?"next":"previous"))}}],update:function(){var e=this
this.connects.forEach(function(t){return e.updateAria(t.children)})
var t=this.$el.children
this.show(Ce(t,"."+this.cls)[0]||t[this.active]||t[0])},methods:{index:function(){return!!this.connects.length&&rt(Ce(this.connects[0].children,"."+this.cls)[0])},show:function(e){for(var t,n,r=this,i=this.$el.children,o=i.length,s=this.index(),a=s>=0,u="previous"===e?-1:1,l=it(e,i,s),c=0;c<o;c++,l=(l+u+o)%o)if(!pe(this.toggles[l],".uk-disabled *, .uk-disabled, [disabled]")){t=this.toggles[l],n=i[l]
break}!n||s>=0&&Ot(n,this.cls)||s===l||(Et(i,this.cls),xt(n,this.cls),J(this.toggles,"aria-expanded",!1),J(t,"aria-expanded",!0),this.connects.forEach(function(e){a?r.toggleElement([e.children[s],e.children[l]]):r.toggleNow(e.children[l])}))}}},Zr={mixins:[Dn],extends:Xr,props:{media:Boolean},data:{media:960,attrItem:"uk-tab-item"},connected:function(){var e=Ot(this.$el,"uk-tab-left")?"uk-tab-left":!!Ot(this.$el,"uk-tab-right")&&"uk-tab-right"
e&&this.$create("toggle",this.$el,{cls:e,mode:"media",media:this.media})}},Jr={mixins:[Rr,Bn],args:"target",props:{href:String,target:null,mode:"list"},data:{href:!1,target:!1,mode:"click",queued:!0},computed:{target:function(e,t){var n=e.href,r=e.target
return(r=ie(r||n,t)).length&&r||[t]}},connected:function(){Fe(this.target,"updatearia",[this])},events:[{name:Le+" "+je,filter:function(){return y(this.mode,"hover")},handler:function(e){In(e)||this.toggle("toggle"+(e.type===Le?"show":"hide"))}},{name:"click",filter:function(){return y(this.mode,"click")||Ne&&y(this.mode,"hover")},handler:function(e){var t;(In(e)||y(this.mode,"click"))&&((ve(e.target,'a[href="#"], a[href=""], button')||(t=ve(e.target,"a[href]"))&&(this.cls||!xe(this.target)||t.hash&&pe(this.target,t.hash)))&&e.preventDefault(),this.toggle())}}],update:{write:function(){if(y(this.mode,"media")&&this.media){var e=this.isToggled(this.target);(this.matchMedia?!e:e)&&this.toggle()}},events:["resize"]},methods:{toggle:function(e){Fe(this.target,e||"toggle",[this])&&this.toggleElement(this.target)}}}
jn.version="3.0.3",function(e){e.component("accordion",zn),e.component("alert",$n),e.component("cover",qn),e.component("drop",Yn),e.component("dropdown",Gn),e.component("formCustom",Qn),e.component("gif",Kn),e.component("grid",er),e.component("heightMatch",nr),e.component("heightViewport",or),e.component("icon",dr),e.component("img",yr),e.component("leader",Lr),e.component("margin",Xn),e.component("modal",zr),e.component("nav",$r),e.component("navbar",Fr),e.component("offcanvas",Hr),e.component("overflowAuto",Vr),e.component("responsive",qr),e.component("scroll",Wr),e.component("scrollspy",Yr),e.component("scrollspyNav",Gr),e.component("sticky",Qr),e.component("svg",ur),e.component("switcher",Xr),e.component("tab",Zr),e.component("toggle",Jr),e.component("video",Vn),e.component("close",gr)
e.component("marker",pr),e.component("navbarToggleIcon",pr),e.component("overlayIcon",pr),e.component("paginationNext",pr),e.component("paginationPrevious",pr),e.component("searchIcon",vr),e.component("slidenavNext",mr),e.component("slidenavPrevious",mr),e.component("spinner",br),e.component("totop",pr),e.use(Fn)}(jn)
var ei={mixins:[Dn],props:{date:String,clsWrapper:String},data:{date:"",clsWrapper:".uk-countdown-%unit%"},computed:{date:function(e){var t=e.date
return Date.parse(t)},days:function(e,t){return yt(e.clsWrapper.replace("%unit%","days"),t)},hours:function(e,t){return yt(e.clsWrapper.replace("%unit%","hours"),t)},minutes:function(e,t){return yt(e.clsWrapper.replace("%unit%","minutes"),t)},seconds:function(e,t){return yt(e.clsWrapper.replace("%unit%","seconds"),t)},units:function(){var e=this
...
var ti,ni="uk-animation-target",ri={props:{animation:Number},data:{animation:150},computed:{target:function(){return this.$el}},methods:{animate:function(e){var t=this
ti||(ti=at(document.head,"<style>").sheet).insertRule("."+ni+" > * {\n                    margin-top: 0 !important;\n                    transform: none !important;\n                }",0)
var n=$(this.target.children),r=n.map(function(e){return ii(e,!0)}),i=en(this.target),o=window.pageYOffset
e(),Ut.cancel(this.target),n.forEach(Ut.cancel),oi(this.target),this.$update(this.target),mn.flush()
var s=en(this.target),a=(n=n.concat($(this.target.children).filter(function(e){return!y(n,e)}))).map(function(e,t){return!!(e.parentNode&&t in r)&&(r[t]?xe(e)?si(e):{opacity:0}:{opacity:xe(e)?1:0})})
...
return o}),xt(this.target,ni),n.forEach(function(e,t){return r[t]&&It(e,r[t])}),It(this.target,"height",i),hn(window,o),Ge.all(n.map(function(e,n){return r[n]&&a[n]?Ut.start(e,a[n],t.animation,"ease"):Ge.resolve()}).concat(Ut.start(this.target,{height:s},this.animation,"ease"))).then(function(){n.forEach(function(e,t){return It(e,{display:0===a[t].opacity?"none":"",zIndex:""})}),oi(t.target),t.$update(t.target),mn.flush()},Q)}}}
function ii(e,t){var n=It(e,"zIndex")
return!!xe(e)&&q({display:"",opacity:t?It(e,"opacity"):"0",pointerEvents:"none",position:"absolute",zIndex:"auto"===n?rt(e):n},si(e))}function oi(e){It(e.children,{height:"",left:"",opacity:"",pointerEvents:"",position:"",top:"",width:""}),Et(e,ni),It(e,"height","")}function si(e){var t=e.getBoundingClientRect(),n=t.height,r=t.width,i=Jt(e),o=i.top,s=i.left
return{top:o+=D(It(e,"marginTop")),left:s,height:n,width:r}}var ai={mixins:[ri],args:"target",props:{target:Boolean,selActive:Boolean},data:{target:null,selActive:!1,attrItem:"uk-filter-control",cls:"uk-active",animation:250},computed:{toggles:{get:function(e,t){e.attrItem
return wt("["+this.attrItem+"],[data-"+this.attrItem+"]",t)},watch:function(){this.setState(this.getState(),!1)}},target:function(e,t){return yt(e.target,t)},children:{get:function(){return $(this.target.children)},watch:function(e,t){var n,r
...
this.toggles.forEach(function(n){return Tt(n,e.cls,y(t,n))})}},methods:{apply:function(e){this.setState(li(e,this.attrItem,this.getState()))},getState:function(){var e=this
return this.toggles.filter(function(t){return Ot(t,e.cls)}).reduce(function(t,n){return li(n,e.attrItem,t)},{filter:{"":""},sort:[]})},setState:function(e,t){var n=this
...
r.forEach(function(e){return It(e,"display",t&&!pe(e,t)?"none":"")})
var i=e.sort,o=i[0],s=i[1]
if(o){var a=function(e,t,n){return q([],e).sort(function(e,r){return ne(e,t).localeCompare(ne(r,t),void 0,{numeric:!0})*("asc"===n||-1)})}(r,o,s)
U(a,r)||a.forEach(function(e){return at(n.target,e)})}}
t?this.animate(i).then(function(){return Fe(n.$el,"afterFilter",[n])}):(i(),Fe(this.$el,"afterFilter",[this]))},updateState:function(){this.setState(this.getState(),!1)}}}
function ui(e,t){return Cn(ne(e,t),["filter"])}function li(e,t,n){return $(e).forEach(function(e){var r=ui(e,t),i=r.filter,o=r.group,s=r.sort,a=r.order
void 0===a&&(a="asc"),(i||M(s))&&(o?(delete n.filter[""],n.filter[o]=i):n.filter={"":i||""}),M(s)||(n.sort=[s,a])}),n}var ci={slide:{show:function(e){return[{transform:fi(-100*e)},{transform:fi()}]},percent:function(e){return hi(e)},translate:function(e,t){return[{transform:fi(-100*t*e)},{transform:fi(100*t*(1-e))}]}}}
function hi(e){return Math.abs(It(e,"transform").split(",")[4]/e.offsetWidth)||0}function fi(e,t){return void 0===e&&(e=0),void 0===t&&(t="%"),"translateX("+e+(e?t:"")+")"}function di(e){return"scale3d("+e+", "+e+", 1)"}var pi=q({},ci,{fade:{show:function(){return[{opacity:0},{opacity:1}]},percent:function(e){return 1-It(e,"opacity")},translate:function(e){return[{opacity:1-e},{opacity:e}]}},scale:{show:function(){return[{opacity:0,transform:di(.8)},{opacity:1,transform:di(1)}]},percent:function(e){return 1-It(e,"opacity")},translate:function(e){return[{opacity:1-e,transform:di(1-.2*e)},{opacity:e,transform:di(.8+.2*e)}]}}})
function mi(e,t,n){Fe(e,He(t,!1,!1,n))}var vi={mixins:[{props:{autoplay:Boolean,autoplayInterval:Number,pauseOnHover:Boolean},data:{autoplay:!1,autoplayInterval:7e3,pauseOnHover:!0},connected:function(){this.startAutoplay(),this.userInteracted=!1},disconnected:function(){this.stopAutoplay()},events:[{name:"visibilitychange",el:document,handler:function(){document.hidden?this.stopAutoplay():!this.userInteracted&&this.startAutoplay()}},{name:Re,handler:function(){this.userInteracted=!0,this.stopAutoplay()}},{name:"mouseenter",filter:function(){return this.autoplay},handler:function(){this.isHovering=!0}},{name:"mouseleave",filter:function(){return this.autoplay},handler:function(){this.isHovering=!1}}],methods:{startAutoplay:function(){var e=this
...
e[t]=function(t){var r=Mn(t).x*(Ae?-1:1)
...
!this.draggable||!In(e)&&(t=e.target,!t.children.length&&t.childNodes.length)||e.button>0||this.length<2||this.start(e)}},{name:"touchmove",passive:!1,handler:"move",delegate:function(){return this.selSlides}},{name:"dragstart",handler:function(e){e.preventDefault()}}],methods:{start:function(){var e=this
...
if(a!==l){if(this.dir=function(e,t){return"next"===e?1:"previous"===e?-1:e<t?-1:1}(e,s),this.prevIndex=s,this.index=u,a&&Fe(a,"beforeitemhide",[this]),!Fe(l,"beforeitemshow",[this,a]))return this.index=this.prevIndex,void o()
var c=this._show(a,l,t).then(function(){return a&&Fe(a,"itemhidden",[n]),Fe(l,"itemshown",[n]),new Ge(function(e){mn.write(function(){r.shift(),r.length?n.show(r.shift(),!0):n._transitioner=null,e()})})})
return a&&Fe(a,"itemhide",[this]),Fe(l,"itemshow",[this]),c}o()}}},getIndex:function(e,t){return void 0===e&&(e=this.index),void 0===t&&(t=this.index),G(it(e,this.slides,t,this.finite),0,this.maxIndex)},getValidIndex:function(e,t){return void 0===e&&(e=this.index),void 0===t&&(t=this.prevIndex),this.getIndex(e,t)},_show:function(e,t,n){if(this._transitioner=this._getTransitioner(e,t,this.dir,q({easing:n?t.offsetWidth<600?"cubic-bezier(0.25, 0.46, 0.45, 0.94)":"cubic-bezier(0.165, 0.84, 0.44, 1)":this.easing},this.transitionOptions)),!n&&!e)return this._transitioner.translate(1),Ge.resolve()
...
return r.translate(e),r},_getTransitioner:function(e,t,n,r){return void 0===e&&(e=this.prevIndex),void 0===t&&(t=this.index),void 0===n&&(n=this.dir||1),void 0===r&&(r=this.transitionOptions),new this.Transitioner(R(e)?this.slides[e]:e,R(t)?this.slides[t]:t,n*(Ae?-1:1),r)}}}
...
void 0===i&&(i=0)
var u=s?"linear":o
return r-=Math.round(r*G(i,-1,1)),this.translate(i),mi(t,"itemin",{percent:i,duration:r,timing:u,dir:n}),mi(e,"itemout",{percent:1-i,duration:r,timing:u,dir:n}),Ge.all([Ut.start(t,l[1],r,u),Ut.start(e,l[0],r,u)]).then(function(){a.reset(),c.resolve()},Q),c.promise},stop:function(){return Ut.stop([t,e])},cancel:function(){Ut.cancel([t,e])},reset:function(){for(var n in l[0])It([t,e],n,"")},forward:function(n,r){return void 0===r&&(r=this.percent()),Ut.cancel([t,e]),this.show(n,r,!0)},translate:function(r){this.reset()
var i=a(r,n)
...
this.$update(t)},itemshow:function(){R(this.prevIndex)&&mn.flush()},beforeitemshow:function(e){xt(e.target,this.clsActive)},itemshown:function(e){xt(e.target,this.clsActivated)},itemhidden:function(e){Et(e.target,this.clsActive,this.clsActivated)}}},yi={mixins:[jr,Dr,Bn,bi],functional:!0,props:{delayControls:Number,preload:Number,videoAutoplay:Boolean,template:String},data:function(){return{preload:1,videoAutoplay:!1,delayControls:3e3,items:[],cls:"uk-open",clsPage:"uk-lightbox-page",selList:".uk-lightbox-items",attrItem:"uk-lightbox-item",selClose:".uk-close-large",pauseOnHover:!1,velocity:2,Animations:pi,template:'<div class="uk-lightbox uk-overflow-hidden"> <ul class="uk-lightbox-items"></ul> <div class="uk-lightbox-toolbar uk-position-top uk-text-right uk-transition-slide-top uk-transition-opaque"> <button class="uk-lightbox-toolbar-icon uk-close-large" type="button" uk-close></button> </div> <a class="uk-lightbox-button uk-position-center-left uk-position-medium uk-transition-fade" href="#" uk-slidenav-previous uk-lightbox-item="previous"></a> <a class="uk-lightbox-button uk-position-center-right uk-position-medium uk-transition-fade" href="#" uk-slidenav-next uk-lightbox-item="next"></a> <div class="uk-lightbox-toolbar uk-lightbox-caption uk-position-bottom uk-text-center uk-transition-slide-bottom uk-transition-opaque"></div> </div>'}},created:function(){var e=this
this.$mount(at(this.container,this.template)),this.caption=yt(".uk-lightbox-caption",this.$el),this.items.forEach(function(){return at(e.list,"<li></li>")})},events:[{name:Ie+" "+Re+" keydown",handler:"showControls"},{name:Me,self:!0,delegate:function(){return this.selSlides},handler:function(e){e.preventDefault(),this.hide()}},{name:"shown",self:!0,handler:function(){this.startAutoplay(),this.showControls()}},{name:"hide",self:!0,handler:function(){this.stopAutoplay(),this.hideControls(),Et(this.slides,this.clsActive),Ut.stop(this.slides)}},{name:"hidden",self:!0,handler:function(){this.$destroy(!0)}},{name:"keyup",el:document,handler:function(e){if(this.isToggled(this.$el))switch(e.keyCode){case 37:this.show("previous")
break
case 39:this.show("next")}}},{name:"beforeitemshow",handler:function(e){this.isToggled()||(this.draggable=!1,e.preventDefault(),this.toggleNow(this.$el,!0),this.animation=pi.scale,Et(e.target,this.clsActive),this.stack.splice(1,0,this.index))}},{name:"itemshow",handler:function(e){var t=rt(e.target),n=this.getItem(t).caption
...
else if("video"===o||i.match(/\.(mp4|webm|ogv)($|\?)/i)){var a=yt("<video controls playsinline"+(t.poster?' poster="'+t.poster+'"':"")+' uk-video="'+this.videoAutoplay+'"></video>')
...
q(t.props,e.component("lightboxPanel").options.props)},props:{toggle:String},data:{toggle:"a"},computed:{toggles:{get:function(e,t){return wt(e.toggle,t)},watch:function(){this.hide()}}},disconnected:function(){this.hide()},events:[{name:"click",delegate:function(){return this.toggle+":not(.uk-disabled)"},handler:function(e){e.preventDefault(),this.show(rt(this.toggles,e.current))}}],methods:{show:function(e){var t=this
...
var Ei={},ki={functional:!0,args:["message","status"],data:{message:"",status:"",timeout:5e3,group:null,pos:"top-center",clsClose:"uk-notification-close",clsMsg:"uk-notification-message"},install:function(e){e.notification.closeAll=function(t,n){bt(document.body,function(r){var i=e.getComponent(r,"notification")
...
this.$mount(at(e,'<div class="'+this.clsMsg+(this.status?" "+this.clsMsg+"-"+this.status:"")+'"> <a href="#" class="'+this.clsClose+'" data-uk-close></a> <div>'+this.message+"</div> </div>"))},connected:function(){var e,t=this,n=D(It(this.$el,this.marginProp))
Ut.start(It(this.$el,this.startProps),(e={opacity:1},e[this.marginProp]=n,e)).then(function(){t.timeout&&(t.timer=setTimeout(t.close,t.timeout))})},events:(_i={click:function(e){ve(e.target,'a[href="#"],a[href=""]')&&e.preventDefault(),this.close()}},_i[Le]=function(){this.timer&&clearTimeout(this.timer)},_i[je]=function(){this.timeout&&(this.timer=setTimeout(this.close,this.timeout))},_i),methods:{close:function(e){var t=this,n=function(){Fe(t.$el,"close",[t]),ht(t.$el),Ei[t.pos].children.length||It(Ei[t.pos],"display","none")}
...
c=c.map(function(e){return It(It(t,"color",e),"color").split(/[(),]/g).slice(1,-1).concat(1).slice(0,4).map(function(e){return D(e)})}),t.style.color=f}else c=c.map(D)
if(i.match(/^bg/))if(It(t,"background-position-"+i[2],""),s=It(t,"backgroundPosition").split(" ")["x"===i[2]?0:1],n.covers){var d=Math.min.apply(Math,c),p=Math.max.apply(Math,c),m=c.indexOf(d)<c.indexOf(p)
a=p-d,c=c.map(function(e){return e-(m?d:p)}),o=(m?-a:0)+"px"}else o=s
...
e.active?t&&It(this.$el,{backgroundSize:t.width+"px "+t.height+"px",backgroundRepeat:"no-repeat"}):It(this.$el,{backgroundSize:"",backgroundRepeat:""})},events:["resize"]},methods:{reset:function(){var e=this
W(this.getCss(0),function(t,n){return It(e.$el,n,"")})},getCss:function(e){var t=this.props,n=!1
return Object.keys(t).reduce(function(r,i){var o=t[i],s=o.steps,a=o.unit,u=o.pos,l=Ai(s,e)
switch(i){case"x":case"y":if(n)break
var c=["x","y"].map(function(n){return i===n?D(l).toFixed(0)+a:t[n]?Ai(t[n].steps,e,1)+t[n].unit:0}),h=c[0],f=c[1]
...
break
case"color":case"backgroundColor":case"borderColor":var d=Ti(s,e),p=d[0],m=d[1],v=d[2]
r[i]="rgba("+p.map(function(e,t){return e+=v*(m[t]-e),3===t?D(e):parseInt(e,10)}).join(",")+")"
break
...
return(R(i)?i+Math.abs(i-o)*s*(i<o?1:-1):+o).toFixed(n)}var Si={mixins:[Oi],props:{target:String,viewport:Number,easing:Number},data:{target:!1,viewport:1,easing:1},computed:{target:function(e,t){var n=e.target
return function e(t){return t?"offsetTop"in t?t:e(t.parentNode):document.body}(n&&re(n,t)||t)}},update:{read:function(e,t){var n=e.percent
if("scroll"!==t&&(n=!1),e.active){var r=n
return{percent:n=function(e,t){return G(e*(1-(t-t*e)))}(cn(this.target)/(this.viewport||1),this.easing),style:r!==n&&this.getCss(n)}}},write:function(e){var t=e.style
e.active?t&&It(this.$el,t):this.reset()},events:["scroll","resize"]}}
var Pi={update:{write:function(){if(!this.stack.length&&!this.dragging){var e=this.getValidIndex()
delete this.index,Et(this.slides,this.clsActive,this.clsActivated),this.show(e)}},events:["resize"]}}
function Ni(e,t,n){var r=Mi(e,t)
return n?r-function(e,t){return Li(t).width/2-Li(e).width/2}(e,t):Math.min(r,Ri(t))}function Ri(e){return Math.max(0,Ii(e)-Li(e).width)}function Ii(e){return Di(e).reduce(function(e,t){return Li(t).width+e},0)}function Mi(e,t){return(Jt(e).left+(Ae?Li(e).width-Li(t).width:0))*(Ae?-1:1)}function Li(e){return e.getBoundingClientRect()}function ji(e,t,n){Fe(e,He(t,!1,!1,n))}function Di(e){return $(e.children)}var Bi={mixins:[Dn,vi,Pi],props:{center:Boolean,sets:Boolean},data:{center:!1,sets:!1,attrItem:"uk-slider-item",selList:".uk-slider-items",selNav:".uk-slider-nav",clsContainer:"uk-slider-container",Transitioner:function(e,t,n,r){var i=r.center,o=r.easing,s=r.list,a=new Qe,u=e?Ni(e,s,i):Ni(t,s,i)+Li(t).width*n,l=t?Ni(t,s,i):u+Li(e).width*n*(Ae?-1:1)
return{dir:n,show:function(t,r,i){void 0===r&&(r=0)
var u=i?"linear":o
return t-=Math.round(t*G(r,-1,1)),this.translate(r),e&&this.updateTranslates(),r=e?r:G(r,0,1),ji(this.getItemIn(),"itemin",{percent:r,duration:t,timing:u,dir:n}),e&&ji(this.getItemIn(!0),"itemout",{percent:1-r,duration:t,timing:u,dir:n}),Ut.start(s,{transform:fi(-l*(Ae?-1:1),"px")},t,u).then(a.resolve,Q),a.promise},stop:function(){return Ut.stop(s)},cancel:function(){Ut.cancel(s)},reset:function(){It(s,"transform","")},forward:function(e,t){return void 0===t&&(t=this.percent()),Ut.cancel(s),this.show(e,t,!0)},translate:function(t){var r=this.getDistance()*n*(Ae?-1:1)
It(s,"transform",fi(G(r-r*t-l,-Ii(s),Li(s).width)*(Ae?-1:1),"px")),this.updateTranslates(),e&&(t=G(t,-1,1),ji(this.getItemIn(),"itemtranslatein",{percent:t,dir:n}),ji(this.getItemIn(!0),"itemtranslateout",{percent:1-t,dir:n}))},percent:function(){return Math.abs((It(s,"transform").split(",")[4]*(Ae?-1:1)+u)/(l-u))},getDistance:function(){return Math.abs(l-u)},getItemIn:function(t){void 0===t&&(t=!1)
var r=this.getActives(),i=Y(Di(s),"offsetLeft"),o=rt(i,r[n*(t?-1:1)>0?r.length-1:0])
return~o&&i[o+(e&&!t?n:0)]},getActives:function(){var n=Ni(e||t,s,i)
return Y(Di(s).filter(function(e){var t=Mi(e,s)
...
for(var e=Ri(this.list),t=this.length;t--;)if(Mi(this.list.children[t],this.list)<e)return Math.min(t+1,this.length-1)
...
t.center&&l&&u<o-Li(l).width/2?o-=u:(o=r,e.push(a),i=s+r+(t.center?u/2:0))}return s+=u,e},[]))&&n.length&&n},transitionOptions:function(){return{center:this.center,list:this.list}}},connected:function(){Tt(this.$el,this.clsContainer,!yt("."+this.clsContainer,this.$el))},update:{write:function(){var e=this
wt("["+this.attrItem+"],[data-"+this.attrItem+"]",this.$el).forEach(function(t){var n=ne(t,e.attrItem)
e.maxIndex&&Tt(t,"uk-hidden",I(n)&&(e.sets&&!y(e.sets,D(n))||n>e.maxIndex))})},events:["resize"]},events:{beforeitemshow:function(e){!this.dragging&&this.sets&&this.stack.length<2&&!y(this.sets,this.index)&&(this.index=this.getValidIndex())
...
this.slides.forEach(function(n){return Tt(n,e.clsActive,y(t,n))}),(!this.sets||y(this.sets,D(this.index)))&&this.slides.forEach(function(n){return Tt(n,e.clsActivated,y(t,n))})}},methods:{reorder:function(){var e=this
...
It(this.list,"minHeight",t)},events:["resize"]}},qi={mixins:[Dn,ri],props:{group:String,threshold:Number,clsItem:String,clsPlaceholder:String,clsDrag:String,clsDragState:String,clsBase:String,clsNoDrag:String,clsEmpty:String,clsCustom:String,handle:String},data:{group:!1,threshold:5,clsItem:"uk-sortable-item",clsPlaceholder:"uk-sortable-placeholder",clsDrag:"uk-sortable-drag",clsDragState:"uk-drag",clsBase:"uk-sortable",clsNoDrag:"uk-sortable-nodrag",clsEmpty:"uk-sortable-empty",clsCustom:"",handle:!1},created:function(){var e=this;["init","start","move","end"].forEach(function(t){var n=e[t]
...
n>0&&n<this.scrollY?e=this.scrollY-5:r<en(document)&&r>en(window)+this.scrollY&&(e=this.scrollY+5),e&&setTimeout(function(){return hn(window,e)},5)}}},methods:{init:function(e){var t=e.target,n=e.button,r=e.defaultPrevented,i=$(this.$el.children).filter(function(e){return Oe(t,e)})[0]
!i||ke(t)||this.handle&&!Oe(t,this.handle)||n>0||Oe(t,"."+this.clsNoDrag)||r||(e.preventDefault(),this.touched=[this],this.placeholder=i,this.origin=q({target:t,index:rt(i)},this.pos),Be(document,Ie,this.move),Be(document,Me,this.end),Be(window,"scroll",this.scroll),this.threshold||this.start(e))},start:function(e){this.drag=at(this.$container,this.placeholder.outerHTML.replace(/^<li/i,"<div").replace(/li>$/i,"div>")),It(this.drag,q({boxSizing:"border-box",width:this.placeholder.offsetWidth,height:this.placeholder.offsetHeight},It(this.placeholder,["paddingLeft","paddingRight","paddingTop","paddingBottom"]))),J(this.drag,"uk-no-boot",""),xt(this.drag,this.clsDrag,this.clsCustom),en(this.drag.firstElementChild,en(this.placeholder.firstElementChild))
var t=Xt(this.placeholder),n=t.left,r=t.top
q(this.origin,{left:n-this.pos.x,top:r-this.pos.y}),xt(this.placeholder,this.clsPlaceholder),xt(this.$el.children,this.clsItem),xt(document.documentElement,this.clsDragState),Fe(this.$el,"start",[this,this.placeholder]),this.move(e)},move:function(e){if(this.drag){this.$emit()
...
if(n&&!Oe(t,this.placeholder)&&(!i||n.group&&n.group===r.group)){if(t=n.$el===t.parentNode&&t||$(n.$el.children).filter(function(e){return Oe(t,e)})[0],i)r.remove(this.placeholder)
else if(!t)return
n.insert(this.placeholder,t),y(this.touched,n)||this.touched.push(n)}}else(Math.abs(this.pos.x-this.origin.x)>this.threshold||Math.abs(this.pos.y-this.origin.y)>this.threshold)&&this.start(e)},end:function(e){if(ze(document,Ie,this.move),ze(document,Me,this.end),ze(window,"scroll",this.scroll),this.drag){Ye()
var t=this.getSortable(this.placeholder)
this===t?this.origin.index!==rt(this.placeholder)&&Fe(this.$el,"moved",[this,this.placeholder]):(Fe(t.$el,"added",[t,this.placeholder]),Fe(this.$el,"removed",[this,this.placeholder])),Fe(this.$el,"stop",[this,this.placeholder]),ht(this.drag),this.drag=null
...
var r=function(){t?!Oe(e,n.$el)||function(e,t){return e.parentNode===t.parentNode&&rt(e)>rt(t)}(e,t)?ut(t,e):lt(t,e):at(n.$el,e)}
this.animation?this.animate(r):r()},remove:function(e){Oe(e,this.$el)&&(this.animation?this.animate(function(){return ht(e)}):ht(e))},getSortable:function(e){return e&&(this.$getComponent(e,"sortable")||this.getSortable(e.parentNode))}}}
var Wi=[],Yi={mixins:[jr,Bn,Wn],args:"title",props:{delay:Number,title:String},data:{pos:"top",title:"",delay:0,animation:["uk-animation-scale-up"],duration:100,cls:"uk-active",clsPos:"uk-tooltip"},beforeConnect:function(){this._hasTitle=ee(this.$el,"title"),J(this.$el,{title:"","aria-expanded":!1})},disconnected:function(){this.hide(),J(this.$el,{title:this._hasTitle?this.title:null,"aria-expanded":null})},methods:{show:function(){var e=this
y(Wi,this)||(Wi.forEach(function(e){return e.hide()}),Wi.push(this),this._unbind=Be(document,Me,function(t){return!Oe(t.target,e.$el)&&e.hide()}),clearTimeout(this.showTimer),this.showTimer=setTimeout(function(){e._show(),e.hideTimer=setInterval(function(){xe(e.$el)||e.hide()},150)},this.delay))},hide:function(){var e=Wi.indexOf(this)
!~e||pe(this.$el,"input")&&this.$el===document.activeElement||(Wi.splice(e,1),clearTimeout(this.showTimer),clearInterval(this.hideTimer),J(this.$el,"aria-expanded",!1),this.toggleElement(this.tooltip,!1),this.tooltip&&ht(this.tooltip),this.tooltip=!1,this._unbind())},_show:function(){this.tooltip=at(this.container,'<div class="'+this.clsPos+'" aria-expanded="true" aria-hidden> <div class="'+this.clsPos+'-inner">'+this.title+"</div> </div>"),this.positionAt(this.tooltip,this.$el),this.origin="y"===this.getAxis()?un(this.dir)+"-"+this.align:this.align+"-"+un(this.dir),this.toggleElement(this.tooltip,!0)}},events:(Hi={},Hi["focus "+Le+" "+Re]=function(e){e.type===Re&&In(e)||this.show()},Hi.blur="hide",Hi[je]=function(e){In(e)||this.hide()},Hi)},Gi={props:{allow:String,clsDragover:String,concurrent:Number,maxSize:Number,method:String,mime:String,msgInvalidMime:String,msgInvalidName:String,msgInvalidSize:String,multiple:Boolean,name:String,params:Object,type:String,url:String},data:{allow:!1,clsDragover:"uk-dragover",concurrent:1,maxSize:0,method:"POST",mime:!1,msgInvalidMime:"Invalid File Type: %s",msgInvalidName:"Invalid File Name: %s",msgInvalidSize:"Invalid File Size: %s Kilobytes Max",multiple:!1,name:"files[]",params:{},type:"",url:"",abort:Q,beforeAll:Q,beforeSend:Q,complete:Q,completeAll:Q,error:Q,fail:Q,load:Q,loadEnd:Q,loadStart:Q,progress:Q},events:{change:function(e){pe(e.target,'input[type="file"]')&&(e.preventDefault(),e.target.files&&this.upload(e.target.files),e.target.value="")},drop:function(e){Ki(e)
...
i(r.shift())}}}}
function Qi(e,t){return t.match(new RegExp("^"+e.replace(/\//g,"\\/").replace(/\*\*/g,"(\\/[^\\/]+)*").replace(/\*/g,"[^\\/]+").replace(/((?!\\))\?/g,"$1.")+"$","i"))}function Ki(e){e.preventDefault(),e.stopPropagation()}return jn.component("countdown",ei),jn.component("filter",ai),jn.component("lightbox",xi),jn.component("lightboxPanel",yi),jn.component("notification",ki),jn.component("parallax",Si),jn.component("slider",Bi),jn.component("sliderParallax",zi),jn.component("slideshow",Vi),jn.component("slideshowParallax",zi),jn.component("sortable",qi),jn.component("tooltip",Yi),jn.component("upload",Gi),function(e){var t=e.connect,n=e.disconnect
...
var g=0
function b(e,t,n,r,i,o){if(n)for(var s=0;s<n.length;++s){var a=n[s],u="__ember_concurrency_handler_"+g++
...
"undefined"!=typeof document&&(n.p=(r=document.querySelectorAll("script"))[r.length-1].src.replace(/\/[^\/]*$/,"/")),e.exports=(i=_eai_d,o=_eai_r,window.emberAutoImportDynamic=function(e){return o("_eai_dyn_"+e)},void i("uikit",[],function(){return n(4)}))}]);(window.webpackJsonp_ember_auto_import_=window.webpackJsonp_ember_auto_import_||[]).push([[2],[,function(e,t){var n
...
function v(e,t){return m.call(e,t)}var g=function(e){return~this.indexOf(e)},b=f.includes||g,y=Array.prototype.includes||g
function w(e,t){return e&&(R(e)?b:y).call(e,t)}var _=Array.isArray
function x(e){return"function"==typeof e}function E(e){return null!==e&&"object"==typeof e}function k(e){return E(e)&&Object.getPrototypeOf(e)===n}function C(e){return E(e)&&e===e.window}function O(e){return E(e)&&9===e.nodeType}function T(e){return E(e)&&!!e.jquery}function A(e){return e instanceof Node||E(e)&&e.nodeType>=1}var S=n.toString
function P(e){return S.call(e).match(/^\[object (NodeList|HTMLCollection)\]$/)}function N(e){return"boolean"==typeof e}function R(e){return"string"==typeof e}function I(e){return"number"==typeof e}function M(e){return I(e)||R(e)&&!isNaN(e-parseFloat(e))}function L(e){return void 0===e}function j(e){return N(e)?e:"true"===e||"1"===e||""===e||"false"!==e&&"0"!==e&&e}function D(e){var t=Number(e)
return!isNaN(t)&&t}function B(e){return parseFloat(e)||0}function z(e){return A(e)||C(e)||O(e)?e:P(e)||T(e)?e[0]:_(e)?z(e[0]):null}var $=Array.prototype
function F(e){return A(e)?[e]:P(e)?$.slice.call(e):_(e)?e.map(z).filter(Boolean):T(e)?e.toArray():[]}function H(e){return _(e)?e:R(e)?e.split(/,(?![^(]*\))/).map(function(e){return M(e)?D(e):j(e.trim())}):[e]}function U(e){return e?v(e,"ms")?B(e):1e3*B(e):0}function V(e,t){return e===t||E(e)&&E(t)&&Object.keys(e).length===Object.keys(t).length&&Y(e,function(e,n){return e===t[n]})}function q(e,t,n){return e.replace(new RegExp(t+"|"+n,"mg"),function(e){return e===t?n:t})}var W=Object.assign||function(e){for(var t=[],n=arguments.length-1;n-- >0;)t[n]=arguments[n+1]
e=Object(e)
for(var r=0;r<t.length;r++){var o=t[r]
if(null!==o)for(var s in o)i(o,s)&&(e[s]=o[s])}return e}
function Y(e,t){for(var n in e)if(!1===t(e[n],n))return!1
return!0}function G(e,t){return e.sort(function(e,n){var r=e[t]
void 0===r&&(r=0)
var i=n[t]
return void 0===i&&(i=0),r>i?1:i>r?-1:0})}function Q(e,t,n){return void 0===t&&(t=0),void 0===n&&(n=1),Math.min(Math.max(D(e)||0,t),n)}function K(){}function X(e,t){return e.left<t.right&&e.right>t.left&&e.top<t.bottom&&e.bottom>t.top}function Z(e,t){return e.x<=t.right&&e.x>=t.left&&e.y<=t.bottom&&e.y>=t.top}var J={ratio:function(e,t,n){var r,i="width"===t?"height":"width"
return(r={})[i]=e[t]?Math.round(n*e[i]/e[t]):e[i],r[t]=n,r},contain:function(e,t){var n=this
return Y(e=W({},e),function(r,i){return e=e[i]>t[i]?n.ratio(e,i,t[i]):e}),e},cover:function(e,t){var n=this
return Y(e=this.contain(e,t),function(r,i){return e=e[i]<t[i]?n.ratio(e,i,t[i]):e}),e}}
function ee(e,t,n){if(E(t))for(var r in t)ee(e,r,t[r])
else{if(L(n))return(e=z(e))&&e.getAttribute(t)
F(e).forEach(function(e){x(n)&&(n=n.call(e,ee(e,t))),null===n?ne(e,t):e.setAttribute(t,n)})}}function te(e,t){return F(e).some(function(e){return e.hasAttribute(t)})}function ne(e,t){e=F(e),t.split(" ").forEach(function(t){return e.forEach(function(e){return e.removeAttribute(t)})})}function re(e,t){for(var n=0,r=[t,"data-"+t];n<r.length;n++)if(te(e,r[n]))return ee(e,r[n])}function ie(e,t){return z(e)||ae(e,se(e,t))}function oe(e,t){var n=F(e)
return n.length&&n||ue(e,se(e,t))}function se(e,t){return void 0===t&&(t=document),fe(e)||O(t)?t:t.ownerDocument}function ae(e,t){return z(le(e,t,"querySelector"))}function ue(e,t){return F(le(e,t,"querySelectorAll"))}function le(e,t,n){if(void 0===t&&(t=document),!e||!R(e))return null
var r
fe(e=e.replace(he,"$1 *"))&&(r=[],e=e.split(",").map(function(e,n){var i=t
if("!"===(e=e.trim())[0]){var o=e.substr(1).trim().split(" ")
i=ge(t.parentNode,o[0]),e=o.slice(1).join(" ").trim()}if("-"===e[0]){var s=e.substr(1).trim().split(" "),a=(i||t).previousElementSibling
i=me(a,e.substr(1))?a:null,e=s.slice(1).join(" ")}return i?(i.id||(i.id="uk-"+Date.now()+n,r.push(function(){return ne(i,"id")})),"#"+we(i.id)+" "+e):null}).filter(Boolean).join(","),t=document)
try{return t[n](e)}catch(e){return null}finally{r&&r.forEach(function(e){return e()})}}var ce=/(^|,)\s*[!>+~-]/,he=/([!>+~-])(?=\s+[!>+~-]|\s*$)/g
function fe(e){return R(e)&&e.match(ce)}var de=Element.prototype,pe=de.matches||de.webkitMatchesSelector||de.msMatchesSelector
function me(e,t){return F(e).some(function(e){return pe.call(e,t)})}var ve=de.closest||function(e){var t=this
do{if(me(t,e))return t
t=t.parentNode}while(t&&1===t.nodeType)}
function ge(e,t){return p(t,">")&&(t=t.slice(1)),A(e)?e.parentNode&&ve.call(e,t):F(e).map(function(e){return ge(e,t)}).filter(Boolean)}function be(e,t){for(var n=[],r=z(e).parentNode;r&&1===r.nodeType;)me(r,t)&&n.push(r),r=r.parentNode
return n}var ye=window.CSS&&CSS.escape||function(e){return e.replace(/([^\x7f-\uFFFF\w-])/g,function(e){return"\\"+e})}
function we(e){return R(e)?ye.call(null,e):""}var _e={area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,menuitem:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0}
function xe(e){return F(e).some(function(e){return _e[e.tagName.toLowerCase()]})}function Ee(e){return F(e).some(function(e){return e.offsetWidth||e.offsetHeight||e.getClientRects().length})}var ke="input,select,textarea,button"
function Ce(e){return F(e).some(function(e){return me(e,ke)})}function Oe(e,t){return F(e).filter(function(e){return me(e,t)})}function Te(e,t){return R(t)?me(e,t)||ge(e,t):e===t||(O(t)?t.documentElement:z(t)).contains(z(e))}var Ae=/msie|trident/i.test(window.navigator.userAgent),Se="rtl"===ee(document.documentElement,"dir"),Pe="ontouchstart"in window,Ne=window.PointerEvent,Re=Pe||window.DocumentTouch&&document instanceof DocumentTouch||navigator.maxTouchPoints,Ie=Ne?"pointerdown":Pe?"touchstart":"mousedown",Me=Ne?"pointermove":Pe?"touchmove":"mousemove",Le=Ne?"pointerup":Pe?"touchend":"mouseup",je=Ne?"pointerenter":Pe?"":"mouseenter",De=Ne?"pointerleave":Pe?"":"mouseleave",Be=Ne?"pointercancel":"touchcancel"
function ze(){for(var e=[],t=arguments.length;t--;)e[t]=arguments[t]
var n=Ve(e),r=n[0],i=n[1],o=n[2],s=n[3],a=n[4]
return r=Ye(r),o&&(s=function(e,t,n){var r=this
return function(i){e.forEach(function(e){var o=">"===t[0]?ue(t,e).reverse().filter(function(e){return Te(i.target,e)})[0]:ge(i.target,t)
o&&(i.delegate=e,i.current=o,n.call(r,i))})}}(r,o,s)),s.length>1&&(s=function(e){return function(t){return _(t.detail)?e.apply(void 0,[t].concat(t.detail)):e(t)}}(s)),i.split(" ").forEach(function(e){return r.forEach(function(t){return t.addEventListener(e,s,a)})}),function(){return $e(r,i,s,a)}}function $e(e,t,n,r){void 0===r&&(r=!1),e=Ye(e),t.split(" ").forEach(function(t){return e.forEach(function(e){return e.removeEventListener(t,n,r)})})}function Fe(){for(var e=[],t=arguments.length;t--;)e[t]=arguments[t]
var n=Ve(e),r=n[0],i=n[1],o=n[2],s=n[3],a=n[4],u=n[5],l=ze(r,i,o,function(e){var t=!u||u(e)
t&&(l(),s(e,t))},a)
return l}function He(e,t,n){return Ye(e).reduce(function(e,r){return e&&r.dispatchEvent(Ue(t,!0,!0,n))},!0)}function Ue(e,t,n,r){if(void 0===t&&(t=!0),void 0===n&&(n=!1),R(e)){var i=document.createEvent("CustomEvent")
i.initCustomEvent(e,t,n,r),e=i}return e}function Ve(e){return x(e[2])&&e.splice(2,0,!1),e}function qe(e){return e&&"addEventListener"in e}function We(e){return qe(e)?e:z(e)}function Ye(e){return _(e)?e.map(We).filter(Boolean):R(e)?ue(e):qe(e)?[e]:F(e)}function Ge(){var e=setTimeout(Fe(document,"click",function(t){t.preventDefault(),t.stopImmediatePropagation(),clearTimeout(e)},!0))
He(document,Be)}var Qe="Promise"in window?window.Promise:Je,Ke=function(){var e=this
this.promise=new Qe(function(t,n){e.reject=n,e.resolve=t})},Xe=2,Ze="setImmediate"in window?t:setTimeout
function Je(e){this.state=Xe,this.value=void 0,this.deferred=[]
var t=this
try{e(function(e){t.resolve(e)},function(e){t.reject(e)})}catch(e){t.reject(e)}}Je.reject=function(e){return new Je(function(t,n){n(e)})},Je.resolve=function(e){return new Je(function(t,n){t(e)})},Je.all=function(e){return new Je(function(t,n){var r=[],i=0
function o(n){return function(o){r[n]=o,(i+=1)===e.length&&t(r)}}0===e.length&&t(r)
for(var s=0;s<e.length;s+=1)Je.resolve(e[s]).then(o(s),n)})},Je.race=function(e){return new Je(function(t,n){for(var r=0;r<e.length;r+=1)Je.resolve(e[r]).then(t,n)})}
var et=Je.prototype
function tt(e,t){return new Qe(function(n,r){var i=W({data:null,method:"GET",headers:{},xhr:new XMLHttpRequest,beforeSend:K,responseType:""},t)
i.beforeSend(i)
var o=i.xhr
...
ze(o,"load",function(){0===o.status||o.status>=200&&o.status<300||304===o.status?n(o):r(W(Error(o.statusText),{xhr:o,status:o.status}))}),ze(o,"error",function(){return r(W(Error("Network Error"),{xhr:o}))}),ze(o,"timeout",function(){return r(W(Error("Network Timeout"),{xhr:o}))}),o.send(i.data)})}function nt(e,t,n){return new Qe(function(r,i){var o=new Image
o.onerror=i,o.onload=function(){return r(o)},n&&(o.sizes=n),t&&(o.srcset=t),o.src=e})}function rt(e){if("loading"===document.readyState)var t=ze(document,"DOMContentLoaded",function(){t(),e()})
else e()}function it(e,t){return t?F(e).indexOf(z(t)):F((e=z(e))&&e.parentNode.children).indexOf(e)}function ot(e,t,n,r){void 0===n&&(n=0),void 0===r&&(r=!1)
var i=(t=F(t)).length
return e=M(e)?D(e):"next"===e?n+1:"previous"===e?n-1:it(t,e),r?Q(e,0,i-1):(e%=i)<0?e+i:e}function st(e){return(e=wt(e)).innerHTML="",e}function at(e,t){return e=wt(e),L(t)?e.innerHTML:ut(e.hasChildNodes()?st(e):e,t)}function ut(e,t){return e=wt(e),ht(t,function(t){return e.appendChild(t)})}function lt(e,t){return e=wt(e),ht(t,function(t){return e.parentNode.insertBefore(t,e)})}function ct(e,t){return e=wt(e),ht(t,function(t){return e.nextSibling?lt(e.nextSibling,t):ut(e.parentNode,t)})}function ht(e,t){return(e=R(e)?bt(e):e)?"length"in e?F(e).map(t):t(e):null}function ft(e){F(e).map(function(e){return e.parentNode&&e.parentNode.removeChild(e)})}function dt(e,t){for(t=z(lt(e,t));t.firstChild;)t=t.firstChild
return ut(t,e),t}function pt(e,t){return F(F(e).map(function(e){return e.hasChildNodes?dt(F(e.childNodes),t):ut(e,t)}))}function mt(e){F(e).map(function(e){return e.parentNode}).filter(function(e,t,n){return n.indexOf(e)===t}).forEach(function(e){lt(e,e.childNodes),ft(e)})}et.resolve=function(e){var t=this
if(t.state===Xe){if(e===t)throw new TypeError("Promise settled with itself.")
var n=!1
try{var r=e&&e.then
if(null!==e&&E(e)&&x(r))return void r.call(e,function(e){n||t.resolve(e),n=!0},function(e){n||t.reject(e),n=!0})}catch(e){return void(n||t.reject(e))}t.state=0,t.value=e,t.notify()}},et.reject=function(e){if(this.state===Xe){if(e===this)throw new TypeError("Promise settled with itself.")
this.state=1,this.value=e,this.notify()}},et.notify=function(){var e=this
Ze(function(){if(e.state!==Xe)for(;e.deferred.length;){var t=e.deferred.shift(),n=t[0],r=t[1],i=t[2],o=t[3]
try{0===e.state?x(n)?i(n.call(void 0,e.value)):i(e.value):1===e.state&&(x(r)?i(r.call(void 0,e.value)):o(e.value))}catch(e){o(e)}}})},et.then=function(e,t){var n=this
return new Je(function(r,i){n.deferred.push([e,t,r,i]),n.notify()})},et.catch=function(e){return this.then(void 0,e)}
var vt=/^\s*<(\w+|!)[^>]*>/,gt=/^<(\w+)\s*\/?>(?:<\/\1>)?$/
function bt(e){var t=gt.exec(e)
if(t)return document.createElement(t[1])
var n=document.createElement("div")
return vt.test(e)?n.insertAdjacentHTML("beforeend",e.trim()):n.textContent=e,n.childNodes.length>1?F(n.childNodes):n.firstChild}function yt(e,t){if(e&&1===e.nodeType)for(t(e),e=e.firstElementChild;e;)yt(e,t),e=e.nextElementSibling}function wt(e,t){return R(e)?xt(e)?z(bt(e)):ae(e,t):z(e)}function _t(e,t){return R(e)?xt(e)?F(bt(e)):ue(e,t):F(e)}function xt(e){return"<"===e[0]||e.match(/^\s*</)}function Et(e){for(var t=[],n=arguments.length-1;n-- >0;)t[n]=arguments[n+1]
St(e,t,"add")}function kt(e){for(var t=[],n=arguments.length-1;n-- >0;)t[n]=arguments[n+1]
St(e,t,"remove")}function Ct(e,t){ee(e,"class",function(e){return(e||"").replace(new RegExp("\\b"+t+"\\b","g"),"")})}function Ot(e){for(var t=[],n=arguments.length-1;n-- >0;)t[n]=arguments[n+1]
t[0]&&kt(e,t[0]),t[1]&&Et(e,t[1])}function Tt(e,t){return t&&F(e).some(function(e){return e.classList.contains(t.split(" ")[0])})}function At(e){for(var t=[],n=arguments.length-1;n-- >0;)t[n]=arguments[n+1]
if(t.length){var r=R((t=Pt(t))[t.length-1])?[]:t.pop()
t=t.filter(Boolean),F(e).forEach(function(e){for(var n=e.classList,i=0;i<t.length;i++)Rt.Force?n.toggle.apply(n,[t[i]].concat(r)):n[(L(r)?!n.contains(t[i]):r)?"add":"remove"](t[i])})}}function St(e,t,n){(t=Pt(t).filter(Boolean)).length&&F(e).forEach(function(e){var r=e.classList
Rt.Multiple?r[n].apply(r,t):t.forEach(function(e){return r[n](e)})})}function Pt(e){return e.reduce(function(e,t){return e.concat.call(e,R(t)&&w(t," ")?t.trim().split(" "):t)},[])}var Nt,Rt={};(Nt=document.createElement("_").classList)&&(Nt.add("a","b"),Nt.toggle("c",!1),Rt.Multiple=Nt.contains("b"),Rt.Force=!Nt.contains("c")),Nt=null
...
function Mt(e,t,n){return F(e).map(function(e){if(R(t)){if(t=$t(t),L(n))return jt(e,t)
n||I(n)?e.style[t]=M(n)&&!It[t]?n+"px":n:e.style.removeProperty(t)}else{if(_(t)){var r=Lt(e)
return t.reduce(function(e,t){return e[t]=r[$t(t)],e},{})}E(t)&&Y(t,function(t,n){return Mt(e,n,t)})}return e})[0]}function Lt(e,t){return(e=z(e)).ownerDocument.defaultView.getComputedStyle(e,t)}function jt(e,t,n){return Lt(e,n)[t]}var Dt={}
function Bt(e){var t=document.documentElement
if(!Ae)return Lt(t).getPropertyValue("--uk-"+e)
if(!(e in Dt)){var n=ut(t,document.createElement("div"))
Et(n,"uk-"+e),Dt[e]=jt(n,"content",":before").replace(/^["'](.*)["']$/,"$1"),ft(n)}return Dt[e]}var zt={}
...
function Ut(e,t,n,r){return void 0===n&&(n=400),void 0===r&&(r="linear"),Qe.all(F(e).map(function(e){return new Qe(function(i,o){for(var s in t){var a=Mt(e,s)
""===a&&Mt(e,s,a)}var u=setTimeout(function(){return He(e,"transitionend")},n)
Fe(e,"transitionend transitioncanceled",function(t){var n=t.type
...
return e===n}),Et(e,"uk-transition"),Mt(e,W({"transition-property":Object.keys(t).map($t).join(","),"transition-duration":n+"ms","transition-timing-function":r},t))})}))}var Vt={start:Ut,stop:function(e){return He(e,"transitionend"),Qe.resolve()},cancel:function(e){He(e,"transitioncanceled")},inProgress:function(e){return Tt(e,"uk-transition")}},qt="uk-animation-",Wt="uk-cancel-animation"
function Yt(e,t,n,r,i){var o=arguments
return void 0===n&&(n=200),Qe.all(F(e).map(function(e){return new Qe(function(s,a){if(Tt(e,Wt))requestAnimationFrame(function(){return Qe.resolve().then(function(){return Yt.apply(void 0,o).then(s,a)})})
else{var u=t+" "+qt+(i?"leave":"enter")
p(t,qt)&&(r&&(u+=" uk-transform-origin-"+r),i&&(u+=" "+qt+"reverse")),l(),Fe(e,"animationend animationcancel",function(t){var n=t.type,r=!1
"animationcancel"===n?(a(),l()):(s(),Qe.resolve().then(function(){r=!0,l()})),requestAnimationFrame(function(){r||(Et(e,Wt),requestAnimationFrame(function(){return kt(e,Wt)}))})},!1,function(t){var n=t.target
return e===n}),Mt(e,"animationDuration",n+"ms"),Et(e,u)}function l(){Mt(e,"animationDuration",""),Ct(e,qt+"\\S*")}})}))}var Gt=new RegExp(qt+"(enter|leave)"),Qt={in:function(e,t,n,r){return Yt(e,t,n,r,!1)},out:function(e,t,n,r){return Yt(e,t,n,r,!0)},inProgress:function(e){return Gt.test(ee(e,"class"))},cancel:function(e){He(e,"animationcancel")}},Kt={width:["x","left","right"],height:["y","top","bottom"]}
function Xt(e,t,n,r,i,o,s,a){n=an(n),r=an(r)
var u={element:n,target:r}
if(!e||!t)return u
var l=Jt(e),c=Jt(t),h=c
if(sn(h,n,l,-1),sn(h,r,c,1),i=un(i,l.width,l.height),o=un(o,c.width,c.height),i.x+=o.x,i.y+=o.y,h.left+=i.x,h.top+=i.y,s){var f=[Jt(pn(e))]
a&&f.unshift(Jt(a)),Y(Kt,function(e,t){var o=e[0],a=e[1],d=e[2];(!0===s||w(s,o))&&f.some(function(e){var s=n[o]===a?-l[t]:n[o]===d?l[t]:0,f=r[o]===a?c[t]:r[o]===d?-c[t]:0
if(h[a]<e[a]||h[a]+l[t]>e[d]){var p=l[t]/2,m="center"===r[o]?-c[t]/2:0
return"center"===n[o]&&(v(p,m)||v(-p,-m))||v(s,f)}function v(n,r){var s=h[a]+n+r-2*i[o]
if(s>=e[a]&&s+l[t]<=e[d])return h[a]=s,["element","target"].forEach(function(e){u[e][o]=n?u[e][o]===Kt[t][1]?Kt[t][2]:Kt[t][1]:u[e][o]}),!0}})})}return Zt(e,h),u}function Zt(e,t){if(e=z(e),!t)return Jt(e)
var n=Zt(e),r=Mt(e,"position");["left","top"].forEach(function(i){if(i in t){var o=Mt(e,i)
Mt(e,i,t[i]-n[i]+B("absolute"===r&&"auto"===o?en(e)[i]:o))}})}function Jt(e){var t,n,r=pn(e=z(e)),i=r.pageYOffset,o=r.pageXOffset
if(C(e)){var s=e.innerHeight,a=e.innerWidth
return{top:i,left:o,height:s,width:a,bottom:i+s,right:o+a}}Ee(e)||(t=ee(e,"style"),n=ee(e,"hidden"),ee(e,{style:(t||"")+";display:block !important;",hidden:null}))
var u=e.getBoundingClientRect()
return L(t)||ee(e,{style:t,hidden:n}),{height:u.height,width:u.width,top:u.top+i,left:u.left+o,bottom:u.bottom+i,right:u.right+o}}function en(e){var t=(e=z(e)).offsetParent||function(e){return mn(e).documentElement}(e),n=Zt(t),r=["top","left"].reduce(function(r,i){var o=h(i)
...
return{x:i?B(i)*(v(i,"%")?t/100:1):0,y:o?B(o)*(v(o,"%")?n/100:1):0}}function ln(e){switch(e){case"left":return"right"
case"right":return"left"
case"top":return"bottom"
case"bottom":return"top"
default:return e}}function cn(e,t,n){if(void 0===t&&(t=0),void 0===n&&(n=0),!Ee(e))return!1
var r=pn(e=z(e)),i=e.getBoundingClientRect(),o={top:-t,left:-n,bottom:t+tn(r),right:n+nn(r)}
return X(i,o)||Z({x:i.left,y:i.top},o)}function hn(e,t){if(void 0===t&&(t=0),!Ee(e))return 0
var n=pn(e=z(e)),r=mn(e),i=e.offsetHeight+t,o=dn(e)[0],s=tn(n),a=s+Math.min(0,o-s),u=Math.max(0,s-(tn(r)+t-(o+i)))
return Q((a+n.pageYOffset-o)/((a+(i-(u<s?u:0)))/100)/100)}function fn(e,t){if(C(e=z(e))||O(e)){var n=pn(e);(0,n.scrollTo)(n.pageXOffset,t)}else e.scrollTop=t}function dn(e){var t=[0,0]
do{if(t[0]+=e.offsetTop,t[1]+=e.offsetLeft,"fixed"===Mt(e,"position")){var n=pn(e)
return t[0]+=n.pageYOffset,t[1]+=n.pageXOffset,t}}while(e=e.offsetParent)
return t}function pn(e){return C(e)?e:mn(e).defaultView}function mn(e){return z(e).ownerDocument}var vn={reads:[],writes:[],read:function(e){return this.reads.push(e),gn(),e},write:function(e){return this.writes.push(e),gn(),e},clear:function(e){return yn(this.reads,e)||yn(this.writes,e)},flush:function(){bn(this.reads),bn(this.writes.splice(0,this.writes.length)),this.scheduled=!1,(this.reads.length||this.writes.length)&&gn()}}
function gn(){vn.scheduled||(vn.scheduled=!0,requestAnimationFrame(vn.flush.bind(vn)))}function bn(e){for(var t;t=e.shift();)t()}function yn(e,t){var n=e.indexOf(t)
...
this.positions=[],this.position=null
var t=!1
this.unbind=ze(document,"mousemove",function(n){t||(setTimeout(function(){var r=Date.now(),i=e.positions.length
i&&r-e.positions[i-1].time>100&&e.positions.splice(0,i),e.positions.push({time:r,x:n.pageX,y:n.pageY}),e.positions.length>5&&e.positions.shift(),t=!1},5),t=!0)})},cancel:function(){this.unbind&&this.unbind()},movesTo:function(e){if(this.positions.length<2)return!1
...
void 0===t&&(t=[])
try{return e?p(e,"{")?JSON.parse(e):t.length&&!w(e,":")?((n={})[t[0]]=e,n):e.split(";").reduce(function(e,t){var n=t.split(/:(.*)/),r=n[0],i=n[1]
return r&&!L(i)&&(e[r.trim()]=i.trim()),e},{}):{}}catch(e){return{}}}xn.events=xn.created=xn.beforeConnect=xn.connected=xn.beforeDisconnect=xn.disconnected=xn.destroy=kn,xn.args=function(e,t){return kn(t||e)},xn.update=function(e,t){return G(kn(e,x(t)?{read:t}:t),"order")},xn.props=function(e,t){return _(t)&&(t=t.reduce(function(e,t){return e[t]=String,e},{})),xn.methods(e,t)},xn.computed=xn.methods=function(e,t){return t?e?W({},e,t):t:e},xn.data=function(e,t,n){return n?En(e,t,n):t?e?function(n){return En(e,t,n)}:t:e}
var Tn=0,An=function(e){this.id=++Tn,this.el=z(e)}
function Sn(e,t){try{e.contentWindow.postMessage(JSON.stringify(W({event:"command"},t)),"*")}catch(e){}}An.prototype.isVideo=function(){return this.isYoutube()||this.isVimeo()||this.isHTML5()},An.prototype.isHTML5=function(){return"VIDEO"===this.el.tagName},An.prototype.isIFrame=function(){return"IFRAME"===this.el.tagName},An.prototype.isYoutube=function(){return this.isIFrame()&&!!this.el.src.match(/\/\/.*?youtube(-nocookie)?\.[a-z]+\/(watch\?v=[^&\s]+|embed)|youtu\.be\/.*/)},An.prototype.isVimeo=function(){return this.isIFrame()&&!!this.el.src.match(/vimeo\.com\/video\/.*/)},An.prototype.enableApi=function(){var e=this
if(this.ready)return this.ready
var t,n=this.isYoutube(),r=this.isVimeo()
return n||r?this.ready=new Qe(function(i){var o
Fe(e.el,"load",function(){if(n){var r=function(){return Sn(e.el,{event:"listening",id:e.id})}
t=setInterval(r,100),r()}}),(o=function(t){return n&&t.id===e.id&&"onReady"===t.event||r&&Number(t.player_id)===e.id},new Qe(function(e){Fe(window,"message",function(t,n){return e(n)},!1,function(e){var t=e.data
if(t&&R(t)){try{t=JSON.parse(t)}catch(e){return}return t&&o(t)}})})).then(function(){i(),t&&clearInterval(t)}),ee(e.el,"src",e.el.src+(w(e.el.src,"?")?"&":"?")+(n?"enablejsapi=1":"api=1&player_id="+e.id))}):Qe.resolve()},An.prototype.play=function(){var e=this
if(this.isVideo())if(this.isIFrame())this.enableApi().then(function(){return Sn(e.el,{func:"playVideo",method:"play"})})
else if(this.isHTML5())try{var t=this.el.play()
t&&t.catch(K)}catch(e){}},An.prototype.pause=function(){var e=this
this.isVideo()&&(this.isIFrame()?this.enableApi().then(function(){return Sn(e.el,{func:"pauseVideo",method:"pause"})}):this.isHTML5()&&this.el.pause())},An.prototype.mute=function(){var e=this
this.isVideo()&&(this.isIFrame()?this.enableApi().then(function(){return Sn(e.el,{func:"mute",method:"setVolume",value:0})}):this.isHTML5()&&(this.el.muted=!0,ee(this.el,"muted","")))}
var Pn,Nn,Rn="IntersectionObserver"in window?window.IntersectionObserver:function(){function e(e,t){var n=this
void 0===t&&(t={})
var r=t.rootMargin
void 0===r&&(r="0 0"),this.targets=[]
var i,o=(r||"0 0").split(" ").map(B),s=o[0],a=o[1]
this.offsetTop=s,this.offsetLeft=a,this.apply=function(){i||(i=requestAnimationFrame(function(){return setTimeout(function(){var t=n.takeRecords()
t.length&&e(t,n),i=!1})}))},this.off=ze(window,"scroll resize load",this.apply,{passive:!0,capture:!0})}return e.prototype.takeRecords=function(){var e=this
return this.targets.filter(function(t){var n=cn(t.target,e.offsetTop,e.offsetLeft)
if(null===t.isIntersecting||n^t.isIntersecting)return t.isIntersecting=n,!0})},e.prototype.observe=function(e){this.targets.push({target:e,isIntersecting:null}),this.apply()},e.prototype.disconnect=function(){this.targets=[],this.off()},e}(),In={}
function Mn(e){return"touch"===e.pointerType||e.touches||Nn}function Ln(e,t){void 0===t&&(t="client")
var n=e.touches,r=e.changedTouches,i=n&&n[0]||r&&r[0]||e
return{x:i[t+"X"],y:i[t+"Y"]}}function jn(e){return!(!p(e,"uk-")&&!p(e,"data-uk-"))&&l(e.replace("data-uk-","").replace("uk-",""))}ze(document,Ie,function(e){In.el&&(In={})
var t=e.target,n=Ln(e),r=n.x,i=n.y
In.el="tagName"in t?t:t.parentNode,In.x=r,In.y=i,Nn=Mn(e)}),ze(document,Le,function(e){var t=Ln(e),n=t.x,r=t.y
In.el&&n&&Math.abs(In.x-n)>100||r&&Math.abs(In.y-r)>100?Pn=setTimeout(function(){var e,t,i,o
In.el&&(He(In.el,"swipe"),He(In.el,"swipe"+(e=In.x,t=In.y,i=n,o=r,Math.abs(e-i)>=Math.abs(t-o)?e-i>0?"Left":"Right":t-o>0?"Up":"Down"))),In={}}):In={},setTimeout(function(){return Nn=!1})}),ze(document,Be,function(){Pn&&clearTimeout(Pn),Pn=null,In={}})
var Dn=function(e){this._init(e)}
Dn.util=Object.freeze({ajax:tt,getImage:nt,transition:Ut,Transition:Vt,animate:Yt,Animation:Qt,attr:ee,hasAttr:te,removeAttr:ne,data:re,addClass:Et,removeClass:kt,removeClasses:Ct,replaceClass:Ot,hasClass:Tt,toggleClass:At,positionAt:Xt,offset:Zt,position:en,height:tn,width:nn,boxModelAdjust:on,flipPosition:ln,isInView:cn,scrolledOver:hn,scrollTop:fn,offsetPosition:dn,ready:rt,index:it,getIndex:ot,empty:st,html:at,prepend:function(e,t){return(e=wt(e)).hasChildNodes()?ht(t,function(t){return e.insertBefore(t,e.firstChild)}):ut(e,t)},append:ut,before:lt,after:ct,remove:ft,wrapAll:dt,wrapInner:pt,unwrap:mt,fragment:bt,apply:yt,$:wt,$$:_t,isIE:Ae,isRtl:Se,hasTouch:Re,pointerDown:Ie,pointerMove:Me,pointerUp:Le,pointerEnter:je,pointerLeave:De,pointerCancel:Be,on:ze,off:$e,once:Fe,trigger:He,createEvent:Ue,toEventTargets:Ye,preventClick:Ge,fastdom:vn,isVoidElement:xe,isVisible:Ee,selInput:ke,isInput:Ce,filter:Oe,within:Te,bind:e,hasOwn:i,hyphenate:a,camelize:l,ucfirst:h,startsWith:p,endsWith:v,includes:w,isArray:_,isFunction:x,isObject:E,isPlainObject:k,isWindow:C,isDocument:O,isJQuery:T,isNode:A,isNodeCollection:P,isBoolean:N,isString:R,isNumber:I,isNumeric:M,isUndefined:L,toBoolean:j,toNumber:D,toFloat:B,toNode:z,toNodes:F,toList:H,toMs:U,isEqual:V,swap:q,assign:W,each:Y,sortBy:G,clamp:Q,noop:K,intersectRect:X,pointInRect:Z,Dimensions:J,MouseTracker:wn,mergeOptions:Cn,parseOptions:On,Player:An,Promise:Qe,Deferred:Ke,IntersectionObserver:Rn,query:ie,queryAll:oe,find:ae,findAll:ue,matches:me,closest:ge,parents:be,escape:we,css:Mt,getStyles:Lt,getStyle:jt,getCssVar:Bt,propName:$t,isTouch:Mn,getPos:Ln}),Dn.data="__uikit__",Dn.prefix="uk-",Dn.options={},function(e){var t,n=e.data
function r(e,t){if(e)for(var n in e)e[n]._connected&&e[n]._callUpdate(t)}e.use=function(e){if(!e.installed)return e.call(null,this),e.installed=!0,this},e.mixin=function(t,n){(n=(R(n)?e.component(n):n)||this).options=Cn(n.options,t)},e.extend=function(e){e=e||{}
var t=function(e){this._init(e)}
return(t.prototype=Object.create(this.prototype)).constructor=t,t.options=Cn(this.options,e),t.super=this,t.extend=this.extend,t},e.update=function(e,t){(function e(t,n){t&&t!==document.body&&t.parentNode&&(e(t.parentNode,n),n(t.parentNode))})(e=e?z(e):document.body,function(e){return r(e[n],t)}),yt(e,function(e){return r(e[n],t)})},Object.defineProperty(e,"container",{get:function(){return t||document.body},set:function(e){t=wt(e)}})}(Dn),function(e){e.prototype._callHook=function(e){var t=this,n=this.$options[e]
n&&n.forEach(function(e){return e.call(t)})},e.prototype._callConnected=function(){this._connected||(this._data={},this._computeds={},this._initProps(),this._callHook("beforeConnect"),this._connected=!0,this._initEvents(),this._initObserver(),this._callHook("connected"),this._callUpdate())},e.prototype._callDisconnected=function(){this._connected&&(this._callHook("beforeDisconnect"),this._observer&&(this._observer.disconnect(),this._observer=null),this._unbindEvents(),this._callHook("disconnected"),this._connected=!1)},e.prototype._callUpdate=function(e){var t=this
void 0===e&&(e="update")
var n=e.type||e
w(["update","resize"],n)&&this._callWatches()
var r=this.$options.update,i=this._frames,o=i.reads,s=i.writes
r&&r.forEach(function(e,r){var i=e.read,a=e.write,u=e.events;("update"===n||w(u,n))&&(i&&!w(vn.reads,o[r])&&(o[r]=vn.read(function(){var e=t._connected&&i.call(t,t._data,n)
!1===e&&a?vn.clear(s[r]):k(e)&&W(t._data,e)})),a&&!w(vn.writes,s[r])&&(s[r]=vn.write(function(){return t._connected&&a.call(t,t._data,n)})))})}}(Dn),function(t){var n=0
...
var o=e.el
if(!i)return n
for(var s in i){var u=a(s),h=re(o,u)
if(!L(h)){if(h=i[s]===Boolean&&""===h||c(i[s],h),"target"===u&&(!h||p(h,"_")))continue
n[s]=h}}var f=On(re(o,t),r)
...
a=x(a)?a.call(t):a||t.$el,_(a)?a.forEach(function(e){return s(t,W({},n,{el:e}),r)}):!a||f&&!f.call(t)||(i=R(u)?t[u]:e(u,t),u=function(e){return _(e.detail)?i.apply(void 0,[e].concat(e.detail)):i(e)},d&&(u=function(e){return function(t){if(t.target===t.currentTarget||t.target===t.current)return e.call(null,t)}}(u)),t._events.push(ze(a,o,h?R(h)?h:h.call(t):null,u,N(c)?{passive:c,capture:l}:l)))}function u(e,t){return e.every(function(e){return!e||!i(e,t)})}function c(e,t){return e===Boolean?j(t):e===Number?D(t):"list"===e?H(t):e?e(t):t}t.prototype._init=function(e){(e=e||{}).data=function(e,t){var n=e.data,r=(e.el,t.args),i=t.props
if(void 0===i&&(i={}),n=_(n)?r&&r.length?n.slice(0,r.length).reduce(function(e,t,n){return k(t)?W(e,t):e[r[n]]=t,e},{}):void 0:n)for(var o in n)L(n[o])?delete n[o]:n[o]=i[o]?c(i[o],n[o]):n[o]
return n}(e,this.constructor.options),this.$options=Cn(this.constructor.options,e,this),this.$el=null,this.$props={},this._frames={reads:{},writes:{}},this._events=[],this._uid=n++,this._initData(),this._initMethods(),this._initComputeds(),this._callHook("created"),e.el&&this.$mount(e.el)},t.prototype._initData=function(){var e=this.$options.data
for(var t in void 0===e&&(e={}),e)this.$props[t]=this[t]=e[t]},t.prototype._initMethods=function(){var t=this.$options.methods
if(t)for(var n in t)this[n]=e(t[n],this)},t.prototype._initComputeds=function(){var e=this.$options.computed
if(this._computeds={},e)for(var t in e)o(this,t,e[t])},t.prototype._callWatches=function(){var e=this.$options.computed,t=this._computeds
for(var n in t){var r=t[n]
delete t[n],e[n].watch&&!V(r,this[n])&&e[n].watch.call(this,this[n],r)}},t.prototype._initProps=function(e){var t
for(t in e=e||r(this.$options,this.$name))L(e[t])||(this.$props[t]=e[t])
var n=[this.$options.computed,this.$options.methods]
...
if(i){if(!r)return i
i.$destroy()}return new s({el:n,data:r})}}
var i=k(r)?W({},r):r.options
if(i.name=t,i.install&&i.install(e,i,t),e._initialized&&!i.functional){var o=a(t)
vn.read(function(){return e[t]("[uk-"+o+"],[data-uk-"+o+"]")})}return n[t]=k(r)?i:r},e.getComponents=function(e){return e&&e[t]||{}},e.getComponent=function(t,n){return e.getComponents(t)[n]},e.connect=function(r){if(r[t])for(var i in r[t])r[t][i]._callConnected()
...
e.prototype.$mount=function(e){var n=this.$options.name
e[t]||(e[t]={}),e[t][n]||(e[t][n]=this,this.$el=this.$options.el=this.$options.el||e,Te(e,document)&&this._callConnected())},e.prototype.$emit=function(e){this._callUpdate(e)},e.prototype.$reset=function(){this._callDisconnected(),this._callConnected()},e.prototype.$destroy=function(e){void 0===e&&(e=!1)
var n=this.$options,r=n.el,i=n.name
r&&this._callDisconnected(),this._callHook("destroy"),r&&r[t]&&(delete r[t][i],Object.keys(r[t]).length||delete r[t],e&&ft(this.$el))},e.prototype.$create=function(t,n,r){return e[t](n,r)},e.prototype.$update=e.update,e.prototype.$getComponent=e.getComponent
var n={}
Object.defineProperties(e.prototype,{$container:Object.getOwnPropertyDescriptor(e,"container"),$name:{get:function(){var t=this.$options.name
return n[t]||(n[t]=e.prefix+a(t)),n[t]}}})}(Dn)
var Bn={connected:function(){!Tt(this.$el,this.$name)&&Et(this.$el,this.$name)}},zn={props:{cls:Boolean,animation:"list",duration:Number,origin:String,transition:String,queued:Boolean},data:{cls:!1,animation:[!1],duration:200,origin:!1,transition:"linear",queued:!1,initProps:{overflow:"",height:"",paddingTop:"",paddingBottom:"",marginTop:"",marginBottom:""},hideProps:{overflow:"hidden",height:0,paddingTop:0,paddingBottom:0,marginTop:0,marginBottom:0}},computed:{hasAnimation:function(e){return!!e.animation[0]},hasTransition:function(e){var t=e.animation
return this.hasAnimation&&!0===t[0]}},methods:{toggleElement:function(e,t,n){var r=this
return new Qe(function(i){e=F(e)
var o,s=function(e){return Qe.all(e.map(function(e){return r._toggleElement(e,t,n)}))},a=e.filter(function(e){return r.isToggled(e)}),u=e.filter(function(e){return!w(a,e)})
if(r.queued&&L(n)&&L(t)&&r.hasAnimation&&!(e.length<2)){var l=document.body,c=l.scrollTop,h=a[0],f=Qt.inProgress(h)&&Tt(h,"uk-animation-leave")||Vt.inProgress(h)&&"0px"===h.style.height
o=s(a),f||(o=o.then(function(){var e=s(u)
return l.scrollTop=c,e}))}else o=s(u.concat(a))
o.then(i,K)})},toggleNow:function(e,t){var n=this
return new Qe(function(r){return Qe.all(F(e).map(function(e){return n._toggleElement(e,t,!1)})).then(r,K)})},isToggled:function(e){var t=F(e||this.$el)
return this.cls?Tt(t,this.cls.split(" ")[0]):!te(t,"hidden")},updateAria:function(e){!1===this.cls&&ee(e,"aria-hidden",!this.isToggled(e))},_toggleElement:function(e,t,n){var r=this
if(t=N(t)?t:Qt.inProgress(e)?Tt(e,"uk-animation-leave"):Vt.inProgress(e)?"0px"===e.style.height:!this.isToggled(e),!He(e,"before"+(t?"show":"hide"),[this]))return Qe.reject()
var i,o,s,a,u,l,c,h=(x(n)?n:!1!==n&&this.hasAnimation?this.hasTransition?(o=(i=this).isToggled,s=i.duration,a=i.initProps,u=i.hideProps,l=i.transition,c=i._toggle,function(e,t){var n=Vt.inProgress(e),r=e.hasChildNodes?B(Mt(e.firstElementChild,"marginTop"))+B(Mt(e.lastElementChild,"marginBottom")):0,i=Ee(e)?tn(e)+(n?0:r):0
Vt.cancel(e),o(e)||c(e,!0),tn(e,""),vn.flush()
var h=tn(e)+(n?0:r)
return tn(e,i),(t?Vt.start(e,W({},a,{overflow:"hidden",height:h}),Math.round(s*(1-i/h)),l):Vt.start(e,u,Math.round(s*(i/h)),l).then(function(){return c(e,!1)})).then(function(){return Mt(e,a)})}):function(e){var t=e.animation,n=e.duration,r=e.origin,i=e._toggle
...
var f=function(){He(e,t?"shown":"hidden",[r]),r.$update(e)}
return h?h.then(f):Qe.resolve(f())},_toggle:function(e,t){var n
e&&(t=Boolean(t),this.cls?(n=w(this.cls," ")||t!==Tt(e,this.cls))&&At(e,this.cls,w(this.cls," ")?void 0:t):(n=t===te(e,"hidden"))&&ee(e,"hidden",t?null:""),_t("[autofocus]",e).some(function(e){return Ee(e)?e.focus()||!0:e.blur()}),this.updateAria(e),n&&this.$update(e))}}},$n={mixins:[Bn,zn],props:{targets:String,active:null,collapsible:Boolean,multiple:Boolean,toggle:String,content:String,transition:String},data:{targets:"> *",active:!1,animation:[!0],collapsible:!0,multiple:!1,clsOpen:"uk-open",toggle:"> .uk-accordion-title",content:"> .uk-accordion-content",transition:"ease"},computed:{items:function(e,t){return _t(e.targets,t)}},events:[{name:"click",delegate:function(){return this.targets+" "+this.$props.toggle},handler:function(e){e.preventDefault(),this.toggle(it(_t(this.targets+" "+this.$props.toggle,this.$el),e.current))}}],connected:function(){if(!1!==this.active){var e=this.items[Number(this.active)]
...
t&&this.toggle(t,!1)},methods:{toggle:function(e,t){var n=this,r=ot(e,this.items),i=Oe(this.items,"."+this.clsOpen);(e=this.items[r])&&[e].concat(!this.multiple&&!w(i,e)&&i||[]).forEach(function(r){var o=r===e,s=o&&!Tt(r,n.clsOpen)
if(s||!o||n.collapsible||!(i.length<2)){At(r,n.clsOpen,s)
var a=r._wrapper?r._wrapper.firstElementChild:wt(n.content,r)
r._wrapper||(r._wrapper=dt(a,"<div>"),ee(r._wrapper,"hidden",s?"":null)),n._toggle(a,!0),n.toggleElement(r._wrapper,s,t).then(function(){Tt(r,n.clsOpen)===s&&(s||n._toggle(a,!1),r._wrapper=null,mt(a))})}})}}},Fn={mixins:[Bn,zn],args:"animation",props:{close:String},data:{animation:[!0],selClose:".uk-alert-close",duration:150,hideProps:W({opacity:0},zn.data.hideProps)},events:[{name:"click",delegate:function(){return this.selClose},handler:function(e){e.preventDefault(),this.close()}}],methods:{close:function(){var e=this
this.toggleElement(this.$el).then(function(){return e.$destroy(!0)})}}}
function Hn(e){rt(function(){var t
e.update(),ze(window,"load resize",function(){return e.update(null,"resize")}),ze(document,"loadedmetadata load",function(t){var n=t.target
return e.update(n,"resize")},!0),ze(window,"scroll",function(n){if(!t){t=!0,vn.write(function(){return t=!1})
var r=n.target
e.update(1!==r.nodeType?document.body:r,n.type)}},{passive:!0,capture:!0})
var n=0
ze(document,"animationstart",function(e){var t=e.target;(Mt(t,"animationName")||"").match(/^uk-.*(left|right)/)&&(n++,Mt(document.body,"overflowX","hidden"),setTimeout(function(){--n||Mt(document.body,"overflowX","")},U(Mt(t,"animationDuration"))+100))},!0)})}var Un,Vn,qn={args:"autoplay",props:{automute:Boolean,autoplay:Boolean},data:{automute:!1,autoplay:!0},computed:{inView:function(e){return"inview"===e.autoplay}},connected:function(){this.inView&&!te(this.$el,"preload")&&(this.$el.preload="none"),this.player=new An(this.$el),this.automute&&this.player.mute()},update:{read:function(){return!!this.player&&{visible:Ee(this.$el)&&"hidden"!==Mt(this.$el,"visibility"),inView:this.inView&&cn(this.$el)}},write:function(e){var t=e.visible,n=e.inView
...
var t=e.parentNode
return{height:t.offsetHeight,width:t.offsetWidth}},write:function(e){var t=e.height,n=e.width,r=this.$el,i=this.width||r.naturalWidth||r.videoWidth||r.clientWidth,o=this.height||r.naturalHeight||r.videoHeight||r.clientHeight
i&&o&&Mt(r,J.cover({width:i,height:o},{width:n+(n%2?1:0),height:t+(t%2?1:0)}))},events:["resize"]}},Yn={props:{pos:String,offset:null,flip:Boolean,clsPos:String},data:{pos:"bottom-"+(Se?"right":"left"),flip:!0,offset:!1,clsPos:""},computed:{pos:function(e){var t=e.pos
...
this.dir="x"===o?a:u,this.align="x"===o?u:a,At(e,this.clsPos+"-"+this.dir+"-"+this.align,!1===this.offset)},getAxis:function(){return"top"===this.dir||"bottom"===this.dir?"y":"x"}}},Gn={mixins:[Yn,zn],args:"pos",props:{mode:"list",toggle:Boolean,boundary:Boolean,boundaryAlign:Boolean,delayShow:Number,delayHide:Number,clsDrop:String},data:{mode:["click","hover"],toggle:"- *",boundary:window,boundaryAlign:!1,delayShow:0,delayHide:800,clsDrop:!1,hoverIdle:200,animation:["uk-animation-fade"],cls:"uk-open"},computed:{boundary:function(e,t){return ie(e.boundary,t)},clsDrop:function(e){return e.clsDrop||"uk-"+this.$options.name},clsPos:function(){return this.clsDrop}},created:function(){this.tracker=new wn},connected:function(){Et(this.$el,this.clsDrop)
var e=this.$props.toggle
this.toggle=e&&this.$create("toggle",ie(e,this.$el),{target:this.$el,mode:this.mode}),!this.toggle&&He(this.$el,"updatearia")},events:[{name:"click",delegate:function(){return"."+this.clsDrop+"-close"},handler:function(e){e.preventDefault(),this.hide(!1)}},{name:"click",delegate:function(){return'a[href^="#"]'},handler:function(e){if(!e.defaultPrevented){var t=e.target.hash
t||e.preventDefault(),t&&Te(t,this.$el)||this.hide(!1)}}},{name:"beforescroll",handler:function(){this.hide(!1)}},{name:"toggle",self:!0,handler:function(e,t){e.preventDefault(),this.isToggled()?this.hide(!1):this.show(t,!1)}},{name:je,filter:function(){return w(this.mode,"hover")},handler:function(e){Mn(e)||(Un&&Un!==this&&Un.toggle&&w(Un.toggle.mode,"hover")&&!Te(e.target,Un.toggle.$el)&&!Z({x:e.pageX,y:e.pageY},Zt(Un.$el))&&Un.hide(!1),e.preventDefault(),this.show(this.toggle))}},{name:"toggleshow",handler:function(e,t){t&&!w(t.target,this.$el)||(e.preventDefault(),this.show(t||this.toggle))}},{name:"togglehide "+De,handler:function(e,t){Mn(e)||t&&!w(t.target,this.$el)||(e.preventDefault(),this.toggle&&w(this.toggle.mode,"hover")&&this.hide())}},{name:"beforeshow",self:!0,handler:function(){this.clearTimers(),Qt.cancel(this.$el),this.position()}},{name:"show",self:!0,handler:function(){this.tracker.init(),He(this.$el,"updatearia"),Vn||(Vn=!0,ze(document,Le,function(e){var t,n=e.target
if(!e.defaultPrevented)for(;Un&&Un!==t&&!Te(n,Un.$el)&&(!Un.toggle||!Te(n,Un.toggle.$el));)t=Un,Un.hide(!1)}))}},{name:"beforehide",self:!0,handler:function(){this.clearTimers()}},{name:"hide",handler:function(e){var t=e.target
this.$el===t?(Un=this.isActive()?null:Un,He(this.$el,"updatearia"),this.tracker.cancel()):Un=null===Un&&Te(t,this.$el)&&this.isToggled()?this:Un}},{name:"updatearia",self:!0,handler:function(e,t){e.preventDefault(),this.updateAria(this.$el),(t||this.toggle)&&(ee((t||this.toggle).$el,"aria-expanded",this.isToggled()?"true":"false"),At(this.toggle.$el,this.cls,this.isToggled()))}}],update:{write:function(){this.isToggled()&&!Qt.inProgress(this.$el)&&this.position()},events:["resize"]},methods:{show:function(e,t){var n=this
void 0===t&&(t=!0)
...
e&&this.toggle&&e.$el!==this.toggle.$el?(Fe(this.$el,"hide",i),this.hide(!1)):i()},hide:function(e){var t=this
void 0===e&&(e=!0)
var n=function(){return t.toggleNow(t.$el,!1)}
this.clearTimers(),this.isDelaying=this.tracker.movesTo(this.$el),e&&this.isDelaying?this.hideTimer=setTimeout(this.hide,this.hoverIdle):e&&this.delayHide?this.hideTimer=setTimeout(n,this.delayHide):n()},clearTimers:function(){clearTimeout(this.showTimer),clearTimeout(this.hideTimer),this.showTimer=null,this.hideTimer=null,this.isDelaying=!1},isActive:function(){return Un===this},isChildOf:function(e){return e&&e!==this&&Te(this.$el,e.$el)},isParentOf:function(e){return e&&e!==this&&Te(e.$el,this.$el)},position:function(){Ct(this.$el,this.clsDrop+"-(stack|boundary)"),Mt(this.$el,{top:"",left:"",display:"block"}),At(this.$el,this.clsDrop+"-boundary",this.boundaryAlign)
...
this.positionAt(this.$el,this.boundaryAlign?this.boundary:this.toggle.$el,this.boundary),Mt(this.$el,"display","")}}},Qn={extends:Gn},Kn={mixins:[Bn],args:"target",props:{target:Boolean},data:{target:!1},computed:{input:function(e,t){return wt(ke,t)},state:function(){return this.input.nextElementSibling},target:function(e,t){var n=e.target
return n&&(!0===n&&this.input.parentNode===t&&this.input.nextElementSibling||ie(n,t))}},update:function(){var e=this.target,t=this.input
if(e){var n,r=Ce(e)?"value":"textContent",i=e[r],o=t.files&&t.files[0]?t.files[0].name:me(t,"select")&&(n=_t("option",t).filter(function(e){return e.selected})[0])?n.textContent:t.value
i!==o&&(e[r]=o)}},events:{change:function(){this.$emit()}}},Xn={update:{read:function(e){var t=cn(this.$el)
if(!t||e.isInView===t)return!1
...
if(!t.length||!Ee(this.$el))return e.rows=[[]]
e.rows=Jn(t),e.stacks=!e.rows.some(function(e){return e.length>1})},write:function(e){var t=this
e.rows.forEach(function(e,n){return e.forEach(function(e,r){At(e,t.margin,0!==n),At(e,t.firstColumn,0===r)})})},events:["resize"]}}
...
void 0===t&&(t=!1)
var r=e.offsetTop,i=e.offsetLeft,o=e.offsetHeight
return t&&(r=(n=dn(e))[0],i=n[1]),{top:r,left:i,height:o,bottom:r+o}}var tr={extends:Zn,mixins:[Bn],name:"grid",props:{masonry:Boolean,parallax:Number},data:{margin:"uk-grid-margin",clsStack:"uk-grid-stack",masonry:!1,parallax:0},computed:{length:function(e,t){return t.children.length},parallax:function(e){var t=e.parallax
return t&&this.length?Math.abs(t):""}},connected:function(){this.masonry&&Et(this.$el,"uk-flex-top uk-flex-wrap-top")},update:[{read:function(e){var t=e.rows;(this.masonry||this.parallax)&&(t=t.map(function(e){return G(e,"offsetLeft")}),Se&&t.map(function(e){return e.reverse()}))
...
At(this.$el,this.clsStack,t),Mt(this.$el,"paddingBottom",this.parallax),!1!==n&&Mt(this.$el,"height",n)},events:["resize"]},{read:function(e){var t=e.height
return{scrolled:!!this.parallax&&hn(this.$el,t?t-tn(this.$el):0)*this.parallax}},write:function(e){var t=e.rows,n=e.scrolled,r=e.translates;(!1!==n||r)&&t.forEach(function(e,t){return e.forEach(function(e,i){return Mt(e,"transform",n||r?"translateY("+((r&&-r[t][i])+(n?i%2?n:n/8:0))+"px)":"")})})},events:["scroll","resize"]}]},nr=Ae?{data:{selMinHeight:!1,forceHeight:!1},computed:{elements:function(e,t){var n=e.selMinHeight
return n?_t(n,t):[t]}},update:[{read:function(){Mt(this.elements,"height","")},order:-5,events:["resize"]},{write:function(){var e=this
this.elements.forEach(function(t){var n=B(Mt(t,"minHeight"))
n&&(e.forceHeight||Math.round(n+on("height",t,"content-box"))>=t.offsetHeight)&&Mt(t,"height",n)})},order:5,events:["resize"]}]}:{},rr={mixins:[nr],args:"target",props:{target:String,row:Boolean},data:{target:"> *",row:!0,forceHeight:!0},computed:{elements:function(e,t){return _t(e.target,t)}},update:{read:function(){return{rows:(this.row?Jn(this.elements):[this.elements]).map(ir)}},write:function(e){e.rows.forEach(function(e){var t=e.heights
return e.elements.forEach(function(e,n){return Mt(e,"minHeight",t[n])})})},events:["resize"]}}
function ir(e){var t
if(e.length<2)return{heights:[""],elements:e}
...
return o&&s&&(Mt(e,"minHeight",""),t=or(e),r=t.heights,i=t.max),{heights:r=e.map(function(e,t){return r[t]===i&&B(e.style.minHeight).toFixed(2)!==i.toFixed(2)?"":i}),elements:e}}function or(e){var t=e.map(function(e){return Zt(e).height-on("height",e,"content-box")})
return{heights:t,max:Math.max.apply(null,t)}}var sr={mixins:[nr],props:{expand:Boolean,offsetTop:Boolean,offsetBottom:Boolean,minHeight:Number},data:{expand:!1,offsetTop:!1,offsetBottom:!1,minHeight:0},update:{read:function(){var e="",t=on("height",this.$el,"content-box")
if(this.expand)e=tn(window)-(ar(document.documentElement)-ar(this.$el))-t||""
else{if(e="calc(100vh",this.offsetTop){var n=Zt(this.$el).top
e+=n<tn(window)/2?" - "+n+"px":""}!0===this.offsetBottom?e+=" - "+ar(this.$el.nextElementSibling)+"px":M(this.offsetBottom)?e+=" - "+this.offsetBottom+"vh":this.offsetBottom&&v(this.offsetBottom,"px")?e+=" - "+B(this.offsetBottom)+"px":R(this.offsetBottom)&&(e+=" - "+ar(ie(this.offsetBottom,this.$el))+"px"),e+=(t?" - "+t+"px":"")+")"}return{minHeight:e}},write:function(e){var t=e.minHeight
Mt(this.$el,{minHeight:t}),this.minHeight&&B(Mt(this.$el,"minHeight"))<this.minHeight&&Mt(this.$el,"minHeight",this.minHeight)},events:["resize"]}}
function ar(e){return e&&e.offsetHeight||0}var ur={},lr={args:"src",props:{id:String,icon:String,src:String,style:String,width:Number,height:Number,ratio:Number,class:String},data:{ratio:1,id:!1,exclude:["ratio","src","icon"],class:""},connected:function(){var e,t=this
if(this.class+=" uk-svg",!this.icon&&w(this.src,"#")){var n=this.src.split("#")
n.length>1&&(e=n,this.src=e[0],this.icon=e[1])}this.svg=this.getSvg().then(function(e){var n
if(R(e)?(t.icon&&w(e,"<symbol")&&(e=function(e,t){if(!hr[e]){var n
for(hr[e]={};n=cr.exec(e);)hr[e][n[3]]='<svg xmlns="http://www.w3.org/2000/svg"'+n[1]+"svg>"
cr.lastIndex=0}return hr[e][t]}(e,t.icon)||e),n=wt(e.substr(e.indexOf("<svg")))):n=e.cloneNode(!0),!n)return Qe.reject("SVG not found.")
var r=ee(n,"viewBox")
for(var i in r&&(r=r.split(" "),t.width=t.$props.width||r[2],t.height=t.$props.height||r[3]),t.width*=t.ratio,t.height*=t.ratio,t.$options.props)t[i]&&!w(t.exclude,i)&&ee(n,i,t[i])
t.id||ne(n,"id"),t.width&&!t.height&&ne(n,"height"),t.height&&!t.width&&ne(n,"width")
var o=t.icon||t.src
ee(n,"data-svg",o)
var s=t.$el
if(xe(s)||"CANVAS"===s.tagName){ee(s,{hidden:!0,id:null})
var a=s.nextElementSibling
o===ee(a,"data-svg")?n=a:ct(s,n)}else{var u=s.lastElementChild
o===ee(u,"data-svg")?n=u:ut(s,n)}return t.svgEl=n,n},K)},disconnected:function(){var e=this
xe(this.$el)&&ee(this.$el,{hidden:null,id:this.id||null}),this.svg&&this.svg.then(function(t){return(!e._connected||t!==e.svgEl)&&ft(t)},K),this.svg=this.svgEl=null},methods:{getSvg:function(){var e=this
return this.src?ur[this.src]?ur[this.src]:(ur[this.src]=new Qe(function(t,n){p(e.src,"data:")?t(decodeURIComponent(e.src.split(",")[1])):tt(e.src).then(function(e){return t(e.response)},function(){return n("SVG not found.")})}),ur[this.src]):Qe.reject()}}},cr=/<symbol(.*?id=(['"])(.*?)\2[^]*?<\/)symbol>/g,hr={},fr={},dr={spinner:'<svg width="30" height="30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" cx="15" cy="15" r="14"/></svg>',totop:'<svg width="18" height="10" viewBox="0 0 18 10" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 9 9 1 17 9 "/></svg>',marker:'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><rect x="9" y="4" width="1" height="11"/><rect x="4" y="9" width="11" height="1"/></svg>',"close-icon":'<svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg"><line fill="none" stroke="#000" stroke-width="1.1" x1="1" y1="1" x2="13" y2="13"/><line fill="none" stroke="#000" stroke-width="1.1" x1="13" y1="1" x2="1" y2="13"/></svg>',"close-large":'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><line fill="none" stroke="#000" stroke-width="1.4" x1="1" y1="1" x2="19" y2="19"/><line fill="none" stroke="#000" stroke-width="1.4" x1="19" y1="1" x2="1" y2="19"/></svg>',"navbar-toggle-icon":'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><rect y="9" width="20" height="2"/><rect y="3" width="20" height="2"/><rect y="15" width="20" height="2"/></svg>',"overlay-icon":'<svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><rect x="19" y="0" width="1" height="40"/><rect x="0" y="19" width="40" height="1"/></svg>',"pagination-next":'<svg width="7" height="12" viewBox="0 0 7 12" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 1 6 6 1 11"/></svg>',"pagination-previous":'<svg width="7" height="12" viewBox="0 0 7 12" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="6 1 1 6 6 11"/></svg>',"search-icon":'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" stroke-width="1.1" cx="9" cy="9" r="7"/><path fill="none" stroke="#000" stroke-width="1.1" d="M14,14 L18,18 L14,14 Z"/></svg>',"search-large":'<svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" stroke-width="1.8" cx="17.5" cy="17.5" r="16.5"/><line fill="none" stroke="#000" stroke-width="1.8" x1="38" y1="39" x2="29" y2="30"/></svg>',"search-navbar":'<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" stroke-width="1.1" cx="10.5" cy="10.5" r="9.5"/><line fill="none" stroke="#000" stroke-width="1.1" x1="23" y1="23" x2="17" y2="17"/></svg>',"slidenav-next":'<svg width="14px" height="24px" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1 "/></svg>',"slidenav-next-large":'<svg width="25px" height="40px" viewBox="0 0 25 40" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="2" points="4.002,38.547 22.527,20.024 4,1.5 "/></svg>',"slidenav-previous":'<svg width="14px" height="24px" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.4" points="12.775,1 1.225,12 12.775,23 "/></svg>',"slidenav-previous-large":'<svg width="25px" height="40px" viewBox="0 0 25 40" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="2" points="20.527,1.5 2,20.024 20.525,38.547 "/></svg>'},pr={install:function(e){e.icon.add=function(t,n){var r,i=R(t)?((r={})[t]=n,r):t
Y(i,function(e,t){dr[t]=e,delete fr[t]}),e._initialized&&yt(document.body,function(t){return Y(e.getComponents(t),function(e){e.$options.isIcon&&e.icon in i&&e.$reset()})})}},attrs:["icon","ratio"],mixins:[Bn,lr],args:"icon",props:["icon"],data:{exclude:["id","style","class","src","icon","ratio"]},isIcon:!0,connected:function(){Et(this.$el,"uk-icon")},methods:{getSvg:function(){var e=function(e){return dr[e]?(fr[e]||(fr[e]=wt(dr[e].trim())),fr[e]):null}(function(e){return Se?q(q(e,"left","right"),"previous","next"):e}(this.icon))
return e?Qe.resolve(e):Qe.reject("Icon not found.")}}},mr={extends:pr,data:function(e){return{icon:a(e.constructor.options.name)}}},vr={extends:mr,connected:function(){Et(this.$el,"uk-slidenav")},computed:{icon:function(e,t){var n=e.icon
return Tt(t,"uk-slidenav-large")?n+"-large":n}}},gr={extends:mr,computed:{icon:function(e,t){var n=e.icon
return Tt(t,"uk-search-icon")&&be(t,".uk-search-large").length?"search-large":be(t,".uk-search-navbar").length?"search-navbar":n}}},br={extends:mr,computed:{icon:function(){return"close-"+(Tt(this.$el,"uk-close-large")?"large":"icon")}}},yr={extends:mr,connected:function(){var e=this
this.svg.then(function(t){return 1!==e.ratio&&Mt(wt("circle",t),"strokeWidth",1/e.ratio)},K)}},wr={props:{dataSrc:String,dataSrcset:Boolean,sizes:String,width:Number,height:Number,offsetTop:String,offsetLeft:String,target:String},data:{dataSrc:"",dataSrcset:!1,sizes:!1,width:!1,height:!1,offsetTop:"50vh",offsetLeft:0,target:!1},computed:{cacheKey:function(e){var t=e.dataSrc
return this.$name+"."+t},width:function(e){var t=e.width,n=e.dataWidth
return t||n},height:function(e){var t=e.height,n=e.dataHeight
return t||n},sizes:function(e){var t=e.sizes,n=e.dataSizes
return t||n},isImg:function(e,t){return Nr(t)},target:{get:function(e){var t=e.target
return[this.$el].concat(oe(t,this.$el))},watch:function(){this.observe()}},offsetTop:function(e){return Or(e.offsetTop,"height")},offsetLeft:function(e){return Or(e.offsetLeft,"width")}},connected:function(){var e,t,n,r
Tr[this.cacheKey]?_r(this.$el,Tr[this.cacheKey]||this.dataSrc,this.dataSrcset,this.sizes):this.isImg&&this.width&&this.height&&_r(this.$el,(e=this.width,t=this.height,(n=this.sizes)&&(e=(r=J.ratio({width:e,height:t},"width",Or(Er(n)))).width,t=r.height),'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="'+e+'" height="'+t+'"></svg>')),this.observer=new Rn(this.load,{rootMargin:this.offsetTop+"px "+this.offsetLeft+"px"}),requestAnimationFrame(this.observe)},disconnected:function(){this.observer.disconnect()},update:{read:function(e){var t=this,n=e.image
if(n||"complete"!==document.readyState||this.load(this.observer.takeRecords()),this.isImg)return!1
n&&n.then(function(e){return e&&""!==e.currentSrc&&_r(t.$el,Rr(e))})},write:function(e){if(this.dataSrcset&&1!==window.devicePixelRatio){var t=Mt(this.$el,"backgroundSize");(t.match(/^(auto\s?)+$/)||B(t)===e.bgSize)&&(e.bgSize=(n=this.dataSrcset,r=this.sizes,i=Or(Er(r)),(o=(n.match(Ar)||[]).map(B).sort(function(e,t){return e-t})).filter(function(e){return e>=i})[0]||o.pop()||""),Mt(this.$el,"backgroundSize",e.bgSize+"px"))}var n,r,i,o},events:["resize"]},methods:{load:function(e){var t=this
e.some(function(e){return e.isIntersecting})&&(this._data.image=nt(this.dataSrc,this.dataSrcset,this.sizes).then(function(e){return _r(t.$el,Rr(e),e.srcset,e.sizes),Tr[t.cacheKey]=Rr(e),e},K),this.observer.disconnect())},observe:function(){var e=this
!this._data.image&&this._connected&&this.target.forEach(function(t){return e.observer.observe(t)})}}}
function _r(e,t,n,r){if(Nr(e))r&&(e.sizes=r),n&&(e.srcset=n),t&&(e.src=t)
else if(t){!w(e.style.backgroundImage,t)&&(Mt(e,"backgroundImage","url("+we(t)+")"),He(e,Ue("load",!1)))}}var xr=/\s*(.*?)\s*(\w+|calc\(.*?\))\s*(?:,|$)/g
function Er(e){var t,n
for(xr.lastIndex=0;t=xr.exec(e);)if(!t[1]||window.matchMedia(t[1]).matches){t=p(n=t[2],"calc")?n.substring(5,n.length-1).replace(kr,function(e){return Or(e)}).replace(/ /g,"").match(Cr).reduce(function(e,t){return e+ +t},0):n
break}return t||"100vw"}var kr=/\d+(?:\w+|%)/g,Cr=/[+-]?(\d+)/g
function Or(e,t,n){return void 0===t&&(t="width"),void 0===n&&(n=window),M(e)?+e:v(e,"vw")?Pr(n,"width",e):v(e,"vh")?Pr(n,"height",e):v(e,"%")?Pr(n,t,e):B(e)}var Tr,Ar=/\s+\d+w\s*(?:,|$)/g,Sr={height:tn,width:nn}
function Pr(e,t,n){return Sr[t](e)*B(n)/100}function Nr(e){return"IMG"===e.tagName}function Rr(e){return e.currentSrc||e.src}try{(Tr=window.sessionStorage||{}).__test__=1,delete Tr.__test__}catch(e){Tr={}}var Ir,Mr,Lr={props:{media:Boolean},data:{media:!1},computed:{matchMedia:function(){var e=function(e){if(R(e))if("@"===e[0]){var t="breakpoint-"+e.substr(1)
e=B(Bt(t))}else if(isNaN(e))return e
return!(!e||isNaN(e))&&"(min-width: "+e+"px)"}(this.media)
return!e||window.matchMedia(e).matches}}},jr={mixins:[Bn,Lr],props:{fill:String},data:{fill:"",clsWrapper:"uk-leader-fill",clsHide:"uk-leader-hide",attrFill:"data-fill"},computed:{fill:function(e){return e.fill||Bt("leader-fill-content")}},connected:function(){var e
e=pt(this.$el,'<span class="'+this.clsWrapper+'">'),this.wrapper=e[0]},disconnected:function(){mt(this.wrapper.childNodes)},update:{read:function(e){var t=e.changed,n=e.width,r=n
return{width:n=Math.floor(this.$el.offsetWidth/2),changed:t||r!==n,hide:!this.matchMedia}},write:function(e){At(this.wrapper,this.clsHide,e.hide),e.changed&&(e.changed=!1,ee(this.wrapper,this.attrFill,new Array(e.width).join(this.fill)))},events:["resize"]}},Dr={props:{container:Boolean},data:{container:!0},computed:{container:function(e){var t=e.container
return!0===t&&this.$container||t&&wt(t)}}},Br={mixins:[Bn,Dr,zn],props:{selPanel:String,selClose:String,escClose:Boolean,bgClose:Boolean,stack:Boolean},data:{cls:"uk-open",escClose:!0,bgClose:!0,overlay:!0,stack:!1},computed:{panel:function(e,t){return wt(e.selPanel,t)},transitionElement:function(){return this.panel},bgClose:function(e){return e.bgClose&&this.panel}},beforeDisconnect:function(){this.isToggled()&&this.toggleNow(this.$el,!1)},events:[{name:"click",delegate:function(){return this.selClose},handler:function(e){e.preventDefault(),this.hide()}},{name:"toggle",self:!0,handler:function(e){e.defaultPrevented||(e.preventDefault(),this.toggle())}},{name:"beforeshow",self:!0,handler:function(e){var t=Ir&&Ir!==this&&Ir
Ir=this,t?this.stack?this.prev=t:(Ir=t,t.isToggled()?t.hide().then(this.show):Fe(t.$el,"beforeshow hidden",this.show,!1,function(e){var n=e.target
return"hidden"===e.type&&n===t.$el}),e.preventDefault()):Mr||(Mr=[ze(document,Le,function(e){var t=e.target,n=e.defaultPrevented
!Ir||!Ir.bgClose||n||Ir.overlay&&!Te(t,Ir.$el)||Te(t,Ir.panel)||Ir.hide()}),ze(document,"keydown",function(e){27===e.keyCode&&Ir&&Ir.escClose&&(e.preventDefault(),Ir.hide())})])}},{name:"show",self:!0,handler:function(){Tt(document.documentElement,this.clsPage)||(this.scrollbarWidth=nn(window)-nn(document),Mt(document.body,"overflowY",this.scrollbarWidth&&this.overlay?"scroll":"")),Et(document.documentElement,this.clsPage)}},{name:"hide",self:!0,handler:function(){Ir&&(Ir!==this||this.prev)||(Mr&&Mr.forEach(function(e){return e()}),Mr=null)}},{name:"hidden",self:!0,handler:function(){var e,t=this.prev
if(Ir=Ir&&Ir!==this&&Ir||t)for(;t;){if(t.clsPage===this.clsPage){e=!0
...
return this.isToggled()?Qe.resolve():this.container&&this.$el.parentNode!==this.container?(ut(this.container,this.$el),new Qe(function(t){return requestAnimationFrame(function(){return e.show().then(t)})})):this.toggleElement(this.$el,!0,zr(this))},hide:function(){return this.isToggled()?this.toggleElement(this.$el,!1,zr(this)):Qe.resolve()},getActive:function(){return Ir}}}
function zr(e){var t=e.transitionElement,n=e._toggle
return function(e,r){return new Qe(function(i,o){return Fe(e,"show hide",function(){e._reject&&e._reject(),e._reject=o,n(e,r),U(Mt(t,"transitionDuration"))?Fe(t,"transitionend",i,!1,function(e){return e.target===t}):i()})})}}var $r={install:function(e){e.modal.dialog=function(t,n){var r=e.modal(' <div class="uk-modal"> <div class="uk-modal-dialog">'+t+"</div> </div> ",n)
return r.show(),ze(r.$el,"hidden",function(e){e.target===e.currentTarget&&Qe.resolve(function(){return r.$destroy(!0)})}),r},e.modal.alert=function(t,n){return n=W({bgClose:!1,escClose:!1,labels:e.modal.labels},n),new Qe(function(r){return ze(e.modal.dialog(' <div class="uk-modal-body">'+(R(t)?t:at(t))+'</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-primary uk-modal-close" autofocus>'+n.labels.ok+"</button> </div> ",n).$el,"hide",r)})},e.modal.confirm=function(t,n){return n=W({bgClose:!1,escClose:!0,labels:e.modal.labels},n),new Qe(function(r,i){var o=e.modal.dialog(' <form> <div class="uk-modal-body">'+(R(t)?t:at(t))+'</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-default uk-modal-close" type="button">'+n.labels.cancel+'</button> <button class="uk-button uk-button-primary" autofocus>'+n.labels.ok+"</button> </div> </form> ",n),s=!1
ze(o.$el,"submit","form",function(e){e.preventDefault(),r(),s=!0,o.hide()}),ze(o.$el,"hide",function(){s||i()})})},e.modal.prompt=function(t,n,r){return r=W({bgClose:!1,escClose:!0,labels:e.modal.labels},r),new Qe(function(i){var o=e.modal.dialog(' <form class="uk-form-stacked"> <div class="uk-modal-body"> <label>'+(R(t)?t:at(t))+'</label> <input class="uk-input" autofocus> </div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-default uk-modal-close" type="button">'+r.labels.cancel+'</button> <button class="uk-button uk-button-primary">'+r.labels.ok+"</button> </div> </form> ",r),s=wt("input",o.$el)
s.value=n
var a=!1
ze(o.$el,"submit","form",function(e){e.preventDefault(),i(s.value),a=!0,o.hide()}),ze(o.$el,"hide",function(){a||i(null)})})},e.modal.labels={ok:"Ok",cancel:"Cancel"}},mixins:[Br],data:{clsPage:"uk-modal-page",selPanel:".uk-modal-dialog",selClose:".uk-modal-close, .uk-modal-close-default, .uk-modal-close-outside, .uk-modal-close-full"},events:[{name:"show",self:!0,handler:function(){Tt(this.panel,"uk-margin-auto-vertical")?Et(this.$el,"uk-flex"):Mt(this.$el,"display","block"),tn(this.$el)}},{name:"hidden",self:!0,handler:function(){Mt(this.$el,"display",""),kt(this.$el,"uk-flex")}}]},Fr={extends:$n,data:{targets:"> .uk-parent",toggle:"> a",content:"> ul"}},Hr={mixins:[Bn,nr],props:{dropdown:String,mode:"list",align:String,offset:Number,boundary:Boolean,boundaryAlign:Boolean,clsDrop:String,delayShow:Number,delayHide:Number,dropbar:Boolean,dropbarMode:String,dropbarAnchor:Boolean,duration:Number},data:{dropdown:".uk-navbar-nav > li",align:Se?"right":"left",clsDrop:"uk-navbar-dropdown",mode:void 0,offset:void 0,delayShow:void 0,delayHide:void 0,boundaryAlign:void 0,flip:"x",boundary:!0,dropbar:!1,dropbarMode:"slide",dropbarAnchor:!1,duration:200,forceHeight:!0,selMinHeight:".uk-navbar-nav > li > a, .uk-navbar-item, .uk-navbar-toggle"},computed:{boundary:function(e,t){var n=e.boundary,r=e.boundaryAlign
return!0===n||r?t:n},dropbarAnchor:function(e,t){return ie(e.dropbarAnchor,t)},pos:function(e){return"bottom-"+e.align},dropdowns:function(e,t){return _t(e.dropdown+" ."+e.clsDrop,t)}},beforeConnect:function(){var e=this.$props.dropbar
this.dropbar=e&&(ie(e,this.$el)||wt("+ .uk-navbar-dropbar",this.$el)||wt("<div></div>")),this.dropbar&&(Et(this.dropbar,"uk-navbar-dropbar"),"slide"===this.dropbarMode&&Et(this.dropbar,"uk-navbar-dropbar-slide"))},disconnected:function(){this.dropbar&&ft(this.dropbar)},update:function(){var e=this
this.$create("drop",this.dropdowns.filter(function(t){return!e.getDropdown(t)}),W({},this.$props,{boundary:this.boundary,pos:this.pos,offset:this.dropbar||this.offset}))},events:[{name:"mouseover",delegate:function(){return this.dropdown},handler:function(e){var t=e.current,n=this.getActive()
n&&n.toggle&&!Te(n.toggle.$el,t)&&!n.tracker.movesTo(n.$el)&&n.hide(!1)}},{name:"mouseleave",el:function(){return this.dropbar},handler:function(){var e=this.getActive()
e&&!me(this.dropbar,":hover")&&e.hide()}},{name:"beforeshow",capture:!0,filter:function(){return this.dropbar},handler:function(){this.dropbar.parentNode||ct(this.dropbarAnchor||this.$el,this.dropbar)}},{name:"show",capture:!0,filter:function(){return this.dropbar},handler:function(e,t){var n=t.$el,r=t.dir
...
return e&&w(e.mode,"hover")&&Te(e.toggle.$el,this.$el)&&e},transitionTo:function(e,t){var n=this,r=this.dropbar,i=Ee(r)?tn(r):0
return Mt(t=i<e&&t,"clip","rect(0,"+t.offsetWidth+"px,"+i+"px,0)"),tn(r,i),Vt.cancel([t,r]),Qe.all([Vt.start(r,{height:e},this.duration),Vt.start(t,{clip:"rect(0,"+t.offsetWidth+"px,"+e+"px,0)"},this.duration)]).catch(K).then(function(){Mt(t,{clip:""}),n.$update(r)})},getDropdown:function(e){return this.$getComponent(e,"drop")||this.$getComponent(e,"dropdown")}}},Ur={mixins:[Br],args:"mode",props:{mode:String,flip:Boolean,overlay:Boolean},data:{mode:"slide",flip:!1,overlay:!1,clsPage:"uk-offcanvas-page",clsContainer:"uk-offcanvas-container",selPanel:".uk-offcanvas-bar",clsFlip:"uk-offcanvas-flip",clsContainerAnimation:"uk-offcanvas-container-animation",clsSidebarAnimation:"uk-offcanvas-bar-animation",clsMode:"uk-offcanvas",clsOverlay:"uk-offcanvas-overlay",selClose:".uk-offcanvas-close"},computed:{clsFlip:function(e){var t=e.flip,n=e.clsFlip
return t?n:""},clsOverlay:function(e){var t=e.overlay,n=e.clsOverlay
return t?n:""},clsMode:function(e){var t=e.mode
return e.clsMode+"-"+t},clsSidebarAnimation:function(e){var t=e.mode,n=e.clsSidebarAnimation
return"none"===t||"reveal"===t?"":n},clsContainerAnimation:function(e){var t=e.mode,n=e.clsContainerAnimation
...
1===t.length&&(this.clientY=t[0].clientY)}},{name:"touchmove",self:!0,passive:!1,filter:function(){return this.overlay},handler:function(e){e.preventDefault()}},{name:"touchmove",passive:!1,el:function(){return this.panel},handler:function(e){if(1===e.targetTouches.length){var t=event.targetTouches[0].clientY-this.clientY,n=this.panel,r=n.scrollTop,i=n.scrollHeight,o=n.clientHeight;(o>=i||0===r&&t>0||i-r<=o&&t<0)&&e.preventDefault()}}},{name:"show",self:!0,handler:function(){"reveal"!==this.mode||Tt(this.panel.parentNode,this.clsMode)||(dt(this.panel,"<div>"),Et(this.panel.parentNode,this.clsMode)),Mt(document.documentElement,"overflowY",this.overlay?"hidden":""),Et(document.body,this.clsContainer,this.clsFlip),Mt(this.$el,"display","block"),Et(this.$el,this.clsOverlay),Et(this.panel,this.clsSidebarAnimation,"reveal"!==this.mode?this.clsMode:""),tn(document.body),Et(document.body,this.clsContainerAnimation),this.clsContainerAnimation&&(Vr().content+=",user-scalable=0")}},{name:"hide",self:!0,handler:function(){kt(document.body,this.clsContainerAnimation)
var e=this.getActive();("none"===this.mode||e&&e!==this&&e!==this.prev)&&He(this.panel,"transitionend")}},{name:"hidden",self:!0,handler:function(){var e
this.clsContainerAnimation&&((e=Vr()).content=e.content.replace(/,user-scalable=0$/,"")),"reveal"===this.mode&&mt(this.panel),kt(this.panel,this.clsSidebarAnimation,this.clsMode),kt(this.$el,this.clsOverlay),Mt(this.$el,"display",""),kt(document.body,this.clsContainer,this.clsFlip),Mt(document.documentElement,"overflowY","")}},{name:"swipeLeft swipeRight",handler:function(e){this.isToggled()&&Mn(e)&&"swipeLeft"===e.type^this.flip&&this.hide()}}]}
function Vr(){return wt('meta[name="viewport"]',document.head)||ut(document.head,'<meta name="viewport">')}var qr={mixins:[Bn],props:{selContainer:String,selContent:String},data:{selContainer:".uk-modal",selContent:".uk-modal-dialog"},computed:{container:function(e,t){return ge(t,e.selContainer)},content:function(e,t){return ge(t,e.selContent)}},connected:function(){Mt(this.$el,"minHeight",150)},update:{read:function(){return!(!this.content||!this.container)&&{current:B(Mt(this.$el,"maxHeight")),max:Math.max(150,tn(this.container)-(Zt(this.content).height-tn(this.$el)))}},write:function(e){var t=e.current,n=e.max
Mt(this.$el,"maxHeight",n),Math.round(t)!==Math.round(n)&&He(this.$el,"resize")},events:["resize"]}},Wr={props:["width","height"],connected:function(){Et(this.$el,"uk-responsive-width")},update:{read:function(){return!!(Ee(this.$el)&&this.width&&this.height)&&{width:nn(this.$el.parentNode),height:this.height}},write:function(e){tn(this.$el,J.contain({height:this.height,width:this.width},e).height)},events:["resize"]}},Yr={props:{duration:Number,offset:Number},data:{duration:1e3,offset:0},methods:{scrollTo:function(e){var t=this
e=e&&wt(e)||document.body
var n=tn(document),r=tn(window),i=Zt(e).top-this.offset
if(i+r>n&&(i=n-r),He(this.$el,"beforescroll",[this,e])){var o=Date.now(),s=window.pageYOffset,a=function(){var n,r=s+(i-s)*(n=Q((Date.now()-o)/t.duration),.5*(1-Math.cos(Math.PI*n)))
fn(window,r),r!==i?requestAnimationFrame(a):He(t.$el,"scrolled",[t,e])}
a()}}},events:{click:function(e){e.defaultPrevented||(e.preventDefault(),this.scrollTo(we(decodeURIComponent(this.$el.hash)).substr(1)))}}},Gr={args:"cls",props:{cls:"list",target:String,hidden:Boolean,offsetTop:Number,offsetLeft:Number,repeat:Boolean,delay:Number},data:function(){return{cls:[],target:!1,hidden:!0,offsetTop:0,offsetLeft:0,repeat:!1,delay:0,inViewClass:"uk-scrollspy-inview"}},computed:{elements:function(e,t){var n=e.target
return n?_t(n,t):[t]}},update:[{write:function(){this.hidden&&Mt(Oe(this.elements,":not(."+this.inViewClass+")"),"visibility","hidden")}},{read:function(e){var t=this
e.update&&this.elements.forEach(function(n,r){var i=e[r]
if(!i||i.el!==n){var o=re(n,"uk-scrollspy-class")
i={el:n,toggles:o&&o.split(",")||t.cls}}i.show=cn(n,t.offsetTop,t.offsetLeft),e[r]=i})},write:function(e){var t=this
if(!e.update)return this.$emit(),e.update=!0
this.elements.forEach(function(n,r){var i=e[r],o=i.toggles[r]||i.toggles[0]
if(!i.show||i.inview||i.queued){if(!i.show&&(i.inview||i.queued)&&t.repeat){if(i.abort&&i.abort(),!i.inview)return
Mt(n,"visibility",t.hidden?"hidden":""),kt(n,t.inViewClass),At(n,o),He(n,"outview"),t.$update(n),i.inview=!1}}else{var s=function(){Mt(n,"visibility",""),Et(n,t.inViewClass),At(n,o),He(n,"inview"),t.$update(n),i.inview=!0,i.abort&&i.abort()}
t.delay?(i.queued=!0,e.promise=(e.promise||Qe.resolve()).then(function(){return!i.inview&&new Qe(function(n){var r=setTimeout(function(){s(),n()},e.promise||1===t.elements.length?t.delay:0)
i.abort=function(){clearTimeout(r),n(),i.queued=!1}})})):s()}})},events:["scroll","resize"]}]},Qr={props:{cls:String,closest:String,scroll:Boolean,overflow:Boolean,offset:Number},data:{cls:"uk-active",closest:!1,scroll:!1,overflow:!0,offset:0},computed:{links:function(e,t){return _t('a[href^="#"]',t).filter(function(e){return e.hash})},elements:function(e){var t=e.closest
return ge(this.links,t||"*")},targets:function(){return _t(this.links.map(function(e){return e.hash}).join(","))}},update:[{read:function(){this.scroll&&this.$create("scroll",this.links,{offset:this.offset||0})}},{read:function(e){var t=this,n=window.pageYOffset+this.offset+1,r=tn(document)-tn(window)+this.offset
...
break}return!(e.active=wt(Oe(t.links,'[href="#'+i.id+'"]')))})},write:function(e){var t=e.active
this.links.forEach(function(e){return e.blur()}),kt(this.elements,this.cls),t&&He(this.$el,"active",[t,Et(this.closest?ge(t,this.closest):t,this.cls)])},events:["scroll","resize"]}]},Kr={mixins:[Bn,Lr],props:{top:null,bottom:Boolean,offset:Number,animation:String,clsActive:String,clsInactive:String,clsFixed:String,clsBelow:String,selTarget:String,widthElement:Boolean,showOnUp:Boolean,targetOffset:Number},data:{top:0,bottom:!1,offset:0,animation:"",clsActive:"uk-active",clsInactive:"",clsFixed:"uk-sticky-fixed",clsBelow:"uk-sticky-below",selTarget:"",widthElement:!1,showOnUp:!1,targetOffset:!1},computed:{selTarget:function(e,t){var n=e.selTarget
return n&&wt(n,t)||t},widthElement:function(e,t){return ie(e.widthElement,t)||this.placeholder},isActive:{get:function(){return Tt(this.selTarget,this.clsActive)},set:function(e){e&&!this.isActive?(Ot(this.selTarget,this.clsInactive,this.clsActive),He(this.$el,"active")):e||Tt(this.selTarget,this.clsInactive)||(Ot(this.selTarget,this.clsActive,this.clsInactive),He(this.$el,"inactive"))}}},connected:function(){this.placeholder=wt("+ .uk-sticky-placeholder",this.$el)||wt('<div class="uk-sticky-placeholder"></div>'),this.isFixed=!1,this.isActive=!1},disconnected:function(){this.isFixed&&(this.hide(),kt(this.selTarget,this.clsInactive)),ft(this.placeholder),this.placeholder=null,this.widthElement=null},events:[{name:"load hashchange popstate",el:window,handler:function(){var e=this
if(!1!==this.targetOffset&&location.hash&&window.pageYOffset>0){var t=wt(location.hash)
t&&vn.read(function(){var n=Zt(t).top,r=Zt(e.$el).top,i=e.$el.offsetHeight
e.isFixed&&r+i>=n&&r<=n+t.offsetHeight&&fn(window,n-i-(M(e.targetOffset)?e.targetOffset:0)-e.offset)})}}}],update:[{read:function(e,t){var n=e.height
this.isActive&&"update"!==t&&(this.hide(),n=this.$el.offsetHeight,this.show()),n=this.isActive?n:this.$el.offsetHeight,this.topOffset=Zt(this.isFixed?this.placeholder:this.$el).top,this.bottomOffset=this.topOffset+n
var r=Xr("bottom",this)
return this.top=Math.max(B(Xr("top",this)),this.topOffset)-this.offset,this.bottom=r&&r-n,this.inactive=!this.matchMedia,{lastScroll:!1,height:n,margins:Mt(this.$el,["marginTop","marginBottom","marginLeft","marginRight"])}},write:function(e){var t=e.height,n=e.margins,r=this.placeholder
Mt(r,W({height:t},n)),Te(r,document)||(ct(this.$el,r),ee(r,"hidden","")),this.isActive=this.isActive},events:["resize"]},{read:function(e){var t=e.scroll
return void 0===t&&(t=0),this.width=(Ee(this.widthElement)?this.widthElement:this.$el).offsetWidth,this.scroll=window.pageYOffset,{dir:t<=this.scroll?"down":"up",scroll:this.scroll,visible:Ee(this.$el),top:dn(this.placeholder)[0]}},write:function(e,t){var n=this,r=e.initTimestamp
void 0===r&&(r=0)
var i=e.dir,o=e.lastDir,s=e.lastScroll,a=e.scroll,u=e.top,l=e.visible,c=performance.now()
if(e.lastScroll=a,!(a<0||a===s||!l||this.disabled||this.showOnUp&&"scroll"!==t||((c-r>300||i!==o)&&(e.initScroll=a,e.initTimestamp=c),e.lastDir=i,this.showOnUp&&Math.abs(e.initScroll-a)<=30&&Math.abs(s-a)<=10)))if(this.inactive||a<this.top||this.showOnUp&&(a<=this.top||"down"===i||"up"===i&&!this.isFixed&&a<=this.bottomOffset)){if(!this.isFixed)return void(Qt.inProgress(this.$el)&&u>a&&(Qt.cancel(this.$el),this.hide()))
this.isFixed=!1,this.animation&&a>this.topOffset?(Qt.cancel(this.$el),Qt.out(this.$el,this.animation).then(function(){return n.hide()},K)):this.hide()}else this.isFixed?this.update():this.animation?(Qt.cancel(this.$el),this.show(),Qt.in(this.$el,this.animation).catch(K)):this.show()},events:["resize","scroll"]}],methods:{show:function(){this.isFixed=!0,this.update(),ee(this.placeholder,"hidden",null)},hide:function(){this.isActive=!1,kt(this.$el,this.clsFixed,this.clsBelow),Mt(this.$el,{position:"",top:"",width:""}),ee(this.placeholder,"hidden","")},update:function(){var e=0!==this.top||this.scroll>this.top,t=Math.max(0,this.offset)
this.bottom&&this.scroll>this.bottom-this.offset&&(t=this.bottom-this.scroll),Mt(this.$el,{position:"fixed",top:t+"px",width:this.width}),this.isActive=e,At(this.$el,this.clsBelow,this.scroll>this.bottomOffset),Et(this.$el,this.clsFixed)}}}
function Xr(e,t){var n=t.$props,r=t.$el,i=t[e+"Offset"],o=n[e]
if(o){if(M(o))return i+B(o)
if(R(o)&&o.match(/^-?\d+vh$/))return tn(window)*B(o)/100
var s=!0===o?r.parentNode:ie(o,r)
return s?Zt(s).top+s.offsetHeight:void 0}}var Zr={mixins:[zn],args:"connect",props:{connect:String,toggle:String,active:Number,swiping:Boolean},data:{connect:"~.uk-switcher",toggle:"> * > :first-child",active:0,swiping:!0,cls:"uk-active",clsContainer:"uk-switcher",attrItem:"uk-switcher-item",queued:!0},computed:{connects:function(e,t){return oe(e.connect,t)},toggles:function(e,t){return _t(e.toggle,t)}},events:[{name:"click",delegate:function(){return this.toggle+":not(.uk-disabled)"},handler:function(e){e.preventDefault(),this.show(F(this.$el.children).filter(function(t){return Te(e.current,t)})[0])}},{name:"click",el:function(){return this.connects},delegate:function(){return"["+this.attrItem+"],[data-"+this.attrItem+"]"},handler:function(e){e.preventDefault(),this.show(re(e.current,this.attrItem))}},{name:"swipeRight swipeLeft",filter:function(){return this.swiping},el:function(){return this.connects},handler:function(e){Mn(e)&&(e.preventDefault(),window.getSelection().toString()||this.show("swipeLeft"===e.type?"next":"previous"))}}],update:function(){var e=this
this.connects.forEach(function(t){return e.updateAria(t.children)})
var t=this.$el.children
this.show(Oe(t,"."+this.cls)[0]||t[this.active]||t[0])},methods:{index:function(){return!!this.connects.length&&it(Oe(this.connects[0].children,"."+this.cls)[0])},show:function(e){for(var t,n,r=this,i=this.$el.children,o=i.length,s=this.index(),a=s>=0,u="previous"===e?-1:1,l=ot(e,i,s),c=0;c<o;c++,l=(l+u+o)%o)if(!me(this.toggles[l],".uk-disabled *, .uk-disabled, [disabled]")){t=this.toggles[l],n=i[l]
break}!n||s>=0&&Tt(n,this.cls)||s===l||(kt(i,this.cls),Et(n,this.cls),ee(this.toggles,"aria-expanded",!1),ee(t,"aria-expanded",!0),this.connects.forEach(function(e){a?r.toggleElement([e.children[s],e.children[l]]):r.toggleNow(e.children[l])}))}}},Jr={mixins:[Bn],extends:Zr,props:{media:Boolean},data:{media:960,attrItem:"uk-tab-item"},connected:function(){var e=Tt(this.$el,"uk-tab-left")?"uk-tab-left":!!Tt(this.$el,"uk-tab-right")&&"uk-tab-right"
e&&this.$create("toggle",this.$el,{cls:e,mode:"media",media:this.media})}},ei={mixins:[Lr,zn],args:"target",props:{href:String,target:null,mode:"list"},data:{href:!1,target:!1,mode:"click",queued:!0},computed:{target:function(e,t){var n=e.href,r=e.target
return(r=oe(r||n,t)).length&&r||[t]}},connected:function(){He(this.target,"updatearia",[this])},events:[{name:je+" "+De,filter:function(){return w(this.mode,"hover")},handler:function(e){Mn(e)||this.toggle("toggle"+(e.type===je?"show":"hide"))}},{name:"click",filter:function(){return w(this.mode,"click")||Re&&w(this.mode,"hover")},handler:function(e){var t;(Mn(e)||w(this.mode,"click"))&&((ge(e.target,'a[href="#"], a[href=""], button')||(t=ge(e.target,"a[href]"))&&(this.cls||!Ee(this.target)||t.hash&&me(this.target,t.hash)))&&e.preventDefault(),this.toggle())}}],update:{write:function(){if(w(this.mode,"media")&&this.media){var e=this.isToggled(this.target);(this.matchMedia?!e:e)&&this.toggle()}},events:["resize"]},methods:{toggle:function(e){He(this.target,e||"toggle",[this])&&this.toggleElement(this.target)}}}
Dn.version="3.0.3",function(e){e.component("accordion",$n),e.component("alert",Fn),e.component("cover",Wn),e.component("drop",Gn),e.component("dropdown",Qn),e.component("formCustom",Kn),e.component("gif",Xn),e.component("grid",tr),e.component("heightMatch",rr),e.component("heightViewport",sr),e.component("icon",pr),e.component("img",wr),e.component("leader",jr),e.component("margin",Zn),e.component("modal",$r),e.component("nav",Fr),e.component("navbar",Hr),e.component("offcanvas",Ur),e.component("overflowAuto",qr),e.component("responsive",Wr),e.component("scroll",Yr),e.component("scrollspy",Gr),e.component("scrollspyNav",Qr),e.component("sticky",Kr),e.component("svg",lr),e.component("switcher",Zr),e.component("tab",Jr),e.component("toggle",ei),e.component("video",qn),e.component("close",br),e.component("marker",mr),e.component("navbarToggleIcon",mr),e.component("overlayIcon",mr),e.component("paginationNext",mr),e.component("paginationPrevious",mr),e.component("searchIcon",gr),e.component("slidenavNext",vr),e.component("slidenavPrevious",vr),e.component("spinner",yr),e.component("totop",mr),e.use(Hn)}(Dn)
var ti,ni={mixins:[Bn],props:{date:String,clsWrapper:String},data:{date:"",clsWrapper:".uk-countdown-%unit%"},computed:{date:function(e){var t=e.date
...
ti||(ti=ut(document.head,"<style>").sheet).insertRule("."+ri+" > * {\n                    margin-top: 0 !important;\n                    transform: none !important;\n                }",0)
var n=F(this.target.children),r=n.map(function(e){return oi(e,!0)}),i=tn(this.target),o=window.pageYOffset
e(),Vt.cancel(this.target),n.forEach(Vt.cancel),si(this.target),this.$update(this.target),vn.flush()
var s=tn(this.target),a=(n=n.concat(F(this.target.children).filter(function(e){return!w(n,e)}))).map(function(e,t){return!!(e.parentNode&&t in r)&&(r[t]?Ee(e)?ai(e):{opacity:0}:{opacity:Ee(e)?1:0})})
return r=a.map(function(e,i){var o=n[i].parentNode===t.target&&(r[i]||oi(n[i]))
if(o)if(e){if(!("opacity"in e))o.opacity%1?e.opacity=1:delete o.opacity}else delete o.opacity
return o}),Et(this.target,ri),n.forEach(function(e,t){return r[t]&&Mt(e,r[t])}),Mt(this.target,"height",i),fn(window,o),Qe.all(n.map(function(e,n){return r[n]&&a[n]?Vt.start(e,a[n],t.animation,"ease"):Qe.resolve()}).concat(Vt.start(this.target,{height:s},this.animation,"ease"))).then(function(){n.forEach(function(e,t){return Mt(e,{display:0===a[t].opacity?"none":"",zIndex:""})}),si(t.target),t.$update(t.target),vn.flush()},K)}}}
function oi(e,t){var n=Mt(e,"zIndex")
return!!Ee(e)&&W({display:"",opacity:t?Mt(e,"opacity"):"0",pointerEvents:"none",position:"absolute",zIndex:"auto"===n?it(e):n},ai(e))}function si(e){Mt(e.children,{height:"",left:"",opacity:"",pointerEvents:"",position:"",top:"",width:""}),kt(e,ri),Mt(e,"height","")}function ai(e){var t=e.getBoundingClientRect(),n=t.height,r=t.width,i=en(e),o=i.top,s=i.left
return{top:o+=B(Mt(e,"marginTop")),left:s,height:n,width:r}}var ui={mixins:[ii],args:"target",props:{target:Boolean,selActive:Boolean},data:{target:null,selActive:!1,attrItem:"uk-filter-control",cls:"uk-active",animation:250},computed:{toggles:{get:function(e,t){return e.attrItem,_t("["+this.attrItem+"],[data-"+this.attrItem+"]",t)},watch:function(){this.setState(this.getState(),!1)}},target:function(e,t){return wt(e.target,t)},children:{get:function(){return F(this.target.children)},watch:function(e,t){var n,r
r=t,(n=e).length===r.length&&n.every(function(e){return~r.indexOf(e)})||this.updateState()}}},events:[{name:"click",delegate:function(){return"["+this.attrItem+"],[data-"+this.attrItem+"]"},handler:function(e){e.preventDefault(),this.apply(e.current)}}],connected:function(){var e=this
if(!1!==this.selActive){var t=_t(this.selActive,this.$el)
this.toggles.forEach(function(n){return At(n,e.cls,w(t,n))})}},methods:{apply:function(e){this.setState(ci(e,this.attrItem,this.getState()))},getState:function(){var e=this
return this.toggles.filter(function(t){return Tt(t,e.cls)}).reduce(function(t,n){return ci(n,e.attrItem,t)},{filter:{"":""},sort:[]})},setState:function(e,t){var n=this
void 0===t&&(t=!0),e=W({filter:{"":""},sort:[]},e),He(this.$el,"beforeFilter",[this,e])
var r=this.children
this.toggles.forEach(function(t){return At(t,n.cls,function(e,t,n){var r=n.filter
void 0===r&&(r={"":""})
var i=n.sort,o=i[0],s=i[1],a=li(e,t),u=a.filter,l=a.group
void 0===l&&(l="")
var c=a.sort,h=a.order
return void 0===h&&(h="asc"),u=L(c)?u||"":u,c=L(u)?c||"":c,(L(u)||l in r&&u===r[l])&&(L(c)||o===c&&s===h)}(t,n.attrItem,e))})
var i=function(){var t=function(e){var t=e.filter,n=""
return Y(t,function(e){return n+=e||""}),n}(e)
r.forEach(function(e){return Mt(e,"display",t&&!me(e,t)?"none":"")})
var i=e.sort,o=i[0],s=i[1]
if(o){var a=function(e,t,n){return W([],r).sort(function(e,r){return re(e,t).localeCompare(re(r,t),void 0,{numeric:!0})*("asc"===n||-1)})}(0,o,s)
V(a,r)||a.forEach(function(e){return ut(n.target,e)})}}
t?this.animate(i).then(function(){return He(n.$el,"afterFilter",[n])}):(i(),He(this.$el,"afterFilter",[this]))},updateState:function(){this.setState(this.getState(),!1)}}}
function li(e,t){return On(re(e,t),["filter"])}function ci(e,t,n){return F(e).forEach(function(e){var r=li(e,t),i=r.filter,o=r.group,s=r.sort,a=r.order
void 0===a&&(a="asc"),(i||L(s))&&(o?(delete n.filter[""],n.filter[o]=i):n.filter={"":i||""}),L(s)||(n.sort=[s,a])}),n}var hi={slide:{show:function(e){return[{transform:di(-100*e)},{transform:di()}]},percent:function(e){return fi(e)},translate:function(e,t){return[{transform:di(-100*t*e)},{transform:di(100*t*(1-e))}]}}}
function fi(e){return Math.abs(Mt(e,"transform").split(",")[4]/e.offsetWidth)||0}function di(e,t){return void 0===e&&(e=0),void 0===t&&(t="%"),"translateX("+e+(e?t:"")+")"}function pi(e){return"scale3d("+e+", "+e+", 1)"}var mi=W({},hi,{fade:{show:function(){return[{opacity:0},{opacity:1}]},percent:function(e){return 1-Mt(e,"opacity")},translate:function(e){return[{opacity:1-e},{opacity:e}]}},scale:{show:function(){return[{opacity:0,transform:pi(.8)},{opacity:1,transform:pi(1)}]},percent:function(e){return 1-Mt(e,"opacity")},translate:function(e){return[{opacity:1-e,transform:pi(1-.2*e)},{opacity:e,transform:pi(.8+.2*e)}]}}})
function vi(e,t,n){He(e,Ue(t,!1,!1,n))}var gi={mixins:[{props:{autoplay:Boolean,autoplayInterval:Number,pauseOnHover:Boolean},data:{autoplay:!1,autoplayInterval:7e3,pauseOnHover:!0},connected:function(){this.startAutoplay(),this.userInteracted=!1},disconnected:function(){this.stopAutoplay()},events:[{name:"visibilitychange",el:document,handler:function(){document.hidden?this.stopAutoplay():!this.userInteracted&&this.startAutoplay()}},{name:Ie,handler:function(){this.userInteracted=!0,this.stopAutoplay()}},{name:"mouseenter",filter:function(){return this.autoplay},handler:function(){this.isHovering=!0}},{name:"mouseleave",filter:function(){return this.autoplay},handler:function(){this.isHovering=!1}}],methods:{startAutoplay:function(){var e=this
this.stopAutoplay(),this.autoplay&&(this.interval=setInterval(function(){return!(e.isHovering&&e.pauseOnHover)&&!e.stack.length&&e.show("next")},this.autoplayInterval))},stopAutoplay:function(){this.interval&&clearInterval(this.interval)}}},{props:{draggable:Boolean},data:{draggable:!0,threshold:10},created:function(){var e=this;["start","move","end"].forEach(function(t){var n=e[t]
e[t]=function(t){var r=Ln(t).x*(Se?-1:1)
e.prevPos=r!==e.pos?e.pos:e.prevPos,e.pos=r,n(t)}})},events:[{name:Ie,delegate:function(){return this.selSlides},handler:function(e){var t
!this.draggable||!Mn(e)&&!(t=e.target).children.length&&t.childNodes.length||e.button>0||this.length<2||this.start(e)}},{name:"touchmove",passive:!1,handler:"move",delegate:function(){return this.selSlides}},{name:"dragstart",handler:function(e){e.preventDefault()}}],methods:{start:function(){var e=this
this.drag=this.pos,this._transitioner?(this.percent=this._transitioner.percent(),this.drag+=this._transitioner.getDistance()*this.percent*this.dir,this._transitioner.cancel(),this._transitioner.translate(this.percent),this.dragging=!0,this.stack=[]):this.prevIndex=this.index
var t="touchmove"!==Me?ze(document,Me,this.move,{passive:!1}):K
this.unbindMove=function(){t(),e.unbindMove=null},ze(window,"scroll",this.unbindMove),ze(document,Le,this.end,!0)},move:function(e){var t=this
if(this.unbindMove){var n=this.pos-this.drag
if(!(0===n||this.prevPos===this.pos||!this.dragging&&Math.abs(n)<this.threshold)){e.cancelable&&e.preventDefault(),this.dragging=!0,this.dir=n<0?1:-1
for(var r=this.slides,i=this.prevIndex,o=Math.abs(n),s=this.getIndex(i+this.dir,i),a=this._getDistance(i,s)||r[i].offsetWidth;s!==i&&o>a;)this.drag-=a*this.dir,i=s,o-=a,s=this.getIndex(i+this.dir,i),a=this._getDistance(i,s)||r[i].offsetWidth
this.percent=o/a
var u,l=r[i],c=r[s],h=this.index!==s,f=i===s;[this.index,this.prevIndex].filter(function(e){return!w([s,i],e)}).forEach(function(e){He(r[e],"itemhidden",[t]),f&&(u=!0,t.prevIndex=i)}),(this.index===i&&this.prevIndex!==i||u)&&He(r[this.index],"itemshown",[this]),h&&(this.prevIndex=i,this.index=s,!f&&He(l,"beforeitemhide",[this]),He(c,"beforeitemshow",[this])),this._transitioner=this._translate(Math.abs(this.percent),l,!f&&c),h&&(!f&&He(l,"itemhide",[this]),He(c,"itemshow",[this]))}}},end:function(){if($e(window,"scroll",this.unbindMove),this.unbindMove&&this.unbindMove(),$e(document,Le,this.end,!0),this.dragging){if(this.dragging=null,this.index===this.prevIndex)this.percent=1-this.percent,this.dir*=-1,this._show(!1,this.index,!0),this._transitioner=null
else{var e=(Se?this.dir*(Se?1:-1):this.dir)<0==this.prevPos>this.pos
this.index=e?this.index:this.prevIndex,e&&(this.percent=1-this.percent),this.show(this.dir>0&&!e||this.dir<0&&e?"next":"previous",!0)}Ge()}this.drag=this.percent=null}}},{data:{selNav:!1},computed:{nav:function(e,t){return wt(e.selNav,t)},selNavItem:function(e){var t=e.attrItem
return"["+t+"],[data-"+t+"]"},navItems:function(e,t){return _t(this.selNavItem,t)}},update:{write:function(){var e=this
this.nav&&this.length!==this.nav.children.length&&at(this.nav,this.slides.map(function(t,n){return"<li "+e.attrItem+'="'+n+'"><a href="#"></a></li>'}).join("")),At(_t(this.selNavItem,this.$el).concat(this.nav),"uk-hidden",!this.maxIndex),this.updateNav()},events:["resize"]},events:[{name:"click",delegate:function(){return this.selNavItem},handler:function(e){e.preventDefault(),this.show(re(e.current,this.attrItem))}},{name:"itemshow",handler:"updateNav"}],methods:{updateNav:function(){var e=this,t=this.getValidIndex()
this.navItems.forEach(function(n){var r=re(n,e.attrItem)
At(n,e.clsActive,D(r)===t),At(n,"uk-invisible",e.finite&&("previous"===r&&0===t||"next"===r&&t>=e.maxIndex))})}}}],props:{clsActivated:Boolean,easing:String,index:Number,finite:Boolean,velocity:Number},data:function(){return{easing:"ease",finite:!1,velocity:1,index:0,stack:[],percent:0,clsActive:"uk-active",clsActivated:!1,Transitioner:!1,transitionOptions:{}}},computed:{duration:function(e,t){var n=e.velocity
...
if(a!==l){if(this.dir=function(e,t){return"next"===e?1:"previous"===e?-1:e<s?-1:1}(e),this.prevIndex=s,this.index=u,a&&He(a,"beforeitemhide",[this]),!He(l,"beforeitemshow",[this,a]))return this.index=this.prevIndex,void o()
var c=this._show(a,l,t).then(function(){return a&&He(a,"itemhidden",[n]),He(l,"itemshown",[n]),new Qe(function(e){vn.write(function(){r.shift(),r.length?n.show(r.shift(),!0):n._transitioner=null,e()})})})
return a&&He(a,"itemhide",[this]),He(l,"itemshow",[this]),c}o()}}},getIndex:function(e,t){return void 0===e&&(e=this.index),void 0===t&&(t=this.index),Q(ot(e,this.slides,t,this.finite),0,this.maxIndex)},getValidIndex:function(e,t){return void 0===e&&(e=this.index),void 0===t&&(t=this.prevIndex),this.getIndex(e,t)},_show:function(e,t,n){if(this._transitioner=this._getTransitioner(e,t,this.dir,W({easing:n?t.offsetWidth<600?"cubic-bezier(0.25, 0.46, 0.45, 0.94)":"cubic-bezier(0.165, 0.84, 0.44, 1)":this.easing},this.transitionOptions)),!n&&!e)return this._transitioner.translate(1),Qe.resolve()
var r=this.stack.length
return this._transitioner[r>1?"forward":"show"](r>1?Math.min(this.duration,75+75/(r-1)):this.duration,this.percent)},_getDistance:function(e,t){return new this._getTransitioner(e,e!==t&&t).getDistance()},_translate:function(e,t,n){void 0===t&&(t=this.prevIndex),void 0===n&&(n=this.index)
var r=this._getTransitioner(t!==n&&t,n)
...
void 0===i&&(i=0)
var u=s?"linear":o
return r-=Math.round(r*Q(i,-1,1)),this.translate(i),vi(t,"itemin",{percent:i,duration:r,timing:u,dir:n}),vi(e,"itemout",{percent:1-i,duration:r,timing:u,dir:n}),Qe.all([Vt.start(t,l[1],r,u),Vt.start(e,l[0],r,u)]).then(function(){a.reset(),c.resolve()},K),c.promise},stop:function(){return Vt.stop([t,e])},cancel:function(){Vt.cancel([t,e])},reset:function(){for(var n in l[0])Mt([t,e],n,"")},forward:function(n,r){return void 0===r&&(r=this.percent()),Vt.cancel([t,e]),this.show(n,r,!0)},translate:function(r){this.reset()
var i=a(r,n)
Mt(t,i[1]),Mt(e,i[0]),vi(t,"itemtranslatein",{percent:r,dir:n}),vi(e,"itemtranslateout",{percent:1-r,dir:n})},percent:function(){return s(e||t,t,n)},getDistance:function(){return e&&e.offsetWidth}}}},computed:{animation:function(e){var t=e.animation,n=e.Animations
return W(t in n?n[t]:n.slide,{name:t})},transitionOptions:function(){return{animation:this.animation}}},events:{"itemshow itemhide itemshown itemhidden":function(e){var t=e.target
this.$update(t)},itemshow:function(){I(this.prevIndex)&&vn.flush()},beforeitemshow:function(e){Et(e.target,this.clsActive)},itemshown:function(e){Et(e.target,this.clsActivated)},itemhidden:function(e){kt(e.target,this.clsActive,this.clsActivated)}}},wi={mixins:[Dr,Br,zn,yi],functional:!0,props:{delayControls:Number,preload:Number,videoAutoplay:Boolean,template:String},data:function(){return{preload:1,videoAutoplay:!1,delayControls:3e3,items:[],cls:"uk-open",clsPage:"uk-lightbox-page",selList:".uk-lightbox-items",attrItem:"uk-lightbox-item",selClose:".uk-close-large",pauseOnHover:!1,velocity:2,Animations:mi,template:'<div class="uk-lightbox uk-overflow-hidden"> <ul class="uk-lightbox-items"></ul> <div class="uk-lightbox-toolbar uk-position-top uk-text-right uk-transition-slide-top uk-transition-opaque"> <button class="uk-lightbox-toolbar-icon uk-close-large" type="button" uk-close></button> </div> <a class="uk-lightbox-button uk-position-center-left uk-position-medium uk-transition-fade" href="#" uk-slidenav-previous uk-lightbox-item="previous"></a> <a class="uk-lightbox-button uk-position-center-right uk-position-medium uk-transition-fade" href="#" uk-slidenav-next uk-lightbox-item="next"></a> <div class="uk-lightbox-toolbar uk-lightbox-caption uk-position-bottom uk-text-center uk-transition-slide-bottom uk-transition-opaque"></div> </div>'}},created:function(){var e=this
this.$mount(ut(this.container,this.template)),this.caption=wt(".uk-lightbox-caption",this.$el),this.items.forEach(function(){return ut(e.list,"<li></li>")})},events:[{name:Me+" "+Ie+" keydown",handler:"showControls"},{name:Le,self:!0,delegate:function(){return this.selSlides},handler:function(e){e.preventDefault(),this.hide()}},{name:"shown",self:!0,handler:function(){this.startAutoplay(),this.showControls()}},{name:"hide",self:!0,handler:function(){this.stopAutoplay(),this.hideControls(),kt(this.slides,this.clsActive),Vt.stop(this.slides)}},{name:"hidden",self:!0,handler:function(){this.$destroy(!0)}},{name:"keyup",el:document,handler:function(e){if(this.isToggled(this.$el))switch(e.keyCode){case 37:this.show("previous")
break
...
for(var r=0;r<=this.preload;r++)this.loadItem(this.getIndex(t+r)),this.loadItem(this.getIndex(t-r))}},{name:"itemshown",handler:function(){this.draggable=this.$props.draggable}},{name:"itemload",handler:function(e,t){var n,r=this,i=t.source,o=t.type,s=t.alt
if(this.setItem(t,"<span uk-spinner></span>"),i)if("image"===o||i.match(/\.(jp(e)?g|png|gif|svg)($|\?)/i))nt(i).then(function(e){return r.setItem(t,'<img width="'+e.width+'" height="'+e.height+'" src="'+i+'" alt="'+(s||"")+'">')},function(){return r.setError(t)})
...
ee(a,"src",i),Fe(a,"error loadedmetadata",function(e){"error"===e?r.setError(t):(ee(a,{width:a.videoWidth,height:a.videoHeight}),r.setItem(t,a))})}else if("iframe"===o||i.match(/\.(html|php)($|\?)/i))this.setItem(t,'<iframe class="uk-lightbox-iframe" src="'+i+'" frameborder="0" allowfullscreen></iframe>')
...
nt("https://img.youtube.com/vi/"+u+"/maxresdefault.jpg").then(function(e){var t=e.width,n=e.height
120===t&&90===n?nt("https://img.youtube.com/vi/"+u+"/0.jpg").then(function(e){var t=e.width,n=e.height
return l(t,n)},l):l(t,n)},l)}else(n=i.match(/(\/\/.*?)vimeo\.[a-z]+\/([0-9]+).*?/))&&tt("https://vimeo.com/api/oembed.json?maxwidth=1920&url="+encodeURI(i),{responseType:"json",withCredentials:!1}).then(function(e){var i=e.response,o=i.height,s=i.width
...
var t=this.getItem(e)
t.content||He(this.$el,"itemload",[t])},getItem:function(e){return void 0===e&&(e=this.index),this.items[e]||{}},setItem:function(e,t){W(e,{content:t})
var n=at(this.slides[this.items.indexOf(e)],t)
He(this.$el,"itemloaded",[this,n]),this.$update(n)},setError:function(e){this.setItem(e,'<span uk-icon="icon: bolt; ratio: 2"></span>')},showControls:function(){clearTimeout(this.controlsTimer),this.controlsTimer=setTimeout(this.hideControls,this.delayControls),Et(this.$el,"uk-active","uk-transition-active")},hideControls:function(){kt(this.$el,"uk-active","uk-transition-active")}}}
function _i(e,t,n,r){return'<iframe src="'+e+'" width="'+t+'" height="'+n+'" style="max-width: 100%; box-sizing: border-box;" frameborder="0" allowfullscreen uk-video="autoplay: '+r+'" uk-responsive></iframe>'}var xi,Ei={install:function(e,t){e.lightboxPanel||e.component("lightboxPanel",wi),W(t.props,e.component("lightboxPanel").options.props)},props:{toggle:String},data:{toggle:"a"},computed:{toggles:{get:function(e,t){return _t(e.toggle,t)},watch:function(){this.hide()}}},disconnected:function(){this.hide()},events:[{name:"click",delegate:function(){return this.toggle+":not(.uk-disabled)"},handler:function(e){e.preventDefault(),this.show(it(this.toggles,e.current))}}],methods:{show:function(e){var t=this
return this.panel=this.panel||this.$create("lightboxPanel",W({},this.$props,{items:this.toggles.reduce(function(e,t){return e.push(["href","caption","type","poster","alt"].reduce(function(e,n){return e["href"===n?"source":n]=re(t,n),e},{})),e},[])})),ze(this.panel.$el,"hidden",function(){return t.panel=!1}),this.panel.show(e)},hide:function(){return this.panel&&this.panel.hide()}}},ki={},Ci={functional:!0,args:["message","status"],data:{message:"",status:"",timeout:5e3,group:null,pos:"top-center",clsClose:"uk-notification-close",clsMsg:"uk-notification-message"},install:function(e){e.notification.closeAll=function(t,n){yt(document.body,function(r){var i=e.getComponent(r,"notification")
...
Vt.start(Mt(this.$el,this.startProps),(e={opacity:1},e[this.marginProp]=n,e)).then(function(){t.timeout&&(t.timer=setTimeout(t.close,t.timeout))})},events:(xi={click:function(e){ge(e.target,'a[href="#"],a[href=""]')&&e.preventDefault(),this.close()}},xi[je]=function(){this.timer&&clearTimeout(this.timer)},xi[De]=function(){this.timeout&&(this.timer=setTimeout(this.close,this.timeout))},xi),methods:{close:function(e){var t=this,n=function(){He(t.$el,"close",[t]),ft(t.$el),ki[t.pos].children.length||Mt(ki[t.pos],"display","none")}
this.timer&&clearTimeout(this.timer),e?n():Vt.start(this.$el,this.startProps).then(n)}}},Oi=["x","y","bgx","bgy","rotate","scale","color","backgroundColor","borderColor","opacity","blur","hue","grayscale","invert","saturate","sepia","fopacity"],Ti={mixins:[Lr],props:Oi.reduce(function(e,t){return e[t]="list",e},{}),data:Oi.reduce(function(e,t){return e[t]=void 0,e},{}),computed:{props:function(e,t){var n=this
return Oi.reduce(function(r,i){if(L(e[i]))return r
var o,s,a,u=i.match(/color/i),l=u||"opacity"===i,c=e[i].slice(0)
l&&Mt(t,i,""),c.length<2&&c.unshift(("scale"===i?1:l?Mt(t,i):0)||0)
var h=w(c.join(""),"%")?"%":"px"
if(u){var f=t.style.color
c=c.map(function(e){return Mt(Mt(t,"color",e),"color").split(/[(),]/g).slice(1,-1).concat(1).slice(0,4).map(function(e){return B(e)})}),t.style.color=f}else c=c.map(B)
if(i.match(/^bg/))if(Mt(t,"background-position-"+i[2],""),s=Mt(t,"backgroundPosition").split(" ")["x"===i[2]?0:1],n.covers){var d=Math.min.apply(Math,c),p=Math.max.apply(Math,c),m=c.indexOf(d)<c.indexOf(p)
a=p-d,c=c.map(function(e){return e-(m?d:p)}),o=(m?-a:0)+"px"}else o=s
return r[i]={steps:c,unit:h,pos:o,bgPos:s,diff:a},r},{})},bgProps:function(){var e=this
...
if(n){var r=new Image
r.src=n,e.image=r,r.naturalWidth||(r.onload=function(){return t.$emit()})}}var i=e.image
if(i&&i.naturalWidth){var o={width:this.$el.offsetWidth,height:this.$el.offsetHeight},s={width:i.naturalWidth,height:i.naturalHeight},a=J.cover(s,o)
this.bgProps.forEach(function(e){var n=t.props[e],r=n.diff,i=n.bgPos,u=n.steps,l="bgy"===e?"height":"width",c=a[l]-o[l]
if(i.match(/%$|0px/)){if(c<r)o[l]=a[l]+r-c
else if(c>r){var h=parseFloat(i)
h&&(t.props[e].steps=u.map(function(e){return e-(c-r)/(100/h)}))}a=J.cover(s,o)}}),e.dim=a}}},write:function(e){var t=e.dim
e.active?t&&Mt(this.$el,{backgroundSize:t.width+"px "+t.height+"px",backgroundRepeat:"no-repeat"}):Mt(this.$el,{backgroundSize:"",backgroundRepeat:""})},events:["resize"]},methods:{reset:function(){var e=this
Y(this.getCss(0),function(t,n){return Mt(e.$el,n,"")})},getCss:function(e){var t=this.props,n=!1
return Object.keys(t).reduce(function(r,i){var o=t[i],s=o.steps,a=o.unit,u=o.pos,l=Si(s,e)
switch(i){case"x":case"y":if(n)break
var c=["x","y"].map(function(n){return i===n?B(l).toFixed(0)+a:t[n]?Si(t[n].steps,e,1)+t[n].unit:0}),h=c[0],f=c[1]
n=r.transform+=" translate3d("+h+", "+f+", 0)"
break
case"rotate":r.transform+=" rotate("+l+"deg)"
break
...
case"bgy":case"bgx":r["background-position-"+i[2]]="calc("+u+" + "+(l+a)+")"
break
case"color":case"backgroundColor":case"borderColor":var d=Ai(s,e),p=d[0],m=d[1],v=d[2]
r[i]="rgba("+p.map(function(e,t){return e+=v*(m[t]-e),3===t?B(e):parseInt(e,10)}).join(",")+")"
break
case"blur":r.filter+=" blur("+l+"px)"
break
case"hue":r.filter+=" hue-rotate("+l+"deg)"
...
return function e(t){return t?"offsetTop"in t?t:e(t.parentNode):document.body}(n&&ie(n,t)||t)}},update:{read:function(e,t){var n=e.percent
if("scroll"!==t&&(n=!1),e.active){var r=n
return{percent:n=function(e,t){return Q(e*(1-(t-t*e)))}(hn(this.target)/(this.viewport||1),this.easing),style:r!==n&&this.getCss(n)}}},write:function(e){var t=e.style
e.active?t&&Mt(this.$el,t):this.reset()},events:["scroll","resize"]}},Ni={update:{write:function(){if(!this.stack.length&&!this.dragging){var e=this.getValidIndex()
delete this.index,kt(this.slides,this.clsActive,this.clsActivated),this.show(e)}},events:["resize"]}}
function Ri(e,t,n){var r=Li(e,t)
return n?r-function(e,t){return ji(t).width/2-ji(e).width/2}(e,t):Math.min(r,Ii(t))}function Ii(e){return Math.max(0,Mi(e)-ji(e).width)}function Mi(e){return Bi(e).reduce(function(e,t){return ji(t).width+e},0)}function Li(e,t){return(en(e).left+(Se?ji(e).width-ji(t).width:0))*(Se?-1:1)}function ji(e){return e.getBoundingClientRect()}function Di(e,t,n){He(e,Ue(t,!1,!1,n))}function Bi(e){return F(e.children)}var zi={mixins:[Bn,gi,Ni],props:{center:Boolean,sets:Boolean},data:{center:!1,sets:!1,attrItem:"uk-slider-item",selList:".uk-slider-items",selNav:".uk-slider-nav",clsContainer:"uk-slider-container",Transitioner:function(e,t,n,r){var i=r.center,o=r.easing,s=r.list,a=new Ke,u=e?Ri(e,s,i):Ri(t,s,i)+ji(t).width*n,l=t?Ri(t,s,i):u+ji(e).width*n*(Se?-1:1)
return{dir:n,show:function(t,r,i){void 0===r&&(r=0)
var u=i?"linear":o
return t-=Math.round(t*Q(r,-1,1)),this.translate(r),e&&this.updateTranslates(),r=e?r:Q(r,0,1),Di(this.getItemIn(),"itemin",{percent:r,duration:t,timing:u,dir:n}),e&&Di(this.getItemIn(!0),"itemout",{percent:1-r,duration:t,timing:u,dir:n}),Vt.start(s,{transform:di(-l*(Se?-1:1),"px")},t,u).then(a.resolve,K),a.promise},stop:function(){return Vt.stop(s)},cancel:function(){Vt.cancel(s)},reset:function(){Mt(s,"transform","")},forward:function(e,t){return void 0===t&&(t=this.percent()),Vt.cancel(s),this.show(e,t,!0)},translate:function(t){var r=this.getDistance()*n*(Se?-1:1)
Mt(s,"transform",di(Q(r-r*t-l,-Mi(s),ji(s).width)*(Se?-1:1),"px")),this.updateTranslates(),e&&(t=Q(t,-1,1),Di(this.getItemIn(),"itemtranslatein",{percent:t,dir:n}),Di(this.getItemIn(!0),"itemtranslateout",{percent:1-t,dir:n}))},percent:function(){return Math.abs((Mt(s,"transform").split(",")[4]*(Se?-1:1)+u)/(l-u))},getDistance:function(){return Math.abs(l-u)},getItemIn:function(t){void 0===t&&(t=!1)
var r=this.getActives(),i=G(Bi(s),"offsetLeft"),o=it(i,r[n*(t?-1:1)>0?r.length-1:0])
return~o&&i[o+(e&&!t?n:0)]},getActives:function(){var n=Ri(e||t,s,i)
return G(Bi(s).filter(function(e){var t=Li(e,s)
...
return(n=n&&this.slides.reduce(function(e,n,a){var u=ji(n).width
if(s+u>i&&(!t.center&&a>t.maxIndex&&(a=t.maxIndex),!w(e,a))){var l=t.slides[a+1]
t.center&&l&&u<o-ji(l).width/2?o-=u:(o=r,e.push(a),i=s+r+(t.center?u/2:0))}return s+=u,e},[]))&&n.length&&n},transitionOptions:function(){return{center:this.center,list:this.list}}},connected:function(){At(this.$el,this.clsContainer,!wt("."+this.clsContainer,this.$el))},update:{write:function(){var e=this
_t("["+this.attrItem+"],[data-"+this.attrItem+"]",this.$el).forEach(function(t){var n=re(t,e.attrItem)
e.maxIndex&&At(t,"uk-hidden",M(n)&&(e.sets&&!w(e.sets,B(n))||n>e.maxIndex))})},events:["resize"]},events:{beforeitemshow:function(e){!this.dragging&&this.sets&&this.stack.length<2&&!w(this.sets,this.index)&&(this.index=this.getValidIndex())
var t=Math.abs(this.index-this.prevIndex+(this.dir>0&&this.index<this.prevIndex||this.dir<0&&this.index>this.prevIndex?(this.maxIndex+1)*this.dir:0))
if(!this.dragging&&t>1){for(var n=0;n<t;n++)this.stack.splice(1,0,this.dir>0?"next":"previous")
...
this.slides.forEach(function(n){return At(n,e.clsActive,w(t,n))}),(!this.sets||w(this.sets,B(this.index)))&&this.slides.forEach(function(n){return At(n,e.clsActivated,w(t,n))})}},methods:{reorder:function(){var e=this
if(Mt(this.slides,"order",""),!this.finite){var t=this.dir>0&&this.slides[this.prevIndex]?this.prevIndex:this.index
if(this.slides.forEach(function(n,r){return Mt(n,"order",e.dir>0&&r<t?1:e.dir<0&&r>=e.index?-1:"")}),this.center)for(var n=this.slides[t],r=ji(this.list).width/2-ji(n).width/2,i=0;r>0;){var o=this.getIndex(--i+t,t),s=this.slides[o]
Mt(s,"order",o>t?-2:-1),r-=ji(s).width}}},getValidIndex:function(e,t){if(void 0===e&&(e=this.index),void 0===t&&(t=this.prevIndex),e=this.getIndex(e,t),!this.sets)return e
var n
do{if(w(this.sets,e))return e
n=e,e=this.getIndex(e+this.dir,t)}while(e!==n)
return e}}},$i={mixins:[Ti],data:{selItem:"!li"},computed:{item:function(e,t){return ie(e.selItem,t)}},events:[{name:"itemshown",self:!0,el:function(){return this.item},handler:function(){Mt(this.$el,this.getCss(.5))}},{name:"itemin itemout",self:!0,el:function(){return this.item},handler:function(e){var t=e.type,n=e.detail,r=n.percent,i=n.duration,o=n.timing,s=n.dir
Vt.cancel(this.$el),Mt(this.$el,this.getCss(Hi(t,s,r))),Vt.start(this.$el,this.getCss(Fi(t)?.5:s>0?1:0),i,o).catch(K)}},{name:"transitioncanceled transitionend",self:!0,el:function(){return this.item},handler:function(){Vt.cancel(this.$el)}},{name:"itemtranslatein itemtranslateout",self:!0,el:function(){return this.item},handler:function(e){var t=e.type,n=e.detail,r=n.percent,i=n.dir
Vt.cancel(this.$el),Mt(this.$el,this.getCss(Hi(t,i,r)))}}]}
function Fi(e){return v(e,"in")}function Hi(e,t,n){return n/=2,Fi(e)?t<0?1-n:n:t<0?n:1-n}var Ui,Vi=W({},hi,{fade:{show:function(){return[{opacity:0,zIndex:0},{zIndex:-1}]},percent:function(e){return 1-Mt(e,"opacity")},translate:function(e){return[{opacity:1-e,zIndex:0},{zIndex:-1}]}},scale:{show:function(){return[{opacity:0,transform:pi(1.5),zIndex:0},{zIndex:-1}]},percent:function(e){return 1-Mt(e,"opacity")},translate:function(e){return[{opacity:1-e,transform:pi(1+.5*e),zIndex:0},{zIndex:-1}]}},pull:{show:function(e){return e<0?[{transform:di(30),zIndex:-1},{transform:di(),zIndex:0}]:[{transform:di(-100),zIndex:0},{transform:di(),zIndex:-1}]},percent:function(e,t,n){return n<0?1-fi(t):fi(e)},translate:function(e,t){return t<0?[{transform:di(30*e),zIndex:-1},{transform:di(-100*(1-e)),zIndex:0}]:[{transform:di(100*-e),zIndex:0},{transform:di(30*(1-e)),zIndex:-1}]}},push:{show:function(e){return e<0?[{transform:di(100),zIndex:0},{transform:di(),zIndex:-1}]:[{transform:di(-30),zIndex:-1},{transform:di(),zIndex:0}]},percent:function(e,t,n){return n>0?1-fi(t):fi(e)},translate:function(e,t){return t<0?[{transform:di(100*e),zIndex:0},{transform:di(-30*(1-e)),zIndex:-1}]:[{transform:di(-30*e),zIndex:-1},{transform:di(100*(1-e)),zIndex:0}]}}}),qi={mixins:[Bn,yi,Ni],props:{ratio:String,minHeight:Boolean,maxHeight:Boolean},data:{ratio:"16:9",minHeight:!1,maxHeight:!1,selList:".uk-slideshow-items",attrItem:"uk-slideshow-item",selNav:".uk-slideshow-nav",Animations:Vi},update:{read:function(){var e=this.ratio.split(":").map(Number),t=e[0],n=e[1]
...
Mt(this.list,"minHeight",t)},events:["resize"]}},Wi={mixins:[Bn,ii],props:{group:String,threshold:Number,clsItem:String,clsPlaceholder:String,clsDrag:String,clsDragState:String,clsBase:String,clsNoDrag:String,clsEmpty:String,clsCustom:String,handle:String},data:{group:!1,threshold:5,clsItem:"uk-sortable-item",clsPlaceholder:"uk-sortable-placeholder",clsDrag:"uk-sortable-drag",clsDragState:"uk-drag",clsBase:"uk-sortable",clsNoDrag:"uk-sortable-nodrag",clsEmpty:"uk-sortable-empty",clsCustom:"",handle:!1},created:function(){var e=this;["init","start","move","end"].forEach(function(t){var n=e[t]
e[t]=function(t){e.scrollY=window.pageYOffset
var r=Ln(t,"page"),i=r.x,o=r.y
e.pos={x:i,y:o},n(t)}})},events:{name:Ie,passive:!1,handler:"init"},update:{write:function(){if(this.clsEmpty&&At(this.$el,this.clsEmpty,!this.$el.children.length),Mt(this.handle?_t(this.handle,this.$el):this.$el.children,"touchAction","none"),this.drag){Zt(this.drag,{top:this.pos.y+this.origin.top,left:this.pos.x+this.origin.left})
var e,t=Zt(this.drag),n=t.top,r=n+t.height
n>0&&n<this.scrollY?e=this.scrollY-5:r<tn(document)&&r>tn(window)+this.scrollY&&(e=this.scrollY+5),e&&setTimeout(function(){return fn(window,e)},5)}}},methods:{init:function(e){var t=e.target,n=e.button,r=e.defaultPrevented,i=F(this.$el.children).filter(function(e){return Te(t,e)})[0]
!i||Ce(t)||this.handle&&!Te(t,this.handle)||n>0||Te(t,"."+this.clsNoDrag)||r||(e.preventDefault(),this.touched=[this],this.placeholder=i,this.origin=W({target:t,index:it(i)},this.pos),ze(document,Me,this.move),ze(document,Le,this.end),ze(window,"scroll",this.scroll),this.threshold||this.start(e))},start:function(e){this.drag=ut(this.$container,this.placeholder.outerHTML.replace(/^<li/i,"<div").replace(/li>$/i,"div>")),Mt(this.drag,W({boxSizing:"border-box",width:this.placeholder.offsetWidth,height:this.placeholder.offsetHeight},Mt(this.placeholder,["paddingLeft","paddingRight","paddingTop","paddingBottom"]))),ee(this.drag,"uk-no-boot",""),Et(this.drag,this.clsDrag,this.clsCustom),tn(this.drag.firstElementChild,tn(this.placeholder.firstElementChild))
var t=Zt(this.placeholder),n=t.left,r=t.top
W(this.origin,{left:n-this.pos.x,top:r-this.pos.y}),Et(this.placeholder,this.clsPlaceholder),Et(this.$el.children,this.clsItem),Et(document.documentElement,this.clsDragState),He(this.$el,"start",[this,this.placeholder]),this.move(e)},move:function(e){if(this.drag){this.$emit()
var t="mousemove"===e.type?e.target:document.elementFromPoint(this.pos.x-window.pageXOffset,this.pos.y-window.pageYOffset),n=this.getSortable(t),r=this.getSortable(this.placeholder),i=n!==r
if(n&&!Te(t,this.placeholder)&&(!i||n.group&&n.group===r.group)){if(t=n.$el===t.parentNode&&t||F(n.$el.children).filter(function(e){return Te(t,e)})[0],i)r.remove(this.placeholder)
else if(!t)return
n.insert(this.placeholder,t),w(this.touched,n)||this.touched.push(n)}}else(Math.abs(this.pos.x-this.origin.x)>this.threshold||Math.abs(this.pos.y-this.origin.y)>this.threshold)&&this.start(e)},end:function(e){if($e(document,Me,this.move),$e(document,Le,this.end),$e(window,"scroll",this.scroll),this.drag){Ge()
var t=this.getSortable(this.placeholder)
this===t?this.origin.index!==it(this.placeholder)&&He(this.$el,"moved",[this,this.placeholder]):(He(t.$el,"added",[t,this.placeholder]),He(this.$el,"removed",[this,this.placeholder])),He(this.$el,"stop",[this,this.placeholder]),ft(this.drag),this.drag=null
var n=this.touched.map(function(e){return e.clsPlaceholder+" "+e.clsItem}).join(" ")
...
var r=function(){t?!Te(e,n.$el)||function(e,t){return e.parentNode===t.parentNode&&it(e)>it(t)}(e,t)?lt(t,e):ct(t,e):ut(n.$el,e)}
this.animation?this.animate(r):r()},remove:function(e){Te(e,this.$el)&&(this.animation?this.animate(function(){return ft(e)}):ft(e))},getSortable:function(e){return e&&(this.$getComponent(e,"sortable")||this.getSortable(e.parentNode))}}},Yi=[],Gi={mixins:[Dr,zn,Yn],args:"title",props:{delay:Number,title:String},data:{pos:"top",title:"",delay:0,animation:["uk-animation-scale-up"],duration:100,cls:"uk-active",clsPos:"uk-tooltip"},beforeConnect:function(){this._hasTitle=te(this.$el,"title"),ee(this.$el,{title:"","aria-expanded":!1})},disconnected:function(){this.hide(),ee(this.$el,{title:this._hasTitle?this.title:null,"aria-expanded":null})},methods:{show:function(){var e=this
w(Yi,this)||(Yi.forEach(function(e){return e.hide()}),Yi.push(this),this._unbind=ze(document,Le,function(t){return!Te(t.target,e.$el)&&e.hide()}),clearTimeout(this.showTimer),this.showTimer=setTimeout(function(){e._show(),e.hideTimer=setInterval(function(){Ee(e.$el)||e.hide()},150)},this.delay))},hide:function(){var e=Yi.indexOf(this)
!~e||me(this.$el,"input")&&this.$el===document.activeElement||(Yi.splice(e,1),clearTimeout(this.showTimer),clearInterval(this.hideTimer),ee(this.$el,"aria-expanded",!1),this.toggleElement(this.tooltip,!1),this.tooltip&&ft(this.tooltip),this.tooltip=!1,this._unbind())},_show:function(){this.tooltip=ut(this.container,'<div class="'+this.clsPos+'" aria-expanded="true" aria-hidden> <div class="'+this.clsPos+'-inner">'+this.title+"</div> </div>"),this.positionAt(this.tooltip,this.$el),this.origin="y"===this.getAxis()?ln(this.dir)+"-"+this.align:this.align+"-"+ln(this.dir),this.toggleElement(this.tooltip,!0)}},events:(Ui={},Ui["focus "+je+" "+Ie]=function(e){e.type===Ie&&Mn(e)||this.show()},Ui.blur="hide",Ui[De]=function(e){Mn(e)||this.hide()},Ui)},Qi={props:{allow:String,clsDragover:String,concurrent:Number,maxSize:Number,method:String,mime:String,msgInvalidMime:String,msgInvalidName:String,msgInvalidSize:String,multiple:Boolean,name:String,params:Object,type:String,url:String},data:{allow:!1,clsDragover:"uk-dragover",concurrent:1,maxSize:0,method:"POST",mime:!1,msgInvalidMime:"Invalid File Type: %s",msgInvalidName:"Invalid File Name: %s",msgInvalidSize:"Invalid File Size: %s Kilobytes Max",multiple:!1,name:"files[]",params:{},type:"",url:"",abort:K,beforeAll:K,beforeSend:K,complete:K,completeAll:K,error:K,fail:K,load:K,loadEnd:K,loadStart:K,progress:K},events:{change:function(e){me(e.target,'input[type="file"]')&&(e.preventDefault(),e.target.files&&this.upload(e.target.files),e.target.value="")},drop:function(e){Xi(e)
var t=e.dataTransfer
...
if(e.length){He(this.$el,"upload",[e])
for(var n=0;n<e.length;n++){if(this.maxSize&&1e3*this.maxSize<e[n].size)return void this.fail(this.msgInvalidSize.replace("%s",this.maxSize))
...
n.push(i)}return n}(e,this.concurrent),i=function(e){var n=new FormData
for(var o in e.forEach(function(e){return n.append(t.name,e)}),t.params)n.append(o,t.params[o])
tt(t.url,{data:n,method:t.method,responseType:t.type,beforeSend:function(e){var n=e.xhr
n.upload&&ze(n.upload,"progress",t.progress),["loadStart","load","loadEnd","abort"].forEach(function(e){return ze(n,e.toLowerCase(),t[e])}),t.beforeSend(e)}}).then(function(e){t.complete(e),r.length?i(r.shift()):t.completeAll(e)},function(e){return t.error(e)})}
i(r.shift())}}}}
function Ki(e,t){return t.match(new RegExp("^"+e.replace(/\//g,"\\/").replace(/\*\*/g,"(\\/[^\\/]+)*").replace(/\*/g,"[^\\/]+").replace(/((?!\\))\?/g,"$1.")+"$","i"))}function Xi(e){e.preventDefault(),e.stopPropagation()}return Dn.component("countdown",ni),Dn.component("filter",ui),Dn.component("lightbox",Ei),Dn.component("lightboxPanel",wi),Dn.component("notification",Ci),Dn.component("parallax",Pi),Dn.component("slider",zi),Dn.component("sliderParallax",$i),Dn.component("slideshow",qi),Dn.component("slideshowParallax",$i),Dn.component("sortable",Wi),Dn.component("tooltip",Gi),Dn.component("upload",Qi),function(e){var t=e.connect,n=e.disconnect
function r(){o(document.body,t),vn.flush(),new MutationObserver(function(e){return e.forEach(i)}).observe(document,{childList:!0,subtree:!0,characterData:!0,attributes:!0}),e._initialized=!0}function i(r){var i=r.target;("attributes"!==r.type?function(e){for(var r=e.addedNodes,i=e.removedNodes,s=0;s<r.length;s++)o(r[s],t)
for(var a=0;a<i.length;a++)o(i[a],n)
return!0}(r):function(t){var n=t.target,r=t.attributeName
if("href"===r)return!0
var i=jn(r)
if(i&&i in e){if(te(n,r))return e[i](n),!0
var o=e.getComponent(n,i)
return o?(o.$destroy(),!0):void 0}}(r))&&e.update(i)}function o(e,t){if(1===e.nodeType&&!te(e,"uk-no-boot"))for(t(e),e=e.firstElementChild;e;){var n=e.nextElementSibling
