...
e.default=be})),t("@ember/-internals/bootstrap")}(),"undefined"==typeof FastBoot&&/*! UIkit 3.13.6 | https://www.getuikit.com | (c) 2014 - 2022 YOOtheme | MIT License */
...
en.util=Wr,en.data="__uikit__",en.prefix="uk-",en.options={},en.version="3.13.6",function(e){const t=e.data
let r
...
function Cn(e){return fe(e).some((e=>"absolute"===Ye(e,"position")))}var Pn={args:"target",props:{target:String,row:Boolean},data:{target:"> *",row:!0,forceHeight:!0},computed:{elements:{get(e,t){let{target:r}=e
