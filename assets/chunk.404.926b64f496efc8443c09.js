/*! For license information please see chunk.404.926b64f496efc8443c09.js.LICENSE.txt */
...
t=t.parentElement}return!1}(e,t.displayCheck)||function(t){return"DETAILS"===t.tagName&&Array.prototype.slice.apply(t.children).some((function(t){return"SUMMARY"===t.tagName}))}(e)||function(t){if(c(t)||"SELECT"===t.tagName||"TEXTAREA"===t.tagName||"BUTTON"===t.tagName)for(var e=t.parentElement;e;){if("FIELDSET"===e.tagName&&e.disabled){for(var n=0;n<e.children.length;n++){var i=e.children.item(n)
if("LEGEND"===i.tagName)return!i.contains(t)}return!0}e=e.parentElement}return!1}(e))},h=function(t,e){return!(!l(t,e)||function(t){return function(t){return c(t)&&"radio"===t.type}(t)&&!function(t){if(!t.name)return!0
...
return!r||r===t}(t)}(e)||a(e)<0)},f=function(t,e){if(e=e||{},!t)throw new Error("No node provided")
return!1!==s.call(t,o)&&h(e,t)},d=r.concat("iframe").join(","),p=function(t,e){if(e=e||{},!t)throw new Error("No node provided")
return!1!==s.call(t,d)&&l(e,t)}
function v(t,e){var n=Object.keys(t)
if(Object.getOwnPropertySymbols){var i=Object.getOwnPropertySymbols(t)
e&&(i=i.filter((function(e){return Object.getOwnPropertyDescriptor(t,e).enumerable}))),n.push.apply(n,i)}return n}function m(t,e,n){return e in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}var g,w=(g=[],{activateTrap:function(t){if(g.length>0){var e=g[g.length-1]
e!==t&&e.pause()}var n=g.indexOf(t);-1===n||g.splice(n,1),g.push(t)},deactivateTrap:function(t){var e=g.indexOf(t);-1!==e&&g.splice(e,1),g.length>0&&g[g.length-1].unpause()}}),b=function(t){return setTimeout(t,0)},y=function(t,e){var n=-1
return t.every((function(t,i){return!e(t)||(n=i,!1)})),n},x=function(t){for(var e=arguments.length,n=new Array(e>1?e-1:0),i=1;i<e;i++)n[i-1]=arguments[i]
return"function"==typeof t?t.apply(void 0,n):t},k=function(t){return t.target.shadowRoot&&"function"==typeof t.composedPath?t.composedPath()[0]:t.target},$=function(t,e){var n,i=(null==e?void 0:e.document)||document,r=function(t){for(var e=1;e<arguments.length;e++){var n=null!=arguments[e]?arguments[e]:{}
e%2?v(Object(n),!0).forEach((function(e){m(t,e,n[e])})):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(n)):v(Object(n)).forEach((function(e){Object.defineProperty(t,e,Object.getOwnPropertyDescriptor(n,e))}))}return t}({returnFocusOnDeactivate:!0,escapeDeactivates:!0,delayInitialFocus:!0},e),c={containers:[],tabbableGroups:[],nodeFocusedBeforeActivation:null,mostRecentlyFocusedNode:null,active:!1,paused:!1,delayInitialFocusTimer:void 0},l=function(t,e,n){return t&&void 0!==t[e]?t[e]:r[n||e]},d=function(t){return!(!t||!c.containers.some((function(e){return e.contains(t)})))},g=function(t){var e=r[t]
...
return a},$=function(){var t=g("initialFocus")
if(!1===t)return!1
if(void 0===t)if(d(i.activeElement))t=i.activeElement
else{var e=c.tabbableGroups[0]
t=e&&e.firstTabbableNode||g("fallbackFocus")}if(!t)throw new Error("Your focus-trap needs to have at least one focusable element")
return t},S=function(){if(c.tabbableGroups=c.containers.map((function(t){var e,n,i,r,c,l,f,d=(n=[],i=[],(r=t,c=(e=e||{}).includeContainer,l=h.bind(null,e),f=Array.prototype.slice.apply(r.querySelectorAll(o)),c&&s.call(r,o)&&f.unshift(r),f.filter(l)).forEach((function(t,e){var r=a(t)
0===r?n.push(t):i.push({documentOrder:e,tabIndex:r,node:t})})),i.sort(u).map((function(t){return t.node})).concat(n))
if(d.length>0)return{container:t,firstTabbableNode:d[0],lastTabbableNode:d[d.length-1]}})).filter((function(t){return!!t})),c.tabbableGroups.length<=0&&!g("fallbackFocus"))throw new Error("Your focus-trap must have at least one container with at least one tabbable node in it at all times")},E=function t(e){!1!==e&&e!==i.activeElement&&(e&&e.focus?(e.focus({preventScroll:!!r.preventScroll}),c.mostRecentlyFocusedNode=e,function(t){return t.tagName&&"input"===t.tagName.toLowerCase()&&"function"==typeof t.select}(e)&&e.select()):t($()))},T=function(t){var e=g("setReturnFocus",t)
return e||!1!==e&&t},I=function(t){var e=k(t)
d(e)||(x(r.clickOutsideDeactivates,t)?n.deactivate({returnFocus:r.returnFocusOnDeactivate&&!p(e)}):x(r.allowOutsideClick,t)||t.preventDefault())},C=function(t){var e=k(t),n=d(e)
n||e instanceof Document?n&&(c.mostRecentlyFocusedNode=e):(t.stopImmediatePropagation(),E(c.mostRecentlyFocusedNode||$()))},A=function(t){if(function(t){return"Escape"===t.key||"Esc"===t.key||27===t.keyCode}(t)&&!1!==x(r.escapeDeactivates,t))return t.preventDefault(),void n.deactivate();(function(t){return"Tab"===t.key||9===t.keyCode})(t)&&function(t){var e=k(t)
S()
var n=null
if(c.tabbableGroups.length>0){var i=y(c.tabbableGroups,(function(t){return t.container.contains(e)}))
if(i<0)n=t.shiftKey?c.tabbableGroups[c.tabbableGroups.length-1].lastTabbableNode:c.tabbableGroups[0].firstTabbableNode
else if(t.shiftKey){var r=y(c.tabbableGroups,(function(t){var n=t.firstTabbableNode
return e===n}))
if(r<0&&(c.tabbableGroups[i].container===e||p(e)&&!f(e))&&(r=i),r>=0){var o=0===r?c.tabbableGroups.length-1:r-1
n=c.tabbableGroups[o].lastTabbableNode}}else{var s=y(c.tabbableGroups,(function(t){var n=t.lastTabbableNode
return e===n}))
if(s<0&&(c.tabbableGroups[i].container===e||p(e)&&!f(e))&&(s=i),s>=0){var a=s===c.tabbableGroups.length-1?0:s+1
n=c.tabbableGroups[a].firstTabbableNode}}}else n=g("fallbackFocus")
n&&(t.preventDefault(),E(n))}(t)},_=function(t){if(!x(r.clickOutsideDeactivates,t)){var e=k(t)
d(e)||x(r.allowOutsideClick,t)||(t.preventDefault(),t.stopImmediatePropagation())}},O=function(){if(c.active)return w.activateTrap(n),c.delayInitialFocusTimer=r.delayInitialFocus?b((function(){E($())})):E($()),i.addEventListener("focusin",C,!0),i.addEventListener("mousedown",I,{capture:!0,passive:!1}),i.addEventListener("touchstart",I,{capture:!0,passive:!1}),i.addEventListener("click",_,{capture:!0,passive:!1}),i.addEventListener("keydown",A,{capture:!0,passive:!1}),n},N=function(){if(c.active)return i.removeEventListener("focusin",C,!0),i.removeEventListener("mousedown",I,!0),i.removeEventListener("touchstart",I,!0),i.removeEventListener("click",_,!0),i.removeEventListener("keydown",A,!0),n}
return(n={activate:function(t){if(c.active)return this
var e=l(t,"onActivate"),n=l(t,"onPostActivate"),r=l(t,"checkCanFocusTrap")
r||S(),c.active=!0,c.paused=!1,c.nodeFocusedBeforeActivation=i.activeElement,e&&e()
var o=function(){r&&S(),O(),n&&n()}
return r?(r(c.containers.concat()).then(o,o),this):(o(),this)},deactivate:function(t){if(!c.active)return this
clearTimeout(c.delayInitialFocusTimer),c.delayInitialFocusTimer=void 0,N(),c.active=!1,c.paused=!1,w.deactivateTrap(n)
var e=l(t,"onDeactivate"),i=l(t,"onPostDeactivate"),r=l(t,"checkCanReturnFocus")
e&&e()
var o=l(t,"returnFocus","returnFocusOnDeactivate"),s=function(){b((function(){o&&E(T(c.nodeFocusedBeforeActivation)),i&&i()}))}
return o&&r?(r(T(c.nodeFocusedBeforeActivation)).then(s,s),this):(s(),this)},pause:function(){return c.paused||!c.active||(c.paused=!0,N()),this},unpause:function(){return c.paused&&c.active?(c.paused=!1,S(),O(),this):this},updateContainerElements:function(t){var e=[].concat(t).filter(Boolean)
return c.containers=e.map((function(t){return"string"==typeof t?i.querySelector(t):t})),c.active&&S(),this}}).updateContainerElements(t),n}
let S
try{S=(0,i.capabilities)("3.22")}catch{S=(0,i.capabilities)("3.13")}var E=(0,i.setModifierManager)((()=>({capabilities:S,createModifier:()=>({focusTrapOptions:void 0,isActive:!0,isPaused:!1,shouldSelfFocus:!1,focusTrap:void 0}),installModifier(t,e,n){let{named:{isActive:i,isPaused:r,shouldSelfFocus:o,focusTrapOptions:s,_createFocusTrap:a}}=n
...
function w(t,e){return t&&(N(t)?m:g).call(t,e)}var b=p.findIndex||function(t){for(var e=arguments,n=0;n<this.length;n++)if(t.call(e[1],this[n],n,this))return n
return-1}
...
function E(t){return"[object Object]"===S.call(t)}function T(t){return $(t)&&t===t.window}function I(t){return 9===_(t)}function C(t){return _(t)>=1}function A(t){return 1===_(t)}function _(t){return!T(t)&&$(t)&&t.nodeType}function O(t){return"boolean"==typeof t}function N(t){return"string"==typeof t}function D(t){return"number"==typeof t}function M(t){return D(t)||N(t)&&!isNaN(t-parseFloat(t))}function P(t){return!(x(t)?t.length:$(t)&&Object.keys(t).length)}function z(t){return void 0===t}function B(t){return O(t)?t:"true"===t||"1"===t||""===t||"false"!==t&&"0"!==t&&t}function H(t){var e=Number(t)
return!isNaN(e)&&e}function F(t){return parseFloat(t)||0}var L=Array.from||function(t){return p.slice.call(t)}
function j(t){return R(t)[0]}function R(t){return t&&(C(t)?[t]:L(t).filter(C))||[]}function W(t){return T(t)?t:(t=j(t))?(I(t)?t:t.ownerDocument).defaultView:window}function V(t){return t?d(t,"ms")?F(t):1e3*F(t):0}function q(t,e){return t===e||$(t)&&$(e)&&Object.keys(t).length===Object.keys(e).length&&X(t,(function(t,n){return t===e[n]}))}function G(t,e,n){return t.replace(new RegExp(e+"|"+n,"g"),(function(t){return t===e?n:e}))}var U=Object.assign||function(t){for(var e=[],i=arguments.length-1;i-- >0;)e[i]=arguments[i+1]
t=Object(t)
...
var r=(e=R(e)).length
return t=M(t)?H(t):"next"===t?n+1:"previous"===t?n-1:e.indexOf(j(t)),i?J(t,0,r-1):(t%=r)<0?t+r:t}function rt(t){var e=Object.create(null)
return function(n){return e[n]||(e[n]=t(n))}}function ot(t,e,n){if($(e))for(var i in e)ot(t,i,e[i])
else{if(z(n))return(t=j(t))&&t.getAttribute(e)
R(t).forEach((function(t){k(n)&&(n=n.call(t,ot(t,e))),null===n?at(t,e):t.setAttribute(e,n)}))}}function st(t,e){return R(t).some((function(t){return t.hasAttribute(e)}))}function at(t,e){t=R(t),e.split(" ").forEach((function(e){return t.forEach((function(t){return t.hasAttribute(e)&&t.removeAttribute(e)}))}))}function ut(t,e){for(var n=0,i=[e,"data-"+e];n<i.length;n++)if(st(t,i[n]))return ot(t,i[n])}var ct="undefined"!=typeof window,lt=ct&&/msie|trident/i.test(window.navigator.userAgent),ht=ct&&"rtl"===ot(document.documentElement,"dir"),ft=ct&&"ontouchstart"in window,dt=ct&&window.PointerEvent,pt=ct&&(ft||window.DocumentTouch&&document instanceof DocumentTouch||navigator.maxTouchPoints),vt=dt?"pointerdown":ft?"touchstart":"mousedown",mt=dt?"pointermove":ft?"touchmove":"mousemove",gt=dt?"pointerup":ft?"touchend":"mouseup",wt=dt?"pointerenter":ft?"":"mouseenter",bt=dt?"pointerleave":ft?"":"mouseleave",yt=dt?"pointercancel":"touchcancel",xt={area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,menuitem:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0}
function kt(t){return R(t).some((function(t){return xt[t.tagName.toLowerCase()]}))}function $t(t){return R(t).some((function(t){return t.offsetWidth||t.offsetHeight||t.getClientRects().length}))}var St="input,select,textarea,button"
function Et(t){return R(t).some((function(t){return Nt(t,St)}))}var Tt=St+",a[href],[tabindex]"
function It(t){return Nt(t,Tt)}function Ct(t){return(t=j(t))&&A(t.parentNode)&&t.parentNode}function At(t,e){return R(t).filter((function(t){return Nt(t,e)}))}var _t=ct?Element.prototype:{},Ot=_t.matches||_t.webkitMatchesSelector||_t.msMatchesSelector||Q
function Nt(t,e){return R(t).some((function(t){return Ot.call(t,e)}))}var Dt=_t.closest||function(t){var e=this
do{if(Nt(e,t))return e}while(e=Ct(e))}
function Mt(t,e){return h(e,">")&&(e=e.slice(1)),A(t)?Dt.call(t,e):R(t).map((function(t){return Mt(t,e)})).filter(Boolean)}function Pt(t,e){return N(e)?Nt(t,e)||!!Mt(t,e):t===e||(I(e)?e.documentElement:j(e)).contains(j(t))}function zt(t,e){for(var n=[];t=Ct(t);)e&&!Nt(t,e)||n.push(t)
return n}function Bt(t,e){var n=(t=j(t))?R(t.children):[]
return e?At(n,e):n}function Ht(t,e){return e?R(t).indexOf(j(e)):Bt(Ct(t)).indexOf(t)}function Ft(t,e){return Rt(t,jt(t,e))}function Lt(t,e){return Wt(t,jt(t,e))}function jt(t,e){return void 0===e&&(e=document),N(t)&&Ut(t)||I(e)?e:e.ownerDocument}function Rt(t,e){return j(Vt(t,e,"querySelector"))}function Wt(t,e){return R(Vt(t,e,"querySelectorAll"))}function Vt(t,e,n){if(void 0===e&&(e=document),!t||!N(t))return t
...
function Zt(t){return N(t)?Kt.call(null,t):""}function Jt(){for(var t=[],e=arguments.length;e--;)t[e]=arguments[e]
...
e&&(c(),s(t,e))}),a)
return c}function ee(t,e,n){return le(t).reduce((function(t,i){return t&&i.dispatchEvent(ne(e,!0,!0,n))}),!0)}function ne(t,e,n,i){if(void 0===e&&(e=!0),void 0===n&&(n=!1),N(t)){var r=document.createEvent("CustomEvent")
r.initCustomEvent(t,e,n,i),t=r}return t}function ie(t){return k(t[2])&&t.splice(2,0,!1),t}function re(t,e){var n=this
return function(i){var r=">"===t[0]?Wt(t,i.currentTarget).reverse().filter((function(t){return Pt(i.target,t)}))[0]:Mt(i.target,t)
r&&(i.current=r,e.call(n,i))}}function oe(t){return function(e){return x(e.detail)?t.apply(void 0,[e].concat(e.detail)):t(e)}}function se(t){return function(e){if(e.target===e.currentTarget||e.target===e.current)return t.call(null,e)}}function ae(t){return t&&lt&&!O(t)?!!t.capture:t}function ue(t){return t&&"addEventListener"in t}function ce(t){return ue(t)?t:j(t)}function le(t){return x(t)?t.map(ce).filter(Boolean):N(t)?Wt(t):ue(t)?[t]:R(t)}function he(t){return"touch"===t.pointerType||!!t.touches}function fe(t){var e=t.touches,n=t.changedTouches,i=e&&e[0]||n&&n[0]||t
...
Jt(r,"load",(function(){0===r.status||r.status>=200&&r.status<300||304===r.status?("json"===e.responseType&&N(r.response)&&(r=U(function(t){var e={}
...
o.onerror=function(t){return r(t)},o.onload=function(){return i(o)},n&&(o.sizes=n),e&&(o.srcset=e),o.src=t}))}function ye(t){return(t=Me(t)).innerHTML="",t}function xe(t,e){return t=Me(t),z(e)?t.innerHTML:ke(t.hasChildNodes()?ye(t):t,e)}function ke(t,e){return t=Me(t),Ee(e,(function(e){return t.appendChild(e)}))}function $e(t,e){return t=Me(t),Ee(e,(function(e){return t.parentNode.insertBefore(e,t)}))}function Se(t,e){return t=Me(t),Ee(e,(function(e){return t.nextSibling?$e(t.nextSibling,e):ke(t.parentNode,e)}))}function Ee(t,e){return(t=N(t)?Ne(t):t)?"length"in t?R(t).map(e):e(t):null}function Te(t){R(t).forEach((function(t){return t.parentNode&&t.parentNode.removeChild(t)}))}function Ie(t,e){for(e=j($e(t,e));e.firstChild;)e=e.firstChild
return ke(e,t),e}function Ce(t,e){return R(R(t).map((function(t){return t.hasChildNodes?Ie(R(t.childNodes),e):ke(t,e)})))}function Ae(t){R(t).map(Ct).filter((function(t,e,n){return n.indexOf(t)===e})).forEach((function(t){$e(t,t.childNodes),Te(t)}))}ge.resolve=function(t){var e=this
...
var _e=/^\s*<(\w+|!)[^>]*>/,Oe=/^<(\w+)\s*\/?>(?:<\/\1>)?$/
function Ne(t){var e=Oe.exec(t)
if(e)return document.createElement(e[1])
var n=document.createElement("div")
return _e.test(t)?n.insertAdjacentHTML("beforeend",t.trim()):n.textContent=t,n.childNodes.length>1?R(n.childNodes):n.firstChild}function De(t,e){if(A(t))for(e(t),t=t.firstElementChild;t;){var n=t.nextElementSibling
De(t,e),t=n}}function Me(t,e){return ze(t)?j(Ne(t)):Rt(t,e)}function Pe(t,e){return ze(t)?R(Ne(t)):Wt(t,e)}function ze(t){return N(t)&&("<"===t[0]||t.match(/^\s*</))}function Be(t){for(var e=[],n=arguments.length-1;n-- >0;)e[n]=arguments[n+1]
We(t,e,"add")}function He(t){for(var e=[],n=arguments.length-1;n-- >0;)e[n]=arguments[n+1]
We(t,e,"remove")}function Fe(t,e){ot(t,"class",(function(t){return(t||"").replace(new RegExp("\\b"+e+"\\b","g"),"")}))}function Le(t){for(var e=[],n=arguments.length-1;n-- >0;)e[n]=arguments[n+1]
e[0]&&He(t,e[0]),e[1]&&Be(t,e[1])}function je(t,e){e=Ve(e)[0]
for(var n=R(t),i=0;i<n.length;i++)if(e&&n[i].classList.contains(e))return!0
return!1}function Re(t,e,n){e=Ve(e)
for(var i=R(t),r=0;r<i.length;r++)for(var o=i[r].classList,s=0;s<e.length;s++)z(n)?o.toggle(e[s]):qe.Force?o.toggle(e[s],!!n):o[n?"add":"remove"](e[s])}function We(t,e,n){var i
e=e.reduce((function(t,e){return t.concat(Ve(e))}),[])
for(var r=R(t),o=function(t){qe.Multiple?(i=r[t].classList)[n].apply(i,e):e.forEach((function(e){return r[t].classList[n](e)}))},s=0;s<r.length;s++)o(s)}function Ve(t){return String(t).split(/\s|,/).filter(Boolean)}var qe={get Multiple(){return this.get("Multiple")},get Force(){return this.get("Force")},get:function(t){var e=document.createElement("_").classList
...
function Ue(t,e,n,i){return void 0===i&&(i=""),R(t).map((function(t){if(N(e)){if(e=Qe(e),z(n))return Xe(t,e)
n||D(n)?t.style.setProperty(e,M(n)&&!Ge[e]?n+"px":n,i):t.style.removeProperty(e)}else{if(x(e)){var r=Ye(t)
return e.reduce((function(t,e){return t[e]=r[Qe(e)],t}),{})}$(e)&&(i=n,X(e,(function(e,n){return Ue(t,n,e,i)})))}return t}))[0]}function Ye(t,e){return W(t).getComputedStyle(t,e)}function Xe(t,e,n){return Ye(t,n)[e]}var Ke=rt((function(t){var e=ke(document.documentElement,Ne("<div>"))
Be(e,"uk-"+t)
...
function en(t,e,n,i){return void 0===n&&(n=400),void 0===i&&(i="linear"),de.all(R(t).map((function(t){return new de((function(r,o){for(var s in e){var a=Ue(t,s)
...
if(t){var i=W(t),r={height:i.pageYOffset,width:i.pageXOffset}
...
t=j(t)
do{if(e[0]+=t.offsetTop,e[1]+=t.offsetLeft,"fixed"===Ue(t,"position")){var n=W(t)
...
return function(n,i){if(z(i)){if(T(n))return n["inner"+e]
...
return n&&et(n,e)}))}}
var Tn={}
function In(t,e,n){return Tn.computed(k(t)?t.call(n,n):t,k(e)?e.call(n,n):e)}function Cn(t,e){return t=t&&!x(t)?[t]:t,e?t?t.concat(e):x(e)?e:[e]:t}function An(t,e){return z(e)?t:e}function _n(t,e,i){var r={}
...
function c(n){r[n]=(Tn[n]||An)(t[n],e[n],i)}return r}function On(t,e){var n
void 0===e&&(e=[])
try{return t?h(t,"{")?JSON.parse(t):e.length&&!w(t,":")?((n={})[e[0]]=t,n):t.split(";").reduce((function(t,e){var n=e.split(/:(.*)/),i=n[0],r=n[1]
return i&&!z(r)&&(t[i.trim()]=r.trim()),t}),{}):{}}catch(t){return{}}}function Nn(t){if(Bn(t)&&Ln(t,{func:"playVideo",method:"play"}),zn(t))try{t.play().catch(Q)}catch(t){}}function Dn(t){Bn(t)&&Ln(t,{func:"pauseVideo",method:"pause"}),zn(t)&&t.pause()}function Mn(t){Bn(t)&&Ln(t,{func:"mute",method:"setVolume",value:0}),zn(t)&&(t.muted=!0)}function Pn(t){return zn(t)||Bn(t)}function zn(t){return t&&"VIDEO"===t.tagName}function Bn(t){return t&&"IFRAME"===t.tagName&&(Hn(t)||Fn(t))}function Hn(t){return!!t.src.match(/\/\/.*?youtube(-nocookie)?\.[a-z]+\/(watch\?v=[^&\s]+|embed)|youtu\.be\/.*/)}function Fn(t){return!!t.src.match(/vimeo\.com\/video\/.*/)}function Ln(t,e){(function(t){if(t._ukPlayer)return t._ukPlayer
var e,n=Hn(t),i=Fn(t),r=++Rn
...
var Rn=0
function Wn(t,e,n){return void 0===e&&(e=0),void 0===n&&(n=0),!!$t(t)&&tt.apply(void 0,Un(t).map((function(t){var i=ln(Yn(t)),r=i.top,o=i.left,s=i.bottom,a=i.right
...
Vn(t,r+e*u),1===u?n():requestAnimationFrame(i)}()}))}(r,d-s).then(e)}}),(function(){return de.resolve()}))()}function Gn(t,e){if(void 0===e&&(e=0),!$t(t))return 0
var n=Un(t,/auto|scroll/,!0)[0],i=n.scrollHeight,r=n.scrollTop,o=Xn(n),s=fn(t)[0]-r-fn(n)[0],a=Math.min(o,s+r)
return J(-1*(s-a)/Math.min(t.offsetHeight+e+a,i-(s+r),i-o))}function Un(t,e,n){void 0===e&&(e=/auto|scroll|hidden/),void 0===n&&(n=!1)
var i=Kn(t),r=zt(t).reverse(),o=y(r=r.slice(r.indexOf(i)+1),(function(t){return"fixed"===Ue(t,"position")}))
return~o&&(r=r.slice(o)),[i].concat(r.filter((function(t){return e.test(Ue(t,"overflow"))&&(!n||t.scrollHeight>Xn(t))}))).reverse()}function Yn(t){return t===Kn(t)?window:t}function Xn(t){return(t===Kn(t)?document.documentElement:t).clientHeight}function Kn(t){var e=W(t).document
...
return{x:r?F(r)*(d(r,"%")?e/100:1):0,y:o?F(o)*(d(o,"%")?n/100:1):0}}var ni=Object.freeze({__proto__:null,ajax:we,getImage:be,transition:en,Transition:nn,animate:on,Animation:an,attr:ot,hasAttr:st,removeAttr:at,data:ut,addClass:Be,removeClass:He,removeClasses:Fe,replaceClass:Le,hasClass:je,toggleClass:Re,dimensions:cn,offset:ln,position:hn,offsetPosition:fn,height:dn,width:pn,boxModelAdjust:mn,flipPosition:gn,toPx:wn,ready:function(t){"loading"===document.readyState?te(document,"DOMContentLoaded",t):t()},empty:ye,html:xe,prepend:function(t,e){return(t=Me(t)).hasChildNodes()?Ee(e,(function(e){return t.insertBefore(e,t.firstChild)})):ke(t,e)},append:ke,before:$e,after:Se,remove:Te,wrapAll:Ie,wrapInner:Ce,unwrap:Ae,fragment:Ne,apply:De,$:Me,$$:Pe,inBrowser:ct,isIE:lt,isRtl:ht,hasTouch:pt,pointerDown:vt,pointerMove:mt,pointerUp:gt,pointerEnter:wt,pointerLeave:bt,pointerCancel:yt,on:Jt,off:Qt,once:te,trigger:ee,createEvent:ne,toEventTargets:le,isTouch:he,getEventPos:fe,fastdom:yn,isVoidElement:kt,isVisible:$t,selInput:St,isInput:Et,selFocusable:Tt,isFocusable:It,parent:Ct,filter:At,matches:Nt,closest:Mt,within:Pt,parents:zt,children:Bt,index:Ht,hasOwn:n,hyphenate:r,camelize:s,ucfirst:a,startsWith:h,endsWith:d,includes:w,findIndex:y,isArray:x,isFunction:k,isObject:$,isPlainObject:E,isWindow:T,isDocument:I,isNode:C,isElement:A,isBoolean:O,isString:N,isNumber:D,isNumeric:M,isEmpty:P,isUndefined:z,toBoolean:B,toNumber:H,toFloat:F,toArray:L,toNode:j,toNodes:R,toWindow:W,toMs:V,isEqual:q,swap:G,assign:U,last:Y,each:X,sortBy:K,uniqueBy:Z,clamp:J,noop:Q,intersectRect:tt,pointInRect:et,Dimensions:nt,getIndex:it,memoize:rt,MouseTracker:En,mergeOptions:_n,parseOptions:On,play:Nn,pause:Dn,mute:Mn,isVideo:Pn,positionAt:Jn,Promise:de,Deferred:pe,query:Ft,queryAll:Lt,find:Rt,findAll:Wt,escape:Zt,css:Ue,getCssVar:Je,propName:Qe,isInView:Wn,scrollTop:Vn,scrollIntoView:qn,scrolledOver:Gn,scrollParents:Un,getViewport:Yn,getViewportClientHeight:Xn}),ii=rt((function(t){return!(!h(t,"uk-")&&!h(t,"data-uk-"))&&s(t.replace("data-uk-","").replace("uk-",""))})),ri=function(t){this._init(t)}
ri.util=ni,ri.data="__uikit__",ri.prefix="uk-",ri.options={},ri.version="3.10.1",function(t){var e,n=t.data
function i(t,e){if(t)for(var n in t)t[n]._connected&&t[n]._callUpdate(e)}t.use=function(t){if(!t.installed)return t.call(null,this),t.installed=!0,this},t.mixin=function(e,n){(n=(N(n)?t.component(n):n)||this).options=_n(n.options,e)},t.extend=function(t){t=t||{}
var e=this,n=function(t){this._init(t)}
return(n.prototype=Object.create(e.prototype)).constructor=n,n.options=_n(e.options,t),n.super=e,n.extend=e.extend,n},t.update=function(t,e){zt(t=t?j(t):document.body).reverse().forEach((function(t){return i(t[n],e)})),De(t,(function(t){return i(t[n],e)}))},Object.defineProperty(t,"container",{get:function(){return e||document.body},set:function(t){e=Me(t)}})}(ri),function(t){function e(t){for(var e=this,n=this.$options.update,i=function(i){var r=n[i],o=r.read,s=r.write,a=r.events
if(t.has("update")||a&&a.some((function(e){return t.has(e)}))){var u=void 0
o&&(u=o.call(e,e._data,t))&&E(u)&&U(e._data,u),s&&!1!==u&&yn.write((function(){return s.call(e,e._data,t)}))}},r=0;r<n.length;r++)i(r)}function i(t){var e=this.$options.computed,i=this._computeds
for(var r in e){var o=n(i,r),s=i[r]
delete i[r]
var a=e[r],u=a.watch,c=a.immediate
u&&(t&&c||o&&!q(s,this[r]))&&u.call(this,this[r],s)}}t.prototype._callHook=function(t){var e=this,n=this.$options[t]
...
z(f)||(f=o[u]===Boolean&&""===f||c(o[u],f),("target"!==l||f&&!h(f,"_"))&&(n[u]=f))}var d=On(ut(a,e),i)
...
r[e]=i.set?i.set.call(t,n):n,z(r[e])&&delete r[e]}})}function a(t,e,n){E(e)||(e={name:n,handler:e})
var i=e.name,r=e.el,o=e.handler,s=e.capture,u=e.passive,c=e.delegate,l=e.filter,h=e.self
r=k(r)?r.call(t):r||t.$el,x(r)?r.forEach((function(i){return a(t,U({},e,{el:i}),n)})):!r||l&&!l.call(t)||t._events.push(Jt(r,i,c?N(c)?c:c.call(t):null,N(o)?t[o]:o.bind(t),{passive:u,capture:s,self:h}))}function u(t,e){return t.every((function(t){return!t||!n(t,e)}))}function c(t,e){return t===Boolean?B(e):t===Number?H(e):"list"===t?function(t){return x(t)?t:N(t)?t.split(/,(?![^(]*\))/).map((function(t){return M(t)?H(t):B(t.trim())})):[t]}(e):t?t(e):e}function l(t){var e=t.$name,n=t.$options,o=t.$props,a=n.attrs,u=n.props,c=n.el
...
return(i===e?l:[s(i),s(n)]).some((function(t){return!z(a[t])&&a[t]!==o[t]}))}))&&t.$reset()}))
...
if(void 0===r&&(r={}),n=x(n)?P(i)?void 0:n.slice(0,i.length).reduce((function(t,e,n){return E(e)?U(t,e):t[i[n]]=e,t}),{}):n,n)for(var o in n)z(n[o])?delete n[o]:n[o]=r[o]?c(r[o],n[o]):n[o]
...
return new de((function(r){return de.all(R(t).map((function(t){var r=O(e)?e:!i.isToggled(t)
...
Be(t,a),ee(t,r?"show":"hide",[i])
var u=function(){He(t,a),ee(t,r?"shown":"hidden",[i]),i.$update(t)}
return s?s.then(u,(function(){return He(t,a),de.reject()})):u()}))).then(r,Q)}))},isToggled:function(t){return void 0===t&&(t=this.$el),!!je(t=R(t)[0],this.clsEnter)||!je(t,this.clsLeave)&&(this.cls?je(t,this.cls.split(" ")[0]):$t(t))},_toggle:function(t,e){var n
t&&(e=Boolean(e),this.cls?(n=w(this.cls," ")||e!==je(t,this.cls))&&Re(t,this.cls,w(this.cls," ")?void 0:e):(n=e===t.hidden)&&(t.hidden=!e),Pe("[autofocus]",t).some((function(t){return $t(t)?t.focus()||!0:t.blur()})),n&&(ee(t,"toggled",[e,this]),this.$update(t)))}}}
...
this.multiple||w(r,i[0])||(i=i.concat(r)),!this.collapsible&&r.length<2&&!At(i,":not(."+this.clsOpen+")").length||i.forEach((function(t){return n.toggleElement(t,!je(t,n.clsOpen),(function(t,i){Re(t,n.clsOpen,i),ot(Me(n.$props.toggle,t),"aria-expanded",i)
...
Ue(this.$el,n,e[n])}else this.boundary&&this.$el.offsetWidth>Math.max(t.right-e.left,e.right-t.left)&&Be(this.$el,this.clsDrop+"-stack")
...
if(t){var n,i=Et(t)?"value":"textContent",r=t[i],o=e.files&&e.files[0]?e.files[0].name:Nt(e,"select")&&(n=Pe("option",e).filter((function(t){return t.selected}))[0])?n.textContent:e.value
r!==o&&(t[i]=o)}},events:[{name:"change",handler:function(){this.$update()}},{name:"reset",el:function(){return Mt(this.$el,"form")},handler:function(){this.$update()}}]},wi={update:{read:function(t){var e=Wn(this.$el)
...
return{rows:t,columns:xi(t)}},write:function(t){for(var e=t.columns,n=t.rows,i=0;i<n.length;i++)for(var r=0;r<n[i].length;r++)Re(n[i][r],this.margin,0!==i),Re(n[i][r],this.firstColumn,!!~e[0].indexOf(n[i][r]))},events:["resize"]}}
...
Re(this.$el,this.clsStack,e.length<2)},events:["resize"]},{read:function(t){var e=t.columns,n=t.rows
if(!e.length||!this.masonry&&!this.parallax||Ei(this.$el))return t.translates=!1,!1
var i=!1,r=Bt(this.$el),o=function(t){return t.map((function(t){return t.reduce((function(t,e){return t+e.offsetHeight}),0)}))}(e),s=function(t,e){var n=t.filter((function(t){return je(t,e)}))[0]
...
return!Ei(this.$el)&&{scrolled:!!this.parallax&&Gn(this.$el,e?e-dn(this.$el):0)*Math.abs(this.parallax)}},write:function(t){var e=t.columns,n=t.scrolled,i=t.translates;(!1!==n||i)&&e.forEach((function(t,e){return t.forEach((function(t,r){return Ue(t,"transform",n||i?"translateY("+((i&&-i[e][r])+(n?e%2?n:n/8:0))+"px)":"")}))}))},events:["scroll","resize"]}]}
function Ei(t){return Bt(t).some((function(t){return"absolute"===Ue(t,"position")}))}var Ti=lt?{props:{selMinHeight:String},data:{selMinHeight:!1,forceHeight:!1},computed:{elements:function(t,e){var n=t.selMinHeight
...
n+=r>0&&r<dn(window)/2?" - "+r+"px":""}!0===this.offsetBottom?n+=" - "+cn(this.$el.nextElementSibling).height+"px":M(this.offsetBottom)?n+=" - "+this.offsetBottom+"vh":this.offsetBottom&&d(this.offsetBottom,"px")?n+=" - "+F(this.offsetBottom)+"px":N(this.offsetBottom)&&(n+=" - "+cn(Ft(this.offsetBottom,this.$el)).height+"px"),n+=(i?" - "+i+"px":"")+")"}return{minHeight:n,prev:e}},write:function(t){var e=t.minHeight,n=t.prev
...
return zi(t,n)?n:Se(e,t)}var i=e.lastElementChild
return zi(t,i)?i:ke(e,t)}(t,e.$el)
...
return Ni(this.src).then((function(e){return function(t,e){return e&&w(t,"<symbol")&&(t=function(t,e){var n
...
var l=ot(e,"viewBox")
l&&!c.some((function(t){return t}))&&(c=l.split(" ").slice(2)),c.forEach((function(e,i){return ot(t,u[i],F(e)*n.ratio||null)}))}}},Ni=rt((function(t){return new de((function(e,n){t?h(t,"data:")?e(decodeURIComponent(t.split(",")[1])):we(t).then((function(t){return e(t.response)}),(function(){return n("SVG not found.")})):n()}))})),Di=/<symbol([^]*?id=(['"])(.+?)\2[^]*?<\/)symbol>/g,Mi={}
function Pi(t){return Math.ceil(Math.max.apply(Math,[0].concat(Pe("[stroke]",t).map((function(t){try{return t.getTotalLength()}catch(t){return 0}})))))}function zi(t,e){return Bi(t)&&Bi(e)&&Hi(t)===Hi(e)}function Bi(t){return t&&"svg"===t.tagName}function Hi(t){return(t.innerHTML||(new XMLSerializer).serializeToString(t).replace(/<svg.*?>(.*?)<\/svg>/g,"$1")).replace(/\s/g,"")}var Fi={spinner:'<svg width="30" height="30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" cx="15" cy="15" r="14"/></svg>',totop:'<svg width="18" height="10" viewBox="0 0 18 10" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 9 9 1 17 9 "/></svg>',marker:'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><rect x="9" y="4" width="1" height="11"/><rect x="4" y="9" width="11" height="1"/></svg>',"close-icon":'<svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg"><line fill="none" stroke="#000" stroke-width="1.1" x1="1" y1="1" x2="13" y2="13"/><line fill="none" stroke="#000" stroke-width="1.1" x1="13" y1="1" x2="1" y2="13"/></svg>',"close-large":'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><line fill="none" stroke="#000" stroke-width="1.4" x1="1" y1="1" x2="19" y2="19"/><line fill="none" stroke="#000" stroke-width="1.4" x1="19" y1="1" x2="1" y2="19"/></svg>',"navbar-toggle-icon":'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><rect y="9" width="20" height="2"/><rect y="3" width="20" height="2"/><rect y="15" width="20" height="2"/></svg>',"overlay-icon":'<svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><rect x="19" y="0" width="1" height="40"/><rect x="0" y="19" width="40" height="1"/></svg>',"pagination-next":'<svg width="7" height="12" viewBox="0 0 7 12" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 1 6 6 1 11"/></svg>',"pagination-previous":'<svg width="7" height="12" viewBox="0 0 7 12" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="6 1 1 6 6 11"/></svg>',"search-icon":'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" stroke-width="1.1" cx="9" cy="9" r="7"/><path fill="none" stroke="#000" stroke-width="1.1" d="M14,14 L18,18 L14,14 Z"/></svg>',"search-large":'<svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" stroke-width="1.8" cx="17.5" cy="17.5" r="16.5"/><line fill="none" stroke="#000" stroke-width="1.8" x1="38" y1="39" x2="29" y2="30"/></svg>',"search-navbar":'<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" stroke-width="1.1" cx="10.5" cy="10.5" r="9.5"/><line fill="none" stroke="#000" stroke-width="1.1" x1="23" y1="23" x2="17" y2="17"/></svg>',"slidenav-next":'<svg width="14" height="24" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1 "/></svg>',"slidenav-next-large":'<svg width="25" height="40" viewBox="0 0 25 40" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="2" points="4.002,38.547 22.527,20.024 4,1.5 "/></svg>',"slidenav-previous":'<svg width="14" height="24" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.4" points="12.775,1 1.225,12 12.775,23 "/></svg>',"slidenav-previous-large":'<svg width="25" height="40" viewBox="0 0 25 40" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="2" points="20.527,1.5 2,20.024 20.525,38.547 "/></svg>'},Li={install:function(t){t.icon.add=function(e,n){var i,r=N(e)?((i={})[e]=n,i):e
X(r,(function(t,e){Fi[e]=t,delete Gi[e]})),t._initialized&&De(document.body,(function(e){return X(t.getComponents(e),(function(t){t.$options.isIcon&&t.icon in r&&t.$reset()}))}))}},extends:Oi,args:"icon",props:["icon"],data:{include:["focusable"]},isIcon:!0,beforeConnect:function(){Be(this.$el,"uk-icon")},methods:{getSvg:function(){var t=function(t){return Fi[t]?(Gi[t]||(Gi[t]=Me((Fi[function(t){return ht?G(G(t,"left","right"),"previous","next"):t}(t)]||Fi[t]).trim())),Gi[t].cloneNode(!0)):null}(this.icon)
return t?de.resolve(t):de.reject("Icon not found.")}}},ji={args:!1,extends:Li,data:function(t){return{icon:r(t.constructor.options.name)}},beforeConnect:function(){Be(this.$el,this.$name)}},Ri={extends:ji,beforeConnect:function(){Be(this.$el,"uk-slidenav")},computed:{icon:function(t,e){var n=t.icon
return je(e,"uk-slidenav-large")?n+"-large":n}}},Wi={extends:ji,computed:{icon:function(t,e){var n=t.icon
return je(e,"uk-search-icon")&&zt(e,".uk-search-large").length?"search-large":zt(e,".uk-search-navbar").length?"search-navbar":n}}},Vi={extends:ji,computed:{icon:function(){return"close-"+(je(this.$el,"uk-close-large")?"large":"icon")}}},qi={extends:ji,connected:function(){var t=this
...
t.some((function(t){return z(t.isIntersecting)||t.isIntersecting}))&&(this._data.image=be(this.dataSrc,this.dataSrcset,this.sizes).then((function(t){return Yi(e.$el,er(t),t.srcset,t.sizes),nr[e.cacheKey]=er(t),t}),(function(t){return ee(e.$el,new t.constructor(t.type,t))})),this.observer.disconnect())},observe:function(){var t=this
...
try{(nr=window.sessionStorage||{})[ir]=1,delete nr[ir]}catch(t){nr={}}var rr={props:{media:Boolean},data:{media:!1},computed:{matchMedia:function(){var t=function(t){if(N(t))if("@"===t[0]){var e="breakpoint-"+t.substr(1)
...
pn(window)>e.clientWidth&&this.overlay&&Ue(document.body,"overflowY","scroll"),this.stack&&Ue(this.$el,"zIndex",F(Ue(this.$el,"zIndex"))+sr.length),Be(e,this.clsPage),this.bgClose&&te(this.$el,"hide",Jt(document,vt,(function(e){var n=e.target
...
return e?(e=this._dropbar||Ft(e,this.$el)||Me("+ .uk-navbar-dropbar",this.$el))||(this._dropbar=Me("<div></div>")):null},watch:function(t){Be(t,"uk-navbar-dropbar")},immediate:!0},dropContainer:function(t,e){return this.container||e},dropdowns:{get:function(t,e){var n=this,i=t.clsDrop,r=Pe("."+i,e)
...
if(w(this.dropdowns,e)){var i=this.getActive(),r=Pe(Tt,e),o=y(r,(function(t){return Nt(t,":focus")}))
...
je(n,this.clsDrop)&&("slide"===this.dropbarMode&&Be(this.dropbar,"uk-navbar-dropbar-slide"),this.clsDrop&&Be(n,this.clsDrop+"-dropbar"),"bottom"===i&&this.transitionTo(n.offsetHeight+F(Ue(n,"marginTop"))+F(Ue(n,"marginBottom")),n))}},{name:"beforehide",el:function(){return this.dropContainer},filter:function(){return this.dropbar},handler:function(t,e){var n=e.$el,i=this.getActive()
Nt(this.dropbar,":hover")&&i&&i.$el===n&&t.preventDefault()}},{name:"hide",el:function(){return this.dropContainer},filter:function(){return this.dropbar},handler:function(t,e){var n=e.$el
...
1===e.length&&(this.clientY=e[0].clientY)}},{name:"touchmove",self:!0,passive:!1,filter:function(){return this.overlay},handler:function(t){t.cancelable&&t.preventDefault()}},{name:"touchmove",passive:!1,el:function(){return this.panel},handler:function(t){if(1===t.targetTouches.length){var e=t.targetTouches[0].clientY-this.clientY,n=this.panel,i=n.scrollTop,r=n.scrollHeight,o=n.clientHeight;(o>=r||0===i&&e>0||r-i<=o&&e<0)&&t.cancelable&&t.preventDefault()}}},{name:"show",self:!0,handler:function(){"reveal"!==this.mode||je(Ct(this.panel),this.clsMode)||(Ie(this.panel,"<div>"),Be(Ct(this.panel),this.clsMode)),Ue(document.documentElement,"overflowY",this.overlay?"hidden":""),Be(document.body,this.clsContainer,this.clsFlip),Ue(document.body,"touch-action","pan-y pinch-zoom"),Ue(this.$el,"display","block"),Be(this.$el,this.clsOverlay),Be(this.panel,this.clsSidebarAnimation,"reveal"!==this.mode?this.clsMode:""),dn(document.body),Be(document.body,this.clsContainerAnimation),this.clsContainerAnimation&&(gr().content+=",user-scalable=0")}},{name:"hide",self:!0,handler:function(){He(document.body,this.clsContainerAnimation),Ue(document.body,"touch-action","")}},{name:"hidden",self:!0,handler:function(){var t
...
this.elements.forEach((function(t){t[xr]||(t[xr]={cls:ut(t,"uk-scrollspy-class")||e.cls}),t[xr].show=Wn(t,e.offsetTop,e.offsetLeft)}))},write:function(t){var e=this
...
M(this.bottom)&&this.scroll>this.bottom-this.offset&&(e=this.bottom-this.offsetParentTop,n="absolute"),Ue(this.$el,{position:n,top:e+"px",width:this.width}),this.isActive=t,Re(this.$el,this.clsBelow,this.scroll>this.bottomOffset),Be(this.$el,this.clsFixed)}}}
function Er(t,e){var n=e.$props,i=e.$el,r=e[t+"Offset"],o=n[t]
if(o)return N(o)&&o.match(/^-?\d/)?r+wn(o):ln(!0===o?Ct(i):Ft(o,i)).bottom}var Tr={mixins:[si],args:"connect",props:{connect:String,toggle:String,itemNav:String,active:Number,swiping:Boolean},data:{connect:"~.uk-switcher",toggle:"> * > :first-child",itemNav:!1,active:0,swiping:!0,cls:"uk-active",attrItem:"uk-switcher-item"},computed:{connects:{get:function(t,e){return Lt(t.connect,e)},watch:function(t){var e=this
this.swiping&&Ue(t,"touch-action","pan-y pinch-zoom")
var n=this.index()
this.connects.forEach((function(t){return Bt(t).forEach((function(t,i){return Re(t,e.cls,i===n)}))}))},immediate:!0},toggles:{get:function(t,e){return Pe(t.toggle,e).filter((function(t){return!Nt(t,".uk-disabled *, .uk-disabled, [disabled]")}))},watch:function(t){var e=this.index()
...
return y(this.children,(function(e){return je(e,t.cls)}))},show:function(t){var e=this,n=this.index(),i=it(this.children[it(t,this.toggles,n)],Bt(this.$el))
n!==i&&(this.children.forEach((function(t,n){Re(t,e.cls,i===n),ot(e.toggles[n],"aria-expanded",i===n)})),this.connects.forEach((function(t){var r=t.children
return e.toggleElement(R(r).filter((function(t){return je(t,e.cls)})),!1,n>=0).then((function(){return e.toggleElement(r[i],!0,n>=0)}))})))}}},Ir={mixins:[oi],extends:Tr,props:{media:Boolean},data:{media:960,attrItem:"uk-tab-item"},connected:function(){var t=je(this.$el,"uk-tab-left")?"uk-tab-left":!!je(this.$el,"uk-tab-right")&&"uk-tab-right"
...
this.toggleElement(i,!1).then((function(){return e.toggleElement(e.target.filter((function(t){return!w(i,t)})),!0)}))}}},updateAria:function(t){w(this.mode,"media")||ot(this.$el,"aria-expanded",O(t)?t:this.isToggled(this.target))}}}
X(Object.freeze({__proto__:null,Accordion:ui,Alert:hi,Cover:di,Drop:mi,Dropdown:mi,FormCustom:gi,Gif:wi,Grid:Si,HeightMatch:Ii,HeightViewport:_i,Icon:Li,Img:Ui,Leader:or,Margin:bi,Modal:cr,Nav:lr,Navbar:fr,Offcanvas:mr,OverflowAuto:wr,Responsive:br,Scroll:yr,Scrollspy:kr,ScrollspyNav:$r,Sticky:Sr,Svg:Oi,Switcher:Tr,Tab:Ir,Toggle:Cr,Video:fi,Close:Vi,Spinner:qi,SlidenavNext:Ri,SlidenavPrevious:Ri,SearchIcon:Wi,Marker:ji,NavbarToggleIcon:ji,OverlayIcon:ji,PaginationNext:ji,PaginationPrevious:ji,Totop:ji}),(function(t,e){return ri.component(e,t)})),ri.use((function(t){if(ct){var e,n,i=function(){e||(e=!0,yn.write((function(){return e=!1})),t.update(null,"resize"))}
...
i=i.length<2?"0"+i:i
var r=e[t]
r.textContent!==i&&((i=i.split("")).length!==r.children.length&&xe(r,i.map((function(){return"<span></span>"})).join("")),i.forEach((function(t,e){return r.children[e].textContent=t})))}))}},methods:{start:function(){this.stop(),this.date&&this.units.length&&(this.$update(),this.timer=setInterval(this.$update,1e3))},stop:function(){this.timer&&(clearInterval(this.timer),this.timer=null)}}},_r="uk-transition-leave",Or="uk-transition-enter"
function Nr(t,e,n,i){void 0===i&&(i=0)
var r=Dr(e,!0),o={opacity:1},s={opacity:0},a=function(t){return function(){return r===Dr(e)?t():de.reject()}},u=a((function(){return Be(e,_r),de.all(Pr(e).map((function(t,e){return new de((function(r){return setTimeout((function(){return nn.start(t,s,n/2,"ease").then(r)}),e*i)}))}))).then((function(){return He(e,_r)}))})),c=a((function(){var a=dn(e)
return Be(e,Or),t(),Ue(Bt(e),{opacity:0}),new de((function(t){return requestAnimationFrame((function(){var u=Bt(e),c=dn(e)
...
a!==c&&h.push(nn.start(e,{height:c},n/2+l.length*i,"ease")),de.all(h).then((function(){He(e,Or),r===Dr(e)&&(Ue(e,{height:"",alignContent:""}),Ue(u,{opacity:""}),delete e.dataset.transition),t()}))}))}))}))
return je(e,_r)?Mr(e).then(c):je(e,Or)?Mr(e).then(u).then(c):u().then(c)}function Dr(t,e){return e&&(t.dataset.transition=1+Dr(t)),H(t.dataset.transition)||0}function Mr(t){return de.all(Bt(t).filter(nn.inProgress).map((function(t){return new de((function(e){return te(t,"transitionend transitioncanceled",e)}))})))}function Pr(t){return yi(Bt(t)).reduce((function(t,e){return t.concat(K(e.filter((function(t){return Wn(t)})),"offsetLeft"))}),[])}function zr(t,e,n){return new de((function(i){return requestAnimationFrame((function(){var r=Bt(e),o=r.map((function(t){return Br(t,!0)})),s=Ue(e,["height","padding"])
nn.cancel(e),r.forEach(nn.cancel),Hr(e),t(),r=r.concat(Bt(e).filter((function(t){return!w(r,t)}))),de.resolve().then((function(){yn.flush()
var t=Ue(e,["height","padding"]),a=function(t,e,n){var i=e.map((function(t,e){return!(!Ct(t)||!(e in n))&&(n[e]?$t(t)?Fr(t):{opacity:0}:{opacity:$t(t)?1:0})})),r=i.map((function(i,r){var o=Ct(e[r])===t&&(n[r]||Br(e[r]))
...
de.all(o).then((function(){r.forEach((function(t,n){return Ct(t)===e&&Ue(t,"display",0===u[n].opacity?"none":"")})),Hr(e)}),Q).then(i)}))}))}))}))}function Br(t,e){var n=Ue(t,"zIndex")
...
void 0===e&&(e=this.$el)
var i=this.animation,r="fade"===i?Nr:"delayed-fade"===i?function(){for(var t=[],e=arguments.length;e--;)t[e]=arguments[e]
return Nr.apply(void 0,t.concat([40]))}:i?zr:function(){return t(),de.resolve()}
...
this.toggles.forEach((function(n){return Re(n,t.cls,w(e,n))}))}},immediate:!0},children:{get:function(t,e){return Pe(t.target+" > *",e)},watch:function(t,e){var n,i
...
return this.toggles.filter((function(e){return je(e,t.cls)})).reduce((function(e,n){return Wr(n,t.attrItem,e)}),{filter:{"":""},sort:[]})},setState:function(t,e){var n=this
void 0===e&&(e=!0),t=U({filter:{"":""},sort:[]},t),ee(this.$el,"beforeFilter",[this,t]),this.toggles.forEach((function(e){return Re(e,n.cls,!!function(t,e,n){var i=n.filter
void 0===i&&(i={"":""})
var r=n.sort,o=r[0],s=r[1],a=Rr(t,e),u=a.filter
void 0===u&&(u="")
var c=a.group
void 0===c&&(c="")
var l=a.sort,h=a.order
return void 0===h&&(h="asc"),z(l)?c in i&&u===i[c]||!u&&c&&!(c in i)&&!i[""]:o===l&&s===h}(e,n.attrItem,t))})),de.all(Pe(this.target,this.$el).map((function(i){var r=function(){(function(t,e,n){var i=function(t){var e=t.filter,n=""
return X(e,(function(t){return n+=t||""})),n}(t)
n.forEach((function(t){return Ue(t,"display",i&&!Nt(t,i)?"none":"")}))
...
q(a,n)||ke(e,a)}})(t,i,Bt(i)),n.$update(n.$el)}
...
function Rr(t,e){return On(ut(t,e),["filter"])}function Wr(t,e,n){var i=Rr(t,e),r=i.filter,o=i.group,s=i.sort,a=i.order
return void 0===a&&(a="asc"),(r||z(s))&&(o?r?(delete n.filter[""],n.filter[o]=r):(delete n.filter[o],(P(n.filter)||""in n.filter)&&(n.filter={"":r||""})):n.filter={"":r||""}),z(s)||(n.sort=[s,a]),n}var Vr={slide:{show:function(t){return[{transform:Gr(-100*t)},{transform:Gr()}]},percent:function(t){return qr(t)},translate:function(t,e){return[{transform:Gr(-100*e*t)},{transform:Gr(100*e*(1-t))}]}}}
...
this.$update(e)},beforeitemshow:function(t){Be(t.target,this.clsActive)},itemshown:function(t){Be(t.target,this.clsActivated)},itemhidden:function(t){He(t.target,this.clsActive,this.clsActivated)}}},eo={mixins:[pi,ar,si,to],functional:!0,props:{delayControls:Number,preload:Number,videoAutoplay:Boolean,template:String},data:function(){return{preload:1,videoAutoplay:!1,delayControls:3e3,items:[],cls:"uk-open",clsPage:"uk-lightbox-page",selList:".uk-lightbox-items",attrItem:"uk-lightbox-item",selClose:".uk-close-large",selCaption:".uk-lightbox-caption",pauseOnHover:!1,velocity:2,Animations:Yr,template:'<div class="uk-lightbox uk-overflow-hidden"> <ul class="uk-lightbox-items"></ul> <div class="uk-lightbox-toolbar uk-position-top uk-text-right uk-transition-slide-top uk-transition-opaque"> <button class="uk-lightbox-toolbar-icon uk-close-large" type="button" uk-close></button> </div> <a class="uk-lightbox-button uk-position-center-left uk-position-medium uk-transition-fade" href uk-slidenav-previous uk-lightbox-item="previous"></a> <a class="uk-lightbox-button uk-position-center-right uk-position-medium uk-transition-fade" href uk-slidenav-next uk-lightbox-item="next"></a> <div class="uk-lightbox-toolbar uk-lightbox-caption uk-position-bottom uk-text-center uk-transition-slide-bottom uk-transition-opaque"></div> </div>'}},created:function(){var t=Me(this.template),e=Me(this.selList,t)
...
function oo(t){var e={}
return["href","caption","type","poster","alt","attrs"].forEach((function(n){e["href"===n?"source":n]=ut(t,n)})),e.attrs=On(e.attrs),e}var so={mixins:[pi],functional:!0,args:["message","status"],data:{message:"",status:"",timeout:5e3,group:null,pos:"top-center",clsContainer:"uk-notification",clsClose:"uk-notification-close",clsMsg:"uk-notification-message"},install:function(t){t.notification.closeAll=function(e,n){De(document.body,(function(i){var r=t.getComponent(i,"notification")
...
this.timer&&clearTimeout(this.timer),t?n(this.$el):nn.start(this.$el,this.startProps).then(n)}}},ao=["x","y","bgx","bgy","rotate","scale","color","backgroundColor","borderColor","opacity","blur","hue","grayscale","invert","saturate","sepia","fopacity","stroke"],uo={mixins:[rr],props:ao.reduce((function(t,e){return t[e]="list",t}),{}),data:ao.reduce((function(t,e){return t[e]=void 0,t}),{}),computed:{props:function(t,e){var n=this
return ao.reduce((function(i,r){if(z(t[r]))return i
var o,s,a,u=r.match(/color/i),c=u||"opacity"===r,l=t[r].slice()
c&&Ue(e,r,""),l.length<2&&l.unshift(("scale"===r?1:c?Ue(e,r):0)||0)
var f=function(t){return t.reduce((function(t,e){return N(e)&&e.replace(/-|\d/g,"").trim()||t}),"")}(l)
if(u){var d=e.style.color
l=l.map((function(t){return function(t,e){return Ue(Ue(t,"color",e),"color").split(/[(),]/g).slice(1,-1).concat(1).slice(0,4).map(F)}(e,t)})),e.style.color=d}else if(h(r,"bg")){var p="bgy"===r?"height":"width"
if(l=l.map((function(t){return wn(t,p,n.$el)})),Ue(e,"background-position-"+r[2],""),s=Ue(e,"backgroundPosition").split(" ")["x"===r[2]?0:1],n.covers){var v=Math.min.apply(Math,l),m=Math.max.apply(Math,l),g=l.indexOf(v)<l.indexOf(m)
a=m-v,l=l.map((function(t){return t-(g?v:m)})),o=(g?-a:0)+"px"}else o=s}else l=l.map(F)
if("stroke"===r){if(!l.some((function(t){return t})))return i
var w=Pi(n.$el)
Ue(e,"strokeDasharray",w),"%"===f&&(l=l.map((function(t){return t*w/100}))),l=l.reverse(),r="strokeDashoffset"}return i[r]={steps:l,unit:f,pos:o,bgPos:s,diff:a},i}),{})},bgProps:function(){var t=this
...
if(this.matchMedia){if(!t.image&&this.covers&&this.bgProps.length){var n=Ue(this.$el,"backgroundImage").replace(/^none|url\(["']?(.+?)["']?\)$/,"$1")
...
this.bgProps.forEach((function(t){var n=e.props[t],i=n.diff,r=n.bgPos,u=n.steps,c="bgy"===t?"height":"width",l=a[c]-o[c]
if(l<i)o[c]=a[c]+i-l
else if(l>i){var h=o[c]/wn(r,c,e.$el)
h&&(e.props[t].steps=u.map((function(t){return t-(l-i)/h})))}a=nt.cover(s,o)})),t.dim=a}}},write:function(t){var e=t.dim
this.matchMedia?e&&Ue(this.$el,{backgroundSize:e.width+"px "+e.height+"px",backgroundRepeat:"no-repeat"}):Ue(this.$el,{backgroundSize:"",backgroundRepeat:""})},events:["resize"]},methods:{reset:function(){var t=this
X(this.getCss(0),(function(e,n){return Ue(t.$el,n,"")}))},getCss:function(t){var e=this.props
return Object.keys(e).reduce((function(n,i){var r=e[i],o=r.steps,s=r.unit,u=r.pos,c=function(t,e,n){void 0===n&&(n=2)
var i=co(t,e),r=i[0],o=i[1],s=i[2]
return(D(r)?r+Math.abs(r-o)*s*(r<o?1:-1):+o).toFixed(n)}(o,t)
switch(i){case"x":case"y":s=s||"px",n.transform+=" translate"+a(i)+"("+F(c).toFixed("px"===s?0:2)+s+")"
break
case"rotate":s=s||"deg",n.transform+=" rotate("+(c+s)+")"
break
case"scale":n.transform+=" scale("+c+")"
break
case"bgy":case"bgx":n["background-position-"+i[2]]="calc("+u+" + "+c+"px)"
break
case"color":case"backgroundColor":case"borderColor":var l=co(o,t),h=l[0],f=l[1],d=l[2]
n[i]="rgba("+h.map((function(t,e){return t+=d*(f[e]-t),3===e?F(t):parseInt(t,10)})).join(",")+")"
break
case"blur":s=s||"px",n.filter+=" blur("+(c+s)+")"
break
case"hue":s=s||"deg",n.filter+=" hue-rotate("+(c+s)+")"
break
case"fopacity":s=s||"%",n.filter+=" opacity("+(c+s)+")"
break
case"grayscale":case"invert":case"saturate":case"sepia":s=s||"%",n.filter+=" "+i+"("+(c+s)+")"
break
default:n[i]=c}return n}),{transform:"",filter:""})}}}
function co(t,e){var n=t.length-1,i=Math.min(Math.floor(n*e),n-1),r=t.slice(i,i+2)
return r.push(1===e?1:e%(1/n)*n),r}var lo={mixins:[uo],props:{target:String,viewport:Number,easing:Number},data:{target:!1,viewport:1,easing:1},computed:{target:function(t,e){var n=t.target
return fo(n&&Ft(n,e)||e)}},update:{read:function(t,e){var n=t.percent
if(e.has("scroll")||(n=!1),this.matchMedia){var i=n
return{percent:n=ho(Gn(this.target)/(this.viewport||1),this.easing),style:i!==n&&this.getCss(n)}}},write:function(t){var e=t.style
this.matchMedia?e&&Ue(this.$el,e):this.reset()},events:["scroll","resize"]}}
function ho(t,e){return J(t*(1-(e-e*t)))}function fo(t){return t?"offsetTop"in t?t:fo(Ct(t)):document.body}var po={update:{write:function(){if(!this.stack.length&&!this.dragging){var t=this.getValidIndex(this.index)
~this.prevIndex&&this.index===t||this.show(t)}},events:["resize"]}}
function vo(t,e,n){var i=wo(t,e)
return n?i-function(t,e){return cn(e).width/2-cn(t).width/2}(t,e):Math.min(i,mo(e))}function mo(t){return Math.max(0,go(t)-cn(t).width)}function go(t){return Bt(t).reduce((function(t,e){return cn(e).width+t}),0)}function wo(t,e){return t&&(hn(t).left+(ht?cn(t).width-cn(e).width:0))*(ht?-1:1)||0}function bo(t,e){e-=1
var n=cn(t).width,i=e+n+2
return Bt(t).filter((function(r){var o=wo(r,t),s=o+Math.min(cn(r).width,n)
return o>=e&&s<=i}))}function yo(t,e,n){ee(t,ne(e,!1,!1,n))}var xo={mixins:[oi,Jr,po],props:{center:Boolean,sets:Boolean},data:{center:!1,sets:!1,attrItem:"uk-slider-item",selList:".uk-slider-items",selNav:".uk-slider-nav",clsContainer:"uk-slider-container",Transitioner:function(t,e,n,i){var r=i.center,o=i.easing,s=i.list,a=new pe,u=t?vo(t,s,r):vo(e,s,r)+cn(e).width*n,c=e?vo(e,s,r):u+cn(t).width*n*(ht?-1:1)
return{dir:n,show:function(e,i,r){void 0===i&&(i=0)
var u=r?"linear":o
return e-=Math.round(e*J(i,-1,1)),this.translate(i),i=t?i:J(i,0,1),yo(this.getItemIn(),"itemin",{percent:i,duration:e,timing:u,dir:n}),t&&yo(this.getItemIn(!0),"itemout",{percent:1-i,duration:e,timing:u,dir:n}),nn.start(s,{transform:Gr(-c*(ht?-1:1),"px")},e,u).then(a.resolve,Q),a.promise},cancel:function(){nn.cancel(s)},reset:function(){Ue(s,"transform","")},forward:function(t,e){return void 0===e&&(e=this.percent()),nn.cancel(s),this.show(t,e,!0)},translate:function(i){var r=this.getDistance()*n*(ht?-1:1)
Ue(s,"transform",Gr(J(r-r*i-c,-go(s),cn(s).width)*(ht?-1:1),"px"))
var o=this.getActives(),a=this.getItemIn(),u=this.getItemIn(!0)
i=t?J(i,-1,1):0,Bt(s).forEach((function(r){var c=w(o,r),l=r===a,h=r===u
yo(r,"itemtranslate"+(l||!h&&(c||n*(ht?-1:1)==-1^wo(r,s)>wo(t||e))?"in":"out"),{dir:n,percent:h?1-i:l?i:c?1:0})}))},percent:function(){return Math.abs((Ue(s,"transform").split(",")[4]*(ht?-1:1)+u)/(c-u))},getDistance:function(){return Math.abs(c-u)},getItemIn:function(n){void 0===n&&(n=!1)
var i=this.getActives(),o=bo(s,vo(e||t,s,r))
if(n){var a=i
i=o,o=a}return o[y(o,(function(t){return!w(i,t)}))]},getActives:function(){return bo(s,vo(t||e,s,r))}}}},computed:{avgWidth:function(){return go(this.list)/this.length},finite:function(t){return t.finite||Math.ceil(go(this.list))<cn(this.list).width+(e=this.list,Math.max.apply(Math,[0].concat(Bt(e).map((function(t){return cn(t).width})))))+this.center
var e},maxIndex:function(){if(!this.finite||this.center&&!this.sets)return this.length-1
if(this.center)return Y(this.sets)
var t=0,e=mo(this.list),n=y(this.slides,(function(n){if(t>=e)return!0
t+=cn(n).width}))
...
e.center&&c&&u<o-cn(c).width/2?o-=u:(o=i,t.push(a),r=s+i+(e.center?u/2:0))}return s+=u,t}),[]),!P(n)&&n}},transitionOptions:function(){return{center:this.center,list:this.list}}},connected:function(){Re(this.$el,this.clsContainer,!Me("."+this.clsContainer,this.$el))},update:{write:function(){var t=this
...
this.duration=Qr(this.avgWidth/this.velocity)*(cn(this.slides[i]).width/this.avgWidth),this.reorder()}},itemshow:function(){~this.prevIndex&&Be(this._getTransitioner().getItemIn(),this.clsActive)}},methods:{reorder:function(){var t=this
...
return t}}},ko={mixins:[uo],data:{selItem:"!li"},computed:{item:function(t,e){return Ft(t.selItem,e)}},events:[{name:"itemin itemout",self:!0,el:function(){return this.item},handler:function(t){var e=this,n=t.type,i=t.detail,r=i.percent,o=i.duration,s=i.timing,a=i.dir
yn.read((function(){var t=e.getCss(So(n,a,r)),i=e.getCss($o(n)?.5:a>0?1:0)
...
e>0&&Ue(this.list,"minHeight",e)},events:["resize"]}},Ao={mixins:[oi,Lr],props:{group:String,threshold:Number,clsItem:String,clsPlaceholder:String,clsDrag:String,clsDragState:String,clsBase:String,clsNoDrag:String,clsEmpty:String,clsCustom:String,handle:String},data:{group:!1,threshold:5,clsItem:"uk-sortable-item",clsPlaceholder:"uk-sortable-placeholder",clsDrag:"uk-sortable-drag",clsDragState:"uk-drag",clsBase:"uk-sortable",clsNoDrag:"uk-sortable-nodrag",clsEmpty:"uk-sortable-empty",clsCustom:"",handle:!1,pos:{}},created:function(){var t=this;["init","start","move","end"].forEach((function(e){var n=t[e]
t[e]=function(e){U(t.pos,fe(e)),n(e)}}))},events:{name:vt,passive:!1,handler:"init"},computed:{target:function(){return(this.$el.tBodies||[this.$el])[0]},items:function(){return Bt(this.target)},isEmpty:{get:function(){return P(this.items)},watch:function(t){Re(this.target,this.clsEmpty,t)},immediate:!0},handles:{get:function(t,e){var n=t.handle
...
if(!l.length||h&&h!==u){var f=this.getSortable(u),d=function(t,e,n,i,r,o){if(Bt(t).length){var s=e.getBoundingClientRect()
if(!o)return function(t,e){var n=1===Bt(t).length
n&&ke(t,e)
var i=Bt(t),r=i.some((function(t,e){var n=t.getBoundingClientRect()
return i.slice(e+1).some((function(t){var e=t.getBoundingClientRect()
return!_o([n.left,n.right],[e.left,e.right])}))}))
return n&&Te(e),r}(t,n)||r<s.top+s.height/2?e:e.nextElementSibling
var a=n.getBoundingClientRect(),u=_o([s.top,s.bottom],[a.top,a.bottom]),c=u?i:r,l=u?"width":"height",h=u?"left":"top",f=u?"right":"bottom",d=a[l]<s[l]?s[l]-a[l]:0
...
U(this.origin,{offsetLeft:this.pos.x-r,offsetTop:this.pos.y-o}),Be(this.drag,this.clsDrag,this.clsCustom),Be(this.placeholder,this.clsPlaceholder),Be(this.items,this.clsItem),Be(document.documentElement,this.clsDragState),ee(this.$el,"start",[this,this.placeholder]),function(t){var e=Date.now()
Eo=setInterval((function(){var n=t.x,i=t.y
...
if(Qt(document,mt,this.move),Qt(document,gt,this.end),Qt(window,"scroll",this.scroll),this.drag){clearInterval(Eo)
...
Be(this.items,this.clsItem),this.animate((function(){return e?$e(e,t):ke(n.target,t)}))},remove:function(t){Pt(t,this.target)&&this.animate((function(){return Te(t)}))},getSortable:function(t){do{var e=this.$getComponent(t,"sortable")
if(e&&(e===this||!1!==this.group&&e.group===this.group))return e}while(t=Ct(t))}}}
function _o(t,e){return t[1]>e[0]&&e[1]>t[0]}var Oo={mixins:[pi,si,vi],args:"title",props:{delay:Number,title:String},data:{pos:"top",title:"",delay:0,animation:["uk-animation-scale-up"],duration:100,cls:"uk-active",clsPos:"uk-tooltip"},beforeConnect:function(){var t
...
Nt(this.$el,"input:focus")||(clearTimeout(this.showTimer),this.isToggled(this.tooltip||null)&&this.toggleElement(this.tooltip,!1,!1).then((function(){Te(t.tooltip),t.tooltip=null,t._unbind()})))},_show:function(){var t=this
this.tooltip=ke(this.container,'<div class="'+this.clsPos+'"> <div class="'+this.clsPos+'-inner">'+this.title+"</div> </div>"),Jt(this.tooltip,"toggled",(function(e,n){t.updateAria(n),n&&(t.positionAt(t.tooltip,t.$el),t.origin="y"===t.getAxis()?gn(t.dir)+"-"+t.align:t.align+"-"+gn(t.dir))})),this.toggleElement(this.tooltip,!0)},updateAria:function(t){ot(this.$el,"aria-expanded",t)}},events:(To={focus:"show",blur:"hide"},To[wt+" "+bt]=function(t){he(t)||this[t.type===wt?"show":"hide"]()},To[vt]=function(t){he(t)&&this.show()},To)},No={props:{allow:String,clsDragover:String,concurrent:Number,maxSize:Number,method:String,mime:String,msgInvalidMime:String,msgInvalidName:String,msgInvalidSize:String,multiple:Boolean,name:String,params:Object,type:String,url:String},data:{allow:!1,clsDragover:"uk-dragover",concurrent:1,maxSize:0,method:"POST",mime:!1,msgInvalidMime:"Invalid File Type: %s",msgInvalidName:"Invalid File Name: %s",msgInvalidSize:"Invalid File Size: %s Kilobytes Max",multiple:!1,name:"files[]",params:{},type:"",url:"",abort:Q,beforeAll:Q,beforeSend:Q,complete:Q,completeAll:Q,error:Q,fail:Q,load:Q,loadEnd:Q,loadStart:Q,progress:Q},events:{change:function(t){Nt(t.target,'input[type="file"]')&&(t.preventDefault(),t.target.files&&this.upload(t.target.files),t.target.value="")},drop:function(t){Mo(t)
var e=t.dataTransfer
e&&e.files&&(He(this.$el,this.clsDragover),this.upload(e.files))},dragenter:function(t){Mo(t)},dragover:function(t){Mo(t),Be(this.$el,this.clsDragover)},dragleave:function(t){Mo(t),He(this.$el,this.clsDragover)}},methods:{upload:function(t){var e=this
...
if(this.allow&&!Do(this.allow,t[n].name))return void this.fail(this.msgInvalidName.replace("%s",this.allow))
if(this.mime&&!Do(this.mime,t[n].type))return void this.fail(this.msgInvalidMime.replace("%s",this.mime))}this.multiple||(t=[t[0]]),this.beforeAll(this,t)
...
r(i.shift())}}}}
function Do(t,e){return e.match(new RegExp("^"+t.replace(/\//g,"\\/").replace(/\*\*/g,"(\\/[^\\/]+)*").replace(/\*/g,"[^\\/]+").replace(/((?!\\))\?/g,"$1.")+"$","i"))}function Mo(t){t.preventDefault(),t.stopPropagation()}return X(Object.freeze({__proto__:null,Countdown:Ar,Filter:jr,Lightbox:ro,LightboxPanel:eo,Notification:so,Parallax:lo,Slider:xo,SliderParallax:ko,Slideshow:Co,SlideshowParallax:ko,Sortable:Ao,Tooltip:Oo,Upload:No}),(function(t,e){return ri.component(e,t)})),ri}()},339:(t,e,n)=>{"use strict"
n.r(e),n.d(e,{setup:()=>c})
