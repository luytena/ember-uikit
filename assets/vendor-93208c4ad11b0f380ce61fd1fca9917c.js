...
e.default=be})),t("@ember/-internals/bootstrap")}(),"undefined"==typeof FastBoot&&/*! UIkit 3.13.7 | https://www.getuikit.com | (c) 2014 - 2022 YOOtheme | MIT License */
...
s.style.setProperty(t,P(r)&&!We[t]?r+"px":r||C(r)?r:"",n)}else{if(p(t)){const e={}
for(const r of t)e[r]=Ye(s,r)
return e}v(t)&&(n=r,z(t,((e,t)=>Ye(s,t,e,n))))}return i[0]}const Ge=/^\s*(["'])?(.*?)\1\s*$/
function Ke(e,t){return void 0===t&&(t=document.documentElement),Ye(t,"--uk-"+e).replace(Ge,"$2")}const Qe=K((e=>function(e){if("-"===e[0])return e
e=i(e)
const{style:t}=document.documentElement
if(e in t)return e
let r,n=Ze.length
for(;n--;)if(r="-"+Ze[n]+"-"+e,r in t)return r}(e))),Ze=["webkit","moz"]
...
it(e,r,"remove")}function et(e,t){Z(e,"class",(e=>(e||"").replace(new RegExp("\\b"+t+"\\b","g"),"")))}function tt(e){(arguments.length<=1?void 0:arguments[1])&&Je(e,arguments.length<=1?void 0:arguments[1]),(arguments.length<=2?void 0:arguments[2])&&Xe(e,arguments.length<=2?void 0:arguments[2])}function rt(e,t){return[t]=st(t),!!t&&I(e).some((e=>e.classList.contains(t)))}function nt(e,t,r){const n=st(t)
S(r)||(r=!!r)
for(const i of I(e))for(const e of n)i.classList.toggle(e,r)}function it(e,t,r){t=t.reduce(((e,t)=>e.concat(st(t))),[])
for(const n of I(e))n.classList[r](...t)}function st(e){return String(e).split(/\s|,/).filter(Boolean)}function ot(e,t,r,n){return void 0===r&&(r=400),void 0===n&&(n="linear"),Promise.all(I(e).map((e=>new Promise(((i,s)=>{for(const r in t){const t=Ye(e,r)
""===t&&Ye(e,r,t)}const o=setTimeout((()=>je(e,"transitionend")),r)
Re(e,"transitionend transitioncanceled",(t=>{let{type:r}=t
clearTimeout(o),Je(e,"uk-transition"),Ye(e,{transitionProperty:"",transitionDuration:"",transitionTimingFunction:""}),"transitioncanceled"===r?s():i(e)}),{self:!0}),Xe(e,"uk-transition"),Ye(e,{transitionProperty:Object.keys(t).map(Qe).join(","),transitionDuration:r+"ms",transitionTimingFunction:n,...t})})))))}const at={start:ot,stop:e=>(je(e,"transitionend"),Promise.resolve()),cancel(e){je(e,"transitioncanceled")},inProgress:e=>rt(e,"uk-transition")},lt="uk-animation-"
function ut(e,t,r,n,i){return void 0===r&&(r=200),Promise.all(I(e).map((e=>new Promise(((s,o)=>{je(e,"animationcanceled")
const a=setTimeout((()=>je(e,"animationend")),r)
Re(e,"animationend animationcanceled",(t=>{let{type:r}=t
clearTimeout(a),"animationcanceled"===r?o():s(e),Ye(e,"animationDuration",""),et(e,"uk-animation-\\S*")}),{self:!0}),Ye(e,"animationDuration",r+"ms"),Xe(e,t,lt+(i?"leave":"enter")),u(t,lt)&&(n&&Xe(e,"uk-transform-origin-"+n),i&&Xe(e,"uk-animation-reverse"))})))))}const ct=new RegExp("uk-animation-(enter|leave)"),dt={in:ut,out:(e,t,r,n)=>ut(e,t,r,n,!0),inProgress:e=>ct.test(Z(e,"class")),cancel(e){je(e,"animationcanceled")}},ht={width:["left","right"],height:["top","bottom"]}
...
for(const e in ht)for(const t of ht[e])r[t]+=i[e]}if(!t)return r
const n=Ye(e,"position")
z(Ye(e,["left","top"]),((i,s)=>Ye(e,s,t[s]-r[s]+R("absolute"===n&&"auto"===i?mt(e)[s]:i))))}function mt(e){let{top:t,left:r}=ft(e)
const{ownerDocument:{body:n,documentElement:i},offsetParent:s}=j(e)
let o=s||i
for(;o&&(o===n||o===i)&&"static"===Ye(o,"position");)o=o.parentNode
if(k(o)){const e=ft(o)
t-=e.top+R(Ye(o,"borderTopWidth")),r-=e.left+R(Ye(o,"borderLeftWidth"))}return{top:t-R(Ye(e,"marginTop")),left:r-R(Ye(e,"marginLeft"))}}function gt(e){const t=[0,0]
e=j(e)
...
return Math.max(e["offset"+t],e["scroll"+t])}return(n="auto"===(n=Ye(r=j(r),e))?r["offset"+t]:R(n)||0)-wt(r,e)}return Ye(r,e,n||0===n?+n+wt(r,e)+"px":"")}}function wt(e,t,r){return void 0===r&&(r="border-box"),Ye(e,"boxSizing")===r?ht[t].map(a).reduce(((t,r)=>t+R(Ye(e,"padding"+r))+R(Ye(e,"border"+r+"Width"))),0):0}function _t(e){for(const t in ht)for(const r in ht[t])if(ht[t][r]===e)return ht[t][1-r]
...
function Pt(e){"loading"===document.readyState?Re(document,"DOMContentLoaded",e):e()}function Tt(e,t){var r
return(null==e||null==(r=e.tagName)?void 0:r.toLowerCase())===t.toLowerCase()}function St(e,t){return S(t)?qt(e).innerHTML:At(e,t)}const At=Lt("replaceChildren"),Mt=Lt("prepend"),Rt=Lt("append"),jt=Lt("before"),It=Lt("after")
function Lt(e){return function(t,r){var n
const i=I(E(r)?Ut(r):r)
return null==(n=qt(t))||n[e](...i),Ht(i)}}function Nt(e){I(e).forEach((e=>e.remove()))}function Dt(e,t){for(t=j(jt(e,t));t.firstChild;)t=t.firstChild
return Rt(t,e),t}function Ft(e,t){return I(I(e).map((e=>e.hasChildNodes()?Dt(I(e.childNodes),t):Rt(e,t))))}function $t(e){I(e).map(le).filter(((e,t,r)=>r.indexOf(e)===t)).forEach((e=>e.replaceWith(...e.childNodes)))}const zt=/^\s*<(\w+|!)[^>]*>/,Bt=/^<(\w+)\s*\/?>(?:<\/\1>)?$/
function Ut(e){const t=Bt.exec(e)
if(t)return document.createElement(t[1])
const r=document.createElement("div")
return zt.test(e)?r.insertAdjacentHTML("beforeend",e.trim()):r.textContent=e,Ht(r.childNodes)}function Ht(e){return e.length>1?e:e[0]}function Vt(e,t){if(k(e))for(t(e),e=e.firstElementChild;e;){const r=e.nextElementSibling
Vt(e,t),e=r}}function qt(e,t){return Yt(e)?j(Ut(e)):be(e,t)}function Wt(e,t){return Yt(e)?I(Ut(e)):ye(e,t)}function Yt(e){return E(e)&&u(e.trim(),"<")}const Gt="undefined"!=typeof window,Kt=Gt&&"rtl"===Z(document.documentElement,"dir"),Qt=Gt&&"ontouchstart"in window,Zt=Gt&&window.PointerEvent,Xt=Zt?"pointerdown":Qt?"touchstart":"mousedown",Jt=Zt?"pointermove":Qt?"touchmove":"mousemove",er=Zt?"pointerup":Qt?"touchend":"mouseup",tr=Zt?"pointerenter":Qt?"":"mouseenter",rr=Zt?"pointerleave":Qt?"":"mouseleave",nr=Zt?"pointercancel":"touchcancel",ir={reads:[],writes:[],read(e){return this.reads.push(e),or(),e},write(e){return this.writes.push(e),or(),e},clear(e){lr(this.reads,e),lr(this.writes,e)},flush:sr}
function sr(e){ar(ir.reads),ar(ir.writes.splice(0)),ir.scheduled=!1,(ir.reads.length||ir.writes.length)&&or(e+1)}function or(e){ir.scheduled||(ir.scheduled=!0,e&&e<4?Promise.resolve().then((()=>sr(e))):requestAnimationFrame((()=>sr(1))))}function ar(e){let t
for(;t=e.shift();)try{t()}catch(r){console.error(r)}}function lr(e,t){const r=e.indexOf(t)
return~r&&e.splice(r,1)}function ur(){}function cr(e,t,r,n){void 0===n&&(n=!0)
const i=new IntersectionObserver(n?(e,r)=>{e.some((e=>e.isIntersecting))&&t(e,r)}:t,r)
for(const s of I(e))i.observe(s)
return i}ur.prototype={positions:[],init(){let e
...
return r&&W(r,t)}))}}
const dr=Gt&&window.ResizeObserver
function hr(e,t,r){return void 0===r&&(r={box:"border-box"}),dr?mr(ResizeObserver,e,t,r):(function(){if(pr)return
let e
pr=new Set
const t=()=>{if(!e){e=!0,ir.read((()=>e=!1))
for(const e of pr)e()}}
Ae(window,"load resize",t),Ae(document,"loadedmetadata load",t,!0)}(),pr.add(t),{disconnect(){pr.delete(t)}})}let pr
function fr(e,t,r){return mr(MutationObserver,e,t,r)}function mr(e,t,r,n){const i=new e(r)
for(const s of I(t))i.observe(s,n)
return i}const gr={}
function vr(e,t,r){return gr.computed(g(e)?e.call(r,r):e,g(t)?t.call(r,r):t)}function br(e,t){return e=e&&!p(e)?[e]:e,t?e?e.concat(t):p(t)?t:[t]:e}function yr(e,t){return S(t)?e:t}function wr(e,t,n){const i={}
if(g(t)&&(t=t.options),t.extends&&(e=wr(e,t.extends,n)),t.mixins)for(const r of t.mixins)e=wr(e,r,n)
for(const r in e)s(r)
for(const o in t)r(e,o)||s(o)
function s(r){i[r]=(gr[r]||yr)(e[r],t[r],n)}return i}function _r(e,t){void 0===t&&(t=[])
try{return e?u(e,"{")?JSON.parse(e):t.length&&!d(e,":")?{[t[0]]:e}:e.split(";").reduce(((e,t)=>{const[r,n]=t.split(/:(.*)/)
return r&&!S(n)&&(e[r.trim()]=n.trim()),e}),{}):{}}catch(r){return{}}}function kr(e){if(Pr(e)&&Ar(e,{func:"playVideo",method:"play"}),Cr(e))try{e.play().catch(V)}catch(t){}}function xr(e){Pr(e)&&Ar(e,{func:"pauseVideo",method:"pause"}),Cr(e)&&e.pause()}function Or(e){Pr(e)&&Ar(e,{func:"mute",method:"setVolume",value:0}),Cr(e)&&(e.muted=!0)}function Er(e){return Cr(e)||Pr(e)}function Cr(e){return Tt(e,"video")}function Pr(e){return Tt(e,"iframe")&&(Tr(e)||Sr(e))}function Tr(e){return!!e.src.match(/\/\/.*?youtube(-nocookie)?\.[a-z]+\/(watch\?v=[^&\s]+|embed)|youtu\.be\/.*/)}function Sr(e){return!!e.src.match(/vimeo\.com\/video\/.*/)}async function Ar(e,t){await function(e){if(e._ukPlayer)return e._ukPlayer
const t=Tr(e),r=Sr(e),n=++Rr
let i
return e._ukPlayer=new Promise((s=>{t&&Re(e,"load",(()=>{const t=()=>Mr(e,{event:"listening",id:n})
i=setInterval(t,100),t()})),Re(window,"message",s,!1,(e=>{let{data:i}=e
try{return i=JSON.parse(i),i&&(t&&i.id===n&&"onReady"===i.event||r&&Number(i.player_id)===n)}catch(s){}})),e.src=e.src+(d(e.src,"?")?"&":"?")+(t?"enablejsapi=1":"api=1&player_id="+n)})).then((()=>clearInterval(i)))}(e),Mr(e,t)}function Mr(e,t){try{e.contentWindow.postMessage(JSON.stringify({event:"command",...t}),"*")}catch(r){}}gr.events=gr.created=gr.beforeConnect=gr.connected=gr.beforeDisconnect=gr.disconnected=gr.destroy=br,gr.args=function(e,t){return!1!==t&&br(t||e)},gr.update=function(e,t){return B(br(e,g(t)?{read:t}:t),"order")},gr.props=function(e,t){if(p(t)){const e={}
for(const r of t)e[r]=String
t=e}return gr.methods(e,t)},gr.computed=gr.methods=function(e,t){return t?e?{...e,...t}:t:e},gr.data=function(e,t,r){return r?vr(e,t,r):t?e?function(r){return vr(e,t,r)}:t:e}
let Rr=0
function jr(e,t,r){return void 0===t&&(t=0),void 0===r&&(r=0),!!ne(e)&&q(...Dr(e).map((e=>{const{top:n,left:i,bottom:s,right:o}=ft(Fr(e))
return{top:n-t,left:i-r,bottom:s+t,right:o+r}})).concat(ft(e)))}function Ir(e,t){if(e=y(e)||w(e)?zr(e):j(e),S(t))return e.scrollTop
e.scrollTop=t}function Lr(e,t){let{offset:r=0}=void 0===t?{}:t
const n=ne(e)?Dr(e):[]
return n.reduce(((t,s,o)=>{const{scrollTop:a,scrollHeight:l,offsetHeight:u}=s,c=l-$r(s),{height:d,top:h}=ft(n[o-1]||e)
let p=Math.ceil(h-ft(Fr(s)).top-r+a)
...
var l
Ir(e,n+t*a),1===a?r():requestAnimationFrame(s)})()}))}}function Nr(e,t,r){if(void 0===t&&(t=0),void 0===r&&(r=0),!ne(e))return 0
const[n]=Dr(e,/auto|scroll/,!0),{scrollHeight:i,scrollTop:s}=n,o=$r(n),a=i-o,l=gt(e)[0]-gt(n)[0],u=Math.max(0,l-o+t)
return H((s-u)/(Math.min(a,l+e.offsetHeight-r)-u))}function Dr(e,t,r){void 0===t&&(t=/auto|scroll|hidden/),void 0===r&&(r=!1)
const n=zr(e)
let i=pe(e).reverse()
i=i.slice(i.indexOf(n)+1)
const s=h(i,(e=>"fixed"===Ye(e,"position")))
return~s&&(i=i.slice(s)),[n].concat(i.filter((e=>t.test(Ye(e,"overflow"))&&(!r||e.scrollHeight>$r(e))))).reverse()}function Fr(e){return e===zr(e)?window:e}function $r(e){return(e===zr(e)?document.documentElement:e).clientHeight}function zr(e){const{document:t}=L(e)
return t.scrollingElement||t.documentElement}const Br={width:["x","left","right"],height:["y","top","bottom"]}
function Ur(e,t,r,n,i,s,o,a){r=Vr(r),n=Vr(n)
const l={element:r,target:n}
if(!e||!t)return l
const u=ft(e),c=ft(t),h=c
if(Hr(h,r,u,-1),Hr(h,n,c,1),i=qr(i,u.width,u.height),s=qr(s,c.width,c.height),i.x+=s.x,i.y+=s.y,h.left+=i.x,h.top+=i.y,o){let t=Dr(e).map(Fr)
a&&!d(t,a)&&t.unshift(a),t=t.map((e=>ft(e))),z(Br,((e,s)=>{let[a,p,f]=e;(!0===o||d(o,a))&&t.some((e=>{const t=r[a]===p?-u[s]:r[a]===f?u[s]:0,o=n[a]===p?c[s]:n[a]===f?-c[s]:0
...
for(const e of["element","target"])t&&(l[e][a]=l[e][a]===Br[s][1]?Br[s][2]:Br[s][1])
return!0}}}))}))}return ft(e,h),l}function Hr(e,t,r,n){z(Br,((i,s)=>{let[o,a,l]=i
t[o]===l?e[a]+=r[s]*n:"center"===t[o]&&(e[a]+=r[s]*n/2)}))}function Vr(e){const t=/left|center|right/,r=/top|center|bottom/
return 1===(e=(e||"").split(" ")).length&&(e=t.test(e[0])?e.concat("center"):r.test(e[0])?["center"].concat(e):["center","center"]),{x:t.test(e[0])?e[0]:"center",y:r.test(e[1])?e[1]:"center"}}function qr(e,t,r){const[n,i]=(e||"").split(" ")
return{x:n?R(n)*(c(n,"%")?t/100:1):0,y:i?R(i)*(c(i,"%")?r/100:1):0}}var Wr=Object.freeze({__proto__:null,ajax:Ve,getImage:qe,transition:ot,Transition:at,animate:ut,Animation:dt,attr:Z,hasAttr:X,removeAttr:J,data:ee,addClass:Xe,removeClass:Je,removeClasses:et,replaceClass:tt,hasClass:rt,toggleClass:nt,dimensions:pt,offset:ft,position:mt,offsetPosition:gt,height:vt,width:bt,boxModelAdjust:wt,flipPosition:_t,toPx:kt,ready:Pt,isTag:Tt,empty:function(e){return At(e,"")},html:St,replaceChildren:At,prepend:Mt,append:Rt,before:jt,after:It,remove:Nt,wrapAll:Dt,wrapInner:Ft,unwrap:$t,fragment:Ut,apply:Vt,$:qt,$$:Wt,inBrowser:Gt,isRtl:Kt,hasTouch:Qt,pointerDown:Xt,pointerMove:Jt,pointerUp:er,pointerEnter:tr,pointerLeave:rr,pointerCancel:nr,on:Ae,off:Me,once:Re,trigger:je,createEvent:Ie,toEventTargets:Be,isTouch:Ue,getEventPos:He,fastdom:ir,isVoidElement:re,isVisible:ne,selInput:ie,isInput:se,selFocusable:oe,isFocusable:ae,parent:le,filter:ue,matches:ce,closest:de,within:he,parents:pe,children:fe,index:me,hasOwn:r,hyphenate:i,camelize:o,ucfirst:a,startsWith:u,endsWith:c,includes:d,findIndex:h,isArray:p,toArray:f,assign:m,isFunction:g,isObject:v,isPlainObject:b,isWindow:y,isDocument:w,isNode:_,isElement:k,isBoolean:O,isString:E,isNumber:C,isNumeric:P,isEmpty:T,isUndefined:S,toBoolean:A,toNumber:M,toFloat:R,toNode:j,toNodes:I,toWindow:L,toMs:N,isEqual:D,swap:F,last:$,each:z,sortBy:B,uniqueBy:U,clamp:H,noop:V,intersectRect:q,pointInRect:W,Dimensions:Y,getIndex:G,memoize:K,Deferred:Q,MouseTracker:ur,observeIntersection:cr,observeResize:hr,observeMutation:fr,mergeOptions:wr,parseOptions:_r,play:kr,pause:xr,mute:Or,isVideo:Er,positionAt:Ur,query:ge,queryAll:ve,find:be,findAll:ye,escape:Se,css:Ye,getCssVar:Ke,propName:Qe,isInView:jr,scrollTop:Ir,scrollIntoView:Lr,scrolledOver:Nr,scrollParents:Dr,getViewport:Fr,getViewportClientHeight:$r,getScrollingElement:zr})
function Yr(e,t){const r={},{args:n=[],props:s={},el:a}=e
if(!s)return r
for(const o in s){const e=i(o)
let t=ee(a,e)
S(t)||(t=s[o]===Boolean&&""===t||Zr(s[o],t),("target"!==e||t&&!u(t,"_"))&&(r[o]=t))}const l=_r(ee(a,t),n)
for(const i in l){const e=o(i)
void 0!==s[e]&&(r[e]=Zr(s[e],l[i]))}return r}function Gr(e,t,n){Object.defineProperty(e,t,{enumerable:!0,get(){const{_computed:i,$props:s,$el:o}=e
return r(i,t)||(i[t]=(n.get||n).call(e,s,o)),i[t]},set(r){const{_computed:i}=e
i[t]=n.set?n.set.call(e,r):r,S(i[t])&&delete i[t]}})}function Kr(e,t,r){b(t)||(t={name:r,handler:t})
let{name:n,el:i,handler:s,capture:o,passive:a,delegate:l,filter:u,self:c}=t
i=g(i)?i.call(e):i||e.$el,p(i)?i.forEach((n=>Kr(e,{...t,el:n},r))):!i||u&&!u.call(e)||e._events.push(Ae(i,n,l?E(l)?l:l.call(e):null,E(s)?e[s]:s.bind(e),{passive:a,capture:o,self:c}))}function Qr(e,t){return e.every((e=>!e||!r(e,t)))}function Zr(e,t){return e===Boolean?A(t):e===Number?M(t):"list"===e?function(e){return p(e)?e:E(e)?e.split(/,(?![^(]*\))/).map((e=>P(e)?M(e):A(e.trim()))):[e]}(t):e?e(t):t}function Xr(e){const{$name:t,$options:r,$props:n}=e,{attrs:s,props:a,el:l}=r
if(!a||!1===s)return
const u=p(s)?s:Object.keys(a),c=u.map((e=>i(e))).concat(t),d=new MutationObserver((i=>{const s=Yr(r,t)
i.some((e=>{let{attributeName:r}=e
const i=r.replace("data-","")
return(i===t?u:[o(i),o(r)]).some((e=>!S(s[e])&&s[e]!==n[e]))}))&&e.$reset()}))
return d.observe(l,{attributes:!0,attributeFilter:c.concat(c.map((e=>"data-"+e)))}),d}const Jr=K((e=>!(!u(e,"uk-")&&!u(e,"data-uk-"))&&o(e.replace("data-uk-","").replace("uk-","")))),en=function(e){this._init(e)}
en.util=Wr,en.data="__uikit__",en.prefix="uk-",en.options={},en.version="3.13.7",function(e){const t=e.data
let r
function n(e,t){if(e)for(const r in e)e[r]._connected&&e[r]._callUpdate(t)}e.use=function(e){if(!e.installed)return e.call(null,this),e.installed=!0,this},e.mixin=function(t,r){(r=(E(r)?e.component(r):r)||this).options=wr(r.options,t)},e.extend=function(e){e=e||{}
const t=this,r=function(e){this._init(e)}
return(r.prototype=Object.create(t.prototype)).constructor=r,r.options=wr(t.options,e),r.super=t,r.extend=t.extend,r},e.update=function(e,r){e=e?j(e):document.body
for(const i of pe(e).reverse())n(i[t],r)
Vt(e,(e=>n(e[t],r)))},Object.defineProperty(e,"container",{get:()=>r||document.body,set(e){r=qt(e)}})}(en),function(e){function t(e){for(const{read:t,write:r,events:n=[]}of this.$options.update){if(!e.has("update")&&!n.some((t=>e.has(t))))continue
let i
t&&(i=t.call(this,this._data,e),i&&b(i)&&m(this._data,i)),r&&!1!==i&&ir.write((()=>r.call(this,this._data,e)))}}function n(e){const{$options:{computed:t}}=this,n={...this._computed}
this._computed={}
...
for(const s in r)S(r[s])?delete r[s]:i[s]&&(r[s]=Zr(i[s],r[s]))
return r}(e,this.constructor.options),this.$options=wr(this.constructor.options,e,this),this.$el=null,this.$props={},this._uid=t++,this._initData(),this._initMethods(),this._initComputeds(),this._callHook("created"),e.el&&this.$mount(e.el)},e.prototype._initData=function(){const{data:e={}}=this.$options
...
if(this._computed={},e)for(const t in e)Gr(this,t,e[t])},e.prototype._initProps=function(e){let t
for(t in e=e||Yr(this.$options,this.$name))S(e[t])||(this.$props[t]=e[t])
const r=[this.$options.computed,this.$options.methods]
for(t in this.$props)t in e&&Qr(r,t)&&(this[t]=this.$props[t])},e.prototype._initEvents=function(){this._events=[]
for(const e of this.$options.events||[])if(r(e,"handler"))Kr(this,e)
else for(const t in e)Kr(this,e[t],t)},e.prototype._unbindEvents=function(){this._events.forEach((e=>e())),delete this._events},e.prototype._initObservers=function(){this._observers=[Xr(this)],this.$options.computed&&this.registerObserver(function(e){const{el:t}=e.$options,r=new MutationObserver((()=>e.$emit()))
return r.observe(t,{childList:!0,subtree:!0}),r}(this))},e.prototype.registerObserver=function(e){this._observers.push(e)},e.prototype._disconnectObservers=function(){this._observers.forEach((e=>null==e?void 0:e.disconnect()))}}(en),function(e){const t=e.data,r={}
e.component=function(t,n){const s=i(t)
if(t=o(s),!n)return b(r[t])&&(r[t]=e.extend(r[t])),r[t]
e[t]=function(r,n){const i=e.component(t)
return i.options.functional?new i({data:b(r)?r:[...arguments]}):r?Wt(r).map(s)[0]:s()
function s(r){const s=e.getComponent(r,t)
if(s){if(!n)return s
s.$destroy()}return new i({el:r,data:n})}}
const a=b(n)?{...n}:n.options
return a.name=t,null==a.install||a.install(e,a,t),e._initialized&&!a.functional&&ir.read((()=>e[t]("[uk-"+s+"],[data-uk-"+s+"]"))),r[t]=b(n)?a:n},e.getComponents=e=>(null==e?void 0:e[t])||{},e.getComponent=(t,r)=>e.getComponents(t)[r],e.connect=n=>{if(n[t])for(const e in n[t])n[t][e]._callConnected()
for(const t of n.attributes){const i=Jr(t.name)
i&&i in r&&e[i](n)}},e.disconnect=e=>{for(const r in e[t])e[t][r]._callDisconnected()}}(en),function(e){const t=e.data
...
r&&this._callDisconnected(),this._callHook("destroy"),null!=r&&r[t]&&(delete r[t][n],T(r[t])||delete r[t],e&&Nt(this.$el))},e.prototype.$emit=function(e){this._callUpdate(e)},e.prototype.$update=function(t,r){void 0===t&&(t=this.$el),e.update(t,r)},e.prototype.$getComponent=e.getComponent
const r=K((t=>e.prefix+i(t)))
Object.defineProperties(e.prototype,{$container:Object.getOwnPropertyDescriptor(e,"container"),$name:{get(){return r(this.$options.name)}}})}(en)
var tn={connected(){!rt(this.$el,this.$name)&&Xe(this.$el,this.$name)}},rn={methods:{lazyload(e,t){void 0===e&&(e=this.$el),void 0===t&&(t=this.$el),this.registerObserver(cr(e,((e,r)=>{for(const n of I(g(t)?t():t))Wt('[loading="lazy"]',n).forEach((e=>J(e,"loading")))
for(const t of e.filter((e=>{let{isIntersecting:t}=e
return t})).map((e=>{let{target:t}=e
return t})))r.unobserve(t)})))}}},nn={props:{cls:Boolean,animation:"list",duration:Number,origin:String,transition:String},data:{cls:!1,animation:[!1],duration:200,origin:!1,transition:"linear",clsEnter:"uk-togglabe-enter",clsLeave:"uk-togglabe-leave",initProps:{overflow:"",height:"",paddingTop:"",paddingBottom:"",marginTop:"",marginBottom:""},hideProps:{overflow:"hidden",height:0,paddingTop:0,paddingBottom:0,marginTop:0,marginBottom:0}},computed:{hasAnimation(e){let{animation:t}=e
...
const i=(g(r)?r:!1!==r&&this.hasAnimation?this.hasTransition?sn(this):(s=this,(e,t)=>{dt.cancel(e)
...
Xe(e,o),je(e,n?"show":"hide",[this])
const a=()=>{Je(e,o),je(e,n?"shown":"hidden",[this]),this.$update(e)}
...
let r
t=Boolean(t),this.cls?(r=d(this.cls," ")||t!==rt(e,this.cls),r&&nt(e,this.cls,d(this.cls," ")?void 0:t)):(r=t===e.hidden,r&&(e.hidden=!t)),Wt("[autofocus]",e).some((e=>ne(e)?e.focus()||!0:e.blur())),r&&(je(e,"toggled",[t,this]),this.$update(e))}}}
function sn(e){let{isToggled:t,duration:r,initProps:n,hideProps:i,transition:s,_toggle:o}=e
return(e,a)=>{const l=at.inProgress(e),u=e.hasChildNodes()?R(Ye(e.firstElementChild,"marginTop"))+R(Ye(e.lastElementChild,"marginBottom")):0,c=ne(e)?vt(e)+(l?0:u):0
at.cancel(e),t(e)||o(e,!0),vt(e,""),ir.flush()
const d=vt(e)+(l?0:u)
return vt(e,c),(a?at.start(e,{...n,overflow:"hidden",height:d},Math.round(r*(1-c/d)),s):at.start(e,i,Math.round(r*(c/d)),s).then((()=>o(e,!1)))).then((()=>Ye(e,n)))}}var on={mixins:[tn,rn,nn],props:{targets:String,active:null,collapsible:Boolean,multiple:Boolean,toggle:String,content:String,transition:String,offset:Number},data:{targets:"> *",active:!1,animation:[!0],collapsible:!0,multiple:!1,clsOpen:"uk-open",toggle:"> .uk-accordion-title",content:"> .uk-accordion-content",transition:"ease",offset:0},computed:{items:{get(e,t){let{targets:r}=e
return Wt(r,t)},watch(e,t){if(e.forEach((e=>an(qt(this.content,e),!rt(e,this.clsOpen)))),t||rt(e,this.clsOpen))return
const r=!1!==this.active&&e[Number(this.active)]||!this.collapsible&&e[0]
r&&this.toggle(r,!1)},immediate:!0},toggles(e){let{toggle:t}=e
return this.items.map((e=>qt(t,e)))}},connected(){this.lazyload()},events:[{name:"click",delegate(){return this.targets+" "+this.$props.toggle},handler(e){e.preventDefault(),this.toggle(me(this.toggles,e.current))}}],methods:{toggle(e,t){let r=[this.items[G(e,this.items)]]
const n=ue(this.items,"."+this.clsOpen)
if(this.multiple||d(n,r[0])||(r=r.concat(n)),this.collapsible||!(n.length<2)||ue(r,":not(."+this.clsOpen+")").length)for(const i of r)this.toggleElement(i,!rt(i,this.clsOpen),(async(e,r)=>{nt(e,this.clsOpen,r),Z(qt(this.$props.toggle,e),"aria-expanded",r)
const n=qt((e._wrapper?"> * ":"")+this.content,e)
if(!1!==t&&this.hasTransition){if(e._wrapper||(e._wrapper=Dt(n,"<div"+(r?" hidden":"")+">")),an(n,!1),await sn(this)(e._wrapper,r),an(n,!r),delete e._wrapper,$t(n),r){const t=qt(this.$props.toggle,e)
ir.read((()=>{jr(t)||Lr(t,{offset:this.offset})}))}}else an(n,!r)}))}}}
function an(e,t){e&&(e.hidden=t)}var ln={mixins:[tn,nn],args:"animation",props:{close:String},data:{animation:[!0],selClose:".uk-alert-close",duration:150,hideProps:{opacity:0,...nn.data.hideProps}},events:[{name:"click",delegate(){return this.selClose},handler(e){e.preventDefault(),this.close()}}],methods:{async close(){await this.toggleElement(this.$el),this.$destroy(!0)}}},un={args:"autoplay",props:{automute:Boolean,autoplay:Boolean},data:{automute:!1,autoplay:!0},connected(){this.inView="inview"===this.autoplay,this.inView&&!X(this.$el,"preload")&&(this.$el.preload="none"),this.automute&&Or(this.$el),this.registerObserver(cr(this.$el,(()=>this.$emit()),{},!1))},update:{read(){return!!Er(this.$el)&&{visible:ne(this.$el)&&"hidden"!==Ye(this.$el,"visibility"),inView:this.inView&&jr(this.$el)}},write(e){let{visible:t,inView:r}=e
!t||this.inView&&!r?xr(this.$el):(!0===this.autoplay||this.inView&&r)&&kr(this.$el)}}},cn={connected(){var e
this.registerObserver(hr((null==(e=this.$options.resizeTargets)?void 0:e.call(this))||this.$el,(()=>this.$emit("resize"))))}},dn={mixins:[cn,un],props:{width:Number,height:Number},data:{automute:!0},events:{"load loadedmetadata"(){this.$emit("resize")}},resizeTargets(){return[this.$el,le(this.$el)]},update:{read(){const e=this.$el,{offsetHeight:t,offsetWidth:r}=function(e){for(;e=le(e);)if("static"!==Ye(e,"position"))return e}(e)||le(e),n=Y.cover({width:this.width||e.naturalWidth||e.videoWidth||e.clientWidth,height:this.height||e.naturalHeight||e.videoHeight||e.clientHeight},{width:r+(r%2?1:0),height:t+(t%2?1:0)})
...
return!0===t&&this.$container||t&&qt(t)}}},pn={props:{pos:String,offset:null,flip:Boolean},data:{pos:"bottom-"+(Kt?"right":"left"),flip:!0,offset:!1},connected(){this.pos=this.$props.pos.split("-").concat("center").slice(0,2),this.dir=this.pos[0],this.align=this.pos[1]},methods:{positionAt(e,t,r){const n=this.getAxis(),i=this.pos[0],s=this.pos[1]
let{offset:o}=this
if(!P(o)){const e=qt(o)
o=e?ft(e)["x"===n?"left":"top"]-ft(t)["x"===n?"right":"bottom"]:0}o=kt(o)+kt(Ke("position-offset",e))
const{x:a,y:l}=Ur(e,t,"x"===n?_t(i)+" "+s:s+" "+_t(i),"x"===n?i+" "+s:s+" "+i,"x"===n?""+("left"===i?-o:o):" "+("top"===i?-o:o),null,this.flip,r).target
this.dir="x"===n?a:l,this.align="x"===n?l:a},getAxis(){return"top"===this.dir||"bottom"===this.dir?"y":"x"}}}
let fn
var mn={mixins:[hn,rn,pn,nn],args:"pos",props:{mode:"list",toggle:Boolean,boundary:Boolean,boundaryAlign:Boolean,delayShow:Number,delayHide:Number,clsDrop:String},data:{mode:["click","hover"],toggle:"- *",boundary:!0,boundaryAlign:!1,delayShow:0,delayHide:800,clsDrop:!1,animation:["uk-animation-fade"],cls:"uk-open",container:!1},created(){this.tracker=new ur},connected(){this.clsDrop=this.$props.clsDrop||"uk-"+this.$options.name,Xe(this.$el,this.clsDrop),this.toggle&&!this.target&&(this.target=this.$create("toggle",ge(this.toggle,this.$el),{target:this.$el,mode:this.mode}).$el,Z(this.target,"aria-haspopup",!0),this.lazyload(this.target))},disconnected(){this.isActive()&&(fn=null)},events:[{name:"click",delegate(){return"."+this.clsDrop+"-close"},handler(e){e.preventDefault(),this.hide(!1)}},{name:"click",delegate:()=>'a[href^="#"]',handler(e){let{defaultPrevented:t,current:{hash:r}}=e
t||!r||he(r,this.$el)||this.hide(!1)}},{name:"beforescroll",handler(){this.hide(!1)}},{name:"toggle",self:!0,handler(e,t){e.preventDefault(),this.isToggled()?this.hide(!1):this.show(null==t?void 0:t.$el,!1)}},{name:"toggleshow",self:!0,handler(e,t){e.preventDefault(),this.show(null==t?void 0:t.$el)}},{name:"togglehide",self:!0,handler(e){e.preventDefault(),ce(this.$el,":focus,:hover")||this.hide()}},{name:tr+" focusin",filter(){return d(this.mode,"hover")},handler(e){Ue(e)||this.clearTimers()}},{name:rr+" focusout",filter(){return d(this.mode,"hover")},handler(e){!Ue(e)&&e.relatedTarget&&this.hide()}},{name:"toggled",self:!0,handler(e,t){t&&(this.clearTimers(),this.position())}},{name:"show",self:!0,handler(){fn=this,this.tracker.init()
for(const e of[Ae(document,Xt,(e=>{let{target:t}=e
return!he(t,this.$el)&&Re(document,er+" "+nr+" scroll",(e=>{let{defaultPrevented:r,type:n,target:i}=e
r||n!==er||t!==i||this.target&&he(t,this.target)||this.hide(!1)}),!0)})),Ae(document,"keydown",(e=>{27===e.keyCode&&this.hide(!1)})),Ae(window,"resize",(()=>this.$emit("resize")))])Re(this.$el,"hide",e,{self:!0})}},{name:"beforehide",self:!0,handler(){this.clearTimers()}},{name:"hide",handler(e){let{target:t}=e
...
let r
for(;fn&&r!==fn&&!he(this.$el,fn.$el);)r=fn,fn.hide(!1)}this.container&&le(this.$el)!==this.container&&Rt(this.container,this.$el),this.showTimer=setTimeout((()=>this.toggleElement(this.$el,!0)),t&&this.delayShow||0)}},hide(e){void 0===e&&(e=!0)
const t=()=>this.toggleElement(this.$el,!1,!1)
this.clearTimers(),this.isDelaying=function(e){const t=[]
return Vt(e,(e=>"static"!==Ye(e,"position")&&t.push(e))),t}(this.$el).some((e=>this.tracker.movesTo(e))),e&&this.isDelaying?this.hideTimer=setTimeout(this.hide,50):e&&this.delayHide?this.hideTimer=setTimeout(t,this.delayHide):t()},clearTimers(){clearTimeout(this.showTimer),clearTimeout(this.hideTimer),this.showTimer=null,this.hideTimer=null,this.isDelaying=!1},isActive(){return fn===this},position(){const e=ge(this.boundary,this.$el)||window
Je(this.$el,this.clsDrop+"-stack"),nt(this.$el,this.clsDrop+"-boundary",this.boundaryAlign)
const t=ft(e),r=ft(this.target),n=this.boundaryAlign?t:r
if("justify"===this.pos[1]){const e="y"===this.getAxis()?"width":"height"
Ye(this.$el,e,n[e])}else this.$el.offsetWidth>Math.max(t.right-n.left,n.right-t.left)&&Xe(this.$el,this.clsDrop+"-stack")
this.positionAt(this.$el,this.boundaryAlign?e:this.target,e)}}}
var gn={mixins:[tn],args:"target",props:{target:Boolean},data:{target:!1},computed:{input:(e,t)=>qt(ie,t),state(){return this.input.nextElementSibling},target(e,t){let{target:r}=e
return r&&(!0===r&&le(this.input)===t&&this.input.nextElementSibling||qt(r,t))}},update(){var e
const{target:t,input:r}=this
if(!t)return
let n
const i=se(t)?"value":"textContent",s=t[i],o=null!=(e=r.files)&&e[0]?r.files[0].name:ce(r,"select")&&(n=Wt("option",r).filter((e=>e.selected))[0])?n.textContent:r.value
s!==o&&(t[i]=o)},events:[{name:"change",handler(){this.$emit()}},{name:"reset",el(){return de(this.$el,"form")},handler(){this.$emit()}}]},vn={mixins:[cn],props:{margin:String,firstColumn:Boolean},data:{margin:"uk-margin-small-top",firstColumn:"uk-first-column"},resizeTargets(){return this.$el.children},connected(){this.registerObserver(fr(this.$el,(()=>this.$reset()),{childList:!0}))},update:{read(){const e=bn(this.$el.children)
return{rows:e,columns:yn(e)}},write(e){let{columns:t,rows:r}=e
for(const n of r)for(const e of n)nt(e,this.margin,r[0]!==n),nt(e,this.firstColumn,!!~t[0].indexOf(e))},events:["resize"]}}
function bn(e){return wn(e,"top","bottom")}function yn(e){const t=[]
for(const r of e){const e=wn(r,"left","right")
for(let r=0;r<e.length;r++)t[r]=t[r]?t[r].concat(e[r]):e[r]}return Kt?t.reverse():t}function wn(e,t,r){const n=[[]]
for(const i of e){if(!ne(i))continue
let e=_n(i)
for(let s=n.length-1;s>=0;s--){const o=n[s]
if(!o[0]){o.push(i)
break}let a
if(o[0].offsetParent===i.offsetParent?a=_n(o[0]):(e=_n(i,!0),a=_n(o[0],!0)),e[t]>=a[r]-1&&e[t]!==a[t]){n.push([i])
break}if(e[r]-1>a[t]||e[t]===a[t]){o.push(i)
break}if(0===s){n.unshift([i])
break}}}return n}function _n(e,t){void 0===t&&(t=!1)
let{offsetTop:r,offsetLeft:n,offsetHeight:i,offsetWidth:s}=e
return t&&([r,n]=gt(e)),{top:r,left:n,bottom:r+i,right:n+s}}var kn={connected(){var e,t
e=this._uid,t=()=>this.$emit("scroll"),On=On||Ae(window,"scroll",(()=>xn.forEach((e=>e()))),{passive:!0,capture:!0}),xn.set(e,t)},disconnected(){var e
e=this._uid,xn.delete(e),On&&!xn.size&&(On(),On=null)}}
const xn=new Map
let On
var En={extends:vn,mixins:[tn,kn],name:"grid",props:{masonry:Boolean,parallax:Number},data:{margin:"uk-grid-margin",clsStack:"uk-grid-stack",masonry:!1,parallax:0},connected(){this.masonry&&Xe(this.$el,"uk-flex-top uk-flex-wrap-top")},update:[{write(e){let{columns:t}=e
nt(this.$el,this.clsStack,t.length<2)},events:["resize"]},{read(e){let{columns:t,rows:r}=e
if(!t.length||!this.masonry&&!this.parallax||Cn(this.$el))return e.translates=!1,!1
let n=!1
...
function Cn(e){return fe(e).some((e=>"absolute"===Ye(e,"position")))}var Pn={mixins:[cn],args:"target",props:{target:String,row:Boolean},data:{target:"> *",row:!0,forceHeight:!0},computed:{elements:{get(e,t){let{target:r}=e
return Wt(r,t)},watch(){this.$reset()}}},resizeTargets(){return this.elements},update:{read(){return{rows:(this.row?bn(this.elements):[this.elements]).map(Tn)}},write(e){let{rows:t}=e
for(const{heights:r,elements:n}of t)n.forEach(((e,t)=>Ye(e,"minHeight",r[t])))},events:["resize"]}}
function Tn(e){if(e.length<2)return{heights:[""],elements:e}
let t=e.map(Sn),r=Math.max(...t)
const n=e.some((e=>e.style.minHeight)),i=e.some(((e,n)=>!e.style.minHeight&&t[n]<r))
return n&&i&&(Ye(e,"minHeight",""),t=e.map(Sn),r=Math.max(...t)),t=e.map(((e,n)=>t[n]===r&&R(e.style.minHeight).toFixed(2)!==r.toFixed(2)?"":r)),{heights:t,elements:e}}function Sn(e){let t=!1
ne(e)||(t=e.style.display,Ye(e,"display","block","important"))
const r=pt(e).height-wt(e,"height","content-box")
return!1!==t&&Ye(e,"display",t),r}var An={mixins:[tn,cn],props:{expand:Boolean,offsetTop:Boolean,offsetBottom:Boolean,minHeight:Number},data:{expand:!1,offsetTop:!1,offsetBottom:!1,minHeight:0},resizeTargets(){return[this.$el,document.documentElement]},update:{read(e){let{minHeight:t}=e
if(!ne(this.$el))return!1
let r=""
const n=wt(this.$el,"height","content-box")
if(this.expand)r=Math.max(vt(window)-(pt(document.documentElement).height-pt(this.$el).height)-n,0)
...
Ye(this.$el,{minHeight:t}),this.minHeight&&R(Ye(this.$el,"minHeight"))<this.minHeight&&Ye(this.$el,"minHeight",this.minHeight)},events:["resize"]}},Mn={args:"src",props:{id:Boolean,icon:String,src:String,style:String,width:Number,height:Number,ratio:Number,class:String,strokeAnimation:Boolean,focusable:Boolean,attributes:"list"},data:{ratio:1,include:["style","class","focusable"],class:"",strokeAnimation:!1},beforeConnect(){this.class+=" uk-svg"},connected(){!this.icon&&d(this.src,"#")&&([this.src,this.icon]=this.src.split("#")),this.svg=this.getSvg().then((e=>{if(this._connected){const t=function(e,t){if(re(t)||Tt(t,"canvas")){t.hidden=!0
const r=t.nextElementSibling
return Dn(e,r)?r:It(t,e)}const r=t.lastElementChild
return Dn(e,r)?r:Rt(t,e)}(e,this.$el)
return this.svgEl&&t!==this.svgEl&&Nt(this.svgEl),this.applyAttributes(t,e),this.svgEl=t}}),V),this.strokeAnimation&&this.svg.then((e=>{this._connected&&(Ln(e),this.registerObserver(cr(e,((t,r)=>{Ln(e),r.disconnect()}))))}))},disconnected(){this.svg.then((e=>{this._connected||(re(this.$el)&&(this.$el.hidden=!1),Nt(e),this.svgEl=null)})),this.svg=null},methods:{async getSvg(){return Tt(this.$el,"img")&&!this.$el.complete&&"lazy"===this.$el.loading?new Promise((e=>Re(this.$el,"load",(()=>e(this.getSvg()))))):function(e,t){var r
t&&d(e,"<symbol")&&(e=function(e,t){if(!In[e]){let t
for(In[e]={},jn.lastIndex=0;t=jn.exec(e);)In[e][t[3]]='<svg xmlns="http://www.w3.org/2000/svg"'+t[1]+"svg>"}return In[e][t]}(e,t)||e)
return e=qt(e.substr(e.indexOf("<svg"))),(null==(r=e)?void 0:r.hasChildNodes())&&e}(await Rn(this.src),this.icon)||Promise.reject("SVG not found.")},applyAttributes(e,t){for(const s in this.$options.props)d(this.include,s)&&s in this&&Z(e,s,this[s])
...
const Rn=K((async e=>e?u(e,"data:")?decodeURIComponent(e.split(",")[1]):(await fetch(e)).text():Promise.reject()))
const jn=/<symbol([^]*?id=(['"])(.+?)\2[^]*?<\/)symbol>/g,In={}
function Ln(e){const t=Nn(e)
t&&e.style.setProperty("--uk-animation-stroke",t)}function Nn(e){return Math.ceil(Math.max(0,...Wt("[stroke]",e).map((e=>{try{return e.getTotalLength()}catch(t){return 0}}))))}function Dn(e,t){return Tt(e,"svg")&&Tt(t,"svg")&&Fn(e)===Fn(t)}function Fn(e){return(e.innerHTML||(new XMLSerializer).serializeToString(e).replace(/<svg.*?>(.*?)<\/svg>/g,"$1")).replace(/\s/g,"")}const $n={spinner:'<svg width="30" height="30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" cx="15" cy="15" r="14"/></svg>',totop:'<svg width="18" height="10" viewBox="0 0 18 10" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 9 9 1 17 9 "/></svg>',marker:'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><rect x="9" y="4" width="1" height="11"/><rect x="4" y="9" width="11" height="1"/></svg>',"close-icon":'<svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg"><line fill="none" stroke="#000" stroke-width="1.1" x1="1" y1="1" x2="13" y2="13"/><line fill="none" stroke="#000" stroke-width="1.1" x1="13" y1="1" x2="1" y2="13"/></svg>',"close-large":'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><line fill="none" stroke="#000" stroke-width="1.4" x1="1" y1="1" x2="19" y2="19"/><line fill="none" stroke="#000" stroke-width="1.4" x1="19" y1="1" x2="1" y2="19"/></svg>',"navbar-toggle-icon":'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><rect y="9" width="20" height="2"/><rect y="3" width="20" height="2"/><rect y="15" width="20" height="2"/></svg>',"overlay-icon":'<svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><rect x="19" y="0" width="1" height="40"/><rect x="0" y="19" width="40" height="1"/></svg>',"pagination-next":'<svg width="7" height="12" viewBox="0 0 7 12" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 1 6 6 1 11"/></svg>',"pagination-previous":'<svg width="7" height="12" viewBox="0 0 7 12" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="6 1 1 6 6 11"/></svg>',"search-icon":'<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" stroke-width="1.1" cx="9" cy="9" r="7"/><path fill="none" stroke="#000" stroke-width="1.1" d="M14,14 L18,18 L14,14 Z"/></svg>',"search-large":'<svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" stroke-width="1.8" cx="17.5" cy="17.5" r="16.5"/><line fill="none" stroke="#000" stroke-width="1.8" x1="38" y1="39" x2="29" y2="30"/></svg>',"search-navbar":'<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><circle fill="none" stroke="#000" stroke-width="1.1" cx="10.5" cy="10.5" r="9.5"/><line fill="none" stroke="#000" stroke-width="1.1" x1="23" y1="23" x2="17" y2="17"/></svg>',"slidenav-next":'<svg width="14" height="24" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1 "/></svg>',"slidenav-next-large":'<svg width="25" height="40" viewBox="0 0 25 40" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="2" points="4.002,38.547 22.527,20.024 4,1.5 "/></svg>',"slidenav-previous":'<svg width="14" height="24" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.4" points="12.775,1 1.225,12 12.775,23 "/></svg>',"slidenav-previous-large":'<svg width="25" height="40" viewBox="0 0 25 40" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="2" points="20.527,1.5 2,20.024 20.525,38.547 "/></svg>'},zn={install:function(e){e.icon.add=(t,r)=>{const n=E(t)?{[t]:r}:t
z(n,((e,t)=>{$n[t]=e,delete Wn[t]})),e._initialized&&Vt(document.body,(t=>z(e.getComponents(t),(e=>{e.$options.isIcon&&e.icon in n&&e.$reset()}))))}},extends:Mn,args:"icon",props:["icon"],data:{include:["focusable"]},isIcon:!0,beforeConnect(){Xe(this.$el,"uk-icon")},methods:{async getSvg(){const e=function(e){if(!$n[e])return null
Wn[e]||(Wn[e]=qt(($n[function(e){return Kt?F(F(e,"left","right"),"previous","next"):e}(e)]||$n[e]).trim()))
return Wn[e].cloneNode(!0)}(this.icon)
if(!e)throw"Icon not found."
return e}}},Bn={args:!1,extends:zn,data:e=>({icon:i(e.constructor.options.name)}),beforeConnect(){Xe(this.$el,this.$name)}},Un={extends:Bn,beforeConnect(){Xe(this.$el,"uk-slidenav")
const e=this.$props.icon
this.icon=rt(this.$el,"uk-slidenav-large")?e+"-large":e}},Hn={extends:Bn,beforeConnect(){this.icon=rt(this.$el,"uk-search-icon")&&pe(this.$el,".uk-search-large").length?"search-large":pe(this.$el,".uk-search-navbar").length?"search-navbar":this.$props.icon}},Vn={extends:Bn,beforeConnect(){this.icon="close-"+(rt(this.$el,"uk-close-large")?"large":"icon")}},qn={extends:Bn,methods:{async getSvg(){const e=await zn.methods.getSvg.call(this)
return 1!==this.ratio&&Ye(qt("circle",e),"strokeWidth",1/this.ratio),e}}},Wn={}
const Yn=Gt&&"loading"in HTMLImageElement.prototype
var Gn={args:"dataSrc",props:{dataSrc:String,sources:String,offsetTop:String,offsetLeft:String,target:String,loading:String},data:{dataSrc:"",sources:!1,offsetTop:"50vh",offsetLeft:"50vw",target:!1,loading:"lazy"},connected(){if("lazy"!==this.loading)return void this.load()
const e=[this.$el,...ve(this.$props.target,this.$el)]
var t
Yn&&Xn(this.$el)&&(this.$el.loading="lazy",Kn(this.$el),1===e.length)||(Xn(t=this.$el)&&!X(t,"src")&&Z(t,"src",'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg"></svg>'),this.registerObserver(cr(e,((e,t)=>{this.load(),t.disconnect()}),{rootMargin:kt(this.offsetTop,"height")+"px "+kt(this.offsetLeft,"width")+"px"})))},disconnected(){this._data.image&&(this._data.image.onload="")},methods:{load(){if(this._data.image)return this._data.image
const e=Xn(this.$el)?this.$el:function(e,t,r){const n=new Image
return function(e,t){if((t=function(e){if(!e)return[]
if(u(e,"["))try{e=JSON.parse(e)}catch(t){e=[]}else e=_r(e)
p(e)||(e=[e])
return e.filter((e=>!T(e)))}(t)).length){const r=Ut("<picture>")
for(const e of t){const t=Ut("<source>")
Z(t,e),Rt(r,t)}Rt(r,e)}}(n,r),Zn(e,n),n.onload=()=>{Kn(e,n.currentSrc)},Z(n,"src",t),n}(this.$el,this.dataSrc,this.sources)
return J(e,"loading"),Kn(this.$el,e.currentSrc),this._data.image=e}}}
function Kn(e,t){if(Xn(e)){const t=le(e);(function(e){return Tt(e,"picture")}(t)?fe(t):[e]).forEach((e=>Zn(e,e)))}else if(t){!d(e.style.backgroundImage,t)&&(Ye(e,"backgroundImage","url("+Se(t)+")"),je(e,Ie("load",!1)))}}const Qn=["data-src","data-srcset","sizes"]
function Zn(e,t){Qn.forEach((r=>{const n=ee(e,r)
n&&Z(t,r.replace(/^(data-)+/,""),n)}))}function Xn(e){return Tt(e,"img")}var Jn={props:{media:Boolean},data:{media:!1},connected(){const e=function(e){if(E(e))if(u(e,"@")){const t="breakpoint-"+e.substr(1)
...
var ei={mixins:[tn,Jn,cn],props:{fill:String},data:{fill:"",clsWrapper:"uk-leader-fill",clsHide:"uk-leader-hide",attrFill:"data-fill"},computed:{fill(e){let{fill:t}=e
return t||Ke("leader-fill-content")}},connected(){[this.wrapper]=Ft(this.$el,'<span class="'+this.clsWrapper+'">')},disconnected(){$t(this.wrapper.childNodes)},update:{read(){return{width:Math.trunc(this.$el.offsetWidth/2),fill:this.fill,hide:!this.matchMedia}},write(e){let{width:t,fill:r,hide:n}=e
nt(this.wrapper,this.clsHide,n),Z(this.wrapper,this.attrFill,new Array(t).join(r))},events:["resize"]}}
const ti=[]
var ri={mixins:[tn,hn,nn],props:{selPanel:String,selClose:String,escClose:Boolean,bgClose:Boolean,stack:Boolean},data:{cls:"uk-open",escClose:!0,bgClose:!0,overlay:!0,stack:!1},computed:{panel(e,t){let{selPanel:r}=e
return qt(r,t)},transitionElement(){return this.panel},bgClose(e){let{bgClose:t}=e
return t&&this.panel}},beforeDisconnect(){d(ti,this)&&this.toggleElement(this.$el,!1,!1)},events:[{name:"click",delegate(){return this.selClose},handler(e){e.preventDefault(),this.hide()}},{name:"toggle",self:!0,handler(e){e.defaultPrevented||(e.preventDefault(),this.isToggled()===d(ti,this)&&this.toggle())}},{name:"beforeshow",self:!0,handler(e){if(d(ti,this))return!1
!this.stack&&ti.length?(Promise.all(ti.map((e=>e.hide()))).then(this.show),e.preventDefault()):ti.push(this)}},{name:"show",self:!0,handler(){const e=document.documentElement
bt(window)>e.clientWidth&&this.overlay&&Ye(document.body,"overflowY","scroll"),this.stack&&Ye(this.$el,"zIndex",R(Ye(this.$el,"zIndex"))+ti.length),Xe(e,this.clsPage),this.bgClose&&Re(this.$el,"hide",Ae(document,Xt,(e=>{let{target:t}=e
$(ti)!==this||this.overlay&&!he(t,this.$el)||he(t,this.panel)||Re(document,er+" "+nr+" scroll",(e=>{let{defaultPrevented:r,type:n,target:i}=e
r||n!==er||t!==i||this.hide()}),!0)})),{self:!0}),this.escClose&&Re(this.$el,"hide",Ae(document,"keydown",(e=>{27===e.keyCode&&$(ti)===this&&this.hide()})),{self:!0})}},{name:"shown",self:!0,handler(){ae(this.$el)||Z(this.$el,"tabindex","-1"),qt(":focus",this.$el)||this.$el.focus()}},{name:"hidden",self:!0,handler(){d(ti,this)&&ti.splice(ti.indexOf(this),1),ti.length||Ye(document.body,"overflowY",""),Ye(this.$el,"zIndex",""),ti.some((e=>e.clsPage===this.clsPage))||Je(document.documentElement,this.clsPage)}}],methods:{toggle(){return this.isToggled()?this.hide():this.show()},show(){return this.container&&le(this.$el)!==this.container?(Rt(this.container,this.$el),new Promise((e=>requestAnimationFrame((()=>this.show().then(e)))))):this.toggleElement(this.$el,!0,ni(this))},hide(){return this.toggleElement(this.$el,!1,ni(this))}}}
function ni(e){let{transitionElement:t,_toggle:r}=e
return(e,n)=>new Promise(((i,s)=>Re(e,"show hide",(()=>{e._reject&&e._reject(),e._reject=s,r(e,n)
const o=Re(t,"transitionstart",(()=>{Re(t,"transitionend transitioncancel",i,{self:!0}),clearTimeout(a)}),{self:!0}),a=setTimeout((()=>{o(),i()}),N(Ye(t,"transitionDuration")))})))).then((()=>delete e._reject))}var ii={install:function(e){let{modal:t}=e
...
return'<div class="uk-modal-body">'+(E(e)?e:St(e))+'</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-primary uk-modal-close" autofocus>'+r.ok+"</button> </div>"}),t,(e=>e.resolve()))},t.confirm=function(e,t){return r((t=>{let{labels:r}=t
return'<form> <div class="uk-modal-body">'+(E(e)?e:St(e))+'</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-default uk-modal-close" type="button">'+r.cancel+'</button> <button class="uk-button uk-button-primary" autofocus>'+r.ok+"</button> </div> </form>"}),t,(e=>e.reject()))},t.prompt=function(e,t,n){return r((r=>{let{labels:n}=r
return'<form class="uk-form-stacked"> <div class="uk-modal-body"> <label>'+(E(e)?e:St(e))+'</label> <input class="uk-input" value="'+(t||"")+'" autofocus> </div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-default uk-modal-close" type="button">'+n.cancel+'</button> <button class="uk-button uk-button-primary">'+n.ok+"</button> </div> </form>"}),n,(e=>e.resolve(null)),(e=>qt("input",e.$el).value))},t.labels={ok:"Ok",cancel:"Cancel"}},mixins:[ri],data:{clsPage:"uk-modal-page",selPanel:".uk-modal-dialog",selClose:".uk-modal-close, .uk-modal-close-default, .uk-modal-close-outside, .uk-modal-close-full"},events:[{name:"show",self:!0,handler(){rt(this.panel,"uk-margin-auto-vertical")?Xe(this.$el,"uk-flex"):Ye(this.$el,"display","block"),vt(this.$el)}},{name:"hidden",self:!0,handler(){Ye(this.$el,"display",""),Je(this.$el,"uk-flex")}}]}
var si={extends:on,data:{targets:"> .uk-parent",toggle:"> a",content:"> ul"}}
const oi=".uk-navbar-nav > li > a, .uk-navbar-item, .uk-navbar-toggle"
var ai={mixins:[tn,hn],props:{dropdown:String,mode:"list",align:String,offset:Number,boundary:Boolean,boundaryAlign:Boolean,clsDrop:String,delayShow:Number,delayHide:Number,dropbar:Boolean,dropbarAnchor:Boolean,duration:Number},data:{dropdown:oi,align:Kt?"right":"left",clsDrop:"uk-navbar-dropdown",mode:void 0,offset:void 0,delayShow:void 0,delayHide:void 0,boundaryAlign:void 0,flip:"x",boundary:!0,dropbar:!1,dropbarAnchor:!1,duration:200,forceHeight:!0,selMinHeight:oi,container:!1},computed:{boundary(e,t){let{boundary:r}=e
...
return t?(t=this._dropbar||ge(t,this.$el)||qt("+ .uk-navbar-dropbar",this.$el),t||(this._dropbar=qt("<div></div>"))):null},watch(e){Xe(e,"uk-navbar-dropbar")},immediate:!0},dropContainer(e,t){return this.container||t},dropdowns:{get(e,t){let{clsDrop:r}=e
const n=Wt("."+r,t)
if(this.dropContainer!==t)for(const s of Wt("."+r,this.dropContainer)){var i
...
return Wt(r,t)}},disconnected(){this.dropbar&&Nt(this.dropbar),delete this._dropbar},events:[{name:"mouseover focusin",delegate(){return this.dropdown},handler(e){let{current:t}=e
...
r===ci.DOWN&&X(t,"aria-expanded")&&(e.preventDefault(),n&&n.target===t?ui(n.$el):(t.click(),Re(this.dropContainer,"show",(e=>{let{target:t}=e
return ui(t)})))),li(e,this.toggles,n)}},{name:"keydown",el(){return this.dropContainer},delegate(){return"."+this.clsDrop},handler(e){const{current:t,keyCode:r}=e
if(!d(this.dropdowns,t))return
const n=this.getActive(),i=Wt(oe,t),s=h(i,(e=>ce(e,":focus")))
var o;(r===ci.UP&&(e.preventDefault(),s>0&&i[s-1].focus()),r===ci.DOWN&&(e.preventDefault(),s<i.length-1&&i[s+1].focus()),r===ci.ESC)&&(null==n||null==(o=n.target)||o.focus())
li(e,this.toggles,n)}},{name:"mouseleave",el(){return this.dropbar},filter(){return this.dropbar},handler(){const e=this.getActive()
e&&d(e.mode,"hover")&&!this.dropdowns.some((e=>ce(e,":hover")))&&e.hide()}},{name:"beforeshow",el(){return this.dropContainer},filter(){return this.dropbar},handler(e,t){let{$el:r}=t
rt(r,this.clsDrop)&&(le(this.dropbar)||It(this.dropbarAnchor||this.$el,this.dropbar),Xe(r,this.clsDrop+"-dropbar"))}},{name:"show",el(){return this.dropContainer},filter(){return this.dropbar},handler(e,t){let{$el:r,dir:n}=t
rt(r,this.clsDrop)&&"bottom"===n&&this.transitionTo(ft(r).bottom-ft(this.dropbar).top+R(Ye(r,"marginBottom")),r)}},{name:"beforehide",el(){return this.dropContainer},filter(){return this.dropbar},handler(e,t){let{$el:r}=t
...
return Ye(t=n<e&&t,"clip","rect(0,"+t.offsetWidth+"px,"+n+"px,0)"),vt(r,n),at.cancel([t,r]),Promise.all([at.start(r,{height:e},this.duration),at.start(t,{clip:"rect(0,"+t.offsetWidth+"px,"+e+"px,0)"},this.duration)]).catch(V).then((()=>{Ye(t,{clip:""}),this.$update(r)}))},getDropdown(e){return this.$getComponent(e,"drop")||this.$getComponent(e,"dropdown")}}}
function li(e,t,r){const{current:n,keyCode:i}=e,s=(null==r?void 0:r.target)||n,o=t.indexOf(s)
i===ci.LEFT&&o>0&&(null==r||r.hide(!1),t[o-1].focus()),i===ci.RIGHT&&o<t.length-1&&(null==r||r.hide(!1),t[o+1].focus()),i===ci.TAB&&(s.focus(),null==r||r.hide(!1))}function ui(e){var t
qt(":focus",e)||(null==(t=qt(oe,e))||t.focus())}const ci={TAB:9,ESC:27,LEFT:37,UP:38,RIGHT:39,DOWN:40}
var di={props:{swiping:Boolean},data:{swiping:!0},computed:{swipeTarget:(e,t)=>t},connected(){this.swiping&&Kr(this,{el:this.swipeTarget,name:Xt,passive:!0,handler(e){if(!Ue(e))return
const t=He(e),r="tagName"in e.target?e.target:le(e.target)
Re(document,er+" "+nr+" scroll",(e=>{const{x:n,y:i}=He(e);("scroll"!==e.type&&r&&n&&Math.abs(t.x-n)>100||i&&Math.abs(t.y-i)>100)&&setTimeout((()=>{var e,s,o,a
je(r,"swipe"),je(r,"swipe"+(e=t.x,s=t.y,o=n,a=i,Math.abs(e-o)>=Math.abs(s-a)?e-o>0?"Left":"Right":s-a>0?"Up":"Down"))}))}))}})}}
var hi={mixins:[ri,di],args:"mode",props:{mode:String,flip:Boolean,overlay:Boolean},data:{mode:"slide",flip:!1,overlay:!1,clsPage:"uk-offcanvas-page",clsContainer:"uk-offcanvas-container",selPanel:".uk-offcanvas-bar",clsFlip:"uk-offcanvas-flip",clsContainerAnimation:"uk-offcanvas-container-animation",clsSidebarAnimation:"uk-offcanvas-bar-animation",clsMode:"uk-offcanvas",clsOverlay:"uk-offcanvas-overlay",selClose:".uk-offcanvas-close",container:!1},computed:{clsFlip(e){let{flip:t,clsFlip:r}=e
...
!r&&t&&qt(t,document.body)&&this.hide()}},{name:"touchstart",passive:!0,el(){return this.panel},handler(e){let{targetTouches:t}=e
...
const t=e.targetTouches[0].clientY-this.clientY,{scrollTop:r,scrollHeight:n,clientHeight:i}=this.panel;(i>=n||0===r&&t>0||n-r<=i&&t<0)&&e.cancelable&&e.preventDefault()}},{name:"show",self:!0,handler(){"reveal"!==this.mode||rt(le(this.panel),this.clsMode)||(Dt(this.panel,"<div>"),Xe(le(this.panel),this.clsMode)),Ye(document.documentElement,"overflowY",this.overlay?"hidden":""),Xe(document.body,this.clsContainer,this.clsFlip),Ye(document.body,"touch-action","pan-y pinch-zoom"),Ye(this.$el,"display","block"),Xe(this.$el,this.clsOverlay),Xe(this.panel,this.clsSidebarAnimation,"reveal"!==this.mode?this.clsMode:""),vt(document.body),Xe(document.body,this.clsContainerAnimation),this.clsContainerAnimation&&(pi().content+=",user-scalable=0")}},{name:"hide",self:!0,handler(){Je(document.body,this.clsContainerAnimation),Ye(document.body,"touch-action","")}},{name:"hidden",self:!0,handler(){this.clsContainerAnimation&&function(){const e=pi()
e.content=e.content.replace(/,user-scalable=0$/,"")}(),"reveal"===this.mode&&$t(this.panel),Je(this.panel,this.clsSidebarAnimation,this.clsMode),Je(this.$el,this.clsOverlay),Ye(this.$el,"display",""),Je(document.body,this.clsContainer,this.clsFlip),Ye(document.documentElement,"overflowY","")}},{name:"swipeLeft swipeRight",handler(e){this.isToggled()&&c(e.type,"Left")^this.flip&&this.hide()}}]}
function pi(){return qt('meta[name="viewport"]',document.head)||Rt(document.head,'<meta name="viewport">')}var fi={mixins:[tn,cn],props:{selContainer:String,selContent:String,minHeight:Number},data:{selContainer:".uk-modal",selContent:".uk-modal-dialog",minHeight:150},computed:{container(e,t){let{selContainer:r}=e
return de(t,r)},content(e,t){let{selContent:r}=e
return de(t,r)}},resizeTargets(){return[this.container,this.content]},update:{read(){return!!(this.content&&this.container&&ne(this.$el))&&{max:Math.max(this.minHeight,vt(this.container)-(pt(this.content).height-vt(this.$el)))}},write(e){let{max:t}=e
Ye(this.$el,{minHeight:this.minHeight,maxHeight:t})},events:["resize"]}},mi={mixins:[cn],props:["width","height"],resizeTargets(){return[this.$el,le(this.$el)]},connected(){Xe(this.$el,"uk-responsive-width")},update:{read(){return!!(ne(this.$el)&&this.width&&this.height)&&{width:bt(le(this.$el)),height:this.height}},write(e){vt(this.$el,Y.contain({height:this.height,width:this.width},e).height)},events:["resize"]}},gi={props:{offset:Number},data:{offset:0},methods:{async scrollTo(e){e=e&&qt(e)||document.body,je(this.$el,"beforescroll",[this,e])&&(await Lr(e,{offset:this.offset}),je(this.$el,"scrolled",[this,e]))}},events:{click(e){e.defaultPrevented||(e.preventDefault(),this.scrollTo(vi(this.$el)))}}}
function vi(e){return document.getElementById(decodeURIComponent(e.hash).substring(1))}const bi="_ukScrollspy"
var yi={mixins:[kn],args:"cls",props:{cls:String,target:String,hidden:Boolean,offsetTop:Number,offsetLeft:Number,repeat:Boolean,delay:Number},data:()=>({cls:"",target:!1,hidden:!0,offsetTop:0,offsetLeft:0,repeat:!1,delay:0,inViewClass:"uk-scrollspy-inview"}),computed:{elements:{get(e,t){let{target:r}=e
return r?Wt(r,t):[t]},watch(e){this.hidden&&Ye(ue(e,":not(."+this.inViewClass+")"),"visibility","hidden")},immediate:!0}},disconnected(){for(const t of this.elements){var e
Je(t,this.inViewClass,(null==(e=t[bi])?void 0:e.cls)||""),delete t[bi]}},update:[{read(){for(const e of this.elements)e[bi]||(e[bi]={cls:ee(e,"uk-scrollspy-class")||this.cls}),!this.repeat&&e[bi].show||(e[bi].show=jr(e,this.offsetTop,this.offsetLeft))},write(e){for(const t of this.elements){const r=t[bi]
!r.show||r.inview||r.queued?!r.show&&r.inview&&!r.queued&&this.repeat&&this.toggle(t,!1):(r.queued=!0,e.promise=(e.promise||Promise.resolve()).then((()=>new Promise((e=>setTimeout(e,this.delay))))).then((()=>{this.toggle(t,!0),setTimeout((()=>{r.queued=!1,this.$emit()}),300)})))}},events:["scroll","resize"]}],methods:{toggle(e,t){const r=e[bi]
if(null==r.off||r.off(),Ye(e,"visibility",!t&&this.hidden?"hidden":""),nt(e,this.inViewClass,t),nt(e,r.cls),/\buk-animation-/.test(r.cls)){const n=()=>et(e,"uk-animation-[\\w-]+")
t?r.off=Re(e,"animationcancel animationend",n):n()}je(e,t?"inview":"outview"),r.inview=t,this.$update(e)}}},wi={mixins:[kn],props:{cls:String,closest:String,scroll:Boolean,overflow:Boolean,offset:Number},data:{cls:"uk-active",closest:!1,scroll:!1,overflow:!0,offset:0},computed:{links:{get:(e,t)=>Wt('a[href^="#"]',t).filter((e=>e.hash)),watch(e){this.scroll&&this.$create("scroll",e,{offset:this.offset||0})},immediate:!0},elements(e){let{closest:t}=e
return de(this.links,t||"*")}},update:[{read(){const e=this.links.map(vi).filter(Boolean),{length:t}=e
if(!t||!ne(this.$el))return!1
const[r]=Dr(e,/auto|scroll/,!0),{scrollTop:n,scrollHeight:i}=r
let s=!1
if(n===i-$r(r))s=t-1
else{for(const t in e){if(ft(e[t]).top-ft(Fr(r)).top-this.offset>0)break
...
for(const n in this.elements)nt(this.elements[n],this.cls,+n===t)
r&&je(this.$el,"active",[t,this.elements[t]])},events:["scroll","resize"]}]},_i={mixins:[tn,Jn,cn,kn],props:{position:String,top:null,bottom:Boolean,offset:String,animation:String,clsActive:String,clsInactive:String,clsFixed:String,clsBelow:String,selTarget:String,showOnUp:Boolean,targetOffset:Number},data:{position:"top",top:0,bottom:!1,offset:0,animation:"",clsActive:"uk-active",clsInactive:"",clsFixed:"uk-sticky-fixed",clsBelow:"uk-sticky-below",selTarget:"",showOnUp:!1,targetOffset:!1},computed:{selTarget(e,t){let{selTarget:r}=e
return r&&qt(r,t)||t}},resizeTargets:()=>document.documentElement,connected(){this.placeholder=qt("+ .uk-sticky-placeholder",this.$el)||qt('<div class="uk-sticky-placeholder"></div>'),this.isFixed=!1,this.setActive(!1)},disconnected(){this.isFixed&&(this.hide(),Je(this.selTarget,this.clsInactive)),Nt(this.placeholder),this.placeholder=null},events:[{name:"load hashchange popstate",el:()=>window,filter(){return!1!==this.targetOffset},handler(){location.hash&&0!==Ir(window)&&ir.read((()=>{const e=ft(qt(location.hash)),t=ft(this.$el)
this.isFixed&&q(e,t)&&Ir(window,e.top-t.height-kt(this.targetOffset,"height")-kt(this.offset,"height"))}))}}],update:[{read(e,t){let{height:r,margin:n}=e
if(this.inactive=!this.matchMedia||!ne(this.$el),this.inactive)return!1
const i=this.isActive&&t.has("resize")
i&&(Ye(this.selTarget,"transition","0s"),this.hide()),this.isActive||(r=ft(this.$el).height,n=Ye(this.$el,"margin")),i&&(this.show(),ir.write((()=>Ye(this.selTarget,"transition",""))))
const s=this.isFixed?this.placeholder:this.$el,o=vt(window)
let a=this.position
"auto"===a&&r>o&&(a="bottom")
let l=kt(this.offset,"height",s)
"bottom"===a&&(l+=o-r)
const u=Math.max(0,r+l-o),c=ft(s).top,d=ki(this.top,this.$el,c),h=ki(this.bottom,this.$el,c+r,!0)
return{start:Math.max(d,c)-l,end:h?h-ft(this.$el).height+u-l:zr(this.$el).scrollHeight-o,offset:l,overflow:u,topOffset:c,height:r,margin:n,width:pt(s).width,top:gt(s)[0]}},write(e){let{height:t,margin:r}=e
const{placeholder:n}=this
Ye(n,{height:t,margin:r}),he(n,document)||(It(this.$el,n),n.hidden=!0)},events:["resize"]},{read(e){let{scroll:t=0,dir:r="down",overflow:n,overflowScroll:i=0,start:s,end:o}=e
const a=Ir(window)
return{dir:t<=a?"down":"up",prevDir:r,scroll:a,prevScroll:t,offsetParentTop:ft(this.$el.offsetParent).top,overflowScroll:H(i+H(a,s,o)-H(t,s,o),0,n)}},write(e,t){const r=t.has("scroll"),{initTimestamp:n=0,dir:i,prevDir:s,scroll:o,prevScroll:a=0,top:l,start:u,topOffset:c,height:d}=e
...
this.isFixed=!1,this.animation&&o>c?(dt.cancel(this.$el),dt.out(this.$el,this.animation).then((()=>this.hide()),V)):this.hide()}else this.isFixed?this.update():this.animation&&o>c?(dt.cancel(this.$el),this.show(),dt.in(this.$el,this.animation).catch(V)):this.show()},events:["resize","scroll"]}],methods:{show(){this.isFixed=!0,this.update(),this.placeholder.hidden=!1},hide(){this.setActive(!1),Je(this.$el,this.clsFixed,this.clsBelow),Ye(this.$el,{position:"",top:"",width:""}),this.placeholder.hidden=!0},update(){let{width:e,scroll:t=0,overflow:r,overflowScroll:n=0,start:i,end:s,offset:o,topOffset:a,height:l,offsetParentTop:u}=this._data
const c=0!==i||t>i
let d="fixed"
t>s&&(o+=s-u,d="absolute"),r&&(o-=n),Ye(this.$el,{position:d,top:o+"px",width:e}),this.setActive(c),nt(this.$el,this.clsBelow,t>a+l),Xe(this.$el,this.clsFixed)},setActive(e){const t=this.active
this.active=e,e?(tt(this.selTarget,this.clsInactive,this.clsActive),t!==e&&je(this.$el,"active")):(tt(this.selTarget,this.clsActive,this.clsInactive),t!==e&&je(this.$el,"inactive"))}}}
function ki(e,t,r,n){if(!e)return 0
if(E(e)&&e.match(/^-?\d/))return r+kt(e)
{const r=!0===e?le(t):ge(e,t)
return ft(r).bottom-(n&&r&&he(t,r)?R(Ye(r,"paddingBottom")):0)}}var xi={mixins:[rn,di,nn],args:"connect",props:{connect:String,toggle:String,itemNav:String,active:Number},data:{connect:"~.uk-switcher",toggle:"> * > :first-child",itemNav:!1,active:0,cls:"uk-active",attrItem:"uk-switcher-item"},computed:{connects:{get(e,t){let{connect:r}=e
...
return Wt(r,t).filter((e=>!ce(e,".uk-disabled *, .uk-disabled, [disabled]")))},watch(e){const t=this.index()
this.show(~t?t:e[this.active]||e[0])},immediate:!0},children(){return fe(this.$el).filter((e=>this.toggles.some((t=>he(t,e)))))},swipeTarget(){return this.connects}},connected(){this.lazyload(this.$el,this.connects),Pt((()=>this.$emit()))},events:[{name:"click",delegate(){return this.toggle},handler(e){e.preventDefault(),this.show(e.current)}},{name:"click",el(){return this.connects.concat(this.itemNav?ve(this.itemNav,this.$el):[])},delegate(){return"["+this.attrItem+"],[data-"+this.attrItem+"]"},handler(e){e.preventDefault(),this.show(ee(e.current,this.attrItem))}},{name:"swipeRight swipeLeft",filter(){return this.swiping},el(){return this.connects},handler(e){let{type:t}=e
this.show(c(t,"Left")?"next":"previous")}}],methods:{index(){return h(this.children,(e=>rt(e,this.cls)))},show(e){const t=this.index(),r=G(e,this.toggles,t),n=G(this.children[r],fe(this.$el))
fe(this.$el).forEach(((e,t)=>{nt(e,this.cls,n===t),Z(this.toggles[t],"aria-expanded",n===t)}))
const i=t>=0&&t!==r
this.connects.forEach((async e=>{let{children:t}=e
await this.toggleElement(I(t).filter((e=>rt(e,this.cls))),!1,i),await this.toggleElement(t[n],!0,i)}))}}},Oi={mixins:[tn],extends:xi,props:{media:Boolean},data:{media:960,attrItem:"uk-tab-item"},connected(){const e=rt(this.$el,"uk-tab-left")?"uk-tab-left":!!rt(this.$el,"uk-tab-right")&&"uk-tab-right"
e&&this.$create("toggle",this.$el,{cls:e,mode:"media",media:this.media})}}
var Ei={mixins:[rn,Jn,nn],args:"target",props:{href:String,target:null,mode:"list",queued:Boolean},data:{href:!1,target:!1,mode:"click",queued:!0},computed:{target:{get(e,t){let{href:r,target:n}=e
return n=ve(n||r,t),n.length&&n||[t]},watch(){this.updateAria()},immediate:!0}},connected(){d(this.mode,"media")||ae(this.$el)||Z(this.$el,"tabindex","0"),this.lazyload(this.$el,this.target),Pt((()=>this.$emit()))},events:[{name:Xt,filter(){return d(this.mode,"hover")},handler(e){Ue(e)&&!this._showState&&(je(this.$el,"focus"),Re(document,Xt,(()=>je(this.$el,"blur")),!0,(e=>!he(e.target,this.$el))),d(this.mode,"click")&&(this._preventClick=!0))}},{name:tr+" "+rr+" focus blur",filter(){return d(this.mode,"hover")},handler(e){if(Ue(e))return
const t=d([tr,"focus"],e.type),r=Z(this.$el,"aria-expanded")
!t&&(e.type===rr&&ce(this.$el,":focus")||"blur"===e.type&&ce(this.$el,":hover"))||(this._showState&&t===(r!==this._showState)?t||(this._showState=null):(this._showState=t?r:null,this.toggle("toggle"+(t?"show":"hide"))))}},{name:"keydown",filter(){return d(this.mode,"click")&&!Tt(this.$el,"input")},handler(e){32===e.keyCode&&(e.preventDefault(),this.$el.click())}},{name:"click",filter(){return d(this.mode,"click")},handler(e){if(this._preventClick)return this._preventClick=null
...
z(Object.freeze({__proto__:null,Accordion:on,Alert:ln,Cover:dn,Drop:mn,Dropdown:mn,FormCustom:gn,Grid:En,HeightMatch:Pn,HeightViewport:An,Icon:zn,Img:Gn,Leader:ei,Margin:vn,Modal:ii,Nav:si,Navbar:ai,Offcanvas:hi,OverflowAuto:fi,Responsive:mi,Scroll:gi,Scrollspy:yi,ScrollspyNav:wi,Sticky:_i,Svg:Mn,Switcher:xi,Tab:Oi,Toggle:Ei,Video:un,Close:Vn,Spinner:qn,SlidenavNext:Un,SlidenavPrevious:Un,SearchIcon:Hn,Marker:Bn,NavbarToggleIcon:Bn,OverlayIcon:Bn,PaginationNext:Bn,PaginationPrevious:Bn,Totop:Bn}),((e,t)=>en.component(t,e))),en.use((function(){if(!Gt)return
let e=0
...
const s=Jr(i)
s&&s in e&&(X(n,i)?e[s](n):null==(r=e.getComponent(n,s))||r.$destroy())}Gt&&window.MutationObserver&&ir.read((function(){document.body&&Vt(document.body,t),new MutationObserver((e=>e.forEach(n))).observe(document,{childList:!0,subtree:!0}),new MutationObserver((e=>e.forEach(i))).observe(document,{attributes:!0,subtree:!0}),e._initialized=!0}))}(en)
const Ci=["days","hours","minutes","seconds"]
var Pi={mixins:[tn],props:{date:String,clsWrapper:String},data:{date:"",clsWrapper:".uk-countdown-%unit%"},connected(){this.date=Date.parse(this.$props.date),this.start()},disconnected(){this.stop()},events:[{name:"visibilitychange",el:()=>document,handler(){document.hidden?this.stop():this.start()}}],methods:{start(){this.stop(),this.update(),this.timer=setInterval(this.update,1e3)},stop(){clearInterval(this.timer)},update(){const e=function(e){const t=e-Date.now()
...
for(const t of Ci){const r=qt(this.clsWrapper.replace("%unit%",t),this.$el)
if(!r)continue
let n=String(Math.trunc(e[t]))
n=n.length<2?"0"+n:n,r.textContent!==n&&(n=n.split(""),n.length!==r.children.length&&St(r,n.map((()=>"<span></span>")).join("")),n.forEach(((e,t)=>r.children[t].textContent=e)))}}}}
const Ti="uk-transition-leave",Si="uk-transition-enter"
function Ai(e,t,r,n){void 0===n&&(n=0)
const i=Mi(t,!0),s={opacity:1},o={opacity:0},a=e=>()=>i===Mi(t)?e():Promise.reject(),l=a((()=>(Xe(t,Ti),Promise.all(ji(t).map(((e,t)=>new Promise((i=>setTimeout((()=>at.start(e,o,r/2,"ease").then(i)),t*n)))))).then((()=>Je(t,Ti)))))),u=a((()=>{const a=vt(t)
return Xe(t,Si),e(),Ye(fe(t),{opacity:0}),new Promise((e=>requestAnimationFrame((()=>{const l=fe(t),u=vt(t)
Ye(t,"alignContent","flex-start"),vt(t,a)
const c=ji(t)
Ye(l,o)
const d=c.map(((e,t)=>new Promise((i=>setTimeout((()=>at.start(e,s,r/2,"ease").then(i)),t*n)))))
a!==u&&d.push(at.start(t,{height:u},r/2+c.length*n,"ease")),Promise.all(d).then((()=>{Je(t,Si),i===Mi(t)&&(Ye(t,{height:"",alignContent:""}),Ye(l,{opacity:""}),delete t.dataset.transition),e()}))}))))}))
return rt(t,Ti)?Ri(t).then(u):rt(t,Si)?Ri(t).then(l).then(u):l().then(u)}function Mi(e,t){return t&&(e.dataset.transition=1+Mi(e)),M(e.dataset.transition)||0}function Ri(e){return Promise.all(fe(e).filter(at.inProgress).map((e=>new Promise((t=>Re(e,"transitionend transitioncanceled",t))))))}function ji(e){return bn(fe(e)).reduce(((e,t)=>e.concat(B(t.filter((e=>jr(e))),"offsetLeft"))),[])}function Ii(e,t,r){return new Promise((n=>requestAnimationFrame((()=>{let i=fe(t)
const s=i.map((e=>Li(e,!0))),o=Ye(t,["height","padding"])
at.cancel(t),i.forEach(at.cancel),Ni(t),e(),i=i.concat(fe(t).filter((e=>!d(i,e)))),Promise.resolve().then((()=>{ir.flush()
const e=Ye(t,["height","padding"]),[a,l]=function(e,t,r){const n=t.map(((e,t)=>!(!le(e)||!(t in r))&&(r[t]?ne(e)?Di(e):{opacity:0}:{opacity:ne(e)?1:0}))),i=n.map(((n,i)=>{const s=le(t[i])===e&&(r[i]||Li(t[i]))
if(!s)return!1
if(n){if(!("opacity"in n)){const{opacity:e}=s
e%1?n.opacity=1:delete s.opacity}}else delete s.opacity
return s}))
return[n,i]}(t,i,s)
i.forEach(((e,t)=>l[t]&&Ye(e,l[t]))),Ye(t,{display:"block",...o}),requestAnimationFrame((()=>{const s=i.map(((e,n)=>le(e)===t&&at.start(e,a[n],r,"ease"))).concat(at.start(t,e,r,"ease"))
Promise.all(s).then((()=>{i.forEach(((e,r)=>le(e)===t&&Ye(e,"display",0===a[r].opacity?"none":""))),Ni(t)}),V).then(n)}))}))}))))}function Li(e,t){const r=Ye(e,"zIndex")
return!!ne(e)&&{display:"",opacity:t?Ye(e,"opacity"):"0",pointerEvents:"none",position:"absolute",zIndex:"auto"===r?me(e):r,...Di(e)}}function Ni(e){Ye(e.children,{height:"",left:"",opacity:"",pointerEvents:"",position:"",top:"",marginTop:"",marginLeft:"",transform:"",width:"",zIndex:""}),Ye(e,{height:"",display:"",padding:""})}function Di(e){const{height:t,width:r}=ft(e),{top:n,left:i}=mt(e),{marginLeft:s,marginTop:o}=Ye(e,["marginTop","marginLeft"])
return{top:n,left:i,height:t,width:r,marginLeft:s,marginTop:o,transform:""}}var Fi={props:{duration:Number,animation:Boolean},data:{duration:150,animation:"slide"},methods:{animate(e,t){void 0===t&&(t=this.$el)
const r=this.animation,n="fade"===r?Ai:"delayed-fade"===r?function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r]
return Ai(...t,40)}:r?Ii:()=>(e(),Promise.resolve())
return n(e,t,this.duration).then((()=>this.$update(t,"resize")),V)}}},$i={mixins:[Fi],args:"target",props:{target:Boolean,selActive:Boolean},data:{target:null,selActive:!1,attrItem:"uk-filter-control",cls:"uk-active",duration:250},computed:{toggles:{get(e,t){let{attrItem:r}=e
return Wt("["+r+"],[data-"+r+"]",t)},watch(){if(this.updateState(),!1!==this.selActive){const e=Wt(this.selActive,this.$el)
this.toggles.forEach((t=>nt(t,this.cls,d(e,t))))}},immediate:!0},children:{get(e,t){let{target:r}=e
return Wt(r+" > *",t)},watch(e,t){var r,n
t&&(n=t,(r=e).length!==n.length||!r.every((e=>~n.indexOf(e))))&&this.updateState()},immediate:!0}},events:[{name:"click",delegate(){return"["+this.attrItem+"],[data-"+this.attrItem+"]"},handler(e){e.preventDefault(),this.apply(e.current)}}],methods:{apply(e){const t=this.getState(),r=Bi(e,this.attrItem,this.getState())
var n,i
n=t,i=r,["filter","sort"].every((e=>D(n[e],i[e])))||this.setState(r)},getState(){return this.toggles.filter((e=>rt(e,this.cls))).reduce(((e,t)=>Bi(t,this.attrItem,e)),{filter:{"":""},sort:[]})},setState(e,t){void 0===t&&(t=!0),e={filter:{"":""},sort:[],...e},je(this.$el,"beforeFilter",[this,e]),this.toggles.forEach((t=>nt(t,this.cls,!!function(e,t,r){let{filter:n={"":""},sort:[i,s]}=r
const{filter:o="",group:a="",sort:l,order:u="asc"}=zi(e,t)
return S(l)?a in n&&o===n[a]||!o&&a&&!(a in n)&&!n[""]:i===l&&s===u}(t,this.attrItem,e)))),Promise.all(Wt(this.target,this.$el).map((r=>{const n=()=>{(function(e,t,r){const n=function(e){let{filter:t}=e,r=""
...
D(e,r)||Rt(t,e)}})(e,r,fe(r)),this.$update(this.$el)}
return t?this.animate(n,r):n()}))).then((()=>je(this.$el,"afterFilter",[this])))},updateState(){ir.write((()=>this.setState(this.getState(),!1)))}}}
function zi(e,t){return _r(ee(e,t),["filter"])}function Bi(e,t,r){const n=zi(e,t),{filter:i,group:s,sort:o,order:a="asc"}=n
return(i||S(o))&&(s?i?(delete r.filter[""],r.filter[s]=i):(delete r.filter[s],(T(r.filter)||""in r.filter)&&(r.filter={"":i||""})):r.filter={"":i||""}),S(o)||(r.sort=[o,a]),r}var Ui={slide:{show:e=>[{transform:Vi(-100*e)},{transform:Vi()}],percent:e=>Hi(e),translate:(e,t)=>[{transform:Vi(-100*t*e)},{transform:Vi(100*t*(1-e))}]}}
function Hi(e){return Math.abs(Ye(e,"transform").split(",")[4]/e.offsetWidth)||0}function Vi(e,t){return void 0===e&&(e=0),void 0===t&&(t="%"),"translate3d("+(e+=e?t:"")+", 0, 0)"}function qi(e){return"scale3d("+e+", "+e+", 1)"}var Wi={...Ui,fade:{show:()=>[{opacity:0},{opacity:1}],percent:e=>1-Ye(e,"opacity"),translate:e=>[{opacity:1-e},{opacity:e}]},scale:{show:()=>[{opacity:0,transform:qi(.8)},{opacity:1,transform:qi(1)}],percent:e=>1-Ye(e,"opacity"),translate:e=>[{opacity:1-e,transform:qi(1-.2*e)},{opacity:e,transform:qi(.8+.2*e)}]}}
function Yi(e,t,r){je(e,Ie(t,!1,!1,r))}var Gi={props:{autoplay:Boolean,autoplayInterval:Number,pauseOnHover:Boolean},data:{autoplay:!1,autoplayInterval:7e3,pauseOnHover:!0},connected(){this.autoplay&&this.startAutoplay()},disconnected(){this.stopAutoplay()},update(){Z(this.slides,"tabindex","-1")},events:[{name:"visibilitychange",el:()=>document,filter(){return this.autoplay},handler(){document.hidden?this.stopAutoplay():this.startAutoplay()}}],methods:{startAutoplay(){this.stopAutoplay(),this.interval=setInterval((()=>(!this.draggable||!qt(":focus",this.$el))&&(!this.pauseOnHover||!ce(this.$el,":hover"))&&!this.stack.length&&this.show("next")),this.autoplayInterval)},stopAutoplay(){this.interval&&clearInterval(this.interval)}}},Ki={props:{draggable:Boolean},data:{draggable:!0,threshold:10},created(){for(const e of["start","move","end"]){const t=this[e]
this[e]=e=>{const r=He(e).x*(Kt?-1:1)
this.prevPos=r===this.pos?this.prevPos:this.pos,this.pos=r,t(e)}}},events:[{name:Xt,delegate(){return this.selSlides},handler(e){var t
!this.draggable||!Ue(e)&&(t=e.target,!t.children.length&&t.childNodes.length)||de(e.target,ie)||e.button>0||this.length<2||this.start(e)}},{name:"dragstart",handler(e){e.preventDefault()}}],methods:{start(){this.drag=this.pos,this._transitioner?(this.percent=this._transitioner.percent(),this.drag+=this._transitioner.getDistance()*this.percent*this.dir,this._transitioner.cancel(),this._transitioner.translate(this.percent),this.dragging=!0,this.stack=[]):this.prevIndex=this.index,Ae(document,Jt,this.move,{passive:!1}),Ae(document,er+" "+nr+" input",this.end,!0),Ye(this.list,"userSelect","none")},move(e){const t=this.pos-this.drag
...
let h;[this.index,this.prevIndex].filter((e=>!d([s,n],e))).forEach((e=>{je(r[e],"itemhidden",[this]),c&&(h=!0,this.prevIndex=n)})),(this.index===n&&this.prevIndex!==n||h)&&je(r[this.index],"itemshown",[this]),u&&(this.prevIndex=n,this.index=s,!c&&je(a,"beforeitemhide",[this]),je(l,"beforeitemshow",[this])),this._transitioner=this._translate(Math.abs(this.percent),a,!c&&l),u&&(!c&&je(a,"itemhide",[this]),je(l,"itemshow",[this]))},end(){if(Me(document,Jt,this.move,{passive:!1}),Me(document,er+" "+nr+" input",this.end,!0),this.dragging)if(this.dragging=null,this.index===this.prevIndex)this.percent=1-this.percent,this.dir*=-1,this._show(!1,this.index,!0),this._transitioner=null
else{const e=(Kt?this.dir*(Kt?1:-1):this.dir)<0==this.prevPos>this.pos
...
var Qi={mixins:[Gi,Ki,{data:{selNav:!1},computed:{nav(e,t){let{selNav:r}=e
return qt(r,t)},selNavItem(e){let{attrItem:t}=e
return"["+t+"],[data-"+t+"]"},navItems(e,t){return Wt(this.selNavItem,t)}},update:{write(){this.nav&&this.length!==this.nav.children.length&&St(this.nav,this.slides.map(((e,t)=>"<li "+this.attrItem+'="'+t+'"><a href></a></li>')).join("")),this.navItems.concat(this.nav).forEach((e=>e&&(e.hidden=!this.maxIndex))),this.updateNav()},events:["resize"]},events:[{name:"click",delegate(){return this.selNavItem},handler(e){e.preventDefault(),this.show(ee(e.current,this.attrItem))}},{name:"itemshow",handler:"updateNav"}],methods:{updateNav(){const e=this.getValidIndex()
for(const t of this.navItems){const r=ee(t,this.attrItem)
nt(t,this.clsActive,M(r)===e),nt(t,"uk-invisible",this.finite&&("previous"===r&&0===e||"next"===r&&e>=this.maxIndex))}}}},cn],props:{clsActivated:Boolean,easing:String,index:Number,finite:Boolean,velocity:Number,selSlides:String},data:()=>({easing:"ease",finite:!1,velocity:1,index:0,prevIndex:-1,stack:[],percent:0,clsActive:"uk-active",clsActivated:!1,Transitioner:!1,transitionOptions:{}}),connected(){this.prevIndex=-1,this.index=this.getValidIndex(this.$props.index),this.stack=[]},disconnected(){Je(this.slides,this.clsActive)},computed:{duration(e,t){let{velocity:r}=e
return Zi(t.offsetWidth/r)},list(e,t){let{selList:r}=e
return qt(r,t)},maxIndex(){return this.length-1},selSlides(e){let{selList:t,selSlides:r}=e
return t+" "+(r||"> *")},slides:{get(){return Wt(this.selSlides,this.$el)},watch(){this.$reset()}},length(){return this.slides.length}},methods:{show(e,t){if(void 0===t&&(t=!1),this.dragging||!this.length)return
...
const u=this._show(o,l,t).then((()=>(o&&je(o,"itemhidden",[this]),je(l,"itemshown",[this]),new Promise((e=>{ir.write((()=>{r.shift(),r.length?this.show(r.shift(),!0):this._transitioner=null,e()}))})))))
...
return n.translate(e),n},_getTransitioner(e,t,r,n){return void 0===e&&(e=this.prevIndex),void 0===t&&(t=this.index),void 0===r&&(r=this.dir||1),void 0===n&&(n=this.transitionOptions),new this.Transitioner(C(e)?this.slides[e]:e,C(t)?this.slides[t]:t,r*(Kt?-1:1),n)}}}
function Zi(e){return.5*e+300}var Xi={mixins:[Qi],props:{animation:String},data:{animation:"slide",clsActivated:"uk-transition-active",Animations:Ui,Transitioner:function(e,t,r,n){let{animation:i,easing:s}=n
const{percent:o,translate:a,show:l=V}=i,u=l(r),c=new Q
return{dir:r,show(n,i,o){void 0===i&&(i=0)
const a=o?"linear":s
return n-=Math.round(n*H(i,-1,1)),this.translate(i),Yi(t,"itemin",{percent:i,duration:n,timing:a,dir:r}),Yi(e,"itemout",{percent:1-i,duration:n,timing:a,dir:r}),Promise.all([at.start(t,u[1],n,a),at.start(e,u[0],n,a)]).then((()=>{this.reset(),c.resolve()}),V),c.promise},cancel(){at.cancel([t,e])},reset(){for(const r in u[0])Ye([t,e],r,"")},forward(r,n){return void 0===n&&(n=this.percent()),at.cancel([t,e]),this.show(r,n,!0)},translate(n){this.reset()
const i=a(n,r)
Ye(t,i[1]),Ye(e,i[0]),Yi(t,"itemtranslatein",{percent:n,dir:r}),Yi(e,"itemtranslateout",{percent:1-n,dir:r})},percent:()=>o(e||t,t,r),getDistance:()=>null==e?void 0:e.offsetWidth}}},computed:{animation(e){let{animation:t,Animations:r}=e
...
Je(t,this.clsActive,this.clsActivated)}}},Ji={mixins:[hn,ri,nn,Xi],functional:!0,props:{delayControls:Number,preload:Number,videoAutoplay:Boolean,template:String},data:()=>({preload:1,videoAutoplay:!1,delayControls:3e3,items:[],cls:"uk-open",clsPage:"uk-lightbox-page",selList:".uk-lightbox-items",attrItem:"uk-lightbox-item",selClose:".uk-close-large",selCaption:".uk-lightbox-caption",pauseOnHover:!1,velocity:2,Animations:Wi,template:'<div class="uk-lightbox uk-overflow-hidden"> <ul class="uk-lightbox-items"></ul> <div class="uk-lightbox-toolbar uk-position-top uk-text-right uk-transition-slide-top uk-transition-opaque"> <button class="uk-lightbox-toolbar-icon uk-close-large" type="button" uk-close></button> </div> <a class="uk-lightbox-button uk-position-center-left uk-position-medium uk-transition-fade" href uk-slidenav-previous uk-lightbox-item="previous"></a> <a class="uk-lightbox-button uk-position-center-right uk-position-medium uk-transition-fade" href uk-slidenav-next uk-lightbox-item="next"></a> <div class="uk-lightbox-toolbar uk-lightbox-caption uk-position-bottom uk-text-center uk-transition-slide-bottom uk-transition-opaque"></div> </div>'}),created(){const e=qt(this.template),t=qt(this.selList,e)
this.items.forEach((()=>Rt(t,"<li>"))),this.$mount(Rt(this.container,e))},computed:{caption(e,t){let{selCaption:r}=e
return qt(r,t)}},events:[{name:Jt+" "+Xt+" keydown",handler:"showControls"},{name:"click",self:!0,delegate(){return this.selSlides},handler(e){e.defaultPrevented||this.hide()}},{name:"shown",self:!0,handler(){this.showControls()}},{name:"hide",self:!0,handler(){this.hideControls(),Je(this.slides,this.clsActive),at.stop(this.slides)}},{name:"hidden",self:!0,handler(){this.$destroy(!0)}},{name:"keyup",el:()=>document,handler(e){if(this.isToggled(this.$el)&&this.draggable)switch(e.keyCode){case 37:this.show("previous")
break
case 39:this.show("next")}}},{name:"beforeitemshow",handler(e){this.isToggled()||(this.draggable=!1,e.preventDefault(),this.toggleElement(this.$el,!0,!1),this.animation=Wi.scale,Je(e.target,this.clsActive),this.stack.splice(1,0,this.index))}},{name:"itemshow",handler(){St(this.caption,this.getItem().caption||"")
...
this.setItem(t,es("img",{src:r,width:e,height:n,alt:i,...o}))}catch(u){this.setError(t)}else if("video"===n||r.match(/\.(mp4|webm|ogv)($|\?)/i)){const e=es("video",{src:r,poster:s,controls:"",playsinline:"","uk-video":""+this.videoAutoplay,...o})
Ae(e,"loadedmetadata",(()=>{Z(e,{width:e.videoWidth,height:e.videoHeight}),this.setItem(t,e)})),Ae(e,"error",(()=>this.setError(t)))}else if("iframe"===n||r.match(/\.(html|php)($|\?)/i))this.setItem(t,es("iframe",{src:r,frameborder:"0",allowfullscreen:"",class:"uk-lightbox-iframe",...o}))
else if(a=r.match(/\/\/(?:.*?youtube(-nocookie)?\..*?[?&]v=|youtu\.be\/)([\w-]{11})[&?]?(.*)?/))this.setItem(t,es("iframe",{src:"https://www.youtube"+(a[1]||"")+".com/embed/"+a[2]+(a[3]?"?"+a[3]:""),width:1920,height:1080,...l,...o}))
...
this.setItem(t,es("iframe",{src:"https://player.vimeo.com/video/"+a[1]+(a[2]?"?"+a[2]:""),width:n,height:e,...l,...o}))}catch(u){this.setError(t)}}}],methods:{loadItem(e){void 0===e&&(e=this.index)
const t=this.getItem(e)
this.getSlide(t).childElementCount||je(this.$el,"itemload",[t])},getItem(e){return void 0===e&&(e=this.index),this.items[G(e,this.slides)]},setItem(e,t){je(this.$el,"itemloaded",[this,St(this.getSlide(e),t)])},getSlide(e){return this.slides[this.items.indexOf(e)]},setError(e){this.setItem(e,'<span uk-icon="icon: bolt; ratio: 2"></span>')},showControls(){clearTimeout(this.controlsTimer),this.controlsTimer=setTimeout(this.hideControls,this.delayControls),Xe(this.$el,"uk-active","uk-transition-active")},hideControls(){Je(this.$el,"uk-active","uk-transition-active")}}}
function es(e,t){const r=Ut("<"+e+">")
return Z(r,t),r}var ts={install:function(e,t){e.lightboxPanel||e.component("lightboxPanel",Ji)
...
return Wt(r,t)},watch(){this.hide()}}},disconnected(){this.hide()},events:[{name:"click",delegate(){return this.toggle+":not(.uk-disabled)"},handler(e){e.preventDefault(),this.show(e.current)}}],methods:{show(e){const t=U(this.toggles.map(rs),"source")
if(k(e)){const{source:r}=rs(e)
...
function rs(e){const t={}
for(const r of["href","caption","type","poster","alt","attrs"])t["href"===r?"source":r]=ee(e,r)
return t.attrs=_r(t.attrs),t}var ns={mixins:[hn],functional:!0,args:["message","status"],data:{message:"",status:"",timeout:5e3,group:null,pos:"top-center",clsContainer:"uk-notification",clsClose:"uk-notification-close",clsMsg:"uk-notification-message"},install:function(e){e.notification.closeAll=function(t,r){Vt(document.body,(n=>{const i=e.getComponent(n,"notification")
!i||t&&t!==i.group||i.close(r)}))}},computed:{marginProp(e){let{pos:t}=e
return"margin"+(u(t,"top")?"Top":"Bottom")},startProps(){return{opacity:0,[this.marginProp]:-this.$el.offsetHeight}}},created(){const e=qt("."+this.clsContainer+"-"+this.pos,this.container)||Rt(this.container,'<div class="'+this.clsContainer+" "+this.clsContainer+"-"+this.pos+'" style="display: block"></div>')
this.$mount(Rt(e,'<div class="'+this.clsMsg+(this.status?" "+this.clsMsg+"-"+this.status:"")+'"> <a href class="'+this.clsClose+'" data-uk-close></a> <div>'+this.message+"</div> </div>"))},async connected(){const e=R(Ye(this.$el,this.marginProp))
await at.start(Ye(this.$el,this.startProps),{opacity:1,[this.marginProp]:e}),this.timeout&&(this.timer=setTimeout(this.close,this.timeout))},events:{click(e){de(e.target,'a[href="#"],a[href=""]')&&e.preventDefault(),this.close()},[tr](){this.timer&&clearTimeout(this.timer)},[rr](){this.timeout&&(this.timer=setTimeout(this.close,this.timeout))}},methods:{async close(e){this.timer&&clearTimeout(this.timer),e||await at.start(this.$el,this.startProps),(e=>{const t=le(e)
je(e,"close",[this]),Nt(e),null!=t&&t.hasChildNodes()||Nt(t)})(this.$el)}}}
const is={x:as,y:as,rotate:as,scale:as,color:ls,backgroundColor:ls,borderColor:ls,blur:us,hue:us,fopacity:us,grayscale:us,invert:us,saturate:us,sepia:us,opacity:function(e,t,r){1===r.length&&r.unshift(ys(t,e,""))
return r=fs(r),(t,n)=>{t[e]=gs(r,n)}},stroke:function(e,t,r){1===r.length&&r.unshift(0)
const n=bs(r),i=Nn(t)
if(r=fs(r.reverse(),(e=>(e=R(e),"%"===n?e*i/100:e))),!r.some((e=>{let[t]=e
return t})))return V
return Ye(t,"strokeDasharray",i),(e,t)=>{e.strokeDashoffset=gs(r,t)}},bgx:cs,bgy:cs},{keys:ss}=Object
var os={mixins:[Jn],props:ws(ss(is),"list"),data:ws(ss(is),void 0),computed:{props:(e,t)=>ss(is).reduce(((r,n)=>(S(e[n])||(r[n]=is[n](n,t,e[n].slice())),r)),{})},events:{load(){this.$emit()}},methods:{reset(){z(this.getCss(0),((e,t)=>Ye(this.$el,t,"")))},getCss(e){const t={transform:"",filter:""}
for(const r in this.props)this.props[r](t,e)
return t}}}
function as(e,t,r){const n=bs(r)||{x:"px",y:"px",rotate:"deg"}[e]||""
let i
return"x"!==e&&"y"!==e||(e="translate"+a(e),i=e=>R(R(e).toFixed("px"===n?0:6))),1===r.length&&r.unshift("scale"===e?1:0),r=fs(r,i),(t,i)=>{t.transform+=" "+e+"("+gs(r,i)+n+")"}}function ls(e,t,r){return 1===r.length&&r.unshift(ys(t,e,"")),r=fs(r,(e=>function(e,t){return ys(e,"color",t).split(/[(),]/g).slice(1,-1).concat(1).slice(0,4).map(R)}(t,e))),(t,n)=>{const[i,s,o]=ms(r,n),a=i.map(((e,t)=>(e+=o*(s[t]-e),3===t?R(e):parseInt(e,10)))).join(",")
t[e]="rgba("+a+")"}}function us(e,t,r){1===r.length&&r.unshift(0)
const n=bs(r)||{blur:"px",hue:"deg"}[e]||"%"
return e={fopacity:"opacity",hue:"hue-rotate"}[e]||e,r=fs(r),(t,i)=>{const s=gs(r,i)
t.filter+=" "+e+"("+(s+n)+")"}}function cs(e,t,r){1===r.length&&r.unshift(0)
const n="y"===(e=e.substr(-1))?"height":"width"
r=fs(r,(e=>kt(e,n,t)))
const i=ys(t,"background-position-"+e,"")
return"cover"===ys(t,"backgroundSize","")?function(e,t,r,n,i){const s=function(e){const t=Ye(e,"backgroundImage").replace(/^none|url\(["']?(.+?)["']?\)$/,"$1")
if(hs[t])return hs[t]
const r=new Image
if(t&&(r.src=t,!r.naturalWidth))return r.onload=()=>{hs[t]=ps(r),je(e,Ie("load",!1))},ps(r)
return hs[t]=ps(r)}(t)
if(!s.width)return V
...
e&&(d-=(f-c)/e)}const m=Y.cover(s,h),g=ds(e,r,d+"px")
return(e,t)=>{g(e,t),e.backgroundSize=m.width+"px "+m.height+"px",e.backgroundRepeat="no-repeat"}}(e,t,r,i,n):ds(e,r,i)}function ds(e,t,r){return function(n,i){n["background-position-"+e]="calc("+r+" + "+gs(t,i)+"px)"}}const hs={}
function ps(e){return{width:e.naturalWidth,height:e.naturalHeight}}function fs(e,t){void 0===t&&(t=R)
const r=[],{length:n}=e
let i=0
...
i=0}}return r}function ms(e,t){const r=h(e.slice(1),(e=>{let[,r]=e
return t<=r}))+1
return[e[r-1][0],e[r][0],(t-e[r-1][1])/(e[r][1]-e[r-1][1])]}function gs(e,t){const[r,n,i]=ms(e,t)
return C(r)?r+Math.abs(r-n)*i*(r<n?1:-1):+n}const vs=/^-?\d+([^\s]*)/
function bs(e,t){for(const r of e){const e=null==r.match?void 0:r.match(vs)
if(e)return e[1]}return t}function ys(e,t,r){const n=e.style[t],i=Ye(Ye(e,t,r),t)
return e.style[t]=n,i}function ws(e,t){return e.reduce(((e,r)=>(e[r]=t,e)),{})}var _s={mixins:[os,cn,kn],props:{target:String,viewport:Number,easing:Number,start:String,end:String},data:{target:!1,viewport:1,easing:1,start:0,end:0},computed:{target(e,t){let{target:r}=e
return ks(r&&ge(r,t)||t)},start(e){let{start:t}=e
...
const n=r
return r=function(e,t){return t>=0?Math.pow(e,t+1):1-Math.pow(1-e,1-t)}(Nr(this.target,this.start,this.end),this.easing),{percent:r,style:n!==r&&this.getCss(r)}},write(e){let{style:t}=e
this.matchMedia?t&&Ye(this.$el,t):this.reset()},events:["scroll","resize"]}}
function ks(e){return e?"offsetTop"in e?e:ks(le(e)):document.documentElement}var xs={update:{write(){if(this.stack.length||this.dragging)return
const e=this.getValidIndex(this.index)
~this.prevIndex&&this.index===e||this.show(e)},events:["resize"]}},Os={mixins:[rn],connected(){this.lazyload(this.slides,this.getAdjacentSlides)}}
function Es(e,t,r){const n=Ts(e,t)
return r?n-function(e,t){return pt(t).width/2-pt(e).width/2}(e,t):Math.min(n,Cs(t))}function Cs(e){return Math.max(0,Ps(e)-pt(e).width)}function Ps(e){return fe(e).reduce(((e,t)=>pt(t).width+e),0)}function Ts(e,t){return e&&(mt(e).left+(Kt?pt(e).width-pt(t).width:0))*(Kt?-1:1)||0}function Ss(e,t){t-=1
const r=pt(e).width,n=t+r+2
return fe(e).filter((i=>{const s=Ts(i,e),o=s+Math.min(pt(i).width,r)
return s>=t&&o<=n}))}function As(e,t,r){je(e,Ie(t,!1,!1,r))}var Ms={mixins:[tn,Qi,xs,Os],props:{center:Boolean,sets:Boolean},data:{center:!1,sets:!1,attrItem:"uk-slider-item",selList:".uk-slider-items",selNav:".uk-slider-nav",clsContainer:"uk-slider-container",Transitioner:function(e,t,r,n){let{center:i,easing:s,list:o}=n
const a=new Q,l=e?Es(e,o,i):Es(t,o,i)+pt(t).width*r,u=t?Es(t,o,i):l+pt(e).width*r*(Kt?-1:1)
return{dir:r,show(t,n,i){void 0===n&&(n=0)
const l=i?"linear":s
return t-=Math.round(t*H(n,-1,1)),this.translate(n),n=e?n:H(n,0,1),As(this.getItemIn(),"itemin",{percent:n,duration:t,timing:l,dir:r}),e&&As(this.getItemIn(!0),"itemout",{percent:1-n,duration:t,timing:l,dir:r}),at.start(o,{transform:Vi(-u*(Kt?-1:1),"px")},t,l).then(a.resolve,V),a.promise},cancel(){at.cancel(o)},reset(){Ye(o,"transform","")},forward(e,t){return void 0===t&&(t=this.percent()),at.cancel(o),this.show(e,t,!0)},translate(n){const i=this.getDistance()*r*(Kt?-1:1)
Ye(o,"transform",Vi(H(i-i*n-u,-Ps(o),pt(o).width)*(Kt?-1:1),"px"))
const s=this.getActives(),a=this.getItemIn(),l=this.getItemIn(!0)
n=e?H(n,-1,1):0
for(const u of fe(o)){const i=d(s,u),c=u===a,h=u===l
As(u,"itemtranslate"+(c||!h&&(i||r*(Kt?-1:1)==-1^Ts(u,o)>Ts(e||t))?"in":"out"),{dir:r,percent:h?1-n:c?n:i?1:0})}},percent:()=>Math.abs((Ye(o,"transform").split(",")[4]*(Kt?-1:1)+l)/(u-l)),getDistance:()=>Math.abs(u-l),getItemIn(r){void 0===r&&(r=!1)
let n=this.getActives(),s=Ss(o,Es(t||e,o,i))
if(r){const e=n
n=s,s=e}return s[h(s,(e=>!d(n,e)))]},getActives:()=>Ss(o,Es(e||t,o,i))}}},computed:{avgWidth(){return Ps(this.list)/this.length},finite(e){let{finite:t}=e
return t||Math.ceil(Ps(this.list))<Math.trunc(pt(this.list).width+(r=this.list,Math.max(0,...fe(r).map((e=>pt(e).width))))+this.center)
var r},maxIndex(){if(!this.finite||this.center&&!this.sets)return this.length-1
if(this.center)return $(this.sets)
let e=0
const t=Cs(this.list),r=h(this.slides,(r=>{if(e>=t)return!0
e+=pt(r).width}))
...
this.duration=Zi(this.avgWidth/this.velocity)*(pt(this.slides[r]).width/this.avgWidth),this.reorder()},itemshow(){~this.prevIndex&&Xe(this._getTransitioner().getItemIn(),this.clsActive)},itemshown(){this.updateActiveClasses()}},methods:{reorder(){if(this.finite)return void Ye(this.slides,"order","")
...
Ye(i,"order",t>e?-2:-1),r-=pt(i).width}},updateActiveClasses(){const e=this._getTransitioner(this.index).getActives(),t=[this.clsActive,(!this.sets||d(this.sets,R(this.index)))&&this.clsActivated||""]
...
var Rs={mixins:[os],data:{selItem:"!li"},beforeConnect(){this.item=ge(this.selItem,this.$el)},disconnected(){this.item=null},events:[{name:"itemin itemout",self:!0,el(){return this.item},handler(e){let{type:t,detail:{percent:r,duration:n,timing:i,dir:s}}=e
ir.read((()=>{const e=this.getCss(Is(t,s,r)),o=this.getCss(js(t)?.5:s>0?1:0)
ir.write((()=>{Ye(this.$el,e),at.start(this.$el,o,n,i).catch(V)}))}))}},{name:"transitioncanceled transitionend",self:!0,el(){return this.item},handler(){at.cancel(this.$el)}},{name:"itemtranslatein itemtranslateout",self:!0,el(){return this.item},handler(e){let{type:t,detail:{percent:r,dir:n}}=e
ir.read((()=>{const e=this.getCss(Is(t,n,r))
ir.write((()=>Ye(this.$el,e)))}))}}]}
function js(e){return c(e,"in")}function Is(e,t,r){return r/=2,js(e)^t<0?r:1-r}var Ls={...Ui,fade:{show:()=>[{opacity:0,zIndex:0},{zIndex:-1}],percent:e=>1-Ye(e,"opacity"),translate:e=>[{opacity:1-e,zIndex:0},{zIndex:-1}]},scale:{show:()=>[{opacity:0,transform:qi(1.5),zIndex:0},{zIndex:-1}],percent:e=>1-Ye(e,"opacity"),translate:e=>[{opacity:1-e,transform:qi(1+.5*e),zIndex:0},{zIndex:-1}]},pull:{show:e=>e<0?[{transform:Vi(30),zIndex:-1},{transform:Vi(),zIndex:0}]:[{transform:Vi(-100),zIndex:0},{transform:Vi(),zIndex:-1}],percent:(e,t,r)=>r<0?1-Hi(t):Hi(e),translate:(e,t)=>t<0?[{transform:Vi(30*e),zIndex:-1},{transform:Vi(-100*(1-e)),zIndex:0}]:[{transform:Vi(100*-e),zIndex:0},{transform:Vi(30*(1-e)),zIndex:-1}]},push:{show:e=>e<0?[{transform:Vi(100),zIndex:0},{transform:Vi(),zIndex:-1}]:[{transform:Vi(-30),zIndex:-1},{transform:Vi(),zIndex:0}],percent:(e,t,r)=>r>0?1-Hi(t):Hi(e),translate:(e,t)=>t<0?[{transform:Vi(100*e),zIndex:0},{transform:Vi(-30*(1-e)),zIndex:-1}]:[{transform:Vi(-30*e),zIndex:-1},{transform:Vi(100*(1-e)),zIndex:0}]}},Ns={mixins:[tn,Xi,xs,Os],props:{ratio:String,minHeight:Number,maxHeight:Number},data:{ratio:"16:9",minHeight:!1,maxHeight:!1,selList:".uk-slideshow-items",attrItem:"uk-slideshow-item",selNav:".uk-slideshow-nav",Animations:Ls},update:{read(){if(!this.list)return!1
...
t>0&&Ye(this.list,"minHeight",t)},events:["resize"]},methods:{getAdjacentSlides(){return[1,-1].map((e=>this.slides[this.getIndex(this.index+e)]))}}},Ds={mixins:[tn,Fi],props:{group:String,threshold:Number,clsItem:String,clsPlaceholder:String,clsDrag:String,clsDragState:String,clsBase:String,clsNoDrag:String,clsEmpty:String,clsCustom:String,handle:String},data:{group:!1,threshold:5,clsItem:"uk-sortable-item",clsPlaceholder:"uk-sortable-placeholder",clsDrag:"uk-sortable-drag",clsDragState:"uk-drag",clsBase:"uk-sortable",clsNoDrag:"uk-sortable-nodrag",clsEmpty:"uk-sortable-empty",clsCustom:"",handle:!1,pos:{}},created(){for(const e of["init","start","move","end"]){const t=this[e]
this[e]=e=>{m(this.pos,He(e)),t(e)}}},events:{name:Xt,passive:!1,handler:"init"},computed:{target(){return(this.$el.tBodies||[this.$el])[0]},items(){return fe(this.target)},isEmpty:{get(){return T(this.items)},watch(e){nt(this.target,this.clsEmpty,e)},immediate:!0},handles:{get(e,t){let{handle:r}=e
return r?Wt(r,t):this.items},watch(e,t){Ye(t,{touchAction:"",userSelect:""}),Ye(e,{touchAction:Qt?"none":"",userSelect:"none"})},immediate:!0}},update:{write(e){if(!this.drag||!le(this.placeholder))return
...
return!$s([r.left,r.right],[t.left,t.right])}))}))
r&&Nt(t)
return i}(e,r)||i<o.top+o.height/2?t:t.nextElementSibling
const a=r.getBoundingClientRect(),l=$s([o.top,o.bottom],[a.top,a.bottom]),u=l?n:i,c=l?"width":"height",d=l?"left":"top",h=l?"right":"bottom",p=a[c]<o[c]?o[c]-a[c]:0
...
!i||n||r>0||se(t)||he(t,"."+this.clsNoDrag)||this.handle&&!he(t,this.handle)||(e.preventDefault(),this.touched=new Set([this]),this.placeholder=i,this.origin={target:t,index:me(i),...this.pos},Ae(document,Jt,this.move),Ae(document,er,this.end),this.threshold||this.start(e))},start(e){this.drag=function(e,t){const r=Rt(e,t.outerHTML.replace(/(^<)(?:li|tr)|(?:li|tr)(\/>$)/g,"$1div$2"))
return Ye(r,"margin","0","important"),Ye(r,{boxSizing:"border-box",width:t.offsetWidth,height:t.offsetHeight,padding:Ye(t,"padding")}),vt(r.firstElementChild,vt(t.firstElementChild)),r}(this.$container,this.placeholder)
const{left:t,top:r}=this.placeholder.getBoundingClientRect()
m(this.origin,{offsetLeft:this.pos.x-t,offsetTop:this.pos.y-r}),Xe(this.drag,this.clsDrag,this.clsCustom),Xe(this.placeholder,this.clsPlaceholder),Xe(this.items,this.clsItem),Xe(document.documentElement,this.clsDragState),je(this.$el,"start",[this,this.placeholder]),function(e){let t=Date.now()
Fs=setInterval((()=>{let{x:r,y:n}=e
n+=Ir(window)
const i=.3*(Date.now()-t)
t=Date.now(),Dr(document.elementFromPoint(r,e.y),/auto|scroll/).reverse().some((e=>{let{scrollTop:t,scrollHeight:r}=e
const{top:s,bottom:o,height:a}=ft(Fr(e))
if(s<n&&s+35>n)t-=i
else{if(!(o>n&&o-35<n))return
t+=i}if(t>0&&t<r-a)return Ir(e,t),!0}))}),15)}(this.pos),this.move(e)},move(e){this.drag?this.$emit("move"):(Math.abs(this.pos.x-this.origin.x)>this.threshold||Math.abs(this.pos.y-this.origin.y)>this.threshold)&&this.start(e)},end(){if(Me(document,Jt,this.move),Me(document,er,this.end),!this.drag)return
clearInterval(Fs)
const e=this.getSortable(this.placeholder)
this===e?this.origin.index!==me(this.placeholder)&&je(this.$el,"moved",[this,this.placeholder]):(je(e.$el,"added",[e,this.placeholder]),je(this.$el,"removed",[this,this.placeholder])),je(this.$el,"stop",[this,this.placeholder]),Nt(this.drag),this.drag=null
...
this.animate((()=>t?jt(t,e):Rt(this.target,e)))},remove(e){he(e,this.target)&&this.animate((()=>Nt(e)))},getSortable(e){do{const t=this.$getComponent(e,"sortable")
if(t&&(t===this||!1!==this.group&&t.group===this.group))return t}while(e=le(e))}}}
let Fs
function $s(e,t){return e[1]>t[0]&&t[1]>e[0]}var zs={mixins:[hn,nn,pn],args:"title",props:{delay:Number,title:String},data:{pos:"top",title:"",delay:0,animation:["uk-animation-scale-up"],duration:100,cls:"uk-active"},beforeConnect(){var e
this._hasTitle=X(this.$el,"title"),Z(this.$el,"title",""),this.updateAria(!1),ae(e=this.$el)||Z(e,"tabindex","0")},disconnected(){this.hide(),Z(this.$el,"title",this._hasTitle?this.title:null)},methods:{show(){!this.isToggled(this.tooltip||null)&&this.title&&(this._unbind=Re(document,"show keydown "+Xt,this.hide,!1,(e=>e.type===Xt&&!he(e.target,this.$el)||"keydown"===e.type&&27===e.keyCode||"show"===e.type&&e.detail[0]!==this&&e.detail[0].$name===this.$name)),clearTimeout(this.showTimer),this.showTimer=setTimeout(this._show,this.delay))},async hide(){ce(this.$el,"input:focus")||(clearTimeout(this.showTimer),this.isToggled(this.tooltip||null)&&(await this.toggleElement(this.tooltip,!1,!1),Nt(this.tooltip),this.tooltip=null,this._unbind()))},_show(){this.tooltip=Rt(this.container,'<div class="uk-'+this.$options.name+'"> <div class="uk-'+this.$options.name+'-inner">'+this.title+"</div> </div>"),Ae(this.tooltip,"toggled",((e,t)=>{this.updateAria(t),t&&(this.positionAt(this.tooltip,this.$el),this.origin="y"===this.getAxis()?_t(this.dir)+"-"+this.align:this.align+"-"+_t(this.dir))})),this.toggleElement(this.tooltip,!0)},updateAria(e){Z(this.$el,"aria-expanded",e)}},events:{focus:"show",blur:"hide",[tr+" "+rr](e){Ue(e)||this[e.type===tr?"show":"hide"]()},[Xt](e){Ue(e)&&this.show()}}}
var Bs={props:{allow:String,clsDragover:String,concurrent:Number,maxSize:Number,method:String,mime:String,msgInvalidMime:String,msgInvalidName:String,msgInvalidSize:String,multiple:Boolean,name:String,params:Object,type:String,url:String},data:{allow:!1,clsDragover:"uk-dragover",concurrent:1,maxSize:0,method:"POST",mime:!1,msgInvalidMime:"Invalid File Type: %s",msgInvalidName:"Invalid File Name: %s",msgInvalidSize:"Invalid File Size: %s Kilobytes Max",multiple:!1,name:"files[]",params:{},type:"",url:"",abort:V,beforeAll:V,beforeSend:V,complete:V,completeAll:V,error:V,fail:V,load:V,loadEnd:V,loadStart:V,progress:V},events:{change(e){ce(e.target,'input[type="file"]')&&(e.preventDefault(),e.target.files&&this.upload(e.target.files),e.target.value="")},drop(e){Hs(e)
const t=e.dataTransfer
null!=t&&t.files&&(Je(this.$el,this.clsDragover),this.upload(t.files))},dragenter(e){Hs(e)},dragover(e){Hs(e),Xe(this.$el,this.clsDragover)},dragleave(e){Hs(e),Je(this.$el,this.clsDragover)}},methods:{async upload(e){if(!(e=f(e)).length)return
je(this.$el,"upload",[e])
...
if(this.allow&&!Us(this.allow,n.name))return void this.fail(this.msgInvalidName.replace("%s",this.allow))
if(this.mime&&!Us(this.mime,n.type))return void this.fail(this.msgInvalidMime.replace("%s",this.mime))}this.multiple||(e=e.slice(0,1)),this.beforeAll(this,e)
...
await r(t.shift())}}}
function Us(e,t){return t.match(new RegExp("^"+e.replace(/\//g,"\\/").replace(/\*\*/g,"(\\/[^\\/]+)*").replace(/\*/g,"[^\\/]+").replace(/((?!\\))\?/g,"$1.")+"$","i"))}function Hs(e){e.preventDefault(),e.stopPropagation()}return z(Object.freeze({__proto__:null,Countdown:Pi,Filter:$i,Lightbox:ts,LightboxPanel:Ji,Notification:ns,Parallax:_s,Slider:Ms,SliderParallax:Rs,Slideshow:Ns,SlideshowParallax:Rs,Sortable:Ds,Tooltip:zs,Upload:Bs}),((e,t)=>en.component(t,e))),en})),"undefined"==typeof FastBoot&&/*! UIkit 3.13.7 | https://www.getuikit.com | (c) 2014 - 2022 YOOtheme | MIT License */
